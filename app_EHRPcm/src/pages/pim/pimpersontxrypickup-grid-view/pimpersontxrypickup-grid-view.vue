 ...
 *
 * @export
 * @class PIMPERSONTXRYPickupGridView
 * @extends {PIMPERSONTXRYPickupGridViewBase}
 */
@Component({
    components: {
        view_grid, 
...
export default class PIMPERSONTXRYPickupGridView extends PIMPERSONTXRYPickupGridViewBase { }
</script>