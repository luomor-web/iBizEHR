<template>
  <app-layout viewName="pcmzpmeglcurndgridview" viewTitle="招聘名额管理表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmzpmeglcur-ndgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="招聘名额管理名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PCMZPMEGLCurNDGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMZPMEGLCurNDGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMZPMEGLCurNDGridViewBase
	 */
	public viewtag: string = '92d6e3a013c18695f7b151d402b408e1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmzpmegl.views.curndgridview.caption',
        srfTitle: 'entities.pcmzpmegl.views.curndgridview.title',
        srfSubTitle: 'entities.pcmzpmegl.views.curndgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMZPMEGLCurNDGridView
     */
...
<style lang='less'>
@import './pcmzpmeglcur-ndgrid-view.less';
</style>