<template>
  <app-layout viewName="pcmprofileszyjtjmpickupview" viewTitle="应聘者社招引进条件选择" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcmprofileszyjtjmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILESZYJTJMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILESZYJTJMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PCMPROFILESZYJTJService}
     * @memberof PCMPROFILESZYJTJMPickupViewBase
     */
    public appEntityService: PCMPROFILESZYJTJService = new PCMPROFILESZYJTJService;
	 ...
	 * @memberof PCMPROFILESZYJTJMPickupViewBase
	 */
	public viewtag: string = '6dabeb1f930b9a81c11e6ea38ceb5e1b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofileszyjtj.views.mpickupview.caption',
        srfTitle: 'entities.pcmprofileszyjtj.views.mpickupview.title',
        srfSubTitle: 'entities.pcmprofileszyjtj.views.mpickupview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            keyPSDEField: 'pcmprofileszyjtj',
            majorPSDEField: 'pcmprofileszyjtjname',
            isLoadDefault: true,
        });
    }
     ...
     *
     * @type {any[]}
     * @memberof PCMPROFILESZYJTJMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmprofileszyjtjname']});
                })
            }
...
<style lang='less'>
@import './pcmprofileszyjtjmpickup-view.less';
</style>