<template>
  <app-layout viewName="pcmprofilerlsb_csrcyjgridview" viewTitle="人力上报" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilerlsb-csrcyjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILERLSB_CSRCYJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILERLSB_CSRCYJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILERLSB_CSRCYJGridViewBase
     */
	 ...
	 * @memberof PCMPROFILERLSB_CSRCYJGridViewBase
	 */
	public viewtag: string = '15fb46caf3382c9945d236ca18ebb8b7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.rlsb_csrcyjgridview.caption',
        srfTitle: 'entities.pcmprofile.views.rlsb_csrcyjgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.rlsb_csrcyjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILERLSB_CSRCYJGridView
     */
...
<style lang='less'>
@import './pcmprofilerlsb-csrcyjgrid-view.less';
</style>