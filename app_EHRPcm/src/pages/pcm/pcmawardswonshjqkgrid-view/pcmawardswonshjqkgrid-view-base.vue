<template>
  <app-layout viewName="pcmawardswonshjqkgridview" viewTitle="获奖情况（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmawardswonshjqkgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMAWARDSWONSHJQKGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMAWARDSWONSHJQKGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PCMAWARDSWONSService}
     * @memberof PCMAWARDSWONSHJQKGridViewBase
     */
	 ...
	 * @memberof PCMAWARDSWONSHJQKGridViewBase
	 */
	public viewtag: string = 'b73b674c74676f40d1c9a1663b14d6ab';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmawardswons.views.hjqkgridview.caption',
        srfTitle: 'entities.pcmawardswons.views.hjqkgridview.title',
        srfSubTitle: 'entities.pcmawardswons.views.hjqkgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMAWARDSWONSHJQKGridView
     */
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
    ...
    protected toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
    ...
    protected toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
    ...
    protected toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMAWARDSWONS");
    }
...
<style lang='less'>
@import './pcmawardswonshjqkgrid-view.less';
</style>