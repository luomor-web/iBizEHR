<template>
  <app-layout viewName="pcmprofilebhsp_csrcyjgridview" viewTitle="编号审批" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilebhsp-csrcyjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEBHSP_CSRCYJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEBHSP_CSRCYJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEBHSP_CSRCYJGridViewBase
     */
	 ...
	 * @memberof PCMPROFILEBHSP_CSRCYJGridViewBase
	 */
	public viewtag: string = '22c7bdfbf9ee4e1c7e58c4f5dcae4eb3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.bhsp_csrcyjgridview.caption',
        srfTitle: 'entities.pcmprofile.views.bhsp_csrcyjgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.bhsp_csrcyjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEBHSP_CSRCYJGridView
     */
    public toolBarModels: any = {
        tbitem1_scbh: { name: 'tbitem1_scbh', caption: '生成编号','isShowCaption':true,'isShowIcon':true, tooltip: '生成编号', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'SCBH', target: 'MULTIKEY' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_scbh')) {
            this.toolbar_tbitem1_scbh_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_scbh_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PcmProfile_SCBH(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofilebhsp-csrcyjedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.bhsp_csrcyjeditview.title'),
...
<style lang='less'>
@import './pcmprofilebhsp-csrcyjgrid-view.less';
</style>