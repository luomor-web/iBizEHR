 ...
 *
 * @export
 * @class PCMPROFILEBHSP_CSRCYJGridView
 * @extends {PCMPROFILEBHSP_CSRCYJGridViewBase}
 */
@Component({
    components: {
        view_grid, 
...
export default class PCMPROFILEBHSP_CSRCYJGridView extends PCMPROFILEBHSP_CSRCYJGridViewBase { }
</script>