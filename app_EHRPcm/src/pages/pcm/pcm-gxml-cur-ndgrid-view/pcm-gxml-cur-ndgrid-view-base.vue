<template>
  <app-layout viewName="pcmgxmlcurndgridview" viewTitle="高校名录表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-gxml-cur-ndgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class PcmGxmlCurNDGridViewBase extends GridViewBase {
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmgxmledit-view', 
            height: 0, 
            width: 1024,  
            title: this.$t('entities.pcmgxml.views.editview.title'),
...
<style lang='less'>
@import './pcm-gxml-cur-ndgrid-view.less';
</style>