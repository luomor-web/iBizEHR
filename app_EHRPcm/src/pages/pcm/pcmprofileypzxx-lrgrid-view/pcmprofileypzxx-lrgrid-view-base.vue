<template>
  <app-layout viewName="pcmprofileypzxx_lrgridview" viewTitle="应聘者信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofileypzxx-lrgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEYPZXX_LRGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEYPZXX_LRGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEYPZXX_LRGridViewBase
     */
	 ...
	 * @memberof PCMPROFILEYPZXX_LRGridViewBase
	 */
	public viewtag: string = '43659d36205f0188071e2809bae87960';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.ypzxx_lrgridview.caption',
        srfTitle: 'entities.pcmprofile.views.ypzxx_lrgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.ypzxx_lrgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEYPZXX_LRGridView
     */
     ...
     * @memberof 
     */
    public toolbar_tbitem1_xz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofileypzxx-lredit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.ypzxx_lreditview.title'),
...
<style lang='less'>
@import './pcmprofileypzxx-lrgrid-view.less';
</style>