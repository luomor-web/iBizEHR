...
export default class PCMPROFILEYPZXX_LRGridViewBase extends GridViewBase {
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_tj')) {
            this.toolbar_tbitem1_tj_click($event, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_xz')) {
            this.toolbar_tbitem1_xz_click($event, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_kscypz')) {
            this.toolbar_tbitem1_kscypz_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    protected toolbar_tbitem1_tj_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected toolbar_tbitem1_xz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected toolbar_tbitem1_kscypz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
