<template>
  <app-layout viewName="pcmpracticeexperiencesxjygridview" viewTitle="实习信息（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmpracticeexperiencesxjygrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPRACTICEEXPERIENCESXJYGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPRACTICEEXPERIENCESXJYGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMPRACTICEEXPERIENCESXJYGridViewBase
	 */
	public viewtag: string = 'b7850952c7fc5ac38fe2077bbe70485b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmpracticeexperience.views.sxjygridview.caption',
        srfTitle: 'entities.pcmpracticeexperience.views.sxjygridview.title',
        srfSubTitle: 'entities.pcmpracticeexperience.views.sxjygridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPRACTICEEXPERIENCESXJYGridView
     */
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMPRACTICEEXPERIENCE");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMPRACTICEEXPERIENCE");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMPRACTICEEXPERIENCE");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMPRACTICEEXPERIENCE");
    }
...
<style lang='less'>
@import './pcmpracticeexperiencesxjygrid-view.less';
</style>