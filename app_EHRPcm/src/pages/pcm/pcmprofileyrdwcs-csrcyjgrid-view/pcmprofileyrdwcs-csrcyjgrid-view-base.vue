<template>
  <app-layout viewName="pcmprofileyrdwcs_csrcyjgridview" viewTitle="用人单位初审" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofileyrdwcs-csrcyjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchYRDWCS_CSRCYJ"
    :newdata="newdata"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PCMPROFILEYRDWCS_CSRCYJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEYRDWCS_CSRCYJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEYRDWCS_CSRCYJGridViewBase
     */
	 ...
	 * @memberof PCMPROFILEYRDWCS_CSRCYJGridViewBase
	 */
	public viewtag: string = '7e2d64b3935aa65a617cf850dbc29143';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.yrdwcs_csrcyjgridview.caption',
        srfTitle: 'entities.pcmprofile.views.yrdwcs_csrcyjgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.yrdwcs_csrcyjgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_gssp')) {
            this.toolbar_tbitem1_gssp_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_gssp_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofileyrdwcs-csrcyjedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.yrdwcs_csrcyjeditview.title'),
...
<style lang='less'>
@import './pcmprofileyrdwcs-csrcyjgrid-view.less';
</style>