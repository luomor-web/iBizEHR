<template>
  <app-layout viewName="pcmprofilebhspgridview" viewTitle="编号审批" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilebhspgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEBHSPGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEBHSPGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEBHSPGridViewBase
     */
	 ...
	 * @memberof PCMPROFILEBHSPGridViewBase
	 */
	public viewtag: string = 'a5ff9e62a82d14a07d81db0c0ef586e1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.bhspgridview.caption',
        srfTitle: 'entities.pcmprofile.views.bhspgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.bhspgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEBHSPGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofilebhspedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.bhspeditview.title'),
...
<style lang='less'>
@import './pcmprofilebhspgrid-view.less';
</style>