<template>
  <app-layout viewName="pcmprofilerzspgridview" viewTitle="局总部初审" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilerzspgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILERZSPGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILERZSPGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILERZSPGridViewBase
     */
	 ...
	 * @memberof PCMPROFILERZSPGridViewBase
	 */
	public viewtag: string = 'feaa15f9310a9dc4cc089eac9844e85f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.rzspgridview.caption',
        srfTitle: 'entities.pcmprofile.views.rzspgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.rzspgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILERZSPGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            ...
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.rzspeditview.title'),
...
<style lang='less'>
@import './pcmprofilerzspgrid-view.less';
</style>