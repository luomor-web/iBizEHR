<template>
  <app-layout viewName="pcmprofilezpdwshgridview" viewTitle="用人单位初审" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilezpdwshgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEZPDWSHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEZPDWSHGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMPROFILEZPDWSHGridViewBase
	 */
	public viewtag: string = 'f666d946fa169ea6c954caff48070694';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.zpdwshgridview.caption',
        srfTitle: 'entities.pcmprofile.views.zpdwshgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.zpdwshgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEZPDWSHGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofilezpdwshedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.zpdwsheditview.title'),
...
<style lang='less'>
@import './pcmprofilezpdwshgrid-view.less';
</style>