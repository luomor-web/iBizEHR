<template>
  <app-layout viewName="testresultcpjg_wsswbjgridview" viewTitle="测评结果摘要信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'test-result-cpjg-wsswbjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TestResultCPJG_WSSWBJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TestResultCPJG_WSSWBJGridViewBase extends GridViewBase {
	 ...
	 * @memberof TestResultCPJG_WSSWBJGridViewBase
	 */
	public viewtag: string = 'b11d32b948546b8182fe02016f89ec41';
     ...
     *
     * @type {*}
     * @memberof TestResultCPJG_WSSWBJGridView
     */
...
<style lang='less'>
@import './test-result-cpjg-wsswbjgrid-view.less';
</style>