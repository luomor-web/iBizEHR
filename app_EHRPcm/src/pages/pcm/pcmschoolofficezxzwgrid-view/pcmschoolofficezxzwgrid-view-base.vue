<template>
  <app-layout viewName="pcmschoolofficezxzwgridview" viewTitle="在校职务（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmschoolofficezxzwgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMSCHOOLOFFICEZXZWGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMSCHOOLOFFICEZXZWGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMSCHOOLOFFICEZXZWGridViewBase
	 */
	public viewtag: string = '56c145537274f073f9b98375809e6010';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmschooloffice.views.zxzwgridview.caption',
        srfTitle: 'entities.pcmschooloffice.views.zxzwgridview.title',
        srfSubTitle: 'entities.pcmschooloffice.views.zxzwgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMSCHOOLOFFICEZXZWGridView
     */
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMSCHOOLOFFICE");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMSCHOOLOFFICE");
    }
...
<style lang='less'>
@import './pcmschoolofficezxzwgrid-view.less';
</style>