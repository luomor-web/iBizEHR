<template>
  <app-layout viewName="tdzwxxtdzw_wsswbjgridview" viewTitle="投递职位摘要信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'tdzwxxtdzw-wsswbjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TDZWXXTDZW_WSSWBJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TDZWXXTDZW_WSSWBJGridViewBase extends GridViewBase {
	 ...
	 * @memberof TDZWXXTDZW_WSSWBJGridViewBase
	 */
	public viewtag: string = 'd11d7cff3a3a81ba0788cddd5506d701';
     ...
     *
     * @type {*}
     * @memberof TDZWXXTDZW_WSSWBJGridView
     */
...
<style lang='less'>
@import './tdzwxxtdzw-wsswbjgrid-view.less';
</style>