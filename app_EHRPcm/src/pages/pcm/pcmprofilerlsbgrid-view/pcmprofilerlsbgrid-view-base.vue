<template>
  <app-layout viewName="pcmprofilerlsbgridview" viewTitle="人力上报" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilerlsbgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILERLSBGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILERLSBGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILERLSBGridViewBase
     */
	 ...
	 * @memberof PCMPROFILERLSBGridViewBase
	 */
	public viewtag: string = '542a69a23fcce66c228b0a9dd3d8ac3a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.rlsbgridview.caption',
        srfTitle: 'entities.pcmprofile.views.rlsbgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.rlsbgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILERLSBGridView
     */
    public toolBarModels: any = {
        tbitem1_sbjzb: { name: 'tbitem1_sbjzb', caption: '提交','isShowCaption':true,'isShowIcon':true, tooltip: '提交', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'SRFUR__RLSBCZAN', uiaction: { tag: 'SBJZB', target: 'MULTIKEY' }, class: '' },

        tbitem14_returnypz: { name: 'tbitem14_returnypz', caption: '失效','isShowCaption':true,'isShowIcon':true, tooltip: '失效', iconcls: 'backspace', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'SRFUR__RLSBCZAN', uiaction: { tag: 'ReturnYPZ', target: 'MULTIKEY' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_sbjzb')) {
            this.toolbar_tbitem1_sbjzb_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem14_returnypz')) {
            this.toolbar_tbitem14_returnypz_click(null, '', $event2);
        }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PcmProfile");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmProfile");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_sbjzb_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PcmProfile_SBJZB(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem14_returnypz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PcmProfileUIService  = new PcmProfileUIService();
        curUIService.PcmProfile_ReturnYPZ(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofilerlsbedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.rlsbeditview.title'),
...
<style lang='less'>
@import './pcmprofilerlsbgrid-view.less';
</style>