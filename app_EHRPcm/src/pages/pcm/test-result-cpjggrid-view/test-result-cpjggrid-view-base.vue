<template>
  <app-layout viewName="testresultcpjggridview" viewTitle="测评结果摘要信息（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'test-result-cpjggrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TestResultCPJGGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TestResultCPJGGridViewBase extends GridViewBase {
	 ...
	 * @memberof TestResultCPJGGridViewBase
	 */
	public viewtag: string = '3d7985f2b41ff52bea5ebcf3bacc6169';
     ...
     *
     * @type {*}
     * @memberof TestResultCPJGGridView
     */
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TestResult");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"TestResult");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TestResult");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TestResult");
    }
...
<style lang='less'>
@import './test-result-cpjggrid-view.less';
</style>