<template>
  <app-layout viewName="pcmeducationexperiencejybjgridview" viewTitle="教育信息（要求：1.高中以上，2.带*必填，3.大专学位证用毕业证代替）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmeducation-experience-jybjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
/**
 * 教育信息（要求：1.高中以上，2.带*必填，3.大专学位证用毕业证代替）基类
 *
 * @export
 * @class PCMEducationExperienceJYBJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMEducationExperienceJYBJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PCMEducationExperienceService}
     * @memberof PCMEducationExperienceJYBJGridViewBase
     */
	 ...
	 * @memberof PCMEducationExperienceJYBJGridViewBase
	 */
	public viewtag: string = 'c1296113c6baff077df6b1f1b1711266';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmeducationexperience.views.jybjgridview.caption',
        srfTitle: 'entities.pcmeducationexperience.views.jybjgridview.title',
        srfSubTitle: 'entities.pcmeducationexperience.views.jybjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMEducationExperienceJYBJGridView
     */
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
    ...
    protected toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
    ...
    protected toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
    ...
    protected toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMEducationExperience");
    }
...
<style lang='less'>
@import './pcmeducation-experience-jybjgrid-view.less';
</style>