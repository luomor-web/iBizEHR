<template>
  <app-layout viewName="pcmprofileypzbd_csrcyjgridview" viewTitle="拟录用人员" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofileypzbd-csrcyjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEYPZBD_CSRCYJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEYPZBD_CSRCYJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEYPZBD_CSRCYJGridViewBase
     */
	 ...
	 * @memberof PCMPROFILEYPZBD_CSRCYJGridViewBase
	 */
	public viewtag: string = '1178128e98145594a3c2fb6ba6a24b53';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.ypzbd_csrcyjgridview.caption',
        srfTitle: 'entities.pcmprofile.views.ypzbd_csrcyjgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.ypzbd_csrcyjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEYPZBD_CSRCYJGridView
     */
    public toolBarModels: any = {
        tbitem1_bd: { name: 'tbitem1_bd', caption: '报到','isShowCaption':true,'isShowIcon':true, tooltip: '报到', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'BDANCXQX', uiaction: { tag: 'BD', target: 'MULTIKEY' }, class: '' },

        tbitem1_yqwbd: { name: 'tbitem1_yqwbd', caption: '逾期未报到','isShowCaption':true,'isShowIcon':true, tooltip: '逾期未报到', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'YQWBDCXQX', uiaction: { tag: 'YQWBD', target: 'MULTIKEY' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_bd')) {
            this.toolbar_tbitem1_bd_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_yqwbd')) {
            this.toolbar_tbitem1_yqwbd_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_bd_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PcmProfile_BD(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_yqwbd_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PcmProfileUIService  = new PcmProfileUIService();
        curUIService.PcmProfile_YQWBD(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofileypzbd-csrcyjedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.ypzbd_csrcyjeditview.title'),
...
<style lang='less'>
@import './pcmprofileypzbd-csrcyjgrid-view.less';
</style>