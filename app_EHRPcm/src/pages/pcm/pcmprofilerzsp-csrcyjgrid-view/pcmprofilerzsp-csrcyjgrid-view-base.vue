<template>
  <app-layout viewName="pcmprofilerzsp_csrcyjgridview" viewTitle="局总部初审" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilerzsp-csrcyjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILERZSP_CSRCYJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILERZSP_CSRCYJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILERZSP_CSRCYJGridViewBase
     */
	 ...
	 * @memberof PCMPROFILERZSP_CSRCYJGridViewBase
	 */
	public viewtag: string = '4f5dde5e2adf0c18d9177424546f212f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.rzsp_csrcyjgridview.caption',
        srfTitle: 'entities.pcmprofile.views.rzsp_csrcyjgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.rzsp_csrcyjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILERZSP_CSRCYJGridView
     */
    public toolBarModels: any = {
        tbitem1_jzbtg: { name: 'tbitem1_jzbtg', caption: '初审通过','isShowCaption':true,'isShowIcon':true, tooltip: '初审通过', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'JZBTG', target: 'MULTIKEY' }, class: '' },

        tbitem1_jzbbtg: { name: 'tbitem1_jzbbtg', caption: '初审不通过','isShowCaption':true,'isShowIcon':true, tooltip: '初审不通过', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'JZBBTG', target: 'MULTIKEY' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_jzbtg')) {
            this.toolbar_tbitem1_jzbtg_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_jzbbtg')) {
            this.toolbar_tbitem1_jzbbtg_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_jzbtg_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PcmProfile_JZBTG(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_jzbbtg_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PcmProfileUIService  = new PcmProfileUIService();
        curUIService.PcmProfile_JZBBTG(datas,contextJO, paramJO,  $event, xData,this,"PcmProfile");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            ...
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.rzsp_csrcyjeditview.title'),
...
<style lang='less'>
@import './pcmprofilerzsp-csrcyjgrid-view.less';
</style>