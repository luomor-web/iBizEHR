 ...
 *
 * @export
 * @class PCMPROFILERZSP_CSRCYJGridView
 * @extends {PCMPROFILERZSP_CSRCYJGridViewBase}
 */
@Component({
    components: {
        view_grid, 
...
export default class PCMPROFILERZSP_CSRCYJGridView extends PCMPROFILERZSP_CSRCYJGridViewBase { }
</script>