<template>
  <app-layout viewName="pcmprofileypzxx_csrcyjgridview" viewTitle="应聘者信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofileypzxx-csrcyjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="姓名，员工编号" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PCMPROFILEYPZXX_CSRCYJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEYPZXX_CSRCYJGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMPROFILEYPZXX_CSRCYJGridViewBase
	 */
	public viewtag: string = 'f5db4770bcce6f7852031664b852654c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.ypzxx_csrcyjgridview.caption',
        srfTitle: 'entities.pcmprofile.views.ypzxx_csrcyjgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.ypzxx_csrcyjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEYPZXX_CSRCYJGridView
     */
    public toolBarModels: any = {
        tbitem1_tj: { name: 'tbitem1_tj', caption: '提交','isShowCaption':true,'isShowIcon':true, tooltip: '提交', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'SRFUR__YPZXXCZAN', uiaction: { tag: 'TJ', target: 'MULTIKEY' }, class: '' },

        tbitem1_sz: { name: 'tbitem1_sz', caption: '社招','isShowCaption':true,'isShowIcon':true, tooltip: '社招', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'SZ', target: 'NONE' }, class: '' },

        tbitem1_fp: { name: 'tbitem1_fp', caption: '返聘','isShowCaption':true,'isShowIcon':true, tooltip: '返聘', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'FP', target: 'NONE' }, class: '' },

        tbitem1_qtzp: { name: 'tbitem1_qtzp', caption: '其他招聘','isShowCaption':true,'isShowIcon':true, tooltip: '其他招聘', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'QTZP', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_tj')) {
            this.toolbar_tbitem1_tj_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_sz')) {
            this.toolbar_tbitem1_sz_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_fp')) {
            this.toolbar_tbitem1_fp_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_qtzp')) {
            this.toolbar_tbitem1_qtzp_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_tj_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    public toolbar_tbitem1_sz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    public toolbar_tbitem1_fp_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    public toolbar_tbitem1_qtzp_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofileypzxx-csrcyjedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.ypzxx_csrcyjeditview.title'),
...
<style lang='less'>
@import './pcmprofileypzxx-csrcyjgrid-view.less';
</style>