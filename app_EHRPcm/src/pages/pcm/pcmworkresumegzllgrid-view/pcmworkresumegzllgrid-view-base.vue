<template>
  <app-layout viewName="pcmworkresumegzllgridview" viewTitle="工作履历（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmworkresumegzllgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMWORKRESUMEGZLLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMWORKRESUMEGZLLGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMWORKRESUMEGZLLGridViewBase
	 */
	public viewtag: string = '0a36bba4db0f174309b0dbcd9fbcdb55';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmworkresume.views.gzllgridview.caption',
        srfTitle: 'entities.pcmworkresume.views.gzllgridview.title',
        srfSubTitle: 'entities.pcmworkresume.views.gzllgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMWORKRESUMEGZLLGridView
     */
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMWORKRESUME");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMWORKRESUME");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMWORKRESUME");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMWORKRESUME");
    }
...
<style lang='less'>
@import './pcmworkresumegzllgrid-view.less';
</style>