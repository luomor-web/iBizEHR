<template>
  <app-layout viewName="tdzwxxtdzwgridview" viewTitle="投递职位摘要信息（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'tdzwxxtdzwgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TDZWXXTDZWGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TDZWXXTDZWGridViewBase extends GridViewBase {
	 ...
	 * @memberof TDZWXXTDZWGridViewBase
	 */
	public viewtag: string = 'feefa68dff81c415ed3f7dfa3ffcc084';
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TDZWXX");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"TDZWXX");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TDZWXX");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TDZWXX");
    }
...
<style lang='less'>
@import './tdzwxxtdzwgrid-view.less';
</style>