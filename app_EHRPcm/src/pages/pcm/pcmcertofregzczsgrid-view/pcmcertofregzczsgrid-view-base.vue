<template>
  <app-layout viewName="pcmcertofregzczsgridview" viewTitle="注册证书（要求：带*必填）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmcertofregzczsgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMCERTOFREGZCZSGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMCERTOFREGZCZSGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PCMCERTOFREGService}
     * @memberof PCMCERTOFREGZCZSGridViewBase
     */
	 ...
	 * @memberof PCMCERTOFREGZCZSGridViewBase
	 */
	public viewtag: string = 'a6fe2d0f44d114e686eb214a6dd4b209';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmcertofreg.views.zczsgridview.caption',
        srfTitle: 'entities.pcmcertofreg.views.zczsgridview.title',
        srfSubTitle: 'entities.pcmcertofreg.views.zczsgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMCERTOFREGZCZSGridView
     */
    ...
    protected toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
    ...
    protected toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
    ...
    protected toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
    ...
    protected toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
    ...
    protected toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
    ...
    protected toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
    ...
    protected toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMCERTOFREG");
    }
...
<style lang='less'>
@import './pcmcertofregzczsgrid-view.less';
</style>