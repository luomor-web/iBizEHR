<template>
  <app-layout viewName="pcmprofilespyygridview" viewTitle="应聘者审批原因表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofilespyygrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="应聘者审批原因名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PCMPROFILESPYYGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILESPYYGridViewBase extends GridViewBase {
	 ...
	 * @memberof PCMPROFILESPYYGridViewBase
	 */
	public viewtag: string = '03d90de71e9cd72a66f040a42cd48d1b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofilespyy.views.gridview.caption',
        srfTitle: 'entities.pcmprofilespyy.views.gridview.title',
        srfSubTitle: 'entities.pcmprofilespyy.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILESPYYGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMPROFILESPYY");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMPROFILESPYY");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMPROFILESPYY");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMPROFILESPYY");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMPROFILESPYY");
    }
...
<style lang='less'>
@import './pcmprofilespyygrid-view.less';
</style>