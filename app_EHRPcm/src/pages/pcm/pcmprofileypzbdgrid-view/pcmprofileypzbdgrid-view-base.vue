<template>
  <app-layout viewName="pcmprofileypzbdgridview" viewTitle="拟录用人员" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmprofileypzbdgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEYPZBDGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEYPZBDGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEYPZBDGridViewBase
     */
	 ...
	 * @memberof PCMPROFILEYPZBDGridViewBase
	 */
	public viewtag: string = 'bf2d5739527f564355ffe5ffce92d9a6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.ypzbdgridview.caption',
        srfTitle: 'entities.pcmprofile.views.ypzbdgridview.title',
        srfSubTitle: 'entities.pcmprofile.views.ypzbdgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEYPZBDGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcmprofileypzbdedit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmprofile.views.ypzbdeditview.title'),
...
<style lang='less'>
@import './pcmprofileypzbdgrid-view.less';
</style>