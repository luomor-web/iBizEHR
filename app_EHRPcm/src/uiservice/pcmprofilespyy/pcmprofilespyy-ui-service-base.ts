 ...
 *
 * @export
 * @class PCMPROFILESPYYUIServiceBase
 */
export default class PCMPROFILESPYYUIServiceBase extends UIService {
     ...
     * @memberof  PCMPROFILESPYYUIServiceBase
     */
    protected dataService:PCMPROFILESPYYService = new PCMPROFILESPYYService();
    ...
    /**
     * Creates an instance of  PCMPROFILESPYYUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMPROFILESPYYUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmprofilespyy:srfkey});
