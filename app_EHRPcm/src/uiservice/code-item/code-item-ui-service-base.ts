 ...
 */
export default class CodeItemUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  CodeItemUIServiceBase
     */
     ...
     * @memberof  CodeItemUIServiceBase
     */
    protected dataService:CodeItemService = new CodeItemService();
    ...
    /**
     * Creates an instance of  CodeItemUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  CodeItemUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({codeitem:srfkey});
