 ...
 *
 * @export
 * @class PCMCERTOFREGUIServiceBase
 */
export default class PCMCERTOFREGUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PCMCERTOFREGUIServiceBase
     */
     ...
     * @memberof  PCMCERTOFREGUIServiceBase
     */
    protected dataService:PCMCERTOFREGService = new PCMCERTOFREGService();
    ...
    /**
     * Creates an instance of  PCMCERTOFREGUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMCERTOFREGUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmcertofreg:srfkey});
