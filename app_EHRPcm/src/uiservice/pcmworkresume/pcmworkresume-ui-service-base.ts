 ...
 *
 * @export
 * @class PCMWORKRESUMEUIServiceBase
 */
export default class PCMWORKRESUMEUIServiceBase extends UIService {
     ...
     * @memberof  PCMWORKRESUMEUIServiceBase
     */
    protected dataService:PCMWORKRESUMEService = new PCMWORKRESUMEService();
    ...
    /**
     * Creates an instance of  PCMWORKRESUMEUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMWORKRESUMEUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmworkresume:srfkey});
