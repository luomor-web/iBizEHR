 ...
 *
 * @export
 * @class PCMPROFILEAPPROVALUIServiceBase
 */
export default class PCMPROFILEAPPROVALUIServiceBase extends UIService {
     ...
     * @memberof  PCMPROFILEAPPROVALUIServiceBase
     */
    protected dataService:PCMPROFILEAPPROVALService = new PCMPROFILEAPPROVALService();
    ...
    /**
     * Creates an instance of  PCMPROFILEAPPROVALUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMPROFILEAPPROVALUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmprofileapproval:srfkey});
