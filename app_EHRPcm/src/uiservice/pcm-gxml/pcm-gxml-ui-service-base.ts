 ...
 *
 * @export
 * @class PcmGxmlUIServiceBase
 */
export default class PcmGxmlUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PcmGxmlUIServiceBase
     */
     ...
     * @memberof  PcmGxmlUIServiceBase
     */
    public dataService:PcmGxmlService = new PcmGxmlService();
    ...
    /**
     * Creates an instance of  PcmGxmlUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PcmGxmlUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmgxml:srfkey});
