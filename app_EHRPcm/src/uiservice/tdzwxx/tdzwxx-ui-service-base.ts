 ...
 *
 * @export
 * @class TDZWXXUIServiceBase
 */
export default class TDZWXXUIServiceBase extends UIService {
     ...
     * @memberof  TDZWXXUIServiceBase
     */
    protected dataService:TDZWXXService = new TDZWXXService();
    ...
    /**
     * Creates an instance of  TDZWXXUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TDZWXXUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({tdzwxx:srfkey});
