 ...
 *
 * @export
 * @class PCMAWARDSWONSUIServiceBase
 */
export default class PCMAWARDSWONSUIServiceBase extends UIService {
     ...
     * @memberof  PCMAWARDSWONSUIServiceBase
     */
    protected dataService:PCMAWARDSWONSService = new PCMAWARDSWONSService();
    ...
    /**
     * Creates an instance of  PCMAWARDSWONSUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMAWARDSWONSUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmawardswons:srfkey});
