...
import RYBD_CSRCYJModel from './rybd-csrcyj-form-model';
 ...
 *
 * @export
 * @class RYBD_CSRCYJService
 */
export default class RYBD_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof RYBD_CSRCYJService
     */
    ...
    /**
     * Creates an instance of RYBD_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof RYBD_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYBD_CSRCYJModel();
    }
