...
import XD_SZService from './xd-sz-wizardpanel-service';
...
export default class XD_SZBase extends Vue implements ControlInterface {
     ...
     * @memberof XD_SZBase
     */
    public service: XD_SZService = new XD_SZService({ $store: this.$store });
    ...
    public regFormActions() {
        ...
        this.regFormAction('wizardpanel_form_wizard05', ['PREV','FINISH']);
    }
