...
import RLSB_CSRCYJModel from './rlsb-csrcyj-form-model';
 ...
 *
 * @export
 * @class RLSB_CSRCYJService
 */
export default class RLSB_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof RLSB_CSRCYJService
     */
    ...
    /**
     * Creates an instance of RLSB_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof RLSB_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RLSB_CSRCYJModel();
    }
