...
import YRDWCS_CSRCYJModel from './yrdwcs-csrcyj-form-model';
...
/**
 * YRDWCS_CSRCYJ 部件服务对象
 *
 * @export
 * @class YRDWCS_CSRCYJService
 */
export default class YRDWCS_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof YRDWCS_CSRCYJService
     */
    ...
    /**
     * Creates an instance of YRDWCS_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof YRDWCS_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new YRDWCS_CSRCYJModel();
    }
