...
import RLSBModel from './rlsb-form-model';
 ...
 * @class RLSBService
 */
export default class RLSBService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof RLSBService
     */
    ...
    /**
     * Creates an instance of RLSBService.
     * 
     * @param {*} [opts={}]
     * @memberof RLSBService
     */
