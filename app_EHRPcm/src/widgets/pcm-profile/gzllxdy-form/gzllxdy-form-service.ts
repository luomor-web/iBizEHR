...
import GZLLXDYModel from './gzllxdy-form-model';
 ...
 *
 * @export
 * @class GZLLXDYService
 */
export default class GZLLXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof GZLLXDYService
     */
    ...
    /**
     * Creates an instance of GZLLXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof GZLLXDYService
     */
