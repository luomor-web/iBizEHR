...
import ZCZSXDYModel from './zczsxdy-form-model';
 ...
 *
 * @export
 * @class ZCZSXDYService
 */
export default class ZCZSXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof ZCZSXDYService
     */
    ...
    /**
     * Creates an instance of ZCZSXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof ZCZSXDYService
     */
