<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard04'  id='pcmprofile_zczsxdy' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.zczsxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import ZCZSXDYService from './zczsxdy-form-service';
...
export default class ZCZSXDYBase extends Vue implements ControlInterface {
     ...
     * @memberof ZCZSXDY
     */
    public service: ZCZSXDYService = new ZCZSXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '注册证书', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.zczsxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public formValidateStatus(): boolean {
        const form: any = this.$refs.wizardpanel_form_wizard04;
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmprofile_zczsxdy',popTitle:'注册证书向导页'});
    }
    ...
    * @public
    * @param {*} [opt={}]
    * @memberof Wizardpanel_form_wizard04
    */
