...
import SZYPZXXXDYModel from './szypzxxxdy-form-model';
 ...
 *
 * @export
 * @class SZYPZXXXDYService
 */
export default class SZYPZXXXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof SZYPZXXXDYService
     */
    ...
    /**
     * Creates an instance of SZYPZXXXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof SZYPZXXXDYService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new SZYPZXXXDYModel();
    }
