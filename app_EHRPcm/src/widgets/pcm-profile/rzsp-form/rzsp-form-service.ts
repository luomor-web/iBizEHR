...
import RZSPModel from './rzsp-form-model';
 ...
 * @class RZSPService
 */
export default class RZSPService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof RZSPService
     */
    ...
    /**
     * Creates an instance of RZSPService.
     * 
     * @param {*} [opts={}]
     * @memberof RZSPService
     */
