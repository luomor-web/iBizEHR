...
import BHSP_CSRCYJModel from './bhsp-csrcyj-form-model';
 ...
 *
 * @export
 * @class BHSP_CSRCYJService
 */
export default class BHSP_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof BHSP_CSRCYJService
     */
    ...
    /**
     * Creates an instance of BHSP_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof BHSP_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BHSP_CSRCYJModel();
    }
