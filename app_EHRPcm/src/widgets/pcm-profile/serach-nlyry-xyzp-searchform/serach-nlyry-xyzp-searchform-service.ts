...
import Serach_NLYRY_XYZPModel from './serach-nlyry-xyzp-searchform-model';


/**
 * Serach_NLYRY_XYZP 部件服务对象
 *
 * @export
 * @class Serach_NLYRY_XYZPService
 */
export default class Serach_NLYRY_XYZPService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof Serach_NLYRY_XYZPService
     */
    ...
    /**
     * Creates an instance of Serach_NLYRY_XYZPService.
     * 
     * @param {*} [opts={}]
     * @memberof Serach_NLYRY_XYZPService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Serach_NLYRY_XYZPModel();
    }
