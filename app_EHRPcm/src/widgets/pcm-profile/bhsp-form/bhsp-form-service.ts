...
import BHSPModel from './bhsp-form-model';
 ...
 * @class BHSPService
 */
export default class BHSPService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof BHSPService
     */
    ...
    /**
     * Creates an instance of BHSPService.
     * 
     * @param {*} [opts={}]
     * @memberof BHSPService
     */
