...
import RZSP_CSRCYJModel from './rzsp-csrcyj-form-model';
 ...
 *
 * @export
 * @class RZSP_CSRCYJService
 */
export default class RZSP_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof RZSP_CSRCYJService
     */
    ...
    /**
     * Creates an instance of RZSP_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof RZSP_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RZSP_CSRCYJModel();
    }
