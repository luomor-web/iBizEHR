<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmprofile_rzsp_csrcyj' style="">
...
<i-col v-show="detailsModel.rgjytg.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    ...
    <app-radio-group v-model="data.rgjytg"  :disabled="detailsModel.rgjytg.disabled"  name="rgjytg" tag='EhrCodeList0054' codelistType='STATIC'  style=""></app-radio-group>
</app-form-item>
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmprofile_rzsp_csrcyj',popTitle:'局总部初审（成熟人才引进）'});
    }
