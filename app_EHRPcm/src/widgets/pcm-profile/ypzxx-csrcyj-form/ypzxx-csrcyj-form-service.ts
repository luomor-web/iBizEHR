...
import YPZXX_CSRCYJModel from './ypzxx-csrcyj-form-model';
 ...
 *
 * @export
 * @class YPZXX_CSRCYJService
 */
export default class YPZXX_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof YPZXX_CSRCYJService
     */
    ...
    /**
     * Creates an instance of YPZXX_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof YPZXX_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new YPZXX_CSRCYJModel();
    }
