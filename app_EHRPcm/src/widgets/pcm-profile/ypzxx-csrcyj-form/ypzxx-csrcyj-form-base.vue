<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmprofile_ypzxx_csrcyj' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.grouppanel15.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel15.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel15')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.sfxzbjnbry.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='sfxzbjnbry' :itemRules="this.rules.sfxzbjnbry" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.sfxzbjnbry')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.sfxzbjnbry.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.grouppanel3.visible" :style="{}"  :lg="{ span: 16, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel3.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel3')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pcmprofilename.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='pcmprofilename' :itemRules="this.rules.pcmprofilename" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.pcmprofilename')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pcmprofilename.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ygbh.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='ygbh' :itemRules="this.rules.ygbh" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.ygbh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ygbh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.certificatetype.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='certificatetype' :itemRules="this.rules.certificatetype" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.certificatetype')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.certificatetype.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.certificatenumber.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='certificatenumber' :itemRules="this.rules.certificatenumber" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.certificatenumber')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.certificatenumber.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.birthday.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='birthday' :itemRules="this.rules.birthday" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.birthday')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.birthday.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.nl.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='nl' :itemRules="this.rules.nl" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.nl')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nl.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gender.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='gender' :itemRules="this.rules.gender" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.gender')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gender.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel5.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel5.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel5')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.nation.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='nation' :itemRules="this.rules.nation" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.nation')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nation.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.wedstate.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wedstate' :itemRules="this.rules.wedstate" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.wedstate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wedstate.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.bloodtype.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='bloodtype' :itemRules="this.rules.bloodtype" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.bloodtype')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bloodtype.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.nativeplace.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='nativeplace' :itemRules="this.rules.nativeplace" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.nativeplace')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nativeplace.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.hklx.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='hklx' :itemRules="this.rules.hklx" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.hklx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.hklx.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.rpr.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='rpr' :itemRules="this.rules.rpr" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.rpr')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.rpr.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.hjdz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='hjdz' :itemRules="this.rules.hjdz" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.hjdz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.hjdz.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.csd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='csd' :itemRules="this.rules.csd" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.csd')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.csd.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.address.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='address' :itemRules="this.rules.address" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.address')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.address.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.mobile.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='mobile' :itemRules="this.rules.mobile" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.mobile')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.mobile.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.email.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='email' :itemRules="this.rules.email" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.email')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.email.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.xznf.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='xznf' :itemRules="this.rules.xznf" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.xznf')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.xznf.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.yydj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='yydj' :itemRules="this.rules.yydj" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.yydj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yydj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.yydjmc.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='yydjmc' :itemRules="this.rules.yydjmc" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.yydjmc')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yydjmc.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.workbegindate.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='workbegindate' :itemRules="this.rules.workbegindate" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.workbegindate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.workbegindate.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.xzc.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='xzc' :itemRules="this.rules.xzc" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.xzc')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.xzc.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.xzc"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.xzc.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.jkzk.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='jkzk' :itemRules="this.rules.jkzk" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.jkzk')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jkzk.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ywzdjbs.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ywzdjbs' :itemRules="this.rules.ywzdjbs" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.ywzdjbs')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ywzdjbs.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.tjqk.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='tjqk' :itemRules="this.rules.tjqk" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.tjqk')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.tjqk.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel17.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel17.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel17')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.bz.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='bz' :itemRules="this.rules.bz" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.bz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.polity.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='polity' :itemRules="this.rules.polity" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.polity')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.polity.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.rdsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='rdsj' :itemRules="this.rules.rdsj" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.rdsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.rdsj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel6.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel6.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel6')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.isblacklist.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='isblacklist' :itemRules="this.rules.isblacklist" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.isblacklist')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.isblacklist.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel14.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel14.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel14')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.sfz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='sfz' :itemRules="this.rules.sfz" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.sfz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.sfz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zczs2.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zczs2' :itemRules="this.rules.zczs2" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.zczs2')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zczs2.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.otherfile.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='otherfile' :itemRules="this.rules.otherfile" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.otherfile')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.otherfile.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-form-item name='ormorgname' :itemRules="this.rules.ormorgname" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.ormorgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.rzqd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='rzqd' :itemRules="this.rules.rzqd" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.rzqd')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.rzqd.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gwlb.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gwlb' :itemRules="this.rules.gwlb" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.gwlb')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gwlb.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.gwlb" :data="data" :itemParam="{}" :disabled="detailsModel.gwlb.disabled"  tag='EhrCodeList0004' codelistType='STATIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.napxm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='napxm' :itemRules="this.rules.napxm" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.napxm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.napxm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.napxmjgwmc.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='napxmjgwmc' :itemRules="this.rules.napxmjgwmc" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.napxmjgwmc')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.napxmjgwmc.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gzbt.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gzbt' :itemRules="this.rules.gzbt" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.gzbt')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gzbt.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.gzbt"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.gzbt.disabled" type='number'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.grouppanel19.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel19.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel19')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.gzkssj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gzkssj' :itemRules="this.rules.gzkssj" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.gzkssj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gzkssj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gzjssj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gzjssj' :itemRules="this.rules.gzjssj" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.gzjssj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gzjssj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgsectorname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormorgsectorname' :itemRules="this.rules.ormorgsectorname" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.ormorgsectorname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgsectorname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.ormpostname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormpostname' :itemRules="this.rules.ormpostname" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.ormpostname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormpostname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.ormdutyname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormdutyname' :itemRules="this.rules.ormdutyname" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.ormdutyname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormdutyname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.wbzz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wbzz' :itemRules="this.rules.wbzz" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.wbzz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wbzz.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.wbzz"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.wbzz.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.wbzzjgdm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wbzzjgdm' :itemRules="this.rules.wbzzjgdm" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.wbzzjgdm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wbzzjgdm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.wbbm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wbbm' :itemRules="this.rules.wbbm" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.wbbm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wbbm.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.wbbm"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.wbbm.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.wbgw.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wbgw' :itemRules="this.rules.wbgw" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.wbgw')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wbgw.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.wbgw"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.wbgw.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.wbzw.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wbzw' :itemRules="this.rules.wbzw" class='' :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.wbzw')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wbzw.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel16.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel16.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel16')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel7.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel7.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel7')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel11.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel11.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel11')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel21.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel21.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel21')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel10.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel10.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel10')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel8.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel8.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel8')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel9.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel9.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel9')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel12.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel12.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel12')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel13.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel13.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.ypzxx_csrcyj_form.details.grouppanel13')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import YPZXX_CSRCYJService from './ypzxx-csrcyj-form-service';
...
export default class YPZXX_CSRCYJBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        rdsj: [
            ...
            { required: true, type: 'string', message: '入党时间 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '入党时间 值不能为空', trigger: 'blur' },
        ],
        isblacklist: [
...
, 
        grouppanel4: new FormGroupPanelModel({ caption: '照片', detailType: 'GROUPPANEL', name: 'grouppanel4', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel5: new FormGroupPanelModel({ caption: '相关信息', detailType: 'GROUPPANEL', name: 'grouppanel5', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel17: new FormGroupPanelModel({ caption: '备注', detailType: 'GROUPPANEL', name: 'grouppanel17', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '政治面貌', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel2: new FormGroupPanelModel({ caption: '职务相关', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel16: new FormGroupPanelModel({ caption: '申报类型', detailType: 'GROUPPANEL', name: 'grouppanel16', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel7: new FormGroupPanelModel({ caption: '教育背景', detailType: 'GROUPPANEL', name: 'grouppanel7', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel11: new FormGroupPanelModel({ caption: '工作履历', detailType: 'GROUPPANEL', name: 'grouppanel11', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel21: new FormGroupPanelModel({ caption: '注册证书', detailType: 'GROUPPANEL', name: 'grouppanel21', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel10: new FormGroupPanelModel({ caption: '获奖情况', detailType: 'GROUPPANEL', name: 'grouppanel10', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel8: new FormGroupPanelModel({ caption: '实习信息', detailType: 'GROUPPANEL', name: 'grouppanel8', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel9: new FormGroupPanelModel({ caption: '在校职务', detailType: 'GROUPPANEL', name: 'grouppanel9', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel12: new FormGroupPanelModel({ caption: '测评结果摘要信息', detailType: 'GROUPPANEL', name: 'grouppanel12', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel13: new FormGroupPanelModel({ caption: '投递职位摘要信息', detailType: 'GROUPPANEL', name: 'grouppanel13', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_csrcyj_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        ygbh: new FormItemModel({ caption: '员工编号', detailType: 'FORMITEM', name: 'ygbh', visible: false, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if (Object.is(name, '') || Object.is(name, 'ygbh')) {
            let ret = false;
            const _ygbh = this.data.ygbh;
            if (this.$verify.testCond(_ygbh, 'ISNOTNULL', '')) {
                ret = true;
            }
            this.detailsModel.ygbh.setVisible(ret);
        }
        ...
        if (Object.is(name, '') || Object.is(name, 'polity')) {
            ...
            if (this.$verify.testCond(_polity, 'NOTEQ', '10')) {
                ret = false;
            }
            this.rules.rdsj.some((rule: any) => {
        ...
        if (Object.is(name, '') || Object.is(name, 'rzqd')) {
            let ret = false;
            const _rzqd = this.data.rzqd;
            if (this.$verify.testCond(_rzqd, 'NOTEQ', '50')) {
                ret = true;
            }
        ...
        if(Object.is(name, 'certificatetype')){
            const details: string[] = ['nl', 'certificatenumber', 'birthday', 'gender'];
            this.updateFormItems('ClearPersonUpdateInfo', this.data, details, true);
        }

        if(Object.is(name, 'certificatenumber')){
            const details: string[] = ['gender', 'nl', 'isblacklist', 'birthday', 'isblacklistreason'];
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof YPZXX_CSRCYJ
     */
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmprofile_ypzxx_csrcyj',popTitle:'应聘者信息（成熟人才引进）'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_CSRCYJEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_CSRCYJEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_CSRCYJEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_CSRCYJEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
