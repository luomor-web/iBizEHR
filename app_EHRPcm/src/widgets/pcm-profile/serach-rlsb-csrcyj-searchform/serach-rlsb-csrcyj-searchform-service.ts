...
import Serach_RLSB_CSRCYJModel from './serach-rlsb-csrcyj-searchform-model';


/**
 * Serach_RLSB_CSRCYJ 部件服务对象
 *
 * @export
 * @class Serach_RLSB_CSRCYJService
 */
export default class Serach_RLSB_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof Serach_RLSB_CSRCYJService
     */
    ...
    /**
     * Creates an instance of Serach_RLSB_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof Serach_RLSB_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Serach_RLSB_CSRCYJModel();
    }
