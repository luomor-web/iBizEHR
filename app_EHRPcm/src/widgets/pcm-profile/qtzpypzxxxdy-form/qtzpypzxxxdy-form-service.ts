...
import QTZPYPZXXXDYModel from './qtzpypzxxxdy-form-model';
 ...
 *
 * @export
 * @class QTZPYPZXXXDYService
 */
export default class QTZPYPZXXXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof QTZPYPZXXXDYService
     */
    ...
    /**
     * Creates an instance of QTZPYPZXXXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof QTZPYPZXXXDYService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new QTZPYPZXXXDYModel();
    }
