<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard07'  id='pcmprofile_tdzwzyxxxdy' style="">
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmprofile_tdzwzyxxxdy',popTitle:'投递职位摘要信息向导页'});
    }
