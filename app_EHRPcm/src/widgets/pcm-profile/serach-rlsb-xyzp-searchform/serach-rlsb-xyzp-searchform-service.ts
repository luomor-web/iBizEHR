...
import Serach_RLSB_XYZPModel from './serach-rlsb-xyzp-searchform-model';


/**
 * Serach_RLSB_XYZP 部件服务对象
 *
 * @export
 * @class Serach_RLSB_XYZPService
 */
export default class Serach_RLSB_XYZPService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof Serach_RLSB_XYZPService
     */
    ...
    /**
     * Creates an instance of Serach_RLSB_XYZPService.
     * 
     * @param {*} [opts={}]
     * @memberof Serach_RLSB_XYZPService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Serach_RLSB_XYZPModel();
    }
