...
import YPZBD_CSRCYJModel from './ypzbd-csrcyj-grid-model';
 ...
 *
 * @export
 * @class YPZBD_CSRCYJService
 */
export default class YPZBD_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof YPZBD_CSRCYJService
     */
    ...
    /**
     * Creates an instance of YPZBD_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof YPZBD_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new YPZBD_CSRCYJModel();
    }
