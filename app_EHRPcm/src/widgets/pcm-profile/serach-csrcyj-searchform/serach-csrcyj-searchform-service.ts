...
import Serach_CSRCYJModel from './serach-csrcyj-searchform-model';


/**
 * Serach_CSRCYJ 部件服务对象
 *
 * @export
 * @class Serach_CSRCYJService
 */
export default class Serach_CSRCYJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof Serach_CSRCYJService
     */
    ...
    /**
     * Creates an instance of Serach_CSRCYJService.
     * 
     * @param {*} [opts={}]
     * @memberof Serach_CSRCYJService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Serach_CSRCYJModel();
    }
