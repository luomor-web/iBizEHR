...
import FPYPZXXXDYModel from './fpypzxxxdy-form-model';
 ...
 *
 * @export
 * @class FPYPZXXXDYService
 */
export default class FPYPZXXXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof FPYPZXXXDYService
     */
    ...
    /**
     * Creates an instance of FPYPZXXXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof FPYPZXXXDYService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new FPYPZXXXDYModel();
    }
