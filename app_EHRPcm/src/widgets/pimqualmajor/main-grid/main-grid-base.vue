    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimqualmajor: keys.join(';') }),Object.assign({ pimqualmajor: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
