...
import XKMLtreeService from './xkmltree-treeview-service';
...
export default class XKMLtreeBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof XKMLtreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {XKMLtreeService}
     * @memberof XKMLtreeBase
     */
    public service: XKMLtreeService = new XKMLtreeService({ $store: this.$store });
