...
import XKMLtreeModel from './xkmltree-treeview-model';
 ...
 *
 * @export
 * @class XKMLtreeService
 */
export default class XKMLtreeService extends ControlService {

    /**
     * 学科目录服务对象
     *
     * @type {PCMXKMLService}
     * @memberof XKMLtreeService
     */
    public appEntityService: PCMXKMLService = new PCMXKMLService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of XKMLtreeService.
     * 
     * @param {*} [opts={}]
     * @memberof XKMLtreeService
     */
     ...
     * @memberof XKMLtreeService
     */
	public TREENODE_PCMXKML: string = 'PCMXKML';
    ...
    public async getNodes(context:any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if (Object.is(strNodeType, this.TREENODE_PCMXKML)) {
            await this.fillPcmxkmlNodeChilds(context,filter, list);
            return Promise.resolve({ status: 200, data: list });
        }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.pcmxkml.xkmltree_treeview.nodes.root' });
    ...
    public async fillRootNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充根节点
            let PcmxkmlRsNavContext:any = {};
            let PcmxkmlRsNavParams:any = {};
            let PcmxkmlRsParams:any = {};
			await this.fillPcmxkmlNodes(context, filter, list ,PcmxkmlRsNavContext,PcmxkmlRsNavParams,PcmxkmlRsParams);
		} else {
			// 填充根节点
            let PcmxkmlRsNavContext:any = {};
            let PcmxkmlRsNavParams:any = {};
     ...
     */
    @Errorlog
    public fillPcmxkmlNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
     ...
     */
    @Errorlog
    public async fillPcmxkmlNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
		} else {
		}
	}
