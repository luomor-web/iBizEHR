    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmprofileszyjtj: keys.join(';') }),Object.assign({ pcmprofileszyjtj: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
