...
import YPZBDModel from './ypzbd-form-model';
 ...
 * @class YPZBDService
 */
export default class YPZBDService extends ControlService {

    /**
     * 向导实体1服务对象
     *
     * @type {WZD0001Service}
     * @memberof YPZBDService
     */
    public appEntityService: WZD0001Service = new WZD0001Service({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of YPZBDService.
     * 
     * @param {*} [opts={}]
     * @memberof YPZBDService
     */
