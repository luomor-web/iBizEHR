        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('nd2')">
                <el-table-column show-overflow-tooltip :prop="'nd2'" :label="$t('entities.pcmgxxktemp.main_grid.columns.nd2')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            <codelist :value="row.nd2" tag='PIMCL_ND' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            ...
            <template v-if="getColumnState('updateman')">
                <el-table-column show-overflow-tooltip :prop="'updateman'" :label="$t('entities.pcmgxxktemp.main_grid.columns.updateman')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('updatedate')">
                <el-table-column show-overflow-tooltip :prop="'updatedate'" :label="$t('entities.pcmgxxktemp.main_grid.columns.updatedate')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'updateman',
            label: '更新人',
            langtag: 'entities.pcmgxxktemp.main_grid.columns.updateman',
            show: true,
            util: 'PX'
        },
        {
            name: 'updatedate',
            label: '更新时间',
            langtag: 'entities.pcmgxxktemp.main_grid.columns.updatedate',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmgxxktemp: keys.join(';') }),Object.assign({ pcmgxxktemp: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
