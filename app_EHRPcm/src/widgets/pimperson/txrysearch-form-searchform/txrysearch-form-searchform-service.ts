...
import TXRYSearchFormModel from './txrysearch-form-searchform-model';


/**
 * TXRYSearchForm 部件服务对象
 *
 * @export
 * @class TXRYSearchFormService
 */
export default class TXRYSearchFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PIMPERSONService}
     * @memberof TXRYSearchFormService
     */
    ...
    /**
     * Creates an instance of TXRYSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof TXRYSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TXRYSearchFormModel();
    }
