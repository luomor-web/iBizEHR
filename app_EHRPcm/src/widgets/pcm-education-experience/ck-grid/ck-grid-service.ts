...
export default class CKService extends ControlService {
     ...
     * @memberof CKService
     */
    public appEntityService: PcmEducationExperienceService = new PcmEducationExperienceService({ $store: this.getStore() });
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.pcmeducationexperienceid = Util.createUUID();
                }
