...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('resumecontent')">
                <el-table-column show-overflow-tooltip :prop="'resumecontent'" :label="$t('entities.pcmworkresume.main_grid.columns.resumecontent')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template v-if="actualIsOpenEdit">
                            <i-form style="height:100%;" :model="row">
                                <app-form-item :name="column.property" :itemRules="rules[column.property]">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected appEntityService: PCMWORKRESUMEService = new PCMWORKRESUMEService({ $store: this.$store });
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'serveendtime';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmworkresume: keys.join(';') }),Object.assign({ pcmworkresume: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
