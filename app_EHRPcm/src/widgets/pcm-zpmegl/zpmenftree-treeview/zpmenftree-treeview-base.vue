...
import ZPMENFtreeService from './zpmenftree-treeview-service';
...
export default class ZPMENFtreeBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof ZPMENFtreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ZPMENFtreeService}
     * @memberof ZPMENFtreeBase
     */
    public service: ZPMENFtreeService = new ZPMENFtreeService({ $store: this.$store });
...
<style lang='less'>
@import './zpmenftree-treeview.less';
</style>