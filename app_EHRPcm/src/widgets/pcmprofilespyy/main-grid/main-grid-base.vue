    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmprofilespyy: keys.join(';') }),Object.assign({ pcmprofilespyy: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
