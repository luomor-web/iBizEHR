...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('practicecontent')">
                <el-table-column show-overflow-tooltip :prop="'practicecontent'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.practicecontent')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template v-if="actualIsOpenEdit">
                            <i-form style="height:100%;" :model="row">
                                <app-form-item :name="column.property" :itemRules="rules[column.property]">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected appEntityService: PCMPRACTICEEXPERIENCEService = new PCMPRACTICEEXPERIENCEService({ $store: this.$store });
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'starttime';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmpracticeexperience: keys.join(';') }),Object.assign({ pcmpracticeexperience: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
