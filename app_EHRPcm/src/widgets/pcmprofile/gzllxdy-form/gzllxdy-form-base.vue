...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.gzllxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import GZLLXDYService from './gzllxdy-form-service';
...
export default class GZLLXDYBase extends Vue implements ControlInterface {
     ...
     * @memberof GZLLXDY
     */
    public service: GZLLXDYService = new GZLLXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '工作履历', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.gzllxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'wizardpanel_form_wizard03',popTitle:'工作履历向导页'});
    }
