...
, 
        sfxzbjnbry: new FormItemModel({ caption: '选择局内部人员', detailType: 'FORMITEM', name: 'sfxzbjnbry', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
