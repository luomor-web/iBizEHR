...
import JYBJXDYModel from './jybjxdy-form-model';
 ...
 *
 * @export
 * @class JYBJXDYService
 */
export default class JYBJXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof JYBJXDYService
     */
    ...
    /**
     * Creates an instance of JYBJXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof JYBJXDYService
     */
