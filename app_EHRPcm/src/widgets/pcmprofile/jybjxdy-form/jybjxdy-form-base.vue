<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard02'  id='wizardpanel_form_wizard02' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.jybjxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import JYBJXDYService from './jybjxdy-form-service';
...
export default class JYBJXDYBase extends Vue implements ControlInterface {
     ...
     * @memberof JYBJXDY
     */
    protected service: JYBJXDYService = new JYBJXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '教育背景', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.jybjxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'wizardpanel_form_wizard02',popTitle:'教育背景向导页'});
    }
