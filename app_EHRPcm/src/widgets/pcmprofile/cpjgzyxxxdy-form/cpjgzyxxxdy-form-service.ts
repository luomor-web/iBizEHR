...
import CPJGZYXXXDYModel from './cpjgzyxxxdy-form-model';
 ...
 *
 * @export
 * @class CPJGZYXXXDYService
 */
export default class CPJGZYXXXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof CPJGZYXXXDYService
     */
    ...
    /**
     * Creates an instance of CPJGZYXXXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof CPJGZYXXXDYService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CPJGZYXXXDYModel();
    }
