<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard06'  id='wizardpanel_form_wizard06' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.cpjgzyxxxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import CPJGZYXXXDYService from './cpjgzyxxxdy-form-service';
...
export default class CPJGZYXXXDYBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof CPJGZYXXXDY
     */
     ...
     * 建构部件服务对象
     *
     * @type {CPJGZYXXXDYService}
     * @memberof CPJGZYXXXDY
     */
    protected service: CPJGZYXXXDYService = new CPJGZYXXXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '测评结果摘要信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.cpjgzyxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected formValidateStatus(): boolean {
        const form: any = this.$refs.wizardpanel_form_wizard06;
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'wizardpanel_form_wizard06',popTitle:'测评结果摘要信息向导页'});
    }
    ...
    * @private
    * @param {*} [opt={}]
    * @memberof Wizardpanel_form_wizard06
    */
