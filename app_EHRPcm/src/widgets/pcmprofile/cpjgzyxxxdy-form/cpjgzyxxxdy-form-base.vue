<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard06'  id='pcmprofile_cpjgzyxxxdy' style="">
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmprofile_cpjgzyxxxdy',popTitle:'测评结果摘要信息向导页'});
    }
