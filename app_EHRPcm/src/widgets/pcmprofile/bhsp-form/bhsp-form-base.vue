...
<i-col v-show="detailsModel.grouppanel16.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel16.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.bhsp_form.details.grouppanel16')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
, 
        grouppanel16: new FormGroupPanelModel({ caption: '应聘者附件', detailType: 'GROUPPANEL', name: 'grouppanel16', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.bhsp_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'编号审批（校园招聘）'});
    }
