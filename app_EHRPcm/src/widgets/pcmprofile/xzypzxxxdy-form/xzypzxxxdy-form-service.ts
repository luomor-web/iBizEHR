...
import XZYPZXXXDYModel from './xzypzxxxdy-form-model';
 ...
 *
 * @export
 * @class XZYPZXXXDYService
 */
export default class XZYPZXXXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof XZYPZXXXDYService
     */
    ...
    /**
     * Creates an instance of XZYPZXXXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof XZYPZXXXDYService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new XZYPZXXXDYModel();
    }
