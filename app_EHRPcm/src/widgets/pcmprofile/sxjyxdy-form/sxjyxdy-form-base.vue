<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard03'  id='wizardpanel_form_wizard03' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.sxjyxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import SXJYXDYService from './sxjyxdy-form-service';
...
export default class SXJYXDYBase extends Vue implements ControlInterface {
     ...
     * @memberof SXJYXDY
     */
    protected service: SXJYXDYService = new SXJYXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '实习信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.sxjyxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'wizardpanel_form_wizard03',popTitle:'实习经验向导页'});
    }
