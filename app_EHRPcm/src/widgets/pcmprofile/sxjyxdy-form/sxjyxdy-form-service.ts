...
import SXJYXDYModel from './sxjyxdy-form-model';
 ...
 *
 * @export
 * @class SXJYXDYService
 */
export default class SXJYXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof SXJYXDYService
     */
    ...
    /**
     * Creates an instance of SXJYXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof SXJYXDYService
     */
