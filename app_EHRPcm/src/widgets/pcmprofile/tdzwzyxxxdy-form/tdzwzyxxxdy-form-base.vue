<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard07'  id='wizardpanel_form_wizard07' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.tdzwzyxxxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import TDZWZYXXXDYService from './tdzwzyxxxdy-form-service';
...
export default class TDZWZYXXXDYBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof TDZWZYXXXDY
     */
     ...
     * 建构部件服务对象
     *
     * @type {TDZWZYXXXDYService}
     * @memberof TDZWZYXXXDY
     */
    protected service: TDZWZYXXXDYService = new TDZWZYXXXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '投递职位摘要信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.tdzwzyxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected formValidateStatus(): boolean {
        const form: any = this.$refs.wizardpanel_form_wizard07;
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'wizardpanel_form_wizard07',popTitle:'投递职位摘要信息向导页'});
    }
    ...
    * @private
    * @param {*} [opt={}]
    * @memberof Wizardpanel_form_wizard07
    */
