...
import TDZWZYXXXDYModel from './tdzwzyxxxdy-form-model';
 ...
 *
 * @export
 * @class TDZWZYXXXDYService
 */
export default class TDZWZYXXXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof TDZWZYXXXDYService
     */
    ...
    /**
     * Creates an instance of TDZWZYXXXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof TDZWZYXXXDYService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TDZWZYXXXDYModel();
    }
