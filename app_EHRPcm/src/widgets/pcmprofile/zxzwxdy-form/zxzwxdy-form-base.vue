...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.zxzwxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import ZXZWXDYService from './zxzwxdy-form-service';
...
export default class ZXZWXDYBase extends Vue implements ControlInterface {
     ...
     * @memberof ZXZWXDY
     */
    protected service: ZXZWXDYService = new ZXZWXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '在校职务', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.zxzwxdy_form', extractMode: 'ITEM', details: [] } })
, 
