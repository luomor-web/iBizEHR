...
import ZXZWXDYModel from './zxzwxdy-form-model';
 ...
 *
 * @export
 * @class ZXZWXDYService
 */
export default class ZXZWXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof ZXZWXDYService
     */
    ...
    /**
     * Creates an instance of ZXZWXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof ZXZWXDYService
     */
