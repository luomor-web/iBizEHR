...
<i-col v-show="detailsModel.ywzdjbs.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='ywzdjbs' :itemRules="this.rules.ywzdjbs" class='' :caption="$t('entities.pcmprofile.ypzxx_lr_form.details.ywzdjbs')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ywzdjbs.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.ywzdjbs" :data="data" :itemParam="{}" :disabled="detailsModel.ywzdjbs.disabled"  tag='PIMCL_YW' codelistType='STATIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>
...
<i-col v-show="detailsModel.ormpostname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
  ...
  editortype="" 
  :pickupView="{ viewname: 'ormpostejormorgidpickup-view', title: $t('entities.ormpost.views.ejormorgidpickupview.title'), deResParameters: [], parameters: [{ pathName: 'ormposts', parameterName: 'ormpost' }, { pathName: 'ejormorgidpickupview', parameterName: 'ejormorgidpickupview' } ], placement:'' }"
  style=""  
  @formitemvaluechange="onFormItemValueChange">
</app-picker>
...
<i-col v-show="detailsModel.isblacklistreason.visible" :style="{}"  :lg="{ span: 16, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <input-box v-model="data.isblacklistreason"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.isblacklistreason.disabled" type='text'  style=""></input-box>
</app-form-item>
...
export default class YPZXX_LRBase extends Vue implements ControlInterface {
     ...
     * @memberof YPZXX_LR
     */
    protected service: YPZXX_LRService = new YPZXX_LRService({ $store: this.$store });
     ...
     * @memberof YPZXX_LR
     */
    protected appEntityService: PCMPROFILEService = new PCMPROFILEService({ $store: this.$store });
    ...
    protected detailsModel: any = {
        grouppanel15: new FormGroupPanelModel({ caption: '选择局内部人员', detailType: 'GROUPPANEL', name: 'grouppanel15', visible: false, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.ypzxx_lr_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'应聘者信息（校园招聘）（主信息）'});
    }
