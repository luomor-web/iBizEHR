...
import Serach_XYZPModel from './serach-xyzp-searchform-model';
 ...
 *
 * @export
 * @class Serach_XYZPService
 */
export default class Serach_XYZPService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof Serach_XYZPService
     */
    ...
    /**
     * Creates an instance of Serach_XYZPService.
     * 
     * @param {*} [opts={}]
     * @memberof Serach_XYZPService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Serach_XYZPModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        const {data:Data,context:Context} = this.handleRequestData(action,context,data);
        //仿真主键数据
        Data.pcmprofileid = Util.createUUID();
        Data.pcmprofile = Data.pcmprofileid;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
