<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard05'  id='wizardpanel_form_wizard05' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.hjqkxdy_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import HJQKXDYService from './hjqkxdy-form-service';
...
export default class HJQKXDYBase extends Vue implements ControlInterface {
     ...
     * @memberof HJQKXDY
     */
    protected service: HJQKXDYService = new HJQKXDYService({ $store: this.$store });
...
, 
        group1: new FormGroupPanelModel({ caption: '获奖情况', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.hjqkxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected formValidateStatus(): boolean {
        const form: any = this.$refs.wizardpanel_form_wizard05;
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'wizardpanel_form_wizard05',popTitle:'获奖情况向导页'});
    }
    ...
    * @private
    * @param {*} [opt={}]
    * @memberof Wizardpanel_form_wizard05
    */
