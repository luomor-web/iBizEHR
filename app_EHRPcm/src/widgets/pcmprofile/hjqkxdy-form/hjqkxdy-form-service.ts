...
import HJQKXDYModel from './hjqkxdy-form-model';
 ...
 *
 * @export
 * @class HJQKXDYService
 */
export default class HJQKXDYService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PCMPROFILEService}
     * @memberof HJQKXDYService
     */
    ...
    /**
     * Creates an instance of HJQKXDYService.
     * 
     * @param {*} [opts={}]
     * @memberof HJQKXDYService
     */
