<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard01'  id='pcmprofile_qtzpypzxxxdy' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.grouppanel3.visible" :style="{}"  :lg="{ span: 16, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel3.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel3')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pcmprofilename.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='pcmprofilename' :itemRules="this.rules.pcmprofilename" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.pcmprofilename')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pcmprofilename.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.certificatetype.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='certificatetype' :itemRules="this.rules.certificatetype" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.certificatetype')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.certificatetype.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.certificatenumber.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='certificatenumber' :itemRules="this.rules.certificatenumber" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.certificatenumber')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.certificatenumber.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.birthday.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='birthday' :itemRules="this.rules.birthday" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.birthday')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.birthday.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.nl.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='nl' :itemRules="this.rules.nl" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.nl')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nl.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gender.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='gender' :itemRules="this.rules.gender" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.gender')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gender.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel4.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel4.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel4')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.zp.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='zp' :itemRules="this.rules.zp" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.zp')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zp.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel5.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel5.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel5')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.nation.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='nation' :itemRules="this.rules.nation" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.nation')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nation.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.wedstate.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wedstate' :itemRules="this.rules.wedstate" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.wedstate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wedstate.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.bloodtype.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='bloodtype' :itemRules="this.rules.bloodtype" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.bloodtype')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bloodtype.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.nativeplace.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='nativeplace' :itemRules="this.rules.nativeplace" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.nativeplace')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nativeplace.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.hklx.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='hklx' :itemRules="this.rules.hklx" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.hklx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.hklx.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.rpr.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='rpr' :itemRules="this.rules.rpr" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.rpr')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.rpr.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.hjdz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='hjdz' :itemRules="this.rules.hjdz" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.hjdz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.hjdz.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.csd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='csd' :itemRules="this.rules.csd" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.csd')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.csd.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.address.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='address' :itemRules="this.rules.address" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.address')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.address.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-autocomplete 
    :data="data"
...
<i-col v-show="detailsModel.mobile.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='mobile' :itemRules="this.rules.mobile" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.mobile')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.mobile.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.email.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='email' :itemRules="this.rules.email" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.email')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.email.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.xznf.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='xznf' :itemRules="this.rules.xznf" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.xznf')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.xznf.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.workbegindate.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='workbegindate' :itemRules="this.rules.workbegindate" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.workbegindate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.workbegindate.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.yydj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='yydj' :itemRules="this.rules.yydj" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.yydj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yydj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.yydjmc.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='yydjmc' :itemRules="this.rules.yydjmc" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.yydjmc')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yydjmc.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.polity.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='polity' :itemRules="this.rules.polity" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.polity')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.polity.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.rdsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='rdsj' :itemRules="this.rules.rdsj" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.rdsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.rdsj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel6.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel6.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel6')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.isblacklist.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='isblacklist' :itemRules="this.rules.isblacklist" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.isblacklist')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.isblacklist.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.isblacklistreason.visible" :style="{}"  :lg="{ span: 16, offset: 0 }">
    <app-form-item name='isblacklistreason' :itemRules="this.rules.isblacklistreason" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.isblacklistreason')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.isblacklistreason.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel7.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel7.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel7')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.sfz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='sfz' :itemRules="this.rules.sfz" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.sfz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.sfz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zczs2.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zczs2' :itemRules="this.rules.zczs2" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.zczs2')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zczs2.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.otherfile.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='otherfile' :itemRules="this.rules.otherfile" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.otherfile')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.otherfile.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel2')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.ormorgname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormorgname' :itemRules="this.rules.ormorgname" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.ormorgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.rzqd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='rzqd' :itemRules="this.rules.rzqd" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.rzqd')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.rzqd.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.rzqd" :data="data" :itemParam="{}" :disabled="detailsModel.rzqd.disabled"  tag='PCMCL_QTZP' codelistType='STATIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.gwlb.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gwlb' :itemRules="this.rules.gwlb" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.gwlb')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gwlb.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.napxm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='napxm' :itemRules="this.rules.napxm" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.napxm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.napxm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.napxmjgwmc.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='napxmjgwmc' :itemRules="this.rules.napxmjgwmc" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.napxmjgwmc')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.napxmjgwmc.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gzbt.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gzbt' :itemRules="this.rules.gzbt" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.gzbt')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gzbt.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel9.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel9.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel9')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.yglx.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='yglx' :itemRules="this.rules.yglx" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.yglx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yglx.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel8.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel8.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.grouppanel8')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.qzsm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='qzsm' :itemRules="this.rules.qzsm" class='' :caption="$t('entities.pcmprofile.qtzpypzxxxdy_form.details.qzsm')" uiStyle="DEFAULT" :labelWidth="250" :isShowCaption="true" :error="detailsModel.qzsm.error" :isEmptyCaption="false" labelPos="LEFT">
...
import QTZPYPZXXXDYService from './qtzpypzxxxdy-form-service';
...
export default class QTZPYPZXXXDYBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof QTZPYPZXXXDY
     */
     ...
     * 建构部件服务对象
     *
     * @type {QTZPYPZXXXDYService}
     * @memberof QTZPYPZXXXDY
     */
    public service: QTZPYPZXXXDYService = new QTZPYPZXXXDYService({ $store: this.$store });
    ...
    public rules: any = {
        ...
        rzqd: [
            ...
            { required: true, type: 'string', message: '入职渠道 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '入职渠道 值不能为空', trigger: 'blur' },
        ],
        gwlb: [
    ...
    public detailsModel: any = {
        grouppanel3: new FormGroupPanelModel({ caption: '', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel4: new FormGroupPanelModel({ caption: '照片', detailType: 'GROUPPANEL', name: 'grouppanel4', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel5: new FormGroupPanelModel({ caption: '相关信息', detailType: 'GROUPPANEL', name: 'grouppanel5', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '政治面貌', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel6: new FormGroupPanelModel({ caption: '是否黑名单', detailType: 'GROUPPANEL', name: 'grouppanel6', visible: false, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel7: new FormGroupPanelModel({ caption: '附件上传', detailType: 'GROUPPANEL', name: 'grouppanel7', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '职务相关', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel9: new FormGroupPanelModel({ caption: '申报类型', detailType: 'GROUPPANEL', name: 'grouppanel9', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel8: new FormGroupPanelModel({ caption: '承诺签字', detailType: 'GROUPPANEL', name: 'grouppanel8', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmprofile.qtzpypzxxxdy_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if(Object.is(name, 'certificatenumber')){
            const details: string[] = ['gender', 'birthday', 'isblacklistreason', 'isblacklist', 'nl'];
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof QTZPYPZXXXDY
     */
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmprofile_qtzpypzxxxdy',popTitle:'其他招聘应聘者信息向导页'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEQTZPWizardView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEQTZPWizardView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEQTZPWizardView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PCMPROFILEQTZPWizardView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
