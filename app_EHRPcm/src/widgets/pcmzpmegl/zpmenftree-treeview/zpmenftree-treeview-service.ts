...
import ZPMENFtreeModel from './zpmenftree-treeview-model';
 ...
 *
 * @export
 * @class ZPMENFtreeService
 */
export default class ZPMENFtreeService extends ControlService {

    /**
     * 招聘名额管理服务对象
     *
     * @type {PCMZPMEGLService}
     * @memberof ZPMENFtreeService
     */
    public appEntityService: PCMZPMEGLService = new PCMZPMEGLService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ZPMENFtreeService.
     * 
     * @param {*} [opts={}]
     * @memberof ZPMENFtreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ZPMENFtreeModel();
    }
     ...
     * @memberof ZPMENFtreeService
     */
	public TREENODE_PCMZPMEGL: string = 'PCMZPMEGL';
    ...
    public async getNodes(context:any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if (Object.is(strNodeType, this.TREENODE_PCMZPMEGL)) {
            await this.fillPcmzpmeglNodeChilds(context,filter, list);
     ...
     */
    @Errorlog
    public fillPcmzpmeglNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let codeListIems:Array<any> = [];
            if (this.getStore()) {
                codeListIems = (this.getStore() as any).getters.getCodeListItems('PIMCL_ND2');
            }
            if(codeListIems && codeListIems.length >0){
                const handleChildData = (context:any,item:any,) =>{
                    Object.assign(item,{srfappctx:context});
                    Object.assign(item, { text: 'codelist.PIMCL_ND2.'+item.value });
                    Object.assign(item, { isUseLangRes: true });
                    Object.assign(item, { srfmajortext: item.text });
                    let strNodeId: string = "PCMZPMEGL";
                ...
                codeListIems.forEach((item:any) => {
                    ...
                    Object.assign(treeNode, { text: 'codelist.PIMCL_ND2.'+item.value });
     ...
     */
    @Errorlog
    public async fillPcmzpmeglNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.pcmzpmegl.zpmenftree_treeview.nodes.root' });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
    ...
    public async fillRootNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充根节点
            let PcmzpmeglRsNavContext:any = {};
            let PcmzpmeglRsNavParams:any = {};
            let PcmzpmeglRsParams:any = {};
			await this.fillPcmzpmeglNodes(context, filter, list ,PcmzpmeglRsNavContext,PcmzpmeglRsNavParams,PcmzpmeglRsParams);
		} else {
			// 填充根节点
            let PcmzpmeglRsNavContext:any = {};
            let PcmzpmeglRsNavParams:any = {};
