    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmzpmegl: keys.join(';') }),Object.assign({ pcmzpmegl: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
