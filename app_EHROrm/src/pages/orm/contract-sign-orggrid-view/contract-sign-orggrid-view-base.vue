<template>
  <app-layout viewName="contractsignorggridview" viewTitle="法人主体设置表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'contract-sign-orggrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="签约主体单位名称，管理单位名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ContractSignORGGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ContractSignORGGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ContractSignORGService}
     * @memberof ContractSignORGGridViewBase
     */
	 ...
	 * @memberof ContractSignORGGridViewBase
	 */
	public viewtag: string = '1c14464d67d8176e1e3836cbe5f262b9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.contractsignorg.views.gridview.caption',
        srfTitle: 'entities.contractsignorg.views.gridview.title',
        srfSubTitle: 'entities.contractsignorg.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ContractSignORGGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ContractSignORG");
    }
...
<style lang='less'>
@import './contract-sign-orggrid-view.less';
</style>