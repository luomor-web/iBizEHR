<template>
  <app-layout viewName="ormpostlibcxgridview" viewTitle="标准岗位查询" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormpost-lib-cxgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMPostLibCXGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMPostLibCXGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMPostLibService}
     * @memberof ORMPostLibCXGridViewBase
     */
	 ...
	 * @memberof ORMPostLibCXGridViewBase
	 */
	public viewtag: string = '343ea136eea85ae2077e353b63f159c3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormpostlib.views.cxgridview.caption',
        srfTitle: 'entities.ormpostlib.views.cxgridview.title',
        srfSubTitle: 'entities.ormpostlib.views.cxgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './ormpost-lib-cxgrid-view.less';
</style>