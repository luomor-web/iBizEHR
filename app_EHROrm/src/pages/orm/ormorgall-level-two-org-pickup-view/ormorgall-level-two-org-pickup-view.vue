 ...
 *
 * @export
 * @class ORMORGAllLevelTwoOrgPickupView
 * @extends {ORMORGAllLevelTwoOrgPickupViewBase}
 */
@Component({
    components: {
...
export default class ORMORGAllLevelTwoOrgPickupView extends ORMORGAllLevelTwoOrgPickupViewBase { }
</script>