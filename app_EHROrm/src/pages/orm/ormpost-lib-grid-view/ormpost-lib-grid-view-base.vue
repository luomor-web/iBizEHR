<template>
  <app-layout viewName="ormpostlibgridview" viewTitle="标准岗位设置" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormpost-lib-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="岗位类型，岗位名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ORMPostLibGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMPostLibGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMPostLibService}
     * @memberof ORMPostLibGridViewBase
     */
	 ...
	 * @memberof ORMPostLibGridViewBase
	 */
	public viewtag: string = '6fcc75caf7850e6ca18c135f0916f948';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormpostlib.views.gridview.caption',
        srfTitle: 'entities.ormpostlib.views.gridview.title',
        srfSubTitle: 'entities.ormpostlib.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ORMPostLib");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"ORMPostLib");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ORMPostLib");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ORMPostLib");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ORMPostLib");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ORMPostLib");
    }
...
<style lang='less'>
@import './ormpost-lib-grid-view.less';
</style>