<template>
  <app-layout viewName="ormpostgwxhwhgridview" viewTitle="岗位设置" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormpostgwxhwhgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
