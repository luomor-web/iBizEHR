<template>
  <app-layout viewName="ormpostgwxhwhgridview" viewTitle="岗位集设置" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormpostgwxhwhgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="岗位集名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ORMPOSTGWXHWHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMPOSTGWXHWHGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMPOSTService}
     * @memberof ORMPOSTGWXHWHGridViewBase
     */
	 ...
	 * @memberof ORMPOSTGWXHWHGridViewBase
	 */
	public viewtag: string = '73b7461f2c4789cb2e1c310295ea0d0f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormpost.views.gwxhwhgridview.caption',
        srfTitle: 'entities.ormpost.views.gwxhwhgridview.title',
        srfSubTitle: 'entities.ormpost.views.gwxhwhgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ORMPOSTGWXHWHGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ORMPOST");
    }
...
<style lang='less'>
@import './ormpostgwxhwhgrid-view.less';
</style>