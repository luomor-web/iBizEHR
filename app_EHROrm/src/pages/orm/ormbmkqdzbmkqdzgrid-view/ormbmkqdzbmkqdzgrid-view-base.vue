<template>
  <app-layout viewName="ormbmkqdzbmkqdzgridview" viewTitle="考勤地址信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormbmkqdzbmkqdzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
