<template>
  <app-layout viewName="ormdutyestmanmpickupview" viewTitle="职务库" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'ormdutyest-man-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMDUTYEstManMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMDUTYEstManMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMDUTYService}
     * @memberof ORMDUTYEstManMPickupViewBase
     */
	 ...
	 * @memberof ORMDUTYEstManMPickupViewBase
	 */
	public viewtag: string = 'dbff0b2a511066b1783f443c9219de71';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormduty.views.estmanmpickupview.caption',
        srfTitle: 'entities.ormduty.views.estmanmpickupview.title',
        srfSubTitle: 'entities.ormduty.views.estmanmpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof ORMDUTYEstManMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['ormdutyname']});
                })
            }
...
<style lang='less'>
@import './ormdutyest-man-mpickup-view.less';
</style>