<template>
  <app-layout viewName="ormpostxjgridview" viewTitle="岗位设置" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'orm-post-xjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="岗位名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class OrmPostXJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class OrmPostXJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmPostService}
     * @memberof OrmPostXJGridViewBase
     */
	 ...
	 * @memberof OrmPostXJGridViewBase
	 */
	public viewtag: string = 'a103d0ea2d848ed7acc56f4c8679a619';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormpost.views.xjgridview.caption',
        srfTitle: 'entities.ormpost.views.xjgridview.title',
        srfSubTitle: 'entities.ormpost.views.xjgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"OrmPost");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"OrmPost");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"OrmPost");
    }
...
<style lang='less'>
@import './orm-post-xjgrid-view.less';
</style>