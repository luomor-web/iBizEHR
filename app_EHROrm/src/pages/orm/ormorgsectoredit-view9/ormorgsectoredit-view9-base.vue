<template>
  <app-layout viewName="ormorgsectoreditview9" viewTitle="部门/项目部信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview9': true, 'ormorgsectoredit-view9': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
import ORMORGSECTORUIService from '@/uiservice/ormorgsector/ormorgsector-ui-service';
