<template>
  <app-layout viewName="ormorgsectorbzcxgridview" viewTitle="编制查询" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormorgsectorbzcxgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMORGSECTORBZCXGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMORGSECTORBZCXGridViewBase extends GridViewBase {
	 ...
	 * @memberof ORMORGSECTORBZCXGridViewBase
	 */
	public viewtag: string = 'c21086cfe485c3db5046ec2181eab9f4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorgsector.views.bzcxgridview.caption',
        srfTitle: 'entities.ormorgsector.views.bzcxgridview.title',
        srfSubTitle: 'entities.ormorgsector.views.bzcxgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ORMORGSECTORBZCXGridView
     */
...
<style lang='less'>
@import './ormorgsectorbzcxgrid-view.less';
</style>