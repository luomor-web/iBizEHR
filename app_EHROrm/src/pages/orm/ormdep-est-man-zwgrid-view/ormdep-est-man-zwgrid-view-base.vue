<template>
  <app-layout viewName="ormdepestmanzwgridview" viewTitle="职务编制明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormdep-est-man-zwgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMDepEstManZWGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMDepEstManZWGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMDepEstManService}
     * @memberof ORMDepEstManZWGridViewBase
     */
	 ...
	 * @memberof ORMDepEstManZWGridViewBase
	 */
	public viewtag: string = '18e432f89fca5dc481d3dd4f883bd1b0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormdepestman.views.zwgridview.caption',
        srfTitle: 'entities.ormdepestman.views.zwgridview.title',
        srfSubTitle: 'entities.ormdepestman.views.zwgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ORMDepEstManZWGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ORMDepEstMan");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"ORMDepEstMan");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ORMDepEstMan");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ORMDepEstMan");
    }
...
<style lang='less'>
@import './ormdep-est-man-zwgrid-view.less';
</style>