<template>
  <app-layout viewName="ormpostlibmpickupview" viewTitle="标准岗位" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'ormpost-lib-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMPostLibMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMPostLibMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMPostLibService}
     * @memberof ORMPostLibMPickupViewBase
     */
	 ...
	 * @memberof ORMPostLibMPickupViewBase
	 */
	public viewtag: string = '0a73019b4898b090e1b0888e7243e623';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormpostlib.views.mpickupview.caption',
        srfTitle: 'entities.ormpostlib.views.mpickupview.title',
        srfSubTitle: 'entities.ormpostlib.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof ORMPostLibMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['ormpostlibname']});
                })
            }
...
<style lang='less'>
@import './ormpost-lib-mpickup-view.less';
</style>