<template>
  <app-layout viewName="ormxmbmxgridview" viewTitle="项目部人员明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormxmbmxgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMXMBMXGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMXMBMXGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMXMBMXService}
     * @memberof ORMXMBMXGridViewBase
     */
	 ...
	 * @memberof ORMXMBMXGridViewBase
	 */
	public viewtag: string = '7d94c09553961c655a31376f988d3176';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormxmbmx.views.gridview.caption',
        srfTitle: 'entities.ormxmbmx.views.gridview.title',
        srfSubTitle: 'entities.ormxmbmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"ORMXMBMX");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ORMXMBMX");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ORMXMBMX");
    }
