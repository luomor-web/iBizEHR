<template>
  <app-layout viewName="ormxmbqmpickupview" viewTitle="项目标签数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'ormxmbqmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMXMBQMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMXMBQMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMXMBQService}
     * @memberof ORMXMBQMPickupViewBase
     */
	 ...
	 * @memberof ORMXMBQMPickupViewBase
	 */
	public viewtag: string = '2aa3d073ee5f5fa06cc56211e0fe2e73';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormxmbq.views.mpickupview.caption',
        srfTitle: 'entities.ormxmbq.views.mpickupview.title',
        srfSubTitle: 'entities.ormxmbq.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['ormxmbqname']});
                })
            }
...
<style lang='less'>
@import './ormxmbqmpickup-view.less';
</style>