<template>
  <app-layout viewName="ormorgorgtreegridview" viewTitle="组织信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormorgorg-tree-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMORGOrgTreeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMORGOrgTreeGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMORGService}
     * @memberof ORMORGOrgTreeGridViewBase
     */
	 ...
	 * @memberof ORMORGOrgTreeGridViewBase
	 */
	public viewtag: string = 'd4cde7471b5b2946fa12d64bb56ee2be';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorg.views.orgtreegridview.caption',
        srfTitle: 'entities.ormorg.views.orgtreegridview.title',
        srfSubTitle: 'entities.ormorg.views.orgtreegridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ORMORGOrgTreeGridView
     */
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: '新建','isShowCaption':true,'isShowIcon':true, tooltip: '新建', iconcls: 'fa fa-file-text-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'SRFUR__JGLYYPZSZYJTJ', uiaction: { tag: 'New', target: '' }, class: '' },
...
<style lang='less'>
@import './ormorgorg-tree-grid-view.less';
</style>