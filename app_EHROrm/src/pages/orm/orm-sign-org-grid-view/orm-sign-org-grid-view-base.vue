<template>
  <app-layout viewName="ormsignorggridview" viewTitle="法人主体维护" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'orm-sign-org-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class OrmSignOrgGridViewBase extends GridViewBase {
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.ormsignorg;
        if(args.length >0){
