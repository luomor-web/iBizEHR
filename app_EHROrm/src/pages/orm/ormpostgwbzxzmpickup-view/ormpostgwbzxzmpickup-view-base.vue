<template>
  <app-layout viewName="ormpostgwbzxzmpickupview" viewTitle="岗位库" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'ormpostgwbzxzmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMPOSTGWBZXZMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMPOSTGWBZXZMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMPOSTService}
     * @memberof ORMPOSTGWBZXZMPickupViewBase
     */
	 ...
	 * @memberof ORMPOSTGWBZXZMPickupViewBase
	 */
	public viewtag: string = '583b76059b38d2f9baef70383e4922a1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormpost.views.gwbzxzmpickupview.caption',
        srfTitle: 'entities.ormpost.views.gwbzxzmpickupview.title',
        srfSubTitle: 'entities.ormpost.views.gwbzxzmpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof ORMPOSTGWBZXZMPickupView
     */
...
<style lang='less'>
@import './ormpostgwbzxzmpickup-view.less';
</style>