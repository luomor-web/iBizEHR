<template>
  <app-layout viewName="ormorgsuborggridview" viewTitle="组织管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'ormorgsub-org-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMORGSubOrgGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMORGSubOrgGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMORGService}
     * @memberof ORMORGSubOrgGridViewBase
     */
	 ...
	 * @memberof ORMORGSubOrgGridViewBase
	 */
	public viewtag: string = 'f48f4ab3198fccc18f177d106869633d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorg.views.suborggridview.caption',
        srfTitle: 'entities.ormorg.views.suborggridview.title',
        srfSubTitle: 'entities.ormorg.views.suborggridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './ormorgsub-org-grid-view.less';
</style>