<template>
  <app-layout viewName="ormtitlempickupview" viewTitle="标准头衔库" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'ormtitlempickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMTITLEMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMTITLEMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {ORMTITLEService}
     * @memberof ORMTITLEMPickupViewBase
     */
	 ...
	 * @memberof ORMTITLEMPickupViewBase
	 */
	public viewtag: string = '337991e5e3d2ae798ba40ee685f3197a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormtitle.views.mpickupview.caption',
        srfTitle: 'entities.ormtitle.views.mpickupview.title',
        srfSubTitle: 'entities.ormtitle.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['ormtitlename']});
                })
            }
...
<style lang='less'>
@import './ormtitlempickup-view.less';
</style>