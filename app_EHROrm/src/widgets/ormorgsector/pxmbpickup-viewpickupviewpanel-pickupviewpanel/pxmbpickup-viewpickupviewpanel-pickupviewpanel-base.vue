...
import PXMBPickupViewpickupviewpanelService from './pxmbpickup-viewpickupviewpanel-pickupviewpanel-service';

import PXMBPickupViewpickupviewpanelModel from './pxmbpickup-viewpickupviewpanel-pickupviewpanel-model';
...
export default class PXMBPickupViewpickupviewpanelBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof PXMBPickupViewpickupviewpanel
     */
     ...
     * 建构部件服务对象
     *
     * @type {PXMBPickupViewpickupviewpanelService}
     * @memberof PXMBPickupViewpickupviewpanel
     */
    public service: PXMBPickupViewpickupviewpanelService = new PXMBPickupViewpickupviewpanelService({ $store: this.$store });
     ...
     */
    protected view: any = {
        viewname: 'ormorgsectorpxmbpickup-grid-view',
        data: {},
    }
...
<style lang='less'>
@import './pxmbpickup-viewpickupviewpanel-pickupviewpanel.less';
</style>