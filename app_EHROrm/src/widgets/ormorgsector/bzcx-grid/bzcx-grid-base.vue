...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('sjbzrs')">
                <el-table-column show-overflow-tooltip :prop="'sjbzrs'" :label="$t('entities.ormorgsector.bzcx_grid.columns.sjbzrs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.sjbzrs}}</span>
                    </template>
                </el-table-column>
            </template>
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'sjbzrs',
            label: '实际编制人数',
            langtag: 'entities.ormorgsector.bzcx_grid.columns.sjbzrs',
            show: true,
            util: 'PX'
        },
    ]
