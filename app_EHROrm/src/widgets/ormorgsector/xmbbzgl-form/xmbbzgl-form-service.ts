...
import XMBBZGLModel from './xmbbzgl-form-model';
 ...
 *
 * @export
 * @class XMBBZGLService
 */
export default class XMBBZGLService extends ControlService {

    /**
     * 部门管理服务对象
     *
     * @type {ORMORGSECTORService}
     * @memberof XMBBZGLService
     */
    ...
    /**
     * Creates an instance of XMBBZGLService.
     * 
     * @param {*} [opts={}]
     * @memberof XMBBZGLService
     */
     ...
     * @memberof XMBBZGLService
     */
    public ormxmglService: ORMXMGLService = new ORMXMGLService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'ORMORGSECTORService') && Object.is(interfaceName, 'FetchJSYXMB')) {
            return this.doItems(this.appEntityService.FetchJSYXMB(JSON.parse(JSON.stringify(context)), data, isloading), 'orgsectorid', 'ormorgsector');
        }
        if (Object.is(serviceName, 'ORMXMGLService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.ormxmglService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'ormxmglid', 'ormxmgl');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.orgsectorid = PrimaryKey;
        Data.ormorgsector = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.orgsectorid = PrimaryKey;
