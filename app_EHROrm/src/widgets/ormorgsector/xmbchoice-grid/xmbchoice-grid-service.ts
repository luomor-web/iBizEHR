...
import XMBChoiceModel from './xmbchoice-grid-model';
 ...
 *
 * @export
 * @class XMBChoiceService
 */
export default class XMBChoiceService extends ControlService {

    /**
     * 部门管理服务对象
     *
     * @type {ORMORGSECTORService}
     * @memberof XMBChoiceService
     */
    ...
    /**
     * Creates an instance of XMBChoiceService.
     * 
     * @param {*} [opts={}]
     * @memberof XMBChoiceService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.orgsectorid = Util.createUUID();
                }
