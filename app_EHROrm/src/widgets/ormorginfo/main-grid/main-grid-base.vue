...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ordernum')">
                <el-table-column show-overflow-tooltip :prop="'ordernum'" :label="$t('entities.ormorginfo.main_grid.columns.ordernum')" :width="90"  :align="'left'" :sortable="'custom'">
            ...
            <template v-if="getColumnState('orgcode')">
                <el-table-column show-overflow-tooltip :prop="'orgcode'" :label="$t('entities.ormorginfo.main_grid.columns.orgcode')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.ormorginfo.main_grid.columns.shortname')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('ormorginfoname')">
                <el-table-column show-overflow-tooltip :prop="'ormorginfoname'" :label="$t('entities.ormorginfo.main_grid.columns.ormorginfoname')" :min-width="1"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('belongregion')">
                <el-table-column show-overflow-tooltip :prop="'belongregion'" :label="$t('entities.ormorginfo.main_grid.columns.belongregion')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('substandard')">
                <el-table-column show-overflow-tooltip :prop="'substandard'" :label="$t('entities.ormorginfo.main_grid.columns.substandard')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('startstopsign')">
                <el-table-column show-overflow-tooltip :prop="'startstopsign'" :label="$t('entities.ormorginfo.main_grid.columns.startstopsign')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    public minorSortPSDEF: string = 'ordernum';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ordernum',
            label: '排序',
            langtag: 'entities.ormorginfo.main_grid.columns.ordernum',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgcode',
            label: '组织编码',
            langtag: 'entities.ormorginfo.main_grid.columns.orgcode',
            show: true,
            util: 'PX'
        },
        {
            name: 'shortname',
            label: '组织简称',
            langtag: 'entities.ormorginfo.main_grid.columns.shortname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorginfoname',
            label: '组织名称',
            langtag: 'entities.ormorginfo.main_grid.columns.ormorginfoname',
            show: true,
            util: 'STAR'
        },
        {
            name: 'belongregion',
            label: '所属区域',
            langtag: 'entities.ormorginfo.main_grid.columns.belongregion',
            show: true,
            util: 'PX'
        },
        {
            name: 'substandard',
            label: '补贴标准',
            langtag: 'entities.ormorginfo.main_grid.columns.substandard',
            show: true,
            util: 'PX'
        },
        {
            name: 'startstopsign',
            label: '启停标识',
            langtag: 'entities.ormorginfo.main_grid.columns.startstopsign',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ORMORGInfoOrgTreeGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ORMORGInfoOrgTreeGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('ormorginfo_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('ormorginfo_main_grid', JSON.stringify(this.allColumns));
    }
        ...
        _this.items.forEach((item:any)=>{
            if(!item.rowDataState){
                ...
                if(!this.createAction){
                    this.$Notice.error({ title: '错误', desc: 'ORMORGInfoOrgTreeGridView视图表格createAction参数未配置' });
                    return;
                }
                ...
                if(!this.updateAction){
                    this.$Notice.error({ title: '错误', desc: 'ORMORGInfoOrgTreeGridView视图表格updateAction参数未配置' });
                    return;
                }
                Object.assign(item,{viewparams:this.viewparams});
                if(item.ormorginfo){
