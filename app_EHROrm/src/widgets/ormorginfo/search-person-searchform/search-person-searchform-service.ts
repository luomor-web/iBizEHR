...
import SearchPersonModel from './search-person-searchform-model';
 ...
 */
export default class SearchPersonService extends ControlService {

    /**
     * 组织信息服务对象
     *
     * @type {ORMORGInfoService}
     * @memberof SearchPersonService
     */
    ...
    /**
     * Creates an instance of SearchPersonService.
     * 
     * @param {*} [opts={}]
     * @memberof SearchPersonService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new SearchPersonModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ormorginfoid = PrimaryKey;
        Data.ormorginfo = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.ormorginfoid = PrimaryKey;
