...
import ORMORGINFOTreeModel from './ormorginfotree-treeview-model';
import CodeListService from '@service/app/codelist-service';
import i18n from '@/locale';


/**
 * ORMORGINFOTree 部件服务对象
 *
 * @export
 * @class ORMORGINFOTreeService
 */
export default class ORMORGINFOTreeService extends ControlService {

    /**
     * 组织信息服务对象
     *
     * @type {ORMORGInfoService}
     * @memberof ORMORGINFOTreeService
     */
    public appEntityService: ORMORGInfoService = new ORMORGInfoService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ORMORGINFOTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof ORMORGINFOTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ORMORGINFOTreeModel();
    }
     ...
     * @memberof ORMORGINFOTreeService
     */
	public TREENODE_CHILDORG: string = 'ChildOrg';
     ...
     * @memberof ORMORGINFOTreeService
     */
	public TREENODE_SUBSUBSUBORMORGINFO: string = 'SubSubSubORMORGINFO';
    ...
    public async getNodes(context:any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if (Object.is(strNodeType, this.TREENODE_CHILDORG)) {
            await this.fillChildorgNodeChilds(context,filter, list);
        ...
        if (Object.is(strNodeType, this.TREENODE_SUBSUBSUBORMORGINFO)) {
            await this.fillSubsubsubormorginfoNodeChilds(context,filter, list);
            return Promise.resolve({ status: 200, data: list });
        }
     ...
     */
    @Errorlog
    public fillChildorgNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            ...
            let records: any[] = [];
            try {
                this.searchChildorg(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        records.forEach((entity: any) => {
                        let treeNode: any = {};
                        // 整理context
                        let strId: string = entity.ormorginfoid;
                        let strText: string = entity.shortname;
                        Object.assign(treeNode,{srfparentdename:'ORMORGInfo',srfparentkey:entity.ormorginfoid});
                        let tempContext:any = JSON.parse(JSON.stringify(context));
                        Object.assign(tempContext,{srfparentdename:'ORMORGInfo',srfparentkey:entity.ormorginfoid,ormorginfo:strId})
                        Object.assign(treeNode,{srfappctx:tempContext});
                        Object.assign(treeNode,{'ormorginfo':strId});
                        Object.assign(treeNode, { srfkey: strId });
                        Object.assign(treeNode, { text: strText, srfmajortext: strText });
                        let strNodeId: string = 'ChildOrg';
     ...
     */
    @Errorlog
    public searchChildorg(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            ...
            Object.assign(searchFilter,{sort: 'ordernum,asc'})
     ...
     */
    @Errorlog
    public async fillChildorgNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
            ...
            try {
                this.searchSubormorginfo(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        ...
                        Object.assign(treeNode, { expanded: filter.isautoexpand });
                        Object.assign(treeNode, { leaf: false });
                        Object.assign(treeNode, { navparams: '{"orgtype":"%NODEID%","nodeid":"%NODEID%"}' });
                        Object.assign(treeNode, { nodeid: treeNode.srfkey });
                        Object.assign(treeNode, { nodeid2: filter.strRealNodeId });
                        list.push(treeNode);
                        resolve(list);
    ...
    public searchSubormorginfo(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            ...
            const _appEntityService: any = this.appEntityService;
            let list: any[] = [];
            if (_appEntityService['FetchCurOrgsector'] && _appEntityService['FetchCurOrgsector'] instanceof Function) {
                const response: Promise<any> = _appEntityService['FetchCurOrgsector'](context, searchFilter, false);
                response.then((response: any) => {
                    if (!response.status || response.status !== 200) {
                        resolve([]);
                        console.log(JSON.stringify(context));
                        console.error('查询FetchCurOrgsector数据集异常!');
                    }
                    const data: any = response.data;
                    if (Object.keys(data).length > 0) {
                        list = JSON.parse(JSON.stringify(data));
    ...
    public async fillSubormorginfoNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充子部门
            let SubsubsubormorginfoRsNavContext:any = {};
            let SubsubsubormorginfoRsNavParams:any = {};
            let SubsubsubormorginfoRsParams:any = {};
			await this.fillSubsubsubormorginfoNodes(context, filter, list ,SubsubsubormorginfoRsNavContext,SubsubsubormorginfoRsNavParams,SubsubsubormorginfoRsParams);
		} else {
			// 填充子部门
            let SubsubsubormorginfoRsNavContext:any = {};
            let SubsubsubormorginfoRsNavParams:any = {};
     ...
     */
    @Errorlog
    public fillSubsubsubormorginfoNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let searchFilter: any = {};
            ...
            let records: any[] = [];
            try {
                this.searchSubsubsubormorginfo(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        records.forEach((entity: any) => {
                        let treeNode: any = {};
                        // 整理context
                        ...
                        Object.assign(treeNode, { srfkey: strId });
                        Object.assign(treeNode, { text: strText, srfmajortext: strText });
                        let strNodeId: string = 'SubSubSubORMORGINFO';
                        strNodeId += this.TREENODE_SEPARATOR;
                        strNodeId += strId;
                        Object.assign(treeNode, { id: strNodeId });
                        Object.assign(treeNode, { expanded: filter.isautoexpand });
     ...
     */
    @Errorlog
    public searchSubsubsubormorginfo(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            if(filter.viewparams){
                Object.assign(searchFilter,filter.viewparams);
            }
            ...
            const _appEntityService: any = this.appEntityService;
            let list: any[] = [];
            if (_appEntityService['FetchSubOrgsector'] && _appEntityService['FetchSubOrgsector'] instanceof Function) {
                const response: Promise<any> = _appEntityService['FetchSubOrgsector'](context, searchFilter, false);
                response.then((response: any) => {
                    if (!response.status || response.status !== 200) {
                        resolve([]);
                        console.log(JSON.stringify(context));
                        console.error('查询FetchSubOrgsector数据集异常!');
                    }
                    const data: any = response.data;
                    if (Object.keys(data).length > 0) {
                        list = JSON.parse(JSON.stringify(data));
     ...
     */
    @Errorlog
    public async fillSubsubsubormorginfoNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
		} else {
		}
	}
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.ormorginfo.ormorginfotree_treeview.nodes.root' });
