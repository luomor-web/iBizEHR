...
import ORMORGINFOTreeService from './ormorginfotree-treeview-service';
...
export default class ORMORGINFOTreeBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof ORMORGINFOTree
     */
     ...
     * 建构部件服务对象
     *
     * @type {ORMORGINFOTreeService}
     * @memberof ORMORGINFOTree
     */
    public service: ORMORGINFOTreeService = new ORMORGINFOTreeService({ $store: this.$store });
...
<style lang='less'>
@import './ormorginfotree-treeview.less';
</style>