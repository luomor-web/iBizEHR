...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: OrmPostDetailsService = new OrmPostDetailsService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public ormpostlibService: OrmPostLibService = new OrmPostLibService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'OrmPostLibService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.ormpostlibService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'ormpostlibid', 'ormpostlib');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ormpostdetailsid = PrimaryKey;
        Data.ormpostdetails = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.ormpostdetailsid = PrimaryKey;
