    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ ormpostlib: keys.join(';') }),Object.assign({ ormpostlib: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
