...
import EstManPickupViewpickupviewpanelService from './est-man-pickup-viewpickupviewpanel-pickupviewpanel-service';

import EstManPickupViewpickupviewpanelModel from './est-man-pickup-viewpickupviewpanel-pickupviewpanel-model';
...
export default class EstManPickupViewpickupviewpanelBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof EstManPickupViewpickupviewpanel
     */
     ...
     * 建构部件服务对象
     *
     * @type {EstManPickupViewpickupviewpanelService}
     * @memberof EstManPickupViewpickupviewpanel
     */
    public service: EstManPickupViewpickupviewpanelService = new EstManPickupViewpickupviewpanelService({ $store: this.$store });
...
<style lang='less'>
@import './est-man-pickup-viewpickupviewpanel-pickupviewpanel.less';
</style>