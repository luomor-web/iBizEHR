...
export default class AppIndexViewModel {
	...
	resourcetag: '',
        ...
        {
	id: 'beb0732833c61c3fb648340c5ca6587b',
	name: 'menuitem4',
	text: '标准化数据',
	type: 'MENUITEM',
	counterid: '',
	...
	resourcetag: '',
		...
		{
	id: 'd76622337119970e415ee5cc1bd56a97',
	name: 'menuitem8',
	text: '标准岗位查询',
	type: 'MENUITEM',
	counterid: '',
	...
	public funcs: any[] = [
        ...
        },
        {
            ...
            appfuncyype: 'APPVIEW',
            openmode: '',
            codename: 'ormpostlibcxgridview',
            deResParameters: [],
            routepath: '/index/:index?/ormpostlibs/:ormpostlib?/cxgridview/:cxgridview?',
            parameters: [
                { pathName: 'ormpostlibs', parameterName: 'ormpostlib' },
