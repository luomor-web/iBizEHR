<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='ormxmbq_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.ormxmbq.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.xh.visible" :style="{}"  :lg="{ span: 6, offset: 0 }">
    <app-form-item name='xh' :itemRules="this.rules.xh" class='' :caption="$t('entities.ormxmbq.main_form.details.xh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.xh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormorgname' :itemRules="this.rules.ormorgname" class='' :caption="$t('entities.ormxmbq.main_form.details.ormorgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormxmbqname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='ormxmbqname' :itemRules="this.rules.ormxmbqname" class='' :caption="$t('entities.ormxmbq.main_form.details.ormxmbqname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormxmbqname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.ormxmbqname"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.ormxmbqname.disabled" type='text'  style=""></input-box>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '项目标签标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '项目标签标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '项目标签标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '项目标签标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
        ...
        ormxmbqname: [
            { type: 'string', message: '项目标签 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '项目标签 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '项目标签 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '项目标签 值不能为空', trigger: 'blur' },
        ],
        ormxmbqid: [
            { type: 'string', message: '项目标签标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '项目标签标识 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '项目标签维护', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.ormxmbq.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '项目标签标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '项目标签', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ormxmbqname: new FormItemModel({ caption: '项目标签', detailType: 'FORMITEM', name: 'ormxmbqname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormxmbqid: new FormItemModel({ caption: '项目标签标识', detailType: 'FORMITEM', name: 'ormxmbqid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    /**
     * 监控表单属性 ormxmbqname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.ormxmbqname')
    onOrmxmbqnameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ormxmbqname', newVal: newVal, oldVal: oldVal });
    }
     ...
     * @memberof MainBase
     */
    @Watch('data.ormxmbqid')
    onOrmxmbqidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ormxmbqid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.ormxmbq){
            Object.assign(this.context,{ormxmbq:data.ormxmbq})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.ormxmbq = copyData.srfkey;
        copyData.ormxmbqid = copyData.srfkey;
        Object.assign(this.context,{ormxmbq:copyData.ormxmbq})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'ormxmbq_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'ORMXMBQEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ORMXMBQEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'ORMXMBQEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'ORMXMBQEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.ormxmbq || Object.is(arg.ormxmbq, '')) {
            return;
        }
