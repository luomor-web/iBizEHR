...
import NewOrgModel from './new-org-grid-model';
 ...
 * @class NewOrgService
 */
export default class NewOrgService extends ControlService {

    /**
     * ERP组织中间表服务对象
     *
     * @type {ORMERPORGService}
     * @memberof NewOrgService
     */
    ...
    /**
     * Creates an instance of NewOrgService.
     * 
     * @param {*} [opts={}]
     * @memberof NewOrgService
     */
