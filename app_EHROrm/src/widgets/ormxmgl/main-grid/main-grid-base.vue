...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('project_number')">
                <el-table-column show-overflow-tooltip :prop="'project_number'" :label="$t('entities.ormxmgl.main_grid.columns.project_number')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.project_number}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('project_name')">
                <el-table-column show-overflow-tooltip :prop="'project_name'" :label="$t('entities.ormxmgl.main_grid.columns.project_name')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.project_name}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('project_type')">
                <el-table-column show-overflow-tooltip :prop="'project_type'" :label="$t('entities.ormxmgl.main_grid.columns.project_type')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.project_type}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('project_full_name')">
                <el-table-column show-overflow-tooltip :prop="'project_full_name'" :label="$t('entities.ormxmgl.main_grid.columns.project_full_name')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.project_full_name}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('project_status_name')">
                <el-table-column show-overflow-tooltip :prop="'project_status_name'" :label="$t('entities.ormxmgl.main_grid.columns.project_status_name')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.project_status_name}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('target_start_date')">
                <el-table-column show-overflow-tooltip :prop="'target_start_date'" :label="$t('entities.ormxmgl.main_grid.columns.target_start_date')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.target_start_date}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('target_finish_date')">
                <el-table-column show-overflow-tooltip :prop="'target_finish_date'" :label="$t('entities.ormxmgl.main_grid.columns.target_finish_date')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.target_finish_date}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('engineeringbustype')">
                <el-table-column show-overflow-tooltip :prop="'engineeringbustype'" :label="$t('entities.ormxmgl.main_grid.columns.engineeringbustype')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            <codelist :value="row.engineeringbustype" tag='ORMCL_EngineeringBusType' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('engineeringpurpose')">
                <el-table-column show-overflow-tooltip :prop="'engineeringpurpose'" :label="$t('entities.ormxmgl.main_grid.columns.engineeringpurpose')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            <codelist :value="row.engineeringpurpose" tag='ORMCL_EngineeringPurpose' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('engineeringscale')">
                <el-table-column show-overflow-tooltip :prop="'engineeringscale'" :label="$t('entities.ormxmgl.main_grid.columns.engineeringscale')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            <codelist :value="row.engineeringscale" tag='ORMCL_EngineeringScale' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('isdirectlymanage')">
                <el-table-column show-overflow-tooltip :prop="'isdirectlymanage'" :label="$t('entities.ormxmgl.main_grid.columns.isdirectlymanage')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            <codelist :value="row.isdirectlymanage" tag='ORMCL_IsDirectlyManage' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('procapitalatt')">
                <el-table-column show-overflow-tooltip :prop="'procapitalatt'" :label="$t('entities.ormxmgl.main_grid.columns.procapitalatt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            <codelist :value="row.procapitalatt" tag='ORMCL_ProCapitalAtt' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'project_number',
            label: '项目编号',
            langtag: 'entities.ormxmgl.main_grid.columns.project_number',
            show: true,
            util: 'PX'
        },
        {
            name: 'project_name',
            label: '项目名称',
            langtag: 'entities.ormxmgl.main_grid.columns.project_name',
            show: true,
            util: 'PX'
        },
        {
            name: 'project_type',
            label: '项目类型',
            langtag: 'entities.ormxmgl.main_grid.columns.project_type',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '项目全称',
            langtag: 'entities.ormxmgl.main_grid.columns.project_full_name',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '项目状态',
            langtag: 'entities.ormxmgl.main_grid.columns.project_status_name',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '项目开始时间',
            langtag: 'entities.ormxmgl.main_grid.columns.target_start_date',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '项目结束时间',
            langtag: 'entities.ormxmgl.main_grid.columns.target_finish_date',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '工程业务类型',
            langtag: 'entities.ormxmgl.main_grid.columns.engineeringbustype',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '工程用途',
            langtag: 'entities.ormxmgl.main_grid.columns.engineeringpurpose',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '工程规模',
            langtag: 'entities.ormxmgl.main_grid.columns.engineeringscale',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '是否局直管',
            langtag: 'entities.ormxmgl.main_grid.columns.isdirectlymanage',
            show: true,
            util: 'px'
        },
        {
            name: 'procapitalatt',
            label: '项目资金属性',
            langtag: 'entities.ormxmgl.main_grid.columns.procapitalatt',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '项目管理标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '项目管理标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ORMXMGLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ORMXMGLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.project_name;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ ormxmgl: keys.join(';') }),Object.assign({ ormxmgl: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.ormxmgl,$event.ormxmgl);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('ormxmgl_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('ormxmgl_main_grid', JSON.stringify(this.allColumns));
    }
        ...
        _this.items.forEach((item:any)=>{
            if(!item.rowDataState){
                ...
                if(!this.createAction){
                    this.$Notice.error({ title: '错误', desc: 'ORMXMGLGridView视图表格createAction参数未配置' });
                    return;
                }
                ...
                if(!this.updateAction){
                    this.$Notice.error({ title: '错误', desc: 'ORMXMGLGridView视图表格updateAction参数未配置' });
                    return;
                }
                Object.assign(item,{viewparams:this.viewparams});
                if(item.ormxmgl){
                    Object.assign(this.context,{ormxmgl:item.ormxmgl})
                }
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.ormxmgl,args.row.ormxmgl);
        });
