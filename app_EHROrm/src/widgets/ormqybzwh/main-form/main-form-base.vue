<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='ormqybzwh_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.ormqybzwh.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.xh.visible" :style="{}"  :lg="{ span: 6, offset: 0 }">
    <app-form-item name='xh' :itemRules="this.rules.xh" class='' :caption="$t('entities.ormqybzwh.main_form.details.xh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.xh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormqybzwhname.visible" :style="{}"  :lg="{ span: 9, offset: 0 }">
    <app-form-item name='ormqybzwhname' :itemRules="this.rules.ormqybzwhname" class='' :caption="$t('entities.ormqybzwh.main_form.details.ormqybzwhname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormqybzwhname.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.ormqybzwhname" :data="data" :itemParam="{}" :disabled="detailsModel.ormqybzwhname.disabled"  tag='ORMCL_QY' codelistType='DYNAMIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.ms.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='ms' :itemRules="this.rules.ms" class='' :caption="$t('entities.ormqybzwh.main_form.details.ms')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ms.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.ms"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.ms.disabled" type='text'  style=""></input-box>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    public appEntityService: ORMQYBZWHService = new ORMQYBZWHService({ $store: this.$store });
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '区域标准维护标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '区域标准维护标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '区域标准维护标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '区域标准维护标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '区域选择 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '区域选择 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '区域选择 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '区域选择 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '区域标准维护', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.ormqybzwh.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '区域标准维护标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '区域选择', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ormorgid: new FormItemModel({ caption: '组织ID', detailType: 'FORMITEM', name: 'ormorgid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ormqybzwhname: new FormItemModel({ caption: '区域选择', detailType: 'FORMITEM', name: 'ormqybzwhname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ms: new FormItemModel({ caption: '描述', detailType: 'FORMITEM', name: 'ms', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormqybzwhid: new FormItemModel({ caption: '区域标准维护标识', detailType: 'FORMITEM', name: 'ormqybzwhid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    /**
     * 监控表单属性 ormqybzwhname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
     */
    @Watch('data.ormqybzwhname')
    onOrmqybzwhnameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ormqybzwhname', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.ms')
    onMsChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ms', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 ormqybzwhid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
     */
    @Watch('data.ormqybzwhid')
    onOrmqybzwhidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ormqybzwhid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.ormqybzwh){
            Object.assign(this.context,{ormqybzwh:data.ormqybzwh})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.ormqybzwh = copyData.srfkey;
        copyData.ormqybzwhid = copyData.srfkey;
        Object.assign(this.context,{ormqybzwh:copyData.ormqybzwh})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'ormqybzwh_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'ORMQYBZWHEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ORMQYBZWHEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'ORMQYBZWHEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'ORMQYBZWHEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.ormqybzwh || Object.is(arg.ormqybzwh, '')) {
            return;
        }
