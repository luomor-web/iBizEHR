    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ ormxmbq: keys.join(';') }),Object.assign({ ormxmbq: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
