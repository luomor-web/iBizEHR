...
import ORMORGTree2Service from './ormorgtree2-treeview-service';
...
export default class ORMORGTree2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof ORMORGTree2Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {ORMORGTree2Service}
     * @memberof ORMORGTree2Base
     */
    public service: ORMORGTree2Service = new ORMORGTree2Service({ $store: this.$store });
...
<style lang='less'>
@import './ormorgtree2-treeview.less';
</style>