...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: AttEndanceRecordService = new AttEndanceRecordService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public ormbmkqdzService: OrmBmkqdzService = new OrmBmkqdzService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'OrmBmkqdzService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.ormbmkqdzService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'ormbmkqdzid', 'ormbmkqdz');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.attendancerecordid = PrimaryKey;
        Data.attendancerecord = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.attendancerecordid = PrimaryKey;
