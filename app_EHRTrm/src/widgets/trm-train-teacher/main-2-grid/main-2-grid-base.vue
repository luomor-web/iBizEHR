    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
            ...
            <template v-if="getColumnState('dj')">
                <el-table-column show-overflow-tooltip :prop="'dj'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.dj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('jslx')">
                <el-table-column show-overflow-tooltip :prop="'jslx'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.jslx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('xb')">
                <el-table-column show-overflow-tooltip :prop="'xb'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.xb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('nl')">
                <el-table-column show-overflow-tooltip :prop="'nl'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.nl')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('lxdh1')">
                <el-table-column show-overflow-tooltip :prop="'lxdh1'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.lxdh1')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.lxdh1')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxdh1}}</span>
            ...
            <template v-if="getColumnState('sfgx')">
                <el-table-column show-overflow-tooltip :prop="'sfgx'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.sfgx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'lxdh1',
            label: '联系电话',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.lxdh1',
            show: true,
            util: 'px'
        },
        {
