...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: TrmTrainPlanService = new TrmTrainPlanService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public trmdemdeftionService: TrmDemdeftionService = new TrmDemdeftionService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'TrmDemdeftionService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.trmdemdeftionService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'trmdemdeftionid', 'trmdemdeftion');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.trmtrainplanid = PrimaryKey;
        Data.trmtrainplan = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.trmtrainplanid = PrimaryKey;
