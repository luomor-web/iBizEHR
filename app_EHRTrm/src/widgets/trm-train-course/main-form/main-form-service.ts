...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: TrmTrainCourseService = new TrmTrainCourseService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public trmcoursesystemService: TrmCourseSystemService = new TrmCourseSystemService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'TrmCourseSystemService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.trmcoursesystemService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'trmcoursesystemid', 'trmcoursesystem');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.trmtraincourseid = PrimaryKey;
        Data.trmtraincourse = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.trmtraincourseid = PrimaryKey;
