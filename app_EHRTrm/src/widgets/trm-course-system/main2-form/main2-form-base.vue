<template>
    <i-form :model="this.data" class='app-form info-form-mode' ref='form'  id='trmcoursesystem_main2' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.trmcoursesystem.main2_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="1" :isInfoGroupMode="true" >    
    <row>
        <i-col v-show="detailsModel.dm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='dm' :itemRules="this.rules.dm" class='' :caption="$t('entities.trmcoursesystem.main2_form.details.dm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.dm.error" :isEmptyCaption="false" labelPos="LEFT">
    
<app-span name='dm' :value="data.dm" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.trmcoursesystemname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='trmcoursesystemname' :itemRules="this.rules.trmcoursesystemname" class='' :caption="$t('entities.trmcoursesystem.main2_form.details.trmcoursesystemname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.trmcoursesystemname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.dygx.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='dygx' :itemRules="this.rules.dygx" class='' :caption="$t('entities.trmcoursesystem.main2_form.details.dygx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.dygx.error" :isEmptyCaption="false" labelPos="LEFT">
    
<app-span name='dygx' :value="data.dygx" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.jb.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='jb' :itemRules="this.rules.jb" class='' :caption="$t('entities.trmcoursesystem.main2_form.details.jb')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jb.error" :isEmptyCaption="false" labelPos="LEFT">
    
<app-span name='jb' :value="data.jb" tag='EhrCodeList0082' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.nr.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='nr' :itemRules="this.rules.nr" class='' :caption="$t('entities.trmcoursesystem.main2_form.details.nr')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nr.error" :isEmptyCaption="false" labelPos="LEFT">
    
<app-span name='nr' :value="data.nr" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.trmcoursesystem.main2_form.details.grouppanel1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="1" :isInfoGroupMode="true" >    
    <row>
    ...
    :localContext ='{}'
    :localParam ='{}'
    parameterName='trmcoursesystem'
    parentName="TrmCourseSystem"  
    refviewtype='DEGRIDVIEW' 
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='trm-train-course-grid-view' 
...
export default class Main2Base extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        dygx: [
            ...
            { type: 'string', message: '对应关系 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '对应关系 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '对应关系 值不能为空', trigger: 'blur' },
        ],
        jb: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '培训模块信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.trmcoursesystem.main2_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '培训课程', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.trmcoursesystem.main2_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '课程体系标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     */
    @Watch('data.dm')
    onDmChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'dm', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.dygx')
    onDygxChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'dygx', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.trmcoursesystem){
            Object.assign(this.context,{trmcoursesystem:data.trmcoursesystem})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.trmcoursesystem = copyData.srfkey;
        copyData.trmcoursesystemid = copyData.srfkey;
        Object.assign(this.context,{trmcoursesystem:copyData.trmcoursesystem})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'trmcoursesystem_main2',popTitle:'主信息表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView9视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView9视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView9视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView9视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.trmcoursesystem || Object.is(arg.trmcoursesystem, '')) {
            return;
        }
