<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='trmcoursesystem_main' style="">
...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <input-box v-model="data.dm"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.dm.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.trmcoursesystemname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='trmcoursesystemname' :itemRules="this.rules.trmcoursesystemname" class='' :caption="$t('entities.trmcoursesystem.main_form.details.trmcoursesystemname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.trmcoursesystemname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.trmcoursesystemname"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.trmcoursesystemname.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.dygx.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='dygx' :itemRules="this.rules.dygx" class='' :caption="$t('entities.trmcoursesystem.main_form.details.dygx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.dygx.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.dygx"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.dygx.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.jb.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='jb' :itemRules="this.rules.jb" class='' :caption="$t('entities.trmcoursesystem.main_form.details.jb')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jb.error" :isEmptyCaption="false" labelPos="LEFT">
 ...
 <dropdown-list 
    ...
    :localContext ='{ }' 
    :localParam ='{ }' 
    :disabled="detailsModel.jb.disabled"  
    tag='EhrCodeList0082' 
    codelistType='STATIC'
...
<i-col v-show="detailsModel.nr.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='nr' :itemRules="this.rules.nr" class='' :caption="$t('entities.trmcoursesystem.main_form.details.nr')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nr.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.nr"  :disabled="detailsModel.nr.disabled" type='textarea' style="" ></input-box>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '培训模块信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.trmcoursesystem.main_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '培训课程', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.trmcoursesystem.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'trmcoursesystem_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'TrmCourseSystemEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
