...
export default class MainService extends ControlService {
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'OrmOrgService') && Object.is(interfaceName, 'FetchKZSJZZXZ')) {
            return this.doItems(this.appEntityService.FetchKZSJZZXZ(JSON.parse(JSON.stringify(context)), data, isloading), 'orgid', 'ormorg');
        }
