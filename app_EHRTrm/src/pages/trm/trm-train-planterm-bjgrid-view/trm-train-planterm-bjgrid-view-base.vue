<template>
  <app-layout viewName="trmtrainplantermbjgridview" viewTitle="培训开班" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-planterm-bjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="培训立项名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
...
import TrmTrainPlantermUIService from '@/uiservice/trm-train-planterm/trm-train-planterm-ui-service';
 ...
 *
 * @export
 * @class TrmTrainPlantermBJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainPlantermBJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainPlantermService}
     * @memberof TrmTrainPlantermBJGridViewBase
     */
	 ...
	 * @memberof TrmTrainPlantermBJGridViewBase
	 */
	public viewtag: string = 'fd6f768022331e805d7c95abaa97f185';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainplanterm.views.bjgridview.caption',
        srfTitle: 'entities.trmtrainplanterm.views.bjgridview.title',
        srfSubTitle: 'entities.trmtrainplanterm.views.bjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTrainPlantermBJGridView
     */
    public toolBarModels: any = {
        tbitem1_kb_sep: {  name: 'tbitem1_kb_sep', type: 'SEPERATOR', visabled: true, dataaccaction: '', uiaction: { }, class: '' },
        tbitem1_kb: { name: 'tbitem1_kb', caption: '开班','isShowCaption':true,'isShowIcon':true, tooltip: '开班', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'KB', target: 'MULTIKEY' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_kb')) {
            this.toolbar_tbitem1_kb_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_kb_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmtrainplanterm;
        if(args.length >0){
            Object.assign(tempContext,args[0]);
        }
        let deResParameters: any[] = [];
        if(tempContext.trmtrainplan && true){
            deResParameters = [
...
<style lang='less'>
@import './trm-train-planterm-bjgrid-view.less';
</style>