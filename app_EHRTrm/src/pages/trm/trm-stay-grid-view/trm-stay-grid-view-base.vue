<template>
  <app-layout viewName="trmstaygridview" viewTitle="培训住宿" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-stay-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmStayGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmStayGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmStayService}
     * @memberof TrmStayGridViewBase
     */
	 ...
	 * @memberof TrmStayGridViewBase
	 */
	public viewtag: string = '30c34b1211a700dd244b47af6ab67002';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmstay.views.gridview.caption',
        srfTitle: 'entities.trmstay.views.gridview.title',
        srfSubTitle: 'entities.trmstay.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmStay");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"TrmStay");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmStay");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmStay");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'trm-stay-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmstay.views.editview.title'),
        };
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { trmstay: args[0].trmstay })
            }
...
<style lang='less'>
@import './trm-stay-grid-view.less';
</style>