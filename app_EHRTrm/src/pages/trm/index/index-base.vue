...
export default class IndexBase extends IndexViewBase {
	 ...
	 * @memberof IndexBase
	 */
	protected viewtag: string = 'A43D4D65-9C2F-4F50-8B47-3BDE94B4C3D2';
    ...
    public render(): any {
        return (<div class="app-container">
            <app-layout viewName="index" viewTitle="EHR—培训管理" className={{ index_view: true }}>
