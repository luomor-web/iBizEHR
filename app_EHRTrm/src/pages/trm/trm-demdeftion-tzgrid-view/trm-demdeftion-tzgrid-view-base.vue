<template>
  <app-layout viewName="trmdemdeftiontzgridview" viewTitle="培训需求汇总表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-demdeftion-tzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
