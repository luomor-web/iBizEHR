<template>
  <app-layout viewName="trmtrainagencygridview" viewTitle="培训机构" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-agency-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class TrmTrainAgencyGridViewBase extends GridViewBase {
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainAgency");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            ...
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmtrainagency.views.editview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'trm-train-agency-tab-exp-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.trmtrainagency.views.tabexpview.title'),
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { trmtrainagency: args[0].trmtrainagency })
            }
