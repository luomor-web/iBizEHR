<template>
  <app-layout viewName="trmhmatsergridview" viewTitle="班主任表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-hmatser-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="班主任名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TrmHmatserGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmHmatserGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmHmatserService}
     * @memberof TrmHmatserGridViewBase
     */
	 ...
	 * @memberof TrmHmatserGridViewBase
	 */
	public viewtag: string = 'cd1674f862673877db7b42eb8a52eb4e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmhmatser.views.gridview.caption',
        srfTitle: 'entities.trmhmatser.views.gridview.title',
        srfSubTitle: 'entities.trmhmatser.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
...
<style lang='less'>
@import './trm-hmatser-grid-view.less';
</style>