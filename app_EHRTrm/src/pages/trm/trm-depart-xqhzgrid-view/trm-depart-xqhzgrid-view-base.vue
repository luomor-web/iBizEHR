<template>
  <app-layout viewName="trmdepartxqhzgridview" viewTitle="需求通知表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-depart-xqhzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmDepartXQHZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmDepartXQHZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmDepartService}
     * @memberof TrmDepartXQHZGridViewBase
     */
	 ...
	 * @memberof TrmDepartXQHZGridViewBase
	 */
	public viewtag: string = '30f91178ca5210e97370ff71768717d7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmdepart.views.xqhzgridview.caption',
        srfTitle: 'entities.trmdepart.views.xqhzgridview.title',
        srfSubTitle: 'entities.trmdepart.views.xqhzgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmDepartXQHZGridView
     */
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmDepart");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmDepart");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmDepart");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const parameters: any[] = [
            ...
            { pathName: 'xqhzeditview', parameterName: 'xqhzeditview' },
        ];
        const _this: any = this;
...
<style lang='less'>
@import './trm-depart-xqhzgrid-view.less';
</style>