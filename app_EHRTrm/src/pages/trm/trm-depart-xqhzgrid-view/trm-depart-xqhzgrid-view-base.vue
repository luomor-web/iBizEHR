<template>
  <app-layout viewName="trmdepartxqhzgridview" viewTitle="需求填报明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-depart-xqhzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class TrmDepartXQHZGridViewBase extends GridViewBase {
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'trm-depart-xqhzedit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmdepart.views.xqhzeditview.title'),
        };
