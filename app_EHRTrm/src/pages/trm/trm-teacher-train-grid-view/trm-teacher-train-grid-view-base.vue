<template>
  <app-layout viewName="trmteachertraingridview" viewTitle="讲师授课记录表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-teacher-train-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="讲师授课记录" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TrmTeacherTrainGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTeacherTrainGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTeacherTrainService}
     * @memberof TrmTeacherTrainGridViewBase
     */
	 ...
	 * @memberof TrmTeacherTrainGridViewBase
	 */
	public viewtag: string = 'e2b7f1016363a6dff46ca882b8a46b62';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmteachertrain.views.gridview.caption',
        srfTitle: 'entities.trmteachertrain.views.gridview.title',
        srfSubTitle: 'entities.trmteachertrain.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTeacherTrainGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmteachertrain;
        if(args.length >0){
...
<style lang='less'>
@import './trm-teacher-train-grid-view.less';
</style>