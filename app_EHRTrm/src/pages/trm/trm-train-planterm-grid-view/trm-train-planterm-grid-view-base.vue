...
export default class TrmTrainPlantermGridViewBase extends GridViewBase {
	 ...
	 * @memberof TrmTrainPlantermGridViewBase
	 */
	public viewtag: string = 'e126cfd8fd9979f69c682f044ebac3de';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainplanterm.views.gridview.caption',
        srfTitle: 'entities.trmtrainplanterm.views.gridview.title',
        srfSubTitle: 'entities.trmtrainplanterm.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem1_lx_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.TrmTrainPlanterm_LX(datas,contextJO, paramJO,  $event, xData,this,"TrmTrainPlanterm");
    }
...
<style lang='less'>
@import './trm-train-planterm-grid-view.less';
</style>