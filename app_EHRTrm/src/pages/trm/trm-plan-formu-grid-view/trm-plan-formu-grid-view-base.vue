<template>
  <app-layout viewName="trmplanformugridview" viewTitle="培训计划制定表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-plan-formu-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="培训计划制定名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TrmPlanFormuGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmPlanFormuGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmPlanFormuService}
     * @memberof TrmPlanFormuGridViewBase
     */
	 ...
	 * @memberof TrmPlanFormuGridViewBase
	 */
	public viewtag: string = '7e9b2f1f660097c455a7ac222609ee63';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmplanformu.views.gridview.caption',
        srfTitle: 'entities.trmplanformu.views.gridview.title',
        srfSubTitle: 'entities.trmplanformu.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmPlanFormu");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmPlanFormu");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmPlanFormu");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmPlanFormu");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmPlanFormu");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmPlanFormu");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmplanformu;
        if(args.length >0){
...
<style lang='less'>
@import './trm-plan-formu-grid-view.less';
</style>