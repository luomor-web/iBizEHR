<template>
  <app-layout viewName="trmtraincoursegridview" viewTitle="培训课程" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-course-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="培训课程名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TrmTrainCourseGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainCourseGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainCourseService}
     * @memberof TrmTrainCourseGridViewBase
     */
	 ...
	 * @memberof TrmTrainCourseGridViewBase
	 */
	public viewtag: string = '439d470930ee9b3ab1812f825de08c5b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtraincourse.views.gridview.caption',
        srfTitle: 'entities.trmtraincourse.views.gridview.title',
        srfSubTitle: 'entities.trmtraincourse.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTrainCourseGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainCourse");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainCourse");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainCourse");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainCourse");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmtraincourse;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'trm-train-course-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmtraincourse.views.editview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'trm-train-course-edit-view9', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmtraincourse.views.editview9.title'),
        };
        openPopupModal(view, data);
    }
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { trmtraincourse: args[0].trmtraincourse })
            }
...
<style lang='less'>
@import './trm-train-course-grid-view.less';
</style>