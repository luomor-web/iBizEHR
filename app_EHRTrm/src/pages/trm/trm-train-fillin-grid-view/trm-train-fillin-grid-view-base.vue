<template>
  <app-layout viewName="trmtrainfillingridview" viewTitle="培训需求填报" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-fillin-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class TrmTrainFillinGridViewBase extends GridViewBase {
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'trm-train-fillin-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmtrainfillin.views.editview.title'),
        };
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { trmtrainfillin: args[0].trmtrainfillin })
            }
