<template>
  <app-layout viewName="trmtrainfillingridview" viewTitle="培训项目部门填报表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-fillin-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="需求填报" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TrmTrainFillinGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainFillinGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainFillinService}
     * @memberof TrmTrainFillinGridViewBase
     */
	 ...
	 * @memberof TrmTrainFillinGridViewBase
	 */
	public viewtag: string = '29b63786f279c189b905d46ff4dfa9b9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainfillin.views.gridview.caption',
        srfTitle: 'entities.trmtrainfillin.views.gridview.title',
        srfSubTitle: 'entities.trmtrainfillin.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTrainFillinGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainFillin");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmtrainfillin;
        if(args.length >0){
            Object.assign(tempContext,args[0]);
        }
        let deResParameters: any[] = [];
        if(tempContext.ormorgsector && true){
            deResParameters = [
...
<style lang='less'>
@import './trm-train-fillin-grid-view.less';
</style>