<template>
  <app-layout viewName="trmtrainteachergridview" viewTitle="培训教师表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-teacher-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTrainTeacherGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainTeacherGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainTeacherService}
     * @memberof TrmTrainTeacherGridViewBase
     */
	 ...
	 * @memberof TrmTrainTeacherGridViewBase
	 */
	public viewtag: string = 'd8a8db81cf25380e25c3f8c4c90d7498';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainteacher.views.gridview.caption',
        srfTitle: 'entities.trmtrainteacher.views.gridview.title',
        srfSubTitle: 'entities.trmtrainteacher.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTrainTeacherGridView
     */
...
<style lang='less'>
@import './trm-train-teacher-grid-view.less';
</style>