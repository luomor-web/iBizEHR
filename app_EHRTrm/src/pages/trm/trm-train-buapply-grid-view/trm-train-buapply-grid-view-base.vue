<template>
  <app-layout viewName="trmtrainbuapplygridview" viewTitle="培训预算申请表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-buapply-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class TrmTrainBuapplyGridViewBase extends GridViewBase {
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainBuapply");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainBuapply");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainBuapply");
    }
