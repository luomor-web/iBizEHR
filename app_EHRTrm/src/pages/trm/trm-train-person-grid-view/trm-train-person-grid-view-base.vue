<template>
  <app-layout viewName="trmtrainpersongridview" viewTitle="培训记录表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-person-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTrainPersonGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainPersonGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainPersonService}
     * @memberof TrmTrainPersonGridViewBase
     */
	 ...
	 * @memberof TrmTrainPersonGridViewBase
	 */
	public viewtag: string = 'd5816ab80e805f256fb89aadeb53c178';
     ...
     *
     * @type {*}
     * @memberof TrmTrainPersonGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmtrainperson;
        if(args.length >0){
...
<style lang='less'>
@import './trm-train-person-grid-view.less';
</style>