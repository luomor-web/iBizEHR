<template>
  <app-layout viewName="trmcouarrangegridview" viewTitle="课程安排表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-couarrange-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmCouarrangeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmCouarrangeGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmCouarrangeService}
     * @memberof TrmCouarrangeGridViewBase
     */
	 ...
	 * @memberof TrmCouarrangeGridViewBase
	 */
	public viewtag: string = '425b1c2c7a6ec8ae771c7cec835d767c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmcouarrange.views.gridview.caption',
        srfTitle: 'entities.trmcouarrange.views.gridview.title',
        srfSubTitle: 'entities.trmcouarrange.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmCouarrangeGridView
     */
...
<style lang='less'>
@import './trm-couarrange-grid-view.less';
</style>