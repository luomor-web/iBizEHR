<template>
  <app-layout viewName="trmcoursesystemgridview" viewTitle="培训模块" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-course-system-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmCourseSystemGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmCourseSystemGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmCourseSystemService}
     * @memberof TrmCourseSystemGridViewBase
     */
	 ...
	 * @memberof TrmCourseSystemGridViewBase
	 */
	public viewtag: string = '18aed033f3c4553b4b65dacabecbb6a9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmcoursesystem.views.gridview.caption',
        srfTitle: 'entities.trmcoursesystem.views.gridview.title',
        srfSubTitle: 'entities.trmcoursesystem.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmCourseSystemGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmCourseSystem");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"TrmCourseSystem");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmCourseSystem");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmCourseSystem");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmcoursesystem;
        if(args.length >0){
        ...
        const view: any = {
            ...
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmcoursesystem.views.editview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'trm-course-system-edit-view9', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.trmcoursesystem.views.editview9.title'),
        };
        openPopupModal(view, data);
    }
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { trmcoursesystem: args[0].trmcoursesystem })
            }
...
<style lang='less'>
@import './trm-course-system-grid-view.less';
</style>