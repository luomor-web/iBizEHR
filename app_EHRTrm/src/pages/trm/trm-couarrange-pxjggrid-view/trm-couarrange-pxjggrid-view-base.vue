<template>
  <app-layout viewName="trmcouarrangepxjggridview" viewTitle="课程安排表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-couarrange-pxjggrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="课程安排名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TrmCouarrangePXJGGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmCouarrangePXJGGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmCouarrangeService}
     * @memberof TrmCouarrangePXJGGridViewBase
     */
	 ...
	 * @memberof TrmCouarrangePXJGGridViewBase
	 */
	public viewtag: string = '66b1d12b94f0b14bf0f9c2f715511171';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmcouarrange.views.pxjggridview.caption',
        srfTitle: 'entities.trmcouarrange.views.pxjggridview.title',
        srfSubTitle: 'entities.trmcouarrange.views.pxjggridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmCouarrangePXJGGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"TrmCouarrange");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"TrmCouarrange");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"TrmCouarrange");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"TrmCouarrange");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"TrmCouarrange");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmCouarrange");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.trmcouarrange;
        if(args.length >0){
...
<style lang='less'>
@import './trm-couarrange-pxjggrid-view.less';
</style>