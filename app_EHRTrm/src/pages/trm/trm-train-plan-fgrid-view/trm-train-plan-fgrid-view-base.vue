<template>
  <app-layout viewName="trmtrainplanfgridview" viewTitle="计划审批" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trm-train-plan-fgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTrainPlanFGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainPlanFGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainPlanService}
     * @memberof TrmTrainPlanFGridViewBase
     */
	 ...
	 * @memberof TrmTrainPlanFGridViewBase
	 */
	public viewtag: string = '7f581c31adcf1941579ec1bc7eb6b73f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainplan.views.fgridview.caption',
        srfTitle: 'entities.trmtrainplan.views.fgridview.title',
        srfSubTitle: 'entities.trmtrainplan.views.fgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTrainPlanFGridView
     */
...
<style lang='less'>
@import './trm-train-plan-fgrid-view.less';
</style>