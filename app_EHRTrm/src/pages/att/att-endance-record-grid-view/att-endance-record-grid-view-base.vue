...
export default class AttEndanceRecordGridViewBase extends GridViewBase {
	 ...
	 * @memberof AttEndanceRecordGridViewBase
	 */
	public viewtag: string = 'd3425907903ff37be55b4d1636c2c6b0';
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.attendancerecord;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'att-endance-record-edit-view', 
            height: 0, 
            width: 1024,  
            title: this.$t('entities.attendancerecord.views.editview.title'),
