 ...
 *
 * @export
 * @class EhrCodeList0167
 */
export default class EhrCodeList0167 {

    /**
     * 是否启用缓存
     *
     * @type boolean
     * @memberof EhrCodeList0167
     */
    ...
    public getItems(context: any={}, data: any={}, isloading?: boolean): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            const promise: Promise<any> = this.pimstafftypeService.FetchDefault(context, data, isloading);
