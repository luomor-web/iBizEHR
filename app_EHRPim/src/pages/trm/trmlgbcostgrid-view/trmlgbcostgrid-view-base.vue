<template>
  <app-layout viewName="trmlgbcostgridview" viewTitle="老干部活动管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trmlgbcostgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="活动" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TRMLGBCOSTGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TRMLGBCOSTGridViewBase extends GridViewBase {
	 ...
	 * @memberof TRMLGBCOSTGridViewBase
	 */
	public viewtag: string = 'dddc3f0be62026e4d2ede67e62746f4e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmlgbcost.views.gridview.caption',
        srfTitle: 'entities.trmlgbcost.views.gridview.title',
        srfSubTitle: 'entities.trmlgbcost.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.trmlgbcost;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'trmlgbcostedit-view', 
            height: 0, 
            width: 1366,  
            title: this.$t('entities.trmlgbcost.views.editview.title'),
...
<style lang='less'>
@import './trmlgbcostgrid-view.less';
</style>