<template>
  <app-layout viewName="trmtrianpersongridview" viewTitle="培训记录表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'trmtrianpersongrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入参培人员" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class TRMTRIANPERSONGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TRMTRIANPERSONGridViewBase extends GridViewBase {
	 ...
	 * @memberof TRMTRIANPERSONGridViewBase
	 */
	public viewtag: string = 'f293b599f7feaaffd1d3c7519a579118';
     ...
     *
     * @type {*}
     * @memberof TRMTRIANPERSONGridView
     */
...
<style lang='less'>
@import './trmtrianpersongrid-view.less';
</style>