<template>
  <app-layout viewName="pcmjxsgzeditview" viewTitle="见习期编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmjxsgzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMJXSGZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMJXSGZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PCMJXSGZService}
     * @memberof PCMJXSGZEditViewBase
     */
	 ...
	 * @memberof PCMJXSGZEditViewBase
	 */
	public viewtag: string = '1ee4cf83c19e727d121adf1c843509ac';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmjxsgz.views.editview.caption',
        srfTitle: 'entities.pcmjxsgz.views.editview.title',
        srfSubTitle: 'entities.pcmjxsgz.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    protected toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    protected toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    protected toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    protected toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    protected toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    protected toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    protected toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
