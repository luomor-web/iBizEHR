<template>
  <app-layout viewName="pcmjxsgzgridview" viewTitle="见习期表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcmjxsgzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入见习生规则名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PCMJXSGZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMJXSGZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PCMJXSGZService}
     * @memberof PCMJXSGZGridViewBase
     */
    public appEntityService: PCMJXSGZService = new PCMJXSGZService;
	 ...
	 * @memberof PCMJXSGZGridViewBase
	 */
	public viewtag: string = '25198e8aef450efde8ac670d85e3622c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmjxsgz.views.gridview.caption',
        srfTitle: 'entities.pcmjxsgz.views.gridview.title',
        srfSubTitle: 'entities.pcmjxsgz.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            keyPSDEField: 'pcmjxsgz',
            majorPSDEField: 'pcmjxsgzname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PCMJXSGZ");
    }
