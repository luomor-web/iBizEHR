<template>
  <app-layout viewName="pimpersonabilitygridview" viewTitle="员工能力表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimperson-ability-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPersonAbilityGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPersonAbilityGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPersonAbilityService}
     * @memberof PIMPersonAbilityGridViewBase
     */
	 ...
	 * @memberof PIMPersonAbilityGridViewBase
	 */
	public viewtag: string = 'e1101a28fb6703dc5a9a9e01d726fe01';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpersonability.views.gridview.caption',
        srfTitle: 'entities.pimpersonability.views.gridview.title',
        srfSubTitle: 'entities.pimpersonability.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPersonAbilityGridView
     */
...
<style lang='less'>
@import './pimperson-ability-grid-view.less';
</style>