<template>
  <app-layout viewName="pimfaminfopimfimgridview" viewTitle="家庭情况表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimfaminfopimfim-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMFAMINFOPimfimGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMFAMINFOPimfimGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMFAMINFOPimfimGridViewBase
	 */
	public viewtag: string = '6c4cbfc8f736328ae63518990928a246';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimfaminfo.views.pimfimgridview.caption',
        srfTitle: 'entities.pimfaminfo.views.pimfimgridview.title',
        srfSubTitle: 'entities.pimfaminfo.views.pimfimgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMFAMINFOPimfimGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pimfaminfoedit-view', 
            height: 0, 
            width: 1024,  
            title: this.$t('entities.pimfaminfo.views.editview.title'),
...
<style lang='less'>
@import './pimfaminfopimfim-grid-view.less';
</style>