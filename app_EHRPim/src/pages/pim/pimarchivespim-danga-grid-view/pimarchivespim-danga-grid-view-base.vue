<template>
  <app-layout viewName="pimarchivespimdangagridview" viewTitle="档案信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchivespim-danga-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESPimDangaGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESPimDangaGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARCHIVESPimDangaGridViewBase
	 */
	public viewtag: string = 'bdaf31b6411a15672bec48d830fd7fa7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.pimdangagridview.caption',
        srfTitle: 'entities.pimarchives.views.pimdangagridview.title',
        srfSubTitle: 'entities.pimarchives.views.pimdangagridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimarchivespim-danga-grid-view.less';
</style>