<template>
  <app-layout viewName="pimcontracttypegridview" viewTitle="合同类别表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimcontracttypegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入合同类别名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMCONTRACTTYPEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTTYPEGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMCONTRACTTYPEService}
     * @memberof PIMCONTRACTTYPEGridViewBase
     */
	 ...
	 * @memberof PIMCONTRACTTYPEGridViewBase
	 */
	public viewtag: string = 'eb48eb4459e5cfe548c9a052b7097548';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontracttype.views.gridview.caption',
        srfTitle: 'entities.pimcontracttype.views.gridview.title',
        srfSubTitle: 'entities.pimcontracttype.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTTYPEGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PIMCONTRACTTYPE");
    }
...
<style lang='less'>
@import './pimcontracttypegrid-view.less';
</style>