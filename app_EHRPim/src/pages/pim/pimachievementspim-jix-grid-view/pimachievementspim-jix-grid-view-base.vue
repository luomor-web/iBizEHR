<template>
  <app-layout viewName="pimachievementspimjixgridview" viewTitle="绩效信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimachievementspim-jix-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMACHIEVEMENTSPimJixGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMACHIEVEMENTSPimJixGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMACHIEVEMENTSPimJixGridViewBase
	 */
	public viewtag: string = '178ca8e0cbc9dd9641fe410584cc0a98';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimachievements.views.pimjixgridview.caption',
        srfTitle: 'entities.pimachievements.views.pimjixgridview.title',
        srfSubTitle: 'entities.pimachievements.views.pimjixgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMACHIEVEMENTSPimJixGridView
     */
...
<style lang='less'>
@import './pimachievementspim-jix-grid-view.less';
</style>