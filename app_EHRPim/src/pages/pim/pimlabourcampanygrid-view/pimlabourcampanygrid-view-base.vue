<template>
  <app-layout viewName="pimlabourcampanygridview" viewTitle="劳务派遣公司表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimlabourcampanygrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="公司名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMLABOURCAMPANYGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLABOURCAMPANYGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimLabourcampanyService}
     * @memberof PIMLABOURCAMPANYGridViewBase
     */
	 ...
	 * @memberof PIMLABOURCAMPANYGridViewBase
	 */
	public viewtag: string = '95c478e45c1b2660c25bb76dd2ea22d3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlabourcampany.views.gridview.caption',
        srfTitle: 'entities.pimlabourcampany.views.gridview.title',
        srfSubTitle: 'entities.pimlabourcampany.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMLABOURCAMPANYGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimlabourcampany;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'pimlabourcampanyedit-view', 
            height: 0, 
            width: 1366,  
            title: this.$t('entities.pimlabourcampany.views.editview.title'),
...
<style lang='less'>
@import './pimlabourcampanygrid-view.less';
</style>