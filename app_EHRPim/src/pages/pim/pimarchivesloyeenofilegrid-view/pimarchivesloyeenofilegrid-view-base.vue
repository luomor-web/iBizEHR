<template>
  <app-layout viewName="pimarchivesloyeenofilegridview" viewTitle="员工不在档提醒表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchivesloyeenofilegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchEMLOYEENOFILE"
    :newdata="newdata"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PIMARCHIVESLOYEENOFILEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESLOYEENOFILEGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARCHIVESLOYEENOFILEGridViewBase
	 */
	public viewtag: string = '1c4f6656ae3964d921333fc8e521b0d6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.loyeenofilegridview.caption',
        srfTitle: 'entities.pimarchives.views.loyeenofilegridview.title',
        srfSubTitle: 'entities.pimarchives.views.loyeenofilegridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESLOYEENOFILEGridView
     */
...
<style lang='less'>
@import './pimarchivesloyeenofilegrid-view.less';
</style>