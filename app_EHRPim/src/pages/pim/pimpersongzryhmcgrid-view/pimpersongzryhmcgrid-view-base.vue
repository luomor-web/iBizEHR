<template>
  <app-layout viewName="pimpersongzryhmcgridview" viewTitle="挂职人员花名册" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersongzryhmcgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONGZRYHMCGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONGZRYHMCGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPERSONService}
     * @memberof PIMPERSONGZRYHMCGridViewBase
     */
	 ...
	 * @memberof PIMPERSONGZRYHMCGridViewBase
	 */
	public viewtag: string = '43e9630b7e34dc56c2ab28ebbea464d0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.gzryhmcgridview.caption',
        srfTitle: 'entities.pimperson.views.gzryhmcgridview.title',
        srfSubTitle: 'entities.pimperson.views.gzryhmcgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONGZRYHMCGridView
     */
...
<style lang='less'>
@import './pimpersongzryhmcgrid-view.less';
</style>