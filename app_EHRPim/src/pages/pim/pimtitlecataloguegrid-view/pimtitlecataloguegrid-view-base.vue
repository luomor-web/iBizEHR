<template>
  <app-layout viewName="pimtitlecataloguegridview" viewTitle="职称目录管理表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimtitlecataloguegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入职称目录名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMTITLECATALOGUEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLECATALOGUEGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMTITLECATALOGUEGridViewBase
	 */
	public viewtag: string = 'a244f9fd24091560df1d952e8a6a282e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitlecatalogue.views.gridview.caption',
        srfTitle: 'entities.pimtitlecatalogue.views.gridview.title',
        srfSubTitle: 'entities.pimtitlecatalogue.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLECATALOGUE");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLECATALOGUE");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLECATALOGUE");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLECATALOGUE");
    }
...
<style lang='less'>
@import './pimtitlecataloguegrid-view.less';
</style>