<template>
  <app-layout viewName="pimarchivesnoloyeenofilegridview" viewTitle="非员工在档提醒表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchivesnoloyeenofilegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchNOEMLOYEENOFILE"
    :newdata="newdata"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PIMARCHIVESNOLOYEENOFILEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESNOLOYEENOFILEGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesService}
     * @memberof PIMARCHIVESNOLOYEENOFILEGridViewBase
     */
	 ...
	 * @memberof PIMARCHIVESNOLOYEENOFILEGridViewBase
	 */
	public viewtag: string = '7c972c0604bdb8bddac7f9be3ce296f7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.noloyeenofilegridview.caption',
        srfTitle: 'entities.pimarchives.views.noloyeenofilegridview.title',
        srfSubTitle: 'entities.pimarchives.views.noloyeenofilegridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESNOLOYEENOFILEGridView
     */
...
<style lang='less'>
@import './pimarchivesnoloyeenofilegrid-view.less';
</style>