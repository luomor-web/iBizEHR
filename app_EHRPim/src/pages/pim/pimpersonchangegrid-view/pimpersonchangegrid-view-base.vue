<template>
  <app-layout viewName="pimpersonchangegridview" viewTitle="员工信息审核表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonchangegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchPIMCL_NOTAPPROVAL"
    :newdata="newdata"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PIMPERSONCHANGEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONCHANGEGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMPERSONCHANGEGridViewBase
	 */
	public viewtag: string = '2151c9cf1466f04ddd57fb78ff15e3a3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpersonchange.views.gridview.caption',
        srfTitle: 'entities.pimpersonchange.views.gridview.title',
        srfSubTitle: 'entities.pimpersonchange.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONCHANGEGridView
     */
    public toolBarModels: any = {
        deuiaction1_qr: { name: 'deuiaction1_qr', caption: '同意','isShowCaption':true,'isShowIcon':true, tooltip: '同意', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'QR', target: 'MULTIKEY' }, class: '' },

        deuiaction1_hisrec: { name: 'deuiaction1_hisrec', caption: '历史审核记录','isShowCaption':true,'isShowIcon':true, tooltip: '历史审核记录', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'HisRec', target: 'NONE' }, class: '' },
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_qr_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_hisrec_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimpersonchange;
        if(args.length >0){
...
<style lang='less'>
@import './pimpersonchangegrid-view.less';
</style>