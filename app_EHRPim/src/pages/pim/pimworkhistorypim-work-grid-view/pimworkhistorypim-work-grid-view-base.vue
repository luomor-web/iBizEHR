<template>
  <app-layout viewName="pimworkhistorypimworkgridview" viewTitle="工作履历表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimworkhistorypim-work-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMWORKHISTORYPimWorkGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMWORKHISTORYPimWorkGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMWORKHISTORYService}
     * @memberof PIMWORKHISTORYPimWorkGridViewBase
     */
	 ...
	 * @memberof PIMWORKHISTORYPimWorkGridViewBase
	 */
	public viewtag: string = '47a51836a8ffb05c23362952df3db3d2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimworkhistory.views.pimworkgridview.caption',
        srfTitle: 'entities.pimworkhistory.views.pimworkgridview.title',
        srfSubTitle: 'entities.pimworkhistory.views.pimworkgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMWORKHISTORYPimWorkGridView
     */
 ...
 tbitem13: { name: 'tbitem13', caption: '导出数据','isShowCaption':true,'isShowIcon':true, tooltip: '导出数据', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMWORKHISTORY");
    }
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimworkhistory: args[0].pimworkhistory })
            }
...
<style lang='less'>
@import './pimworkhistorypim-work-grid-view.less';
</style>