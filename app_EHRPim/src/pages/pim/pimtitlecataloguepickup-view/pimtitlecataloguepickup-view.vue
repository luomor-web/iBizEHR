 ...
 *
 * @export
 * @class PIMTITLECATALOGUEPickupView
 * @extends {PIMTITLECATALOGUEPickupViewBase}
 */
@Component({
    components: {
...
export default class PIMTITLECATALOGUEPickupView extends PIMTITLECATALOGUEPickupViewBase { }
</script>