<template>
  <app-layout viewName="pimqualmajorgridview" viewTitle="执业资格专业" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimqualmajorgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMQUALMAJORGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMQUALMAJORGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMQUALMAJORGridViewBase
	 */
	public viewtag: string = 'e1fa33d9a9ef62606b265a129ed77cbe';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimqualmajor.views.gridview.caption',
        srfTitle: 'entities.pimqualmajor.views.gridview.title',
        srfSubTitle: 'entities.pimqualmajor.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimqualmajor;
        if(args.length >0){
...
<style lang='less'>
@import './pimqualmajorgrid-view.less';
</style>