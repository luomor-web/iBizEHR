<template>
  <app-layout viewName="pimlanguageabilityyynlgridview" viewTitle="语言能力表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimlanguageabilityyynlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMLANGUAGEABILITYYYNLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLANGUAGEABILITYYYNLGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMLANGUAGEABILITYYYNLGridViewBase
	 */
	public viewtag: string = '229f46ac0aaea849d9b2ad137a920848';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlanguageability.views.yynlgridview.caption',
        srfTitle: 'entities.pimlanguageability.views.yynlgridview.title',
        srfSubTitle: 'entities.pimlanguageability.views.yynlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMLANGUAGEABILITYYYNLGridView
     */
...
<style lang='less'>
@import './pimlanguageabilityyynlgrid-view.less';
</style>