<template>
  <app-layout viewName="archivalcataloguegridview" viewTitle="档案类别表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'archivalcataloguegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入档案目录名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ARCHIVALCATALOGUEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVALCATALOGUEGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ARCHIVALCATALOGUEService}
     * @memberof ARCHIVALCATALOGUEGridViewBase
     */
	 ...
	 * @memberof ARCHIVALCATALOGUEGridViewBase
	 */
	public viewtag: string = '81cf0534845590aa2ba94ec70460a34c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.archivalcatalogue.views.gridview.caption',
        srfTitle: 'entities.archivalcatalogue.views.gridview.title',
        srfSubTitle: 'entities.archivalcatalogue.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ARCHIVALCATALOGUEGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ARCHIVALCATALOGUE");
    }
...
<style lang='less'>
@import './archivalcataloguegrid-view.less';
</style>