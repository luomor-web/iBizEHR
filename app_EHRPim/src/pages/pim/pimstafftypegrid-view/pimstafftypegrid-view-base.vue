<template>
  <app-layout viewName="pimstafftypegridview" viewTitle="员工类型表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimstafftypegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入员工类型管理名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMSTAFFTYPEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMSTAFFTYPEGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMSTAFFTYPEService}
     * @memberof PIMSTAFFTYPEGridViewBase
     */
	 ...
	 * @memberof PIMSTAFFTYPEGridViewBase
	 */
	public viewtag: string = '1e662f352a8f29e529e90f29e3b40f67';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimstafftype.views.gridview.caption',
        srfTitle: 'entities.pimstafftype.views.gridview.title',
        srfSubTitle: 'entities.pimstafftype.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
    ...
    public toolbar2_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PIMSTAFFTYPE");
    }
...
<style lang='less'>
@import './pimstafftypegrid-view.less';
</style>