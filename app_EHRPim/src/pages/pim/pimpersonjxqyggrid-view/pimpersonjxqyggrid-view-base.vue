<template>
  <app-layout viewName="pimpersonjxqyggridview" viewTitle="见习员工" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonjxqyggrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONJXQYGGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONJXQYGGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMPERSONJXQYGGridViewBase
	 */
	public viewtag: string = '64dfa07027b70064fc6dab4cbeac0d2d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.jxqyggridview.caption',
        srfTitle: 'entities.pimperson.views.jxqyggridview.title',
        srfSubTitle: 'entities.pimperson.views.jxqyggridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONJXQYGGridView
     */
...
<style lang='less'>
@import './pimpersonjxqyggrid-view.less';
</style>