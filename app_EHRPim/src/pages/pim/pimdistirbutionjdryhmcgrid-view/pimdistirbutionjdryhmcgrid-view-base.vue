<template>
  <app-layout viewName="pimdistirbutionjdryhmcgridview" viewTitle="借调人员花名册" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimdistirbutionjdryhmcgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMDISTIRBUTIONJDRYHMCGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMDISTIRBUTIONJDRYHMCGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMDISTIRBUTIONService}
     * @memberof PIMDISTIRBUTIONJDRYHMCGridViewBase
     */
	 ...
	 * @memberof PIMDISTIRBUTIONJDRYHMCGridViewBase
	 */
	public viewtag: string = 'ed44db0490d330fba632498accfecc6a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.jdryhmcgridview.caption',
        srfTitle: 'entities.pimdistirbution.views.jdryhmcgridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.jdryhmcgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMDISTIRBUTIONJDRYHMCGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pimdistirbutionmaturity-due-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pimdistirbution.views.maturitydueeditview.title'),
...
<style lang='less'>
@import './pimdistirbutionjdryhmcgrid-view.less';
</style>