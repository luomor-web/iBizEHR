 ...
 *
 * @export
 * @class PIMDISTIRBUTIONJDRYHMCGridView
 * @extends {PIMDISTIRBUTIONJDRYHMCGridViewBase}
 */
@Component({
    components: {
        view_grid, 
...
export default class PIMDISTIRBUTIONJDRYHMCGridView extends PIMDISTIRBUTIONJDRYHMCGridViewBase { }
</script>