<template>
  <app-layout viewName="pimpersonchangehisrecgridview" viewTitle="历史审核记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonchangehis-rec-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONCHANGEHisRecGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONCHANGEHisRecGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMPERSONCHANGEHisRecGridViewBase
	 */
	public viewtag: string = '7c82bcf008bd9c66a7e08c5d1b3583ec';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpersonchange.views.hisrecgridview.caption',
        srfTitle: 'entities.pimpersonchange.views.hisrecgridview.title',
        srfSubTitle: 'entities.pimpersonchange.views.hisrecgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONCHANGEHisRecGridView
     */
...
<style lang='less'>
@import './pimpersonchangehis-rec-grid-view.less';
</style>