<template>
  <app-layout viewName="pimarchiveschangedadcjlgridview" viewTitle="档案调出记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchiveschangedadcjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入归档地变更记录" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMARCHIVESCHANGEDADCJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESCHANGEDADCJLGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARCHIVESCHANGEDADCJLGridViewBase
	 */
	public viewtag: string = 'fe7b00219922eede26cfaddc3ad03115';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchiveschange.views.dadcjlgridview.caption',
        srfTitle: 'entities.pimarchiveschange.views.dadcjlgridview.title',
        srfSubTitle: 'entities.pimarchiveschange.views.dadcjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESCHANGEDADCJLGridView
     */
...
<style lang='less'>
@import './pimarchiveschangedadcjlgrid-view.less';
</style>