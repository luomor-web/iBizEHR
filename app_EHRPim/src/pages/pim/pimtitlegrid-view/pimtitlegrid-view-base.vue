<template>
  <app-layout viewName="pimtitlegridview" viewTitle="职称信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimtitlegrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入员工姓名，员工编号" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchAscriptionSys"
    :newdata="newdata"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PIMTITLEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLEGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMTITLEService}
     * @memberof PIMTITLEGridViewBase
     */
	 ...
	 * @memberof PIMTITLEGridViewBase
	 */
	public viewtag: string = '053ad31fdeb2b1fad51395e7e1a81c67';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitle.views.gridview.caption',
        srfTitle: 'entities.pimtitle.views.gridview.title',
        srfSubTitle: 'entities.pimtitle.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLE");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLE");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLE");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PIMTITLE");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pimtitleedit-view', 
            height: 0, 
            width: 1366,  
            title: this.$t('entities.pimtitle.views.editview.title'),
