<template>
  <app-layout viewName="pimpersonlzyghmcgridview" viewTitle="离职员工" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonlzyghmcgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONLZYGHMCGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONLZYGHMCGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPERSONService}
     * @memberof PIMPERSONLZYGHMCGridViewBase
     */
	 ...
	 * @memberof PIMPERSONLZYGHMCGridViewBase
	 */
	public viewtag: string = 'eb9653f376333616bccf8f9560e62c93';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.lzyghmcgridview.caption',
        srfTitle: 'entities.pimperson.views.lzyghmcgridview.title',
        srfSubTitle: 'entities.pimperson.views.lzyghmcgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONLZYGHMCGridView
     */
...
<style lang='less'>
@import './pimpersonlzyghmcgrid-view.less';
</style>