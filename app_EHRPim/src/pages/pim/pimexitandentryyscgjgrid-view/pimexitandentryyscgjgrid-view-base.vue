<template>
  <app-layout viewName="pimexitandentryyscgjgridview" viewTitle="出入境管理实体表格视图（因私出国境）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimexitandentryyscgjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
/**
 * 出入境管理实体表格视图（因私出国境）基类
 *
 * @export
 * @class PIMEXITANDENTRYYSCGJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXITANDENTRYYSCGJGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMEXITANDENTRYYSCGJGridViewBase
	 */
	public viewtag: string = '9a0fc29bb2f74862dd23e692fcbc12f9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexitandentry.views.yscgjgridview.caption',
        srfTitle: 'entities.pimexitandentry.views.yscgjgridview.title',
        srfSubTitle: 'entities.pimexitandentry.views.yscgjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXITANDENTRYYSCGJGridView
     */
    public toolBarModels: any = {
        tbitem1_newys: { name: 'tbitem1_newys', caption: '因私新建','isShowCaption':true,'isShowIcon':true, tooltip: '因私新建', iconcls: 'fa fa-file-text-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'newYS', target: 'NONE' }, class: '' },
 ...
 tbitem13: { name: 'tbitem13', caption: '导出数据','isShowCaption':true,'isShowIcon':true, tooltip: '导出数据', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_newys')) {
            this.toolbar_tbitem1_newys_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_newys_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
...
<style lang='less'>
@import './pimexitandentryyscgjgrid-view.less';
</style>