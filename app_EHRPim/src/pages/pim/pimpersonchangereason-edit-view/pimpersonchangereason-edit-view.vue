 ...
 *
 * @export
 * @class PIMPERSONCHANGEReasonEditView
 * @extends {PIMPERSONCHANGEReasonEditViewBase}
 */
@Component({
    components: {
        view_form, 
...
export default class PIMPERSONCHANGEReasonEditView extends PIMPERSONCHANGEReasonEditViewBase { }
</script>