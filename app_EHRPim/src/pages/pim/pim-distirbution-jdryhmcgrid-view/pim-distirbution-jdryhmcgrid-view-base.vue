<template>
  <app-layout viewName="pimdistirbutionjdryhmcgridview" viewTitle="借调人员花名册" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-jdryhmcgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<style lang='less'>
@import './pim-distirbution-jdryhmcgrid-view.less';
</style>