<template>
  <app-layout viewName="pimpersonltxyggridview" viewTitle="离（退）休人员" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonltxyggrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONLTXYGGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONLTXYGGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPERSONService}
     * @memberof PIMPERSONLTXYGGridViewBase
     */
	 ...
	 * @memberof PIMPERSONLTXYGGridViewBase
	 */
	public viewtag: string = 'a9ed8a2bef67f5ccfcde130ed72c28ba';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.ltxyggridview.caption',
        srfTitle: 'entities.pimperson.views.ltxyggridview.title',
        srfSubTitle: 'entities.pimperson.views.ltxyggridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONLTXYGGridView
     */
...
<style lang='less'>
@import './pimpersonltxyggrid-view.less';
</style>