<template>
  <app-layout viewName="pimpersonhmdgridview" viewTitle="黑名单表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonhmdgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONHMDGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONHMDGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPERSONService}
     * @memberof PIMPERSONHMDGridViewBase
     */
	 ...
	 * @memberof PIMPERSONHMDGridViewBase
	 */
	public viewtag: string = '7d8f556220d7acf33780801065c39c8a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.hmdgridview.caption',
        srfTitle: 'entities.pimperson.views.hmdgridview.title',
        srfSubTitle: 'entities.pimperson.views.hmdgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimpersonhmdgrid-view.less';
</style>