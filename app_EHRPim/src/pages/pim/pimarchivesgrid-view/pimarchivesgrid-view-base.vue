<template>
  <app-layout viewName="pimarchivesgridview" viewTitle="档案信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchivesgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARCHIVESGridViewBase
	 */
	public viewtag: string = '4e67a1b41944cdaf106f4479e83da889';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.gridview.caption',
        srfTitle: 'entities.pimarchives.views.gridview.title',
        srfSubTitle: 'entities.pimarchives.views.gridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimarchivesgrid-view.less';
</style>