<template>
  <app-layout viewName="pimrewardpunishmenthonorgridview" viewTitle="荣誉奖励" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimrewardpunishmenthonorgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMREWARDPUNISHMENTHONORGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMREWARDPUNISHMENTHONORGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMREWARDPUNISHMENTHONORGridViewBase
	 */
	public viewtag: string = '19f00009bc07fdec629eaaf02b39c92e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimrewardpunishment.views.honorgridview.caption',
        srfTitle: 'entities.pimrewardpunishment.views.honorgridview.title',
        srfSubTitle: 'entities.pimrewardpunishment.views.honorgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMREWARDPUNISHMENTHONORGridView
     */
...
<style lang='less'>
@import './pimrewardpunishmenthonorgrid-view.less';
</style>