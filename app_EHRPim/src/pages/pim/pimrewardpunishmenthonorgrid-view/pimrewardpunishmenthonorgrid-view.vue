 ...
 *
 * @export
 * @class PIMREWARDPUNISHMENTHONORGridView
 * @extends {PIMREWARDPUNISHMENTHONORGridViewBase}
 */
@Component({
    components: {
        view_grid, 
...
export default class PIMREWARDPUNISHMENTHONORGridView extends PIMREWARDPUNISHMENTHONORGridViewBase { }
</script>