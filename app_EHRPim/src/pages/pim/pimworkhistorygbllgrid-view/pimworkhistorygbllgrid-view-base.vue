<template>
  <app-layout viewName="pimworkhistorygbllgridview" viewTitle="工作履历" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimworkhistorygbllgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMWORKHISTORYGBLLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMWORKHISTORYGBLLGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMWORKHISTORYGBLLGridViewBase
	 */
	public viewtag: string = 'dae003e488bbbf5fc12b8f781c2b292a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimworkhistory.views.gbllgridview.caption',
        srfTitle: 'entities.pimworkhistory.views.gbllgridview.title',
        srfSubTitle: 'entities.pimworkhistory.views.gbllgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMWORKHISTORYGBLLGridView
     */
...
<style lang='less'>
@import './pimworkhistorygbllgrid-view.less';
</style>