<template>
  <app-layout viewName="pimcontractlwgridview" viewTitle="劳务合同管理表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimcontractlwgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMCONTRACTLWGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTLWGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMCONTRACTLWGridViewBase
	 */
	public viewtag: string = '4d3329e182f9a7d62e89d80a8e66677a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontract.views.lwgridview.caption',
        srfTitle: 'entities.pimcontract.views.lwgridview.title',
        srfSubTitle: 'entities.pimcontract.views.lwgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTLWGridView
     */
...
<style lang='less'>
@import './pimcontractlwgrid-view.less';
</style>