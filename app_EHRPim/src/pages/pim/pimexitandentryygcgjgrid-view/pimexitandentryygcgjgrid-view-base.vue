<template>
  <app-layout viewName="pimexitandentryygcgjgridview" viewTitle="出入境管理实体表格视图（因公出国境）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimexitandentryygcgjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入出入境管理名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
...
/**
 * 出入境管理实体表格视图（因公出国境）基类
 *
 * @export
 * @class PIMEXITANDENTRYYGCGJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXITANDENTRYYGCGJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMEXITANDENTRYService}
     * @memberof PIMEXITANDENTRYYGCGJGridViewBase
     */
	 ...
	 * @memberof PIMEXITANDENTRYYGCGJGridViewBase
	 */
	public viewtag: string = 'adafd3d52426b170e4c9731d99309ecb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexitandentry.views.ygcgjgridview.caption',
        srfTitle: 'entities.pimexitandentry.views.ygcgjgridview.title',
        srfSubTitle: 'entities.pimexitandentry.views.ygcgjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXITANDENTRYYGCGJGridView
     */
    public toolBarModels: any = {
        tbitem1_newyg: { name: 'tbitem1_newyg', caption: '因公新建','isShowCaption':true,'isShowIcon':true, tooltip: '因公新建', iconcls: 'fa fa-file-text-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'newYG', target: 'NONE' }, class: '' },

        tbitem1_ksccgj: { name: 'tbitem1_ksccgj', caption: '删除','isShowCaption':true,'isShowIcon':true, tooltip: '删除', iconcls: 'fa fa-remove', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'KSCCGJ', uiaction: { tag: 'KSCCGJ', target: 'SINGLEKEY' }, class: '' },
 ...
 tbitem13: { name: 'tbitem13', caption: '导出数据','isShowCaption':true,'isShowIcon':true, tooltip: '导出数据', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_newyg')) {
            this.toolbar_tbitem1_newyg_click($event, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem1_ksccgj')) {
            this.toolbar_tbitem1_ksccgj_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_newyg_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PIMEXITANDENTRY_newYG(datas,contextJO, paramJO,  $event, xData,this,"PIMEXITANDENTRY");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_ksccgj_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimexitandentry: args[0].pimexitandentry })
            }
...
<style lang='less'>
@import './pimexitandentryygcgjgrid-view.less';
</style>