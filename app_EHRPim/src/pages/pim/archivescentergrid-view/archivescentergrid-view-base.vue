<template>
  <app-layout viewName="archivescentergridview" viewTitle="档案室管理表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'archivescentergrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入档案存放位置" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ARCHIVESCENTERGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVESCENTERGridViewBase extends GridViewBase {
	 ...
	 * @memberof ARCHIVESCENTERGridViewBase
	 */
	public viewtag: string = 'cf07226cf97f3e8429dd04917035b611';
     ...
     *
     * @type {*}
     * @memberof ARCHIVESCENTERGridView
     */
...
<style lang='less'>
@import './archivescentergrid-view.less';
</style>