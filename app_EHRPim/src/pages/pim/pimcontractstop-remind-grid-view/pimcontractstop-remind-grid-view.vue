 ...
 *
 * @export
 * @class PIMCONTRACTStopRemindGridView
 * @extends {PIMCONTRACTStopRemindGridViewBase}
 */
@Component({
    components: {
        view_grid, 
...
export default class PIMCONTRACTStopRemindGridView extends PIMCONTRACTStopRemindGridViewBase { }
</script>