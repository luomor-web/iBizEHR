<template>
  <app-layout viewName="pimcontractstopremindgridview" viewTitle="合同信息表格视图(终止提醒)" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimcontractstop-remind-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchStopContracts"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PIMCONTRACTStopRemindGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTStopRemindGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimContractService}
     * @memberof PIMCONTRACTStopRemindGridViewBase
     */
	 ...
	 * @memberof PIMCONTRACTStopRemindGridViewBase
	 */
	public viewtag: string = '08c5124c92aeb7656cc47a957f4d95a8';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontract.views.stopremindgridview.caption',
        srfTitle: 'entities.pimcontract.views.stopremindgridview.title',
        srfSubTitle: 'entities.pimcontract.views.stopremindgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTStopRemindGridView
     */
...
<style lang='less'>
@import './pimcontractstop-remind-grid-view.less';
</style>