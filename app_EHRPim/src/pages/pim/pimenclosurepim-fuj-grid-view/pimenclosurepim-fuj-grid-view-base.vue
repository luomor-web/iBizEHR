<template>
  <app-layout viewName="pimenclosurepimfujgridview" viewTitle="附件信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimenclosurepim-fuj-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMENCLOSUREPimFujGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMENCLOSUREPimFujGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMENCLOSUREService}
     * @memberof PIMENCLOSUREPimFujGridViewBase
     */
	 ...
	 * @memberof PIMENCLOSUREPimFujGridViewBase
	 */
	public viewtag: string = 'a0d42b3740428217a63cf0bd45166d51';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimenclosure.views.pimfujgridview.caption',
        srfTitle: 'entities.pimenclosure.views.pimfujgridview.title',
        srfSubTitle: 'entities.pimenclosure.views.pimfujgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMENCLOSUREPimFujGridView
     */
    ...
    protected toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMENCLOSURE");
    }
    ...
    protected toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PIMENCLOSURE");
    }
    ...
    protected toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PIMENCLOSURE");
    }
    ...
    protected toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PIMENCLOSURE");
    }
    ...
    protected toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMENCLOSURE");
    }
...
<style lang='less'>
@import './pimenclosurepim-fuj-grid-view.less';
</style>