<template>
  <app-layout viewName="pimarmycadresarmygridview" viewTitle="军转干部表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarmycadresarmygrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARMYCADRESARMYGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARMYCADRESARMYGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARMYCADRESARMYGridViewBase
	 */
	public viewtag: string = 'cc266564b3f51daaea8b907e94e9dd04';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarmycadres.views.armygridview.caption',
        srfTitle: 'entities.pimarmycadres.views.armygridview.title',
        srfSubTitle: 'entities.pimarmycadres.views.armygridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARMYCADRESARMYGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMARMYCADRES");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PIMARMYCADRES");
    }
...
<style lang='less'>
@import './pimarmycadresarmygrid-view.less';
</style>