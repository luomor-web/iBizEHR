<template>
  <app-layout viewName="pimpersongridview" viewTitle="员工信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersongrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入原员工编号，员工编号，员工姓名" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMPERSONGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPERSONService}
     * @memberof PIMPERSONGridViewBase
     */
	 ...
	 * @memberof PIMPERSONGridViewBase
	 */
	public viewtag: string = '0152964b7b7c749e3634a2f4fe12d37c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.gridview.caption',
        srfTitle: 'entities.pimperson.views.gridview.title',
        srfSubTitle: 'entities.pimperson.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        deuiaction1_quickcreateperson: { name: 'deuiaction1_quickcreateperson', caption: '新建','isShowCaption':true,'isShowIcon':true, tooltip: '新建', iconcls: 'fa fa-file-text-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'QuickCreatePerson', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_quickcreateperson')) {
            this.toolbar_deuiaction1_quickcreateperson_click($event, '', $event2);
        }
        if (Object.is($event.tag, 'deuiaction8')) {
            this.toolbar_deuiaction8_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_quickcreateperson_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PIMPERSON_QuickCreatePerson(datas,contextJO, paramJO,  $event, xData,this,"PIMPERSON");
    }
    ...
    public toolbar_deuiaction8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PIMPERSON");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            ...
            height: 0, 
            width: 0,  
            title: this.$t('entities.pimperson.views.editview2.title'),
...
<style lang='less'>
@import './pimpersongrid-view.less';
</style>