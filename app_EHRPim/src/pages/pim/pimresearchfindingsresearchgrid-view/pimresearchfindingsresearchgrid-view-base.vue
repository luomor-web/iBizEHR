<template>
  <app-layout viewName="pimresearchfindingsresearchgridview" viewTitle="科研成果表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimresearchfindingsresearchgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMRESEARCHFINDINGSRESEARCHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMRESEARCHFINDINGSRESEARCHGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMRESEARCHFINDINGSService}
     * @memberof PIMRESEARCHFINDINGSRESEARCHGridViewBase
     */
	 ...
	 * @memberof PIMRESEARCHFINDINGSRESEARCHGridViewBase
	 */
	public viewtag: string = 'dc68131064e2696cebab97f195439653';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimresearchfindings.views.researchgridview.caption',
        srfTitle: 'entities.pimresearchfindings.views.researchgridview.title',
        srfSubTitle: 'entities.pimresearchfindings.views.researchgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMRESEARCHFINDINGSRESEARCHGridView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"PIMRESEARCHFINDINGS");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"PIMRESEARCHFINDINGS");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"PIMRESEARCHFINDINGS");
    }
...
<style lang='less'>
@import './pimresearchfindingsresearchgrid-view.less';
</style>