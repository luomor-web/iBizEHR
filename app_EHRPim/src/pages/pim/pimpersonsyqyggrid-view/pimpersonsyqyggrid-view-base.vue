<template>
  <app-layout viewName="pimpersonsyqyggridview" viewTitle="试用员工" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpersonsyqyggrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONSYQYGGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONSYQYGGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMPERSONService}
     * @memberof PIMPERSONSYQYGGridViewBase
     */
	 ...
	 * @memberof PIMPERSONSYQYGGridViewBase
	 */
	public viewtag: string = 'b67bcd30b457b30ca3f0de999d97cef4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.syqyggridview.caption',
        srfTitle: 'entities.pimperson.views.syqyggridview.title',
        srfSubTitle: 'entities.pimperson.views.syqyggridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONSYQYGGridView
     */
...
<style lang='less'>
@import './pimpersonsyqyggrid-view.less';
</style>