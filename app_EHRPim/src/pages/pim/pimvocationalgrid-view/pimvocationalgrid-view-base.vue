<template>
  <app-layout viewName="pimvocationalgridview" viewTitle="证书信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimvocationalgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="证书名称，员工姓名，员工编号" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
...
<view_grid 
    ...
    loadAction=""
    createAction=""
    fetchAction="FetchAscriptionSysDQ"
    :newdata="newdata"
    :opendata="opendata"
    name="grid"  
    ref='grid' 
 ...
 *
 * @export
 * @class PIMVOCATIONALGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMVOCATIONALGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMVOCATIONALGridViewBase
	 */
	public viewtag: string = '7268dd996b966c5cc72c0f62ae16e162';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimvocational.views.gridview.caption',
        srfTitle: 'entities.pimvocational.views.gridview.title',
        srfSubTitle: 'entities.pimvocational.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMVOCATIONALGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.pimvocational;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'pimvocationaledit-view', 
            height: 0, 
            width: 1366,  
            title: this.$t('entities.pimvocational.views.editview.title'),
...
<style lang='less'>
@import './pimvocationalgrid-view.less';
</style>