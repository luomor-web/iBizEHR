<template>
  <app-layout viewName="pimdistirbutionygfenpeigridview" viewTitle="分配信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimdistirbutionygfen-pei-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class PIMDISTIRBUTIONYGFenPeiGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMDISTIRBUTIONYGFenPeiGridViewBase
	 */
	public viewtag: string = '5e8063923fbd33440a4682a8d85feef4';
...
<style lang='less'>
@import './pimdistirbutionygfen-pei-grid-view.less';
</style>