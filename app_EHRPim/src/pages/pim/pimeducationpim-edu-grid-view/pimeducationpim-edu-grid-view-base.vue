<template>
  <app-layout viewName="pimeducationpimedugridview" viewTitle="教育信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimeducationpim-edu-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEDUCATIONPimEduGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEDUCATIONPimEduGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMEDUCATIONPimEduGridViewBase
	 */
	public viewtag: string = '87e832e8a0468437a4c83ccbd3ff6fd2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimeducation.views.pimedugridview.caption',
        srfTitle: 'entities.pimeducation.views.pimedugridview.title',
        srfSubTitle: 'entities.pimeducation.views.pimedugridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"PimEducation");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"PimEducation");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimeducation;
        if(args.length >0){
...
<style lang='less'>
@import './pimeducationpim-edu-grid-view.less';
</style>