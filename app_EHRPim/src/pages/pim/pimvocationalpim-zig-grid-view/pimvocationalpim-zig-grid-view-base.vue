<template>
  <app-layout viewName="pimvocationalpimziggridview" viewTitle="证书信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimvocationalpim-zig-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMVOCATIONALPimZigGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMVOCATIONALPimZigGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMVOCATIONALPimZigGridViewBase
	 */
	public viewtag: string = '80133c7eeb811cfeb62536c1dabafb0f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimvocational.views.pimziggridview.caption',
        srfTitle: 'entities.pimvocational.views.pimziggridview.title',
        srfSubTitle: 'entities.pimvocational.views.pimziggridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMVOCATIONALPimZigGridView
     */
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimvocational: args[0].pimvocational })
            }
...
<style lang='less'>
@import './pimvocationalpim-zig-grid-view.less';
</style>