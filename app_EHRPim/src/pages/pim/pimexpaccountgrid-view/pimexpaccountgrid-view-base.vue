<template>
  <app-layout viewName="pimexpaccountgridview" viewTitle="费用台账表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimexpaccountgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="费用台账名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMEXPACCOUNTGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXPACCOUNTGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMEXPACCOUNTGridViewBase
	 */
	public viewtag: string = '31d665cddd46d10553d2cc3e093f0d3c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexpaccount.views.gridview.caption',
        srfTitle: 'entities.pimexpaccount.views.gridview.title',
        srfSubTitle: 'entities.pimexpaccount.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXPACCOUNTGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimexpaccount;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'pimexpaccountedit-view', 
            height: 0, 
            width: 1366,  
            title: this.$t('entities.pimexpaccount.views.editview.title'),
...
<style lang='less'>
@import './pimexpaccountgrid-view.less';
</style>