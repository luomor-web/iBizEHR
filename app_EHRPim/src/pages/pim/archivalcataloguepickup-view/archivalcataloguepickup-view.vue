 ...
 *
 * @export
 * @class ARCHIVALCATALOGUEPickupView
 * @extends {ARCHIVALCATALOGUEPickupViewBase}
 */
@Component({
    components: {
...
export default class ARCHIVALCATALOGUEPickupView extends ARCHIVALCATALOGUEPickupViewBase { }
</script>