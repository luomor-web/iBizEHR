<template>
  <app-layout viewName="pimtitlepimzhicgridview" viewTitle="职称信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimtitlepim-zhic-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTITLEPimZhicGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLEPimZhicGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMTITLEPimZhicGridViewBase
	 */
	public viewtag: string = 'a2b904dc7d6f61660e5377b783da889e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitle.views.pimzhicgridview.caption',
        srfTitle: 'entities.pimtitle.views.pimzhicgridview.title',
        srfSubTitle: 'entities.pimtitle.views.pimzhicgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMTITLEPimZhicGridView
     */
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimtitle: args[0].pimtitle })
            }
...
<style lang='less'>
@import './pimtitlepim-zhic-grid-view.less';
</style>