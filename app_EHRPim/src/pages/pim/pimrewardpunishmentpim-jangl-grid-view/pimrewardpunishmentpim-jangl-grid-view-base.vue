<template>
  <app-layout viewName="pimrewardpunishmentpimjanglgridview" viewTitle="奖励惩罚表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimrewardpunishmentpim-jangl-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMREWARDPUNISHMENTPimJanglGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMREWARDPUNISHMENTPimJanglGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMREWARDPUNISHMENTPimJanglGridViewBase
	 */
	public viewtag: string = '719049119fad9f3be18ffa99c24f8210';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimrewardpunishment.views.pimjanglgridview.caption',
        srfTitle: 'entities.pimrewardpunishment.views.pimjanglgridview.title',
        srfSubTitle: 'entities.pimrewardpunishment.views.pimjanglgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimrewardpunishmentpim-jangl-grid-view.less';
</style>