<template>
  <app-layout viewName="pimtypecontractgridview" viewTitle="合同类型表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimtypecontractgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入合同类型名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMTYPECONTRACTGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTYPECONTRACTGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMTYPECONTRACTGridViewBase
	 */
	public viewtag: string = '1645ed409a7f3aafd85689fdb860aac9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtypecontract.views.gridview.caption',
        srfTitle: 'entities.pimtypecontract.views.gridview.title',
        srfSubTitle: 'entities.pimtypecontract.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMTYPECONTRACTGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMTYPECONTRACT");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PIMTYPECONTRACT");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMTYPECONTRACT");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PIMTYPECONTRACT");
    }
...
<style lang='less'>
@import './pimtypecontractgrid-view.less';
</style>