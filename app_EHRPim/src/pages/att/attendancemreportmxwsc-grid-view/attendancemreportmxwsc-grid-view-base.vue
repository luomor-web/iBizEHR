 ...
 *
 * @export
 * @class ATTENDANCEMREPORTMXWscGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ATTENDANCEMREPORTMXWscGridViewBase extends GridViewBase {
	 ...
	 * @memberof ATTENDANCEMREPORTMXWscGridViewBase
	 */
	public viewtag: string = 'fab303ed55b60ecd0e8b6e77f938d2ab';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancemreportmx.views.wscgridview.caption',
        srfTitle: 'entities.attendancemreportmx.views.wscgridview.title',
        srfSubTitle: 'entities.attendancemreportmx.views.wscgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './attendancemreportmxwsc-grid-view.less';
</style>