 ...
 *
 * @export
 * @class ORMDUTYOrmOrgSectorPickupView
 * @extends {ORMDUTYOrmOrgSectorPickupViewBase}
 */
@Component({
    components: {
...
export default class ORMDUTYOrmOrgSectorPickupView extends ORMDUTYOrmOrgSectorPickupViewBase { }
</script>