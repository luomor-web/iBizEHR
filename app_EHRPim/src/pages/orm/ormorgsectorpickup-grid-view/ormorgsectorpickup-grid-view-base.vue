<template>
  <app-layout viewName="ormorgsectorpickupgridview" viewTitle="部门管理选择表格视图" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'depickupgridview': true, 'ormorgsectorpickup-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<style lang='less'>
@import './ormorgsectorpickup-grid-view.less';
</style>