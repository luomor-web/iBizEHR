...
import PIMPROVINCEService from '@/service/pimprovince/pimprovince-service';

/**
 * 省UI服务对象基类
 *
 * @export
 * @class PIMPROVINCEUIServiceBase
 */
export default class PIMPROVINCEUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PIMPROVINCEUIServiceBase
     */
     ...
     * @memberof  PIMPROVINCEUIServiceBase
     */
    protected dataService:PIMPROVINCEService = new PIMPROVINCEService();
    ...
    /**
     * Creates an instance of  PIMPROVINCEUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PIMPROVINCEUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pimprovince:srfkey});
