...
import PIMVACATIONService from '@/service/pimvacation/pimvacation-service';

/**
 * 休假信息UI服务对象基类
 *
 * @export
 * @class PIMVACATIONUIServiceBase
 */
export default class PIMVACATIONUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PIMVACATIONUIServiceBase
     */
     ...
     * @memberof  PIMVACATIONUIServiceBase
     */
    protected dataService:PIMVACATIONService = new PIMVACATIONService();
    ...
    /**
     * Creates an instance of  PIMVACATIONUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PIMVACATIONUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pimvacation:srfkey});
