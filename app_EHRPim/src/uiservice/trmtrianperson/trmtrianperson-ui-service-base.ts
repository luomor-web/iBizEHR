 ...
 *
 * @export
 * @class TRMTRIANPERSONUIServiceBase
 */
export default class TRMTRIANPERSONUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  TRMTRIANPERSONUIServiceBase
     */
     ...
     * @memberof  TRMTRIANPERSONUIServiceBase
     */
    protected dataService:TRMTRIANPERSONService = new TRMTRIANPERSONService();
    ...
    /**
     * Creates an instance of  TRMTRIANPERSONUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TRMTRIANPERSONUIServiceBase
     */
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'trmtrianpeople'});
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'trmtrianpeople'});
    }
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({trmtrianperson:srfkey});
