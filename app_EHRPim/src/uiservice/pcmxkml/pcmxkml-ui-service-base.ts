 ...
 *
 * @export
 * @class PCMXKMLUIServiceBase
 */
export default class PCMXKMLUIServiceBase extends UIService {
     ...
     * @memberof  PCMXKMLUIServiceBase
     */
    protected dataService:PCMXKMLService = new PCMXKMLService();
    ...
    /**
     * Creates an instance of  PCMXKMLUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMXKMLUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmxkml:srfkey});
