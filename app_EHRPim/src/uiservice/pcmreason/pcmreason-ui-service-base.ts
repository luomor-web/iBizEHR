...
import PCMReasonService from '@/service/pcmreason/pcmreason-service';

/**
 * 配置原因代码表UI服务对象基类
 *
 * @export
 * @class PCMReasonUIServiceBase
 */
export default class PCMReasonUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PCMReasonUIServiceBase
     */
     ...
     * @memberof  PCMReasonUIServiceBase
     */
    protected dataService:PCMReasonService = new PCMReasonService();
    ...
    /**
     * Creates an instance of  PCMReasonUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PCMReasonUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pcmreason:srfkey});
