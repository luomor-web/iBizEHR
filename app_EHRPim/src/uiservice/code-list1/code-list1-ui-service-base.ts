 ...
 */
export default class CodeList1UIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  CodeList1UIServiceBase
     */
     ...
     * @memberof  CodeList1UIServiceBase
     */
    protected dataService:CodeList1Service = new CodeList1Service();
    ...
    /**
     * Creates an instance of  CodeList1UIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  CodeList1UIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({codelist1:srfkey});
