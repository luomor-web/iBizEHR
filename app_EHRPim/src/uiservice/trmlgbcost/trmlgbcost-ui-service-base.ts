 ...
 *
 * @export
 * @class TRMLGBCOSTUIServiceBase
 */
export default class TRMLGBCOSTUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  TRMLGBCOSTUIServiceBase
     */
     ...
     * @memberof  TRMLGBCOSTUIServiceBase
     */
    protected dataService:TRMLGBCOSTService = new TRMLGBCOSTService();
    ...
    /**
     * Creates an instance of  TRMLGBCOSTUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TRMLGBCOSTUIServiceBase
     */
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'trmlgbcosts'});
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'trmlgbcosts'});
    }
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({trmlgbcost:srfkey});
