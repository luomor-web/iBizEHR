...
import ORMRANKService from '@/service/ormrank/ormrank-service';

/**
 * 职级管理UI服务对象基类
 *
 * @export
 * @class ORMRANKUIServiceBase
 */
export default class ORMRANKUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  ORMRANKUIServiceBase
     */
     ...
     * @memberof  ORMRANKUIServiceBase
     */
    protected dataService:ORMRANKService = new ORMRANKService();
    ...
    /**
     * Creates an instance of  ORMRANKUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ORMRANKUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ormrank:srfkey});
