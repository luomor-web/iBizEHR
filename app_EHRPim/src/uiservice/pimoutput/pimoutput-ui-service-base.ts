 ...
 *
 * @export
 * @class PIMOUTPUTUIServiceBase
 */
export default class PIMOUTPUTUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PIMOUTPUTUIServiceBase
     */
     ...
     * @memberof  PIMOUTPUTUIServiceBase
     */
    protected dataService:PIMOUTPUTService = new PIMOUTPUTService();
    ...
    /**
     * Creates an instance of  PIMOUTPUTUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PIMOUTPUTUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pimoutput:srfkey});
