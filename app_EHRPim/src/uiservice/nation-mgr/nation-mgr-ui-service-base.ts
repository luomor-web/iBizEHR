...
import NationMGRService from '@/service/nation-mgr/nation-mgr-service';

/**
 * 民族管理UI服务对象基类
 *
 * @export
 * @class NationMGRUIServiceBase
 */
export default class NationMGRUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  NationMGRUIServiceBase
     */
     ...
     * @memberof  NationMGRUIServiceBase
     */
    protected dataService:NationMGRService = new NationMGRService();
    ...
    /**
     * Creates an instance of  NationMGRUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  NationMGRUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({nationmgr:srfkey});
