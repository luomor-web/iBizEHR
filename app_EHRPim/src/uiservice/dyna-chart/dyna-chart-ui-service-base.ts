...
import DynaChartService from '@/service/dyna-chart/dyna-chart-service';

/**
 * 动态图表UI服务对象基类
 *
 * @export
 * @class DynaChartUIServiceBase
 */
export default class DynaChartUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  DynaChartUIServiceBase
     */
     ...
     * @memberof  DynaChartUIServiceBase
     */
    protected dataService:DynaChartService = new DynaChartService();
    ...
    /**
     * Creates an instance of  DynaChartUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  DynaChartUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({dynachart:srfkey});
