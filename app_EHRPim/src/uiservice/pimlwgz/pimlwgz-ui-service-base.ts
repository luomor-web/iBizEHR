...
import PIMLWGZService from '@/service/pimlwgz/pimlwgz-service';

/**
 * 轮岗规则UI服务对象基类
 *
 * @export
 * @class PIMLWGZUIServiceBase
 */
export default class PIMLWGZUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  PIMLWGZUIServiceBase
     */
     ...
     * @memberof  PIMLWGZUIServiceBase
     */
    protected dataService:PIMLWGZService = new PIMLWGZService();
    ...
    /**
     * Creates an instance of  PIMLWGZUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  PIMLWGZUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pimlwgz:srfkey});
