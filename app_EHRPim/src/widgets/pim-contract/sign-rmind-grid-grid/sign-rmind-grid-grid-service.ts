...
import SignRmindGridModel from './sign-rmind-grid-grid-model';
import PimPersonService from '@/service/pim-person/pim-person-service';


/**
 * SignRmindGrid 部件服务对象
 *
 * @export
 * @class SignRmindGridService
 */
export default class SignRmindGridService extends ControlService {

    /**
     * 合同信息服务对象
     *
     * @type {PimContractService}
     * @memberof SignRmindGridService
     */
    ...
    /**
     * Creates an instance of SignRmindGridService.
     * 
     * @param {*} [opts={}]
     * @memberof SignRmindGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new SignRmindGridModel();
    }
