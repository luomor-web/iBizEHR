...
import StopRemindGridModel from './stop-remind-grid-grid-model';
import PimPersonService from '@/service/pim-person/pim-person-service';


/**
 * StopRemindGrid 部件服务对象
 *
 * @export
 * @class StopRemindGridService
 */
export default class StopRemindGridService extends ControlService {
    ...
    /**
     * Creates an instance of StopRemindGridService.
     * 
     * @param {*} [opts={}]
     * @memberof StopRemindGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StopRemindGridModel();
    }
