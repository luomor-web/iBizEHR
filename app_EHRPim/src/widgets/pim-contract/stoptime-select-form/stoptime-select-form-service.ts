...
import StoptimeSelectModel from './stoptime-select-form-model';


/**
 * StoptimeSelect 部件服务对象
 *
 * @export
 * @class StoptimeSelectService
 */
export default class StoptimeSelectService extends ControlService {

    /**
     * 合同信息服务对象
     *
     * @type {PimContractService}
     * @memberof StoptimeSelectService
     */
    ...
    /**
     * Creates an instance of StoptimeSelectService.
     * 
     * @param {*} [opts={}]
     * @memberof StoptimeSelectService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StoptimeSelectModel();
    }
