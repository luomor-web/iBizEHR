...
export default class IndexBase extends AppMenusCtrlBase {
     ...
     * @memberof Index
     */
    protected clickAuto459(item: any = {}) {
        const viewparam: any = {};
     ...
     * @memberof Index
     */
    protected clickAuto470(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto489(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto462(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto498(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto479(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto471(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto492(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto484(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto451(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto466(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto488(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto473(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto481(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto474(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto454(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto472(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto460(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto467(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto490(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto455(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto480(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto477(item: any = {}) {
        const viewparam: any = {};
     ...
     * @memberof Index
     */
    protected clickAuto463(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto491(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto457(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto496(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto494(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto464(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto469(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto487(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto475(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto493(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto458(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
     ...
     * @memberof Index
     */
    protected clickAuto476(item: any = {}) {
        const viewparam: any = {};
        Object.assign(viewparam, {});
        const deResParameters: any[] = [];
        const parameters: any[] = [
