...
export default class OrgPersonAgeBase extends Vue implements ControlInterface {
    ...
    */
    ...
    categorCodeList:{type:'STATIC',tag:'PIMCL_NLFB',emptycode:'empty',emptytext:'未定义'},
    valueField:'countnum',
    seriesValues:[],
    seriesIndex:0,
    data:[],
    seriesMap:{},
    dataSetFields:[
    {name:"agetype",codelist:{type:"STATIC",tag:"PIMCL_NLFB",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
