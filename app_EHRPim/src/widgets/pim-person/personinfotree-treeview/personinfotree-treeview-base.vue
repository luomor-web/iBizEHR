...
import PERSONINFOTREEService from './personinfotree-treeview-service';
...
export default class PERSONINFOTREEBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof PERSONINFOTREEBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {PERSONINFOTREEService}
     * @memberof PERSONINFOTREEBase
     */
    public service: PERSONINFOTREEService = new PERSONINFOTREEService({ $store: this.$store });
...
<style lang='less'>
@import './personinfotree-treeview.less';
</style>