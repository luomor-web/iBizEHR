...
import RYInfoForm_4Model from './ryinfo-form-4-form-model';
 ...
 *
 * @export
 * @class RYInfoForm_4Service
 */
export default class RYInfoForm_4Service extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof RYInfoForm_4Service
     */
    ...
    /**
     * Creates an instance of RYInfoForm_4Service.
     * 
     * @param {*} [opts={}]
     * @memberof RYInfoForm_4Service
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYInfoForm_4Model();
    }
