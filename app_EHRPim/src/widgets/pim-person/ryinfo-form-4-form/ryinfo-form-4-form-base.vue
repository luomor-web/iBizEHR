<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimperson_ryinfoform_4' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.rawitem1.visible" :style="{}"  :sm="{ span: 12, offset: 0 }" :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <div class="" style="">
    <div style="
...
<i-col v-show="detailsModel.druipart1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    paramItem='pimperson' 
    :parentdata='{"srfparentdefname":"PIMPERSONID","srfparentdename":"PIMPERSON","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_PIMRESEARCHFINDINGS_PIMPERSON_PIMPERSONID","SRFDER1NID":"DER1N_PIMRESEARCHFINDINGS_PIMPERSON_PIMPERSONID"}'
    :parameters="[
    ...
    viewname='pimresearchfindingsresearchgrid-view' 
...
<i-col v-show="detailsModel.druipart2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    :isForbidLoad="this.data.srfuf === '0'"
    paramItem='pimperson' 
    :parentdata='{"srfparentdefname":"PIMPERSONID","srfparentdename":"PIMPERSON","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_PIMPATENT_PIMPERSON_PIMPERSONID","SRFDER1NID":"DER1N_PIMPATENT_PIMPERSON_PIMPERSONID"}'
    :parameters="[
        { pathName: 'pimpeople', parameterName: 'pimperson' },
    ]"
    :context="context"
    ...
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='pimpatentpatentgrid-view' 
    :data="JSON.stringify(this.data)" 
    @drdatasaved="drdatasaved($event)"
    style=";overflow: auto;">
</app-form-druipart>
...
<i-col v-show="detailsModel.druipart3.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    :isForbidLoad="this.data.srfuf === '0'"
    paramItem='pimperson' 
    :parentdata='{"srfparentdefname":"PIMPERSONID","srfparentdename":"PIMPERSON","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_PIMPAPER_PIMPERSON_PIMPERSONID","SRFDER1NID":"DER1N_PIMPAPER_PIMPERSON_PIMPERSONID"}'
    :parameters="[
        { pathName: 'pimpeople', parameterName: 'pimperson' },
    ]"
    :context="context"
    ...
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='pimpaperpapergrid-view' 
    :data="JSON.stringify(this.data)" 
    @drdatasaved="drdatasaved($event)"
    style=";overflow: auto;">
</app-form-druipart>
...
import RYInfoForm_4Service from './ryinfo-form-4-form-service';
...
export default class RYInfoForm_4Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof RYInfoForm_4Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {RYInfoForm_4Service}
     * @memberof RYInfoForm_4Base
     */
    public service: RYInfoForm_4Service = new RYInfoForm_4Service({ $store: this.$store });
...
, 
        formpage3: new FormPageModel({ caption: '学术成果', detailType: 'FORMPAGE', name: 'formpage3', visible: true, isShowCaption: true, form: this })
, 
...
, 
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof RYInfoForm_4Base
     */
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimperson_ryinfoform_4',popTitle:'人员信息（科研专利论文）'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONXSCGEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONXSCGEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONXSCGEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMPERSONXSCGEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
...
<style lang='less'>
@import './ryinfo-form-4-form.less';
</style>