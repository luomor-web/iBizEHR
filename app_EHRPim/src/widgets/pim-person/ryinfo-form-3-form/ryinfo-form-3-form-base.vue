<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimperson_ryinfoform_3' style="">
...
<div v-show="detailsModel.druipart2.visible">
    ...
    paramItem='pimperson' 
    :parentdata='{"srfparentdefname":"PIMPERSONID","srfparentdename":"PIMPERSON","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_PIMTITLE_PIMPERSON_PIMPERSONID","SRFDER1NID":"DER1N_PIMTITLE_PIMPERSON_PIMPERSONID"}'
    :parameters="[
    ...
    viewname='pimtitlepim-zhic-grid-view' 
...
<div v-show="detailsModel.druipart1.visible">
    ...
    :isForbidLoad="this.data.srfuf === '0'"
    paramItem='pimperson' 
    :parentdata='{"srfparentdefname":"PIMPERSONID","srfparentdename":"PIMPERSON","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_PIMVOCATIONAL_PIMPERSON_PIMPERSONID","SRFDER1NID":"DER1N_PIMVOCATIONAL_PIMPERSON_PIMPERSONID"}'
    :parameters="[
        { pathName: 'pimpeople', parameterName: 'pimperson' },
    ]"
    :context="context"
    ...
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='pimvocationalpim-zig-grid-view' 
    :data="JSON.stringify(this.data)" 
    @drdatasaved="drdatasaved($event)"
    style=";overflow: auto;">
</app-form-druipart>
...
import RYInfoForm_3Service from './ryinfo-form-3-form-service';
...
export default class RYInfoForm_3Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof RYInfoForm_3Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {RYInfoForm_3Service}
     * @memberof RYInfoForm_3Base
     */
    public service: RYInfoForm_3Service = new RYInfoForm_3Service({ $store: this.$store });
...
, 
        formpage1: new FormPageModel({ caption: '证书信息', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this })
, 
...
, 
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof RYInfoForm_3Base
     */
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimperson_ryinfoform_3',popTitle:'人员信息(证书职称)'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONZHZCEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONZHZCEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONZHZCEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMPERSONZHZCEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
...
<style lang='less'>
@import './ryinfo-form-3-form.less';
</style>