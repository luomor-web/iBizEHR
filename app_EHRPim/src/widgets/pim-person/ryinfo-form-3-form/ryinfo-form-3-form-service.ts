...
import RYInfoForm_3Model from './ryinfo-form-3-form-model';
 ...
 *
 * @export
 * @class RYInfoForm_3Service
 */
export default class RYInfoForm_3Service extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof RYInfoForm_3Service
     */
    ...
    /**
     * Creates an instance of RYInfoForm_3Service.
     * 
     * @param {*} [opts={}]
     * @memberof RYInfoForm_3Service
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYInfoForm_3Model();
    }
