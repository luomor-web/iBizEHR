...
import HMDInfoGridModel from './hmdinfo-grid-grid-model';
 ...
 *
 * @export
 * @class HMDInfoGridService
 */
export default class HMDInfoGridService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof HMDInfoGridService
     */
    ...
    /**
     * Creates an instance of HMDInfoGridService.
     * 
     * @param {*} [opts={}]
     * @memberof HMDInfoGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new HMDInfoGridModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.pimpersonid = Util.createUUID();
                }
