...
import QuickEditFormModel from './quick-edit-form-form-model';


/**
 * QuickEditForm 部件服务对象
 *
 * @export
 * @class QuickEditFormService
 */
export default class QuickEditFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof QuickEditFormService
     */
    ...
    /**
     * Creates an instance of QuickEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof QuickEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new QuickEditFormModel();
    }
