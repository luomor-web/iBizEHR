<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimperson_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimperson.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.ygbh.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='ygbh' :itemRules="this.rules.ygbh" class='' :caption="$t('entities.pimperson.main_form.details.ygbh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ygbh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pimperson.main_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.yglx.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='yglx' :itemRules="this.rules.yglx" class='' :caption="$t('entities.pimperson.main_form.details.yglx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yglx.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.yglx" :data="data" :itemParam="{}" :disabled="detailsModel.yglx.disabled"  tag='PIMCL_YGLX' codelistType='DYNAMIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>
...
<i-col v-show="detailsModel.zjhm.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='zjhm' :itemRules="this.rules.zjhm" class='' :caption="$t('entities.pimperson.main_form.details.zjhm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zjhm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.dbdwsj.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='dbdwsj' :itemRules="this.rules.dbdwsj" class='' :caption="$t('entities.pimperson.main_form.details.dbdwsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.dbdwsj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.duration.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='duration' :itemRules="this.rules.duration" class='' :caption="$t('entities.pimperson.main_form.details.duration')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.duration.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.duration"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.duration.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.jxdq.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='jxdq' :itemRules="this.rules.jxdq" class='' :caption="$t('entities.pimperson.main_form.details.jxdq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jxdq.error" :isEmptyCaption="false" labelPos="LEFT">
    <date-picker type="date" :transfer="true" format="yyyy-MM-dd" placeholder="请选择时间..." :value="data.jxdq" :disabled="detailsModel.jxdq.disabled" style="min-width: 150px; width:100px;width:100%;" @on-change="(val1, val2) => { this.data.jxdq = val1 }"></date-picker>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.sydq.visible" :style="{}"  :lg="{ span: 12, offset: 0 }">
    <app-form-item name='sydq' :itemRules="this.rules.sydq" class='' :caption="$t('entities.pimperson.main_form.details.sydq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.sydq.error" :isEmptyCaption="false" labelPos="LEFT">
    <date-picker type="date" :transfer="true" format="yyyy-MM-dd" placeholder="请选择时间..." :value="data.sydq" :disabled="detailsModel.sydq.disabled" style="min-width: 150px; width:100px;width:100%;" @on-change="(val1, val2) => { this.data.sydq = val1 }"></date-picker>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        dbdwsj: [
            ...
            { required: true, type: 'string', message: '到本单位时间 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '到本单位时间 值不能为空', trigger: 'blur' },
        ],
        ygzt: [
        ...
        duration: [
            { type: 'string', message: '实习/试用期限 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '实习/试用期限 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '实习/试用期限 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '实习/试用期限 值不能为空', trigger: 'blur' },
        ],
        jxdq: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '人员信息基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimperson.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        duration: new FormItemModel({ caption: '实习/试用期限', detailType: 'FORMITEM', name: 'duration', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
        jxdq: new FormItemModel({ caption: '见习到期时间', detailType: 'FORMITEM', name: 'jxdq', visible: false, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        sydq: new FormItemModel({ caption: '试用到期时间', detailType: 'FORMITEM', name: 'sydq', visible: false, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     */
    @Watch('data.duration')
    onDurationChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'duration', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.jxdq')
    onJxdqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'jxdq', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.sydq')
    onSydqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'sydq', newVal: newVal, oldVal: oldVal });
    }
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if (Object.is(name, '') || Object.is(name, 'ygzt')) {
            ...
            if (this.$verify.testCond(_ygzt, 'EQ', '20')) {
                ret = true;
            }
            this.detailsModel.jxdq.setVisible(ret);
        }

        if (Object.is(name, '') || Object.is(name, 'ygzt')) {
            let ret = false;
            const _ygzt = this.data.ygzt;
            if (this.$verify.testCond(_ygzt, 'EQ', '10')) {
                ret = true;
            }
            this.detailsModel.sydq.setVisible(ret);
        }
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimperson_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONRYInfoEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONRYInfoEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONRYInfoEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMPERSONRYInfoEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
