 ...
 *
 * @export
 * @class RYInfoFormService
 */
export default class RYInfoFormService extends ControlService {
    ...
    /**
     * Creates an instance of RYInfoFormService.
     * 
     * @param {*} [opts={}]
     * @memberof RYInfoFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYInfoFormModel();
    }
