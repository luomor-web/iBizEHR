...
import ReadRYInfoFormModel from './read-ryinfo-form-form-model';


/**
 * ReadRYInfoForm 部件服务对象
 *
 * @export
 * @class ReadRYInfoFormService
 */
export default class ReadRYInfoFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof ReadRYInfoFormService
     */
    ...
    /**
     * Creates an instance of ReadRYInfoFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ReadRYInfoFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ReadRYInfoFormModel();
    }
