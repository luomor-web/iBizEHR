...
<i-col v-show="detailsModel.zjlx.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='zjlx'
:value="data.zjlx" tag='PIMCL_ZJLX' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.xb.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='xb'
:value="data.xb" tag='PIMCL_XB' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.mz.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='mz'
:value="data.mz" tag='PIMCL_NATION' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.hyzk.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='hyzk'
:value="data.hyzk" tag='PIMCL_HY' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.zzmm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='zzmm'
:value="data.zzmm" tag='PIMCL_ZZMM' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.rank.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='rank'
:value="data.rank" tag='PIMCL_RANK' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" style=""></app-span>
</app-form-item>
...
:value="data.higheducation" tag='PIM_XL2' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" style=""></app-span>
</app-form-item>
...
:value="data.firsteducation" tag='PIM_XL2' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" style=""></app-span>
</app-form-item>
...
<div v-show="detailsModel.grouppanel5.visible">
    ...
    <app-span   name='hklx'
:value="data.hklx" tag='PIMCL_HKLX' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.hjszd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='hjszd'
:value="data.hjszd" tag='NATIVEPLACE' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.xx.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='xx'
:value="data.xx" tag='PIMCL_XX' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" style=""></app-span>
</app-form-item>
...
:value="data.sfdszn" tag='PIMCL_SFLJ' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.rzqd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='rzqd'
:value="data.rzqd" tag='PIMCL_RZLB' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.hmd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-span   name='hmd'
:value="data.hmd" tag='YesNo' codelistType='STATIC' style=""></app-span>
</app-form-item>
