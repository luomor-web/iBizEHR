...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'zlhqsj';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimpatent: keys.join(';') }),Object.assign({ pimpatent: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
