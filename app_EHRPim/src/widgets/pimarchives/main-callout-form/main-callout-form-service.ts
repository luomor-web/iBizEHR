...
export default class Main_CALLOUTService extends ControlService {
     ...
     * @memberof Main_CALLOUTService
     */
    public archivescenterService: ARCHIVESCENTERService = new ARCHIVESCENTERService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'ARCHIVESCENTERService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.archivescenterService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'archivescenterid', 'archivescenter');
        }
