...
export default class Main_FYGZDBase extends Vue implements ControlInterface {
     ...
     * @memberof Main_FYGZD
     */
    protected service: Main_FYGZDService = new Main_FYGZDService({ $store: this.$store });
     ...
     * @memberof Main_FYGZD
     */
    protected minorSortPSDEF: string = 'dadrrq';
    ...
    */
    ...
    protected allColumns: any[] = [
        ...
        },
        {
            name: 'duration',
            label: '档案未转出月数',
            langtag: 'entities.pimarchives.main_fygzd_grid.columns.duration',
            show: true,
            util: 'PX'
        },
        {
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimarchives: keys.join(';') }),Object.assign({ pimarchives: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
