<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimsearchmodal_main' style="">
        ...
        @on-click="detailsModel.form.clickPage($event)">
            <tab-pane v-show="detailsModel.formpage1.visible" name='formpage1' :index="0" tab='main' class=''  
                :label="(h) =>{
                    ...
                    $t('entities.pimsearchmodal.main_form.details.formpage1')
                    ])
                }">
...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <input-box v-model="data.pimsearchmodalname"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.pimsearchmodalname.disabled" type='text'  style=""></input-box>
</app-form-item>
            ...
            <tab-pane v-show="detailsModel.formpage2.visible" name='formpage2' :index="1" tab='main' class=''  
                :label="(h) =>{
                    ...
                    $t('entities.pimsearchmodal.main_form.details.formpage2')
                    ])
                }">
...
<i-col v-show="detailsModel.createdate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='createdate' :itemRules="this.rules.createdate" class='' :caption="$t('entities.pimsearchmodal.main_form.details.createdate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.createdate.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.updateman.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='updateman' :itemRules="this.rules.updateman" class='' :caption="$t('entities.pimsearchmodal.main_form.details.updateman')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.updateman.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.updatedate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='updatedate' :itemRules="this.rules.updatedate" class='' :caption="$t('entities.pimsearchmodal.main_form.details.updatedate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.updatedate.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PimSearchModalService = new PimSearchModalService({ $store: this.$store });
    ...
    public data: any = {
        ...
        srfdeid: null,
        srfsourcekey: null,
        pimsearchmodalname: null,
        createman: null,
        createdate: null,
        updateman: null,
        updatedate: null,
        pimsearchmodalid: null,
        pimsearchmodal:null,
    };
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '组合查询模版标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '组合查询模版标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '组合查询模版标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '组合查询模版标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '组合查询模版名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '组合查询模版名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '组合查询模版名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '组合查询模版名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '组合查询模版基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimsearchmodal.main_form', extractMode: 'ITEM', details: [] } })
, 
        formpage1: new FormPageModel({ caption: '基本信息', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this })
, 
        group2: new FormGroupPanelModel({ caption: '操作信息', detailType: 'GROUPPANEL', name: 'group2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimsearchmodal.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '组合查询模版标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '组合查询模版名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimsearchmodalname: new FormItemModel({ caption: '组合查询模版名称', detailType: 'FORMITEM', name: 'pimsearchmodalname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimsearchmodalid: new FormItemModel({ caption: '组合查询模版标识', detailType: 'FORMITEM', name: 'pimsearchmodalid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    ...
    /**
     * 监控表单属性 pimsearchmodalname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.pimsearchmodalname')
    onPimsearchmodalnameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pimsearchmodalname', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 pimsearchmodalid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.pimsearchmodalid')
    onPimsearchmodalidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pimsearchmodalid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pimsearchmodal){
            Object.assign(this.context,{pimsearchmodal:data.pimsearchmodal})
        }
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimsearchmodal_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PimSearchModalEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PimSearchModalEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PimSearchModalEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PimSearchModalEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pimsearchmodal || Object.is(arg.pimsearchmodal, '')) {
            return;
        }
