<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimresearchfindings_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimresearchfindings.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pimresearchfindings.main_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
...
<i-col v-show="detailsModel.pimresearchfindingsname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimresearchfindingsname' :itemRules="this.rules.pimresearchfindingsname" class='' :caption="$t('entities.pimresearchfindings.main_form.details.pimresearchfindingsname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimresearchfindingsname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.pimresearchfindingsname"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.pimresearchfindingsname.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.hqsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='hqsj' :itemRules="this.rules.hqsj" class='' :caption="$t('entities.pimresearchfindings.main_form.details.hqsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.hqsj.error" :isEmptyCaption="false" labelPos="LEFT">
    <date-picker type="date" :transfer="true" format="yyyy-MM-dd" placeholder="请选择时间..." :value="data.hqsj" :disabled="detailsModel.hqsj.disabled" style="min-width: 150px; width:100px;width:100%;" @on-change="(val1, val2) => { this.data.hqsj = val1 }"></date-picker>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.fj.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='fj' :itemRules="this.rules.fj" class='' :caption="$t('entities.pimresearchfindings.main_form.details.fj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.fj.error" :isEmptyCaption="false" labelPos="LEFT">
...
import PIMRESEARCHFINDINGSService from '@/service/pimresearchfindings/pimresearchfindings-service';
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public data: any = {
        ...
        srfsourcekey: null,
        pimpersonname: null,
        pimresearchfindingsname: null,
        hqsj: null,
        fj: null,
        jlss: null,
        pimresearchfindingsid: null,
        pimpersonid: null,
        pimresearchfindings:null,
    };
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '科研成果标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '科研成果标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '科研成果标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '科研成果标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '科研成果名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '科研成果名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '科研成果名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '科研成果名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        pimresearchfindingsname: [
            { type: 'string', message: '科研成果名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '科研成果名称 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '科研成果名称 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '科研成果名称 值不能为空', trigger: 'blur' },
        ],
        hqsj: [
            { type: 'string', message: '获取时间 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '获取时间 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '获取时间 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '获取时间 值不能为空', trigger: 'blur' },
        ],
        fj: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '科研成果基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimresearchfindings.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '科研成果标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '科研成果名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimresearchfindingsname: new FormItemModel({ caption: '科研成果名称', detailType: 'FORMITEM', name: 'pimresearchfindingsname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        hqsj: new FormItemModel({ caption: '获取时间', detailType: 'FORMITEM', name: 'hqsj', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimresearchfindingsid: new FormItemModel({ caption: '科研成果标识', detailType: 'FORMITEM', name: 'pimresearchfindingsid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    /**
     * 监控表单属性 pimresearchfindingsname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
    ...
    onPimresearchfindingsnameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pimresearchfindingsname', newVal: newVal, oldVal: oldVal });
    }
    ...
    onHqsjChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'hqsj', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 pimresearchfindingsid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
    ...
    onPimresearchfindingsidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pimresearchfindingsid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pimresearchfindings){
            Object.assign(this.context,{pimresearchfindings:data.pimresearchfindings})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pimresearchfindings = copyData.srfkey;
        copyData.pimresearchfindingsid = copyData.srfkey;
        Object.assign(this.context,{pimresearchfindings:copyData.pimresearchfindings})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimresearchfindings_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pimresearchfindings || Object.is(arg.pimresearchfindings, '')) {
            return;
        }
