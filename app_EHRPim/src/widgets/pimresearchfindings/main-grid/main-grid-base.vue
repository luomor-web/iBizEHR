...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'hqsj';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimresearchfindings: keys.join(';') }),Object.assign({ pimresearchfindings: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
