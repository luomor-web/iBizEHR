...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: PimArchivesRecordService = new PimArchivesRecordService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public pimarchivalcatalogueService: PimArchivalCatalogueService = new PimArchivalCatalogueService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'PimArchivalCatalogueService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.pimarchivalcatalogueService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'archivalcatalogueid', 'pimarchivalcatalogue');
        }
