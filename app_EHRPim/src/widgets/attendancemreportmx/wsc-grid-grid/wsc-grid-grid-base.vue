...
export default class WscGridBase extends Vue implements ControlInterface {
     ...
     * @memberof WscGrid
     */
    protected service: WscGridService = new WscGridService({ $store: this.$store });
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ attendancemreportmx: keys.join(';') }),Object.assign({ attendancemreportmx: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
