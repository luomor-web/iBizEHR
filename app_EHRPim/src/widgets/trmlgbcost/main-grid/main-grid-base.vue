    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmlgbcost: keys.join(';') }),Object.assign({ trmlgbcost: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
