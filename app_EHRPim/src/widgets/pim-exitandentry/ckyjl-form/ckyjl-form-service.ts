...
import CKYJLModel from './ckyjl-form-model';
 ...
 * @class CKYJLService
 */
export default class CKYJLService extends ControlService {

    /**
     * 出入境管理服务对象
     *
     * @type {PimExitandentryService}
     * @memberof CKYJLService
     */
    ...
    /**
     * Creates an instance of CKYJLService.
     * 
     * @param {*} [opts={}]
     * @memberof CKYJLService
     */
