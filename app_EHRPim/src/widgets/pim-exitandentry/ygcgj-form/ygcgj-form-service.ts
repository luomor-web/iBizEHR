...
import YGCGJModel from './ygcgj-form-model';
 ...
 * @class YGCGJService
 */
export default class YGCGJService extends ControlService {

    /**
     * 出入境管理服务对象
     *
     * @type {PimExitandentryService}
     * @memberof YGCGJService
     */
    public appEntityService: PimExitandentryService = new PimExitandentryService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of YGCGJService.
     * 
     * @param {*} [opts={}]
     * @memberof YGCGJService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimexitandentryid = PrimaryKey;
        Data.pimexitandentry = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimexitandentryid = PrimaryKey;
