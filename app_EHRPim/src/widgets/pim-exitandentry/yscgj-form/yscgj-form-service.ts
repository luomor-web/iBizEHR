...
import YSCGJModel from './yscgj-form-model';
 ...
 * @class YSCGJService
 */
export default class YSCGJService extends ControlService {

    /**
     * 出入境管理服务对象
     *
     * @type {PimExitandentryService}
     * @memberof YSCGJService
     */
    ...
    /**
     * Creates an instance of YSCGJService.
     * 
     * @param {*} [opts={}]
     * @memberof YSCGJService
     */
