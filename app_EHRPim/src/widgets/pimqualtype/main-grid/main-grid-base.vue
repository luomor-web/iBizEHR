...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'seialno';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimqualtype: keys.join(';') }),Object.assign({ pimqualtype: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
