...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimpersonabilityname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonabilityname'" :label="$t('entities.pimpersonability.main_grid.columns.pimpersonabilityname')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.pimpersonabilityname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pimpersonid')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonid'" :label="$t('entities.pimpersonability.main_grid.columns.pimpersonid')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.pimpersonid}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimpersonability.main_grid.columns.pimpersonname')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('year')">
                <el-table-column show-overflow-tooltip :prop="'year'" :label="$t('entities.pimpersonability.main_grid.columns.year')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.year}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('month')">
                <el-table-column show-overflow-tooltip :prop="'month'" :label="$t('entities.pimpersonability.main_grid.columns.month')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.month}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('performscore')">
                <el-table-column show-overflow-tooltip :prop="'performscore'" :label="$t('entities.pimpersonability.main_grid.columns.performscore')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.performscore"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('eduscore')">
                <el-table-column show-overflow-tooltip :prop="'eduscore'" :label="$t('entities.pimpersonability.main_grid.columns.eduscore')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.eduscore"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('techscore')">
                <el-table-column show-overflow-tooltip :prop="'techscore'" :label="$t('entities.pimpersonability.main_grid.columns.techscore')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.techscore}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('trainresultscore')">
                <el-table-column show-overflow-tooltip :prop="'trainresultscore'" :label="$t('entities.pimpersonability.main_grid.columns.trainresultscore')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.trainresultscore"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pracscore')">
                <el-table-column show-overflow-tooltip :prop="'pracscore'" :label="$t('entities.pimpersonability.main_grid.columns.pracscore')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.pracscore"></app-format-data>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    protected allColumns: any[] = [
        {
            ...
            label: '员工能力名称',
            langtag: 'entities.pimpersonability.main_grid.columns.pimpersonabilityname',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonid',
            label: '人员信息标识',
            langtag: 'entities.pimpersonability.main_grid.columns.pimpersonid',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimpersonability.main_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'year',
            label: '年',
            langtag: 'entities.pimpersonability.main_grid.columns.year',
            show: true,
            util: 'px'
        },
        {
            name: 'month',
            label: '月',
            langtag: 'entities.pimpersonability.main_grid.columns.month',
            show: true,
            util: 'px'
        },
        {
            name: 'performscore',
            label: '绩效得分',
            langtag: 'entities.pimpersonability.main_grid.columns.performscore',
            show: true,
            util: 'px'
        },
        {
            name: 'eduscore',
            label: '学历得分',
            langtag: 'entities.pimpersonability.main_grid.columns.eduscore',
            show: true,
            util: 'px'
        },
        {
            name: 'techscore',
            label: '职称得分',
            langtag: 'entities.pimpersonability.main_grid.columns.techscore',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '培训结果得分',
            langtag: 'entities.pimpersonability.main_grid.columns.trainresultscore',
            show: true,
            util: 'px'
        },
        {
            name: 'pracscore',
            label: '执业资格得分',
            langtag: 'entities.pimpersonability.main_grid.columns.pracscore',
            show: true,
            util: 'px'
        },
    ]
    ...
    protected rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '员工能力标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '员工能力标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    protected load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPersonAbilityGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    protected async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPersonAbilityGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimpersonabilityname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimpersonability: keys.join(';') }),Object.assign({ pimpersonability: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    protected rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimpersonability,$event.pimpersonability);
        });
    ...
    protected setColState() {
		const _data: any = localStorage.getItem('pimpersonability_main_grid');
		if (_data) {
    ...
    protected onColChange() {
        localStorage.setItem('pimpersonability_main_grid', JSON.stringify(this.allColumns));
    }
        ...
        _this.items.forEach((item:any)=>{
            if(!item.rowDataState){
                ...
                if(!this.createAction){
                    this.$Notice.error({ title: '错误', desc: 'PIMPersonAbilityGridView视图表格createAction参数未配置' });
                    return;
                }
                ...
                if(!this.updateAction){
                    this.$Notice.error({ title: '错误', desc: 'PIMPersonAbilityGridView视图表格updateAction参数未配置' });
                    return;
                }
                Object.assign(item,{viewparams:this.viewparams});
                if(item.pimpersonability){
                    Object.assign(this.context,{pimpersonability:item.pimpersonability})
                }
    ...
    protected getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pimpersonability,args.row.pimpersonability);
        });
