...
export default class OrgTitleBarBase extends Vue implements ControlInterface {
     ...
     * @memberof OrgTitleBar
     */
    protected service: OrgTitleBarService = new OrgTitleBarService({ $store: this.$store });
    ...
    */
    ...
    categorCodeList:{type:'DYNAMIC',tag:'PIMCL_ZCDJ',emptycode:'empty',emptytext:'未定义'},
    valueField:'countnum',
    seriesValues:[],
    seriesIndex:0,
    data:[],
    seriesMap:{},
    dataSetFields:[
    {name:"professor_type",codelist:{type:"DYNAMIC",tag:"PIMCL_ZCDJ",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
