<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimarchivesmanage_main' style="">
        ...
        @on-click="detailsModel.form.clickPage($event)">
            <tab-pane v-show="detailsModel.formpage1.visible" name='formpage1' :index="0" tab='main' class=''  
                :label="(h) =>{
                    ...
                    $t('entities.pimarchivesmanage.main_form.details.formpage1')
                    ])
                }">
                    
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimarchivesmanage.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.archivesmanagename.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='archivesmanagename' :itemRules="this.rules.archivesmanagename" class='' :caption="$t('entities.pimarchivesmanage.main_form.details.archivesmanagename')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.archivesmanagename.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.archivesmanagename"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.archivesmanagename.disabled" type='text'  style=""></input-box>
            ...
            <tab-pane v-show="detailsModel.formpage2.visible" name='formpage2' :index="1" tab='main' class=''  
                :label="(h) =>{
                    ...
                    $t('entities.pimarchivesmanage.main_form.details.formpage2')
                    ])
                }">
                    
<i-col v-show="detailsModel.group2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimarchivesmanage.main_form.details.group2')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PimArchivesManageService = new PimArchivesManageService({ $store: this.$store });
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '档案管理基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimarchivesmanage.main_form', extractMode: 'ITEM', details: [] } })
, 
        formpage1: new FormPageModel({ caption: '基本信息', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this })
, 
        group2: new FormGroupPanelModel({ caption: '操作信息', detailType: 'GROUPPANEL', name: 'group2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimarchivesmanage.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pimarchivesmanage){
            Object.assign(this.context,{pimarchivesmanage:data.pimarchivesmanage})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pimarchivesmanage = copyData.srfkey;
        copyData.archivesmanageid = copyData.srfkey;
        Object.assign(this.context,{pimarchivesmanage:copyData.pimarchivesmanage})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimarchivesmanage_main',popTitle:'主编辑表单'});
    }
    ...
    */
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pimarchivesmanage || Object.is(arg.pimarchivesmanage, '')) {
            return;
        }
