...
import Main_FYGZDModel from './main-fygzd-grid-model';
 ...
 *
 * @export
 * @class Main_FYGZDService
 */
export default class Main_FYGZDService extends ControlService {

    /**
     * 档案信息服务对象
     *
     * @type {PimArchivesService}
     * @memberof Main_FYGZDService
     */
    ...
    /**
     * Creates an instance of Main_FYGZDService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_FYGZDService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_FYGZDModel();
    }
