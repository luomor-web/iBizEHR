...
import PIMRecordService from './pimrecord-treeview-service';
...
export default class PIMRecordBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof PIMRecordBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {PIMRecordService}
     * @memberof PIMRecordBase
     */
    public service: PIMRecordService = new PIMRecordService({ $store: this.$store });
...
<style lang='less'>
@import './pimrecord-treeview.less';
</style>