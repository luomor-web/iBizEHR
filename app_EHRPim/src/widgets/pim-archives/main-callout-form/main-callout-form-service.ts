...
import Main_CALLOUTModel from './main-callout-form-model';
 ...
 *
 * @export
 * @class Main_CALLOUTService
 */
export default class Main_CALLOUTService extends ControlService {

    /**
     * 档案信息服务对象
     *
     * @type {PimArchivesService}
     * @memberof Main_CALLOUTService
     */
    ...
    /**
     * Creates an instance of Main_CALLOUTService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_CALLOUTService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_CALLOUTModel();
    }
     ...
     * @memberof Main_CALLOUTService
     */
    public pimarchivescenterService: PimArchivesCenterService = new PimArchivesCenterService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'PimArchivesCenterService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.pimarchivescenterService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'archivescenterid', 'pimarchivescenter');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimarchivesid = PrimaryKey;
        Data.pimarchives = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimarchivesid = PrimaryKey;
