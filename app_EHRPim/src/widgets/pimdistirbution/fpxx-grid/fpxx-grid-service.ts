...
import FPXXModel from './fpxx-grid-model';
 ...
 * @class FPXXService
 */
export default class FPXXService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PIMDISTIRBUTIONService}
     * @memberof FPXXService
     */
    ...
    /**
     * Creates an instance of FPXXService.
     * 
     * @param {*} [opts={}]
     * @memberof FPXXService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.pimdistirbution = Util.createUUID();
                }
