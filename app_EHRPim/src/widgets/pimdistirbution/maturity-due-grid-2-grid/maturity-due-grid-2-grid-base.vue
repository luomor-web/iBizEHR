    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimdistirbution: keys.join(';') }),Object.assign({ pimdistirbution: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
