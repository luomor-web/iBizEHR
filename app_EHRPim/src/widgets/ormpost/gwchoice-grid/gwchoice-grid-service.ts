...
import GWChoiceModel from './gwchoice-grid-model';
 ...
 *
 * @export
 * @class GWChoiceService
 */
export default class GWChoiceService extends ControlService {
     ...
     */
    public appEntityService: ORMPOSTService = new ORMPOSTService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of GWChoiceService.
     * 
     * @param {*} [opts={}]
     * @memberof GWChoiceService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.ormpost = Util.createUUID();
                }
