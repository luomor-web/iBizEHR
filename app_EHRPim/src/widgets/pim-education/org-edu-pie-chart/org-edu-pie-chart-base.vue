...
export default class OrgEduPieBase extends Vue implements ControlInterface {
    ...
    */
    ...
    categorCodeList:{type:'STATIC',tag:'PIMCL_XL3',emptycode:'empty',emptytext:'未定义'},
    valueField:'countnum',
    seriesValues:[],
    seriesIndex:0,
    data:[],
    seriesMap:{},
    dataSetFields:[
    {name:"highestdegree",codelist:{type:"STATIC",tag:"PIMCL_XL3",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
