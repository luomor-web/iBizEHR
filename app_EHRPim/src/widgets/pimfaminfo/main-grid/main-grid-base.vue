...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'csrq';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimfaminfo: keys.join(';') }),Object.assign({ pimfaminfo: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
