    ...
    */
    ...
    protected allColumns: any[] = [
        {
            name: 'pxbj',
            label: '培训班级',
            langtag: 'entities.trmtrianperson.main_grid.columns.pxbj',
            show: true,
            util: 'px'
        },
        {
            name: 'trainbegin',
            label: '培训开始时间',
            langtag: 'entities.trmtrianperson.main_grid.columns.trainbegin',
            show: true,
            util: 'px'
        },
        {
            name: 'trainend',
            label: '培训结束时间',
            langtag: 'entities.trmtrianperson.main_grid.columns.trainend',
            show: true,
            util: 'px'
        },
        {
            name: 'pxkc',
            label: '培训课程',
            langtag: 'entities.trmtrianperson.main_grid.columns.pxkc',
            show: true,
            util: 'px'
        },
        {
            name: 'pxjg',
            label: '培训机构',
            langtag: 'entities.trmtrianperson.main_grid.columns.pxjg',
            show: true,
            util: 'px'
        },
        {
            name: 'trainres',
            label: '培训结果',
            langtag: 'entities.trmtrianperson.main_grid.columns.trainres',
            show: true,
            util: 'px'
        },
        {
            name: 'fs',
            label: '分数',
            langtag: 'entities.trmtrianperson.main_grid.columns.fs',
            show: true,
            util: 'px'
        },
    ]
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmtrianperson: keys.join(';') }),Object.assign({ trmtrianperson: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    protected save(args: any[], params?: any, $event?: any, xData?: any): void {
        ...
        _this.items.forEach((item:any)=>{
            if(!item.rowDataState){
                ...
                Object.assign(item,{viewparams:this.viewparams});
                if(item.trmtrianperson){
                    Object.assign(this.context,{trmtrianperson:item.trmtrianperson})
                }
    ...
    protected getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmtrianperson,args.row.trmtrianperson);
        });
