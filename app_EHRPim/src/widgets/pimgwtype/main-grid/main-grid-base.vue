    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimgwtype: keys.join(';') }),Object.assign({ pimgwtype: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
