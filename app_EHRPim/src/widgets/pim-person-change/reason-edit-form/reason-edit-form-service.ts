...
import ReasonEditModel from './reason-edit-form-model';
 ...
 *
 * @export
 * @class ReasonEditService
 */
export default class ReasonEditService extends ControlService {

    /**
     * 人员信息变更审核服务对象
     *
     * @type {PimPersonChangeService}
     * @memberof ReasonEditService
     */
    public appEntityService: PimPersonChangeService = new PimPersonChangeService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ReasonEditService.
     * 
     * @param {*} [opts={}]
     * @memberof ReasonEditService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ReasonEditModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimpersonchangeid = PrimaryKey;
        Data.pimpersonchange = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimpersonchangeid = PrimaryKey;
