<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimarmycadres_admin_greditform' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimarmycadres.admin_greditform_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.fssj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='fssj' :itemRules="this.rules.fssj" class='' :caption="$t('entities.pimarmycadres.admin_greditform_form.details.fssj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.fssj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.fj.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='fj' :itemRules="this.rules.fj" class='' :caption="$t('entities.pimarmycadres.admin_greditform_form.details.fj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.fj.error" :isEmptyCaption="false" labelPos="LEFT">
...
import Admin_GREditFormService from './admin-gredit-form-form-service';
...
export default class Admin_GREditFormBase extends Vue implements ControlInterface {
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimarmycadres_admin_greditform',popTitle:'主编辑表单（管理员）'});
    }
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESEditView视图表单'+actionName+'参数未配置' });
            return;
        }
...
<style lang='less'>
@import './admin-gredit-form-form.less';
</style>