...
export default class HTQDDWWPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     *
     * @type {string}
     * @memberof HTQDDWWPickupViewpickupviewpanelBase
     */
     ...
     * @memberof HTQDDWWPickupViewpickupviewpanelBase
     */
    public service: HTQDDWWPickupViewpickupviewpanelService = new HTQDDWWPickupViewpickupviewpanelService({ $store: this.$store });
