...
import GBLLModel from './gbll-grid-model';
 ...
 * @class GBLLService
 */
export default class GBLLService extends ControlService {

    /**
     * 工作履历服务对象
     *
     * @type {PIMWORKHISTORYService}
     * @memberof GBLLService
     */
    ...
    /**
     * Creates an instance of GBLLService.
     * 
     * @param {*} [opts={}]
     * @memberof GBLLService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.pimworkhistory = Util.createUUID();
                }
