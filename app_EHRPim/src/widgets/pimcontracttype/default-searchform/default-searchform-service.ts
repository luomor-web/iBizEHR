...
export default class DefaultService extends ControlService {
     ...
     */
    public appEntityService: PIMCONTRACTTYPEService = new PIMCONTRACTTYPEService({ $store: this.getStore() });
    ...
    public add(action: string, context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Object.assign(Data,{pimcontracttypeid: data.pimcontracttypeid, srffrontuf: '1'});
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimcontracttypeid = PrimaryKey;
        Data.pimcontracttype = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimcontracttypeid = PrimaryKey;
