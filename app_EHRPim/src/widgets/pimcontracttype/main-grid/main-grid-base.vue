    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimcontracttype: keys.join(';') }),Object.assign({ pimcontracttype: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
