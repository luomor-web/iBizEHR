<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimpatent_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimpatent.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pimpatent.main_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zlh.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zlh' :itemRules="this.rules.zlh" class='' :caption="$t('entities.pimpatent.main_form.details.zlh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zlh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.pimpatentname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpatentname' :itemRules="this.rules.pimpatentname" class='' :caption="$t('entities.pimpatent.main_form.details.pimpatentname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpatentname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zlpzgb.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zlpzgb' :itemRules="this.rules.zlpzgb" class='' :caption="$t('entities.pimpatent.main_form.details.zlpzgb')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zlpzgb.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zlhqsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zlhqsj' :itemRules="this.rules.zlhqsj" class='' :caption="$t('entities.pimpatent.main_form.details.zlhqsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zlhqsj.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.enclolure.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='enclolure' :itemRules="this.rules.enclolure" class='' :caption="$t('entities.pimpatent.main_form.details.enclolure')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.enclolure.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '专利信息基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimpatent.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimpatent_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMPATENTEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
