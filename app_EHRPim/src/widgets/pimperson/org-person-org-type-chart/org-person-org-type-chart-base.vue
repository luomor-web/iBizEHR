...
export default class OrgPersonOrgTypeBase extends Vue implements ControlInterface {
     ...
     * @memberof OrgPersonOrgType
     */
    protected service: OrgPersonOrgTypeService = new OrgPersonOrgTypeService({ $store: this.$store });
    ...
    */
    ...
    categorCodeList:{type:'STATIC',tag:'PIMCL_JGXMFB',emptycode:'empty',emptytext:'未定义'},
    valueField:'countnum',
    seriesValues:[],
    seriesIndex:0,
    data:[],
    seriesMap:{},
    dataSetFields:[
    {name:"ormtype",codelist:{type:"STATIC",tag:"PIMCL_JGXMFB",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
