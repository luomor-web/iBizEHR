...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimperson.sydqyg_grid.columns.zzdzs')" :align="'center'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <span>{{row.zzdzs}}</span>
                    </template>
                </el-table-column>
...
export default class SYDQYGBase extends Vue implements ControlInterface {
     ...
     * @memberof SYDQYG
     */
    protected service: SYDQYGService = new SYDQYGService({ $store: this.$store });
     ...
     * @memberof SYDQYG
     */
    protected minorSortPSDEF: string = 'sydq';
