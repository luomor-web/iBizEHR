...
import Admin_GREditFormModel from './admin-gredit-form-form-model';


/**
 * Admin_GREditForm 部件服务对象
 *
 * @export
 * @class Admin_GREditFormService
 */
export default class Admin_GREditFormService extends ControlService {

    /**
     * 军转干部服务对象
     *
     * @type {PimArmycadresService}
     * @memberof Admin_GREditFormService
     */
    public appEntityService: PimArmycadresService = new PimArmycadresService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of Admin_GREditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof Admin_GREditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Admin_GREditFormModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimarmycadresid = PrimaryKey;
        Data.pimarmycadres = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimarmycadresid = PrimaryKey;
