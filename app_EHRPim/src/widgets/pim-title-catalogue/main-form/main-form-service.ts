...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: PimTitleCatalogueService = new PimTitleCatalogueService({ $store: this.getStore() });
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'PimTitleCatalogueService') && Object.is(interfaceName, 'FetchIsRootDQ')) {
            return this.doItems(this.appEntityService.FetchIsRootDQ(JSON.parse(JSON.stringify(context)), data, isloading), 'pimtitlecatalogueid', 'pimtitlecatalogue');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimtitlecatalogueid = PrimaryKey;
        Data.pimtitlecatalogue = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimtitlecatalogueid = PrimaryKey;
