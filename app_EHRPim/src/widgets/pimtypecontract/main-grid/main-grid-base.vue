...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'typecode';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimtypecontract: keys.join(';') }),Object.assign({ pimtypecontract: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
