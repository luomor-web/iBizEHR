<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimdistirbution_maturitydueeditform' style="">
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimdistirbution_maturitydueeditform',popTitle:'主编辑表单(借调到期)'});
    }
