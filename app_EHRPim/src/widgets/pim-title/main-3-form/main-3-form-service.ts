...
export default class Main_3Service extends ControlService {
     ...
     * @memberof Main_3Service
     */
    public pimtitlecatalogueService: PimTitleCatalogueService = new PimTitleCatalogueService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'PimTitleCatalogueService') && Object.is(interfaceName, 'FetchNotRootDQ')) {
            return this.doItems(this.pimtitlecatalogueService.FetchNotRootDQ(JSON.parse(JSON.stringify(context)),data, isloading), 'pimtitlecatalogueid', 'pimtitlecatalogue');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimtitleid = PrimaryKey;
        Data.pimtitle = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimtitleid = PrimaryKey;
