...
export default class MainService extends ControlService {
     ...
     * @memberof MainService
     */
    public archivalcatalogueService: ARCHIVALCATALOGUEService = new ARCHIVALCATALOGUEService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'ARCHIVALCATALOGUEService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.archivalcatalogueService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'archivalcatalogueid', 'archivalcatalogue');
        }
