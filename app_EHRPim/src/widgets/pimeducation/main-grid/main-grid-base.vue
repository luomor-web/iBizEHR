...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('fj')">
              ...
              uploadparams='' 
              exportparams='' 
              :customparams="{'foldertype': 'IDCARD'}" style="overflow: auto;">
            </app-file-upload>
                                </app-form-item>
                            </i-form>
                        </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'jssj';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimeducation: keys.join(';') }),Object.assign({ pimeducation: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
