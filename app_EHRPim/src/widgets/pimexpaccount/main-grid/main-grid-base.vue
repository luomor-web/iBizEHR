    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimexpaccount: keys.join(';') }),Object.assign({ pimexpaccount: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
