...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'createdate';
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimachievements: keys.join(';') }),Object.assign({ pimachievements: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
