<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimmajorsetype_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimmajorsetype.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.serialno.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='serialno' :itemRules="this.rules.serialno" class='' :caption="$t('entities.pimmajorsetype.main_form.details.serialno')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.serialno.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.pimmajorsetypename.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimmajorsetypename' :itemRules="this.rules.pimmajorsetypename" class='' :caption="$t('entities.pimmajorsetype.main_form.details.pimmajorsetypename')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimmajorsetypename.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PimMajorSetypeService = new PimMajorSetypeService({ $store: this.$store });
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '专业序列类型', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimmajorsetype.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '专业序列类型标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '专业序列类型', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimmajorsetypename: new FormItemModel({ caption: '专业序列类型', detailType: 'FORMITEM', name: 'pimmajorsetypename', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pimmajorsetype){
            Object.assign(this.context,{pimmajorsetype:data.pimmajorsetype})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pimmajorsetype = copyData.srfkey;
        copyData.pimmajorsetypeid = copyData.srfkey;
        Object.assign(this.context,{pimmajorsetype:copyData.pimmajorsetype})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimmajorsetype_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMMAJORSETYPEEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMMAJORSETYPEEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMMAJORSETYPEEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMMAJORSETYPEEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pimmajorsetype || Object.is(arg.pimmajorsetype, '')) {
            return;
        }
