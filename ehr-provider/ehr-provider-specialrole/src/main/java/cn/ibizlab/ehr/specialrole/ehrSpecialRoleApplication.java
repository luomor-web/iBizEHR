package cn.ibizlab.ehr.specialrole;
...
public class ehrSpecialRoleApplication extends WebMvcConfigurerAdapter{

    public static void main(String[] args) {
        SpringApplication.run(ehrSpecialRoleApplication.class, args);
    }
