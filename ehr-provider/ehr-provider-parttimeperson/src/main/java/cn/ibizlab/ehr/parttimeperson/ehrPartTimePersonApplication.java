package cn.ibizlab.ehr.parttimeperson;
...
public class ehrPartTimePersonApplication extends WebMvcConfigurerAdapter{

    public static void main(String[] args) {
        SpringApplication.run(ehrPartTimePersonApplication.class, args);
    }
