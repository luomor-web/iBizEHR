...
public class UniResResource {
    ...
    @Autowired
    @Lazy
    private UniResMapping uniresMapping;




    @PreAuthorize("hasPermission(#unires_id,'Update',{this.getEntity(),'Sql'})")
    ...
    @PreAuthorize("hasPermission(#unires_id,'Get',{this.getEntity(),'Sql'})")
