...
public class TDZWXXResource {
    ...
    @Autowired
    @Lazy
    private TDZWXXMapping tdzwxxMapping;
    ...
    @PreAuthorize("hasPermission(#tdzwxx_id,'Update',{this.getEntity(),'Sql'})")
    ...
    @PreAuthorize("hasPermission(#tdzwxx_id,'Get',{this.getEntity(),'Sql'})")
