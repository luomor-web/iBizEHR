...
public class VACLEAVESYSTEMDETAILResource {
    ...
    @Autowired
    public IVACLEAVESYSTEMDETAILService vacleavesystemdetailService;

    @Autowired
    @Lazy
    public VACLEAVESYSTEMDETAILMapping vacleavesystemdetailMapping;

    @PreAuthorize("hasPermission(this.vacleavesystemdetailService.get(#vacleavesystemdetail_id),'ehr-VACLEAVESYSTEMDETAIL-Update')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailService.getVacleavesystemdetailByEntities(this.vacleavesystemdetailMapping.toDomain(#vacleavesystemdetaildtos)),'ehr-VACLEAVESYSTEMDETAIL-Update')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailMapping.toDomain(#vacleavesystemdetaildto),'ehr-VACLEAVESYSTEMDETAIL-Save')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailMapping.toDomain(#vacleavesystemdetaildtos),'ehr-VACLEAVESYSTEMDETAIL-Save')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailService.get(#vacleavesystemdetail_id),'ehr-VACLEAVESYSTEMDETAIL-Remove')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailService.getVacleavesystemdetailByIds(#ids),'ehr-VACLEAVESYSTEMDETAIL-Remove')")
    ...
    @PostAuthorize("hasPermission(this.vacleavesystemdetailMapping.toDomain(returnObject.body),'ehr-VACLEAVESYSTEMDETAIL-Get')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailMapping.toDomain(#vacleavesystemdetaildto),'ehr-VACLEAVESYSTEMDETAIL-Create')")
    ...
    @PreAuthorize("hasPermission(this.vacleavesystemdetailMapping.toDomain(#vacleavesystemdetaildtos),'ehr-VACLEAVESYSTEMDETAIL-Create')")
