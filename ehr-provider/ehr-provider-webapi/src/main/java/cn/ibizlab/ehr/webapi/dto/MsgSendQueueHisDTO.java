...
/**
 * 服务DTO对象[MsgSendQueueHisDTO]
 */
@Data
public class MsgSendQueueHisDTO extends DTOBase implements Serializable {
    ...
    /**
     * 属性 [MSGSENDQUEUEHISNAME]
     *
     */
    @JSONField(name = "msgsendqueuehisname")
    @JsonProperty("msgsendqueuehisname")
    ...
    /**
     * 属性 [MSGSENDQUEUEHISID]
     *
     */
    @JSONField(name = "msgsendqueuehisid")
    @JsonProperty("msgsendqueuehisid")
