...
public class WFUserResource {
    ...
    @Autowired
    @Lazy
    private WFUserMapping wfuserMapping;
    ...
    @PreAuthorize("hasPermission(#wfuser_id,'Get',{this.getEntity(),'Sql'})")
    ...
    @PreAuthorize("hasPermission(#wfuser_id,'Remove',{this.getEntity(),'Sql'})")
