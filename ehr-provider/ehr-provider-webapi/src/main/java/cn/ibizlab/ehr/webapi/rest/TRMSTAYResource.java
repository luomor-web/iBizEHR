...
public class TRMSTAYResource {
    ...
    @Autowired
    @Lazy
    private TRMSTAYMapping trmstayMapping;
    ...
    @PreAuthorize("hasPermission(#trmstay_id,'Get',{this.getEntity(),'Sql'})")
    ...
    @PreAuthorize("hasPermission(#trmstay_id,'Update',{this.getEntity(),'Sql'})")
