package cn.ibizlab.ehr.saasadmin;
...
public class ehrSaaSAdminApplication extends WebMvcConfigurerAdapter{

    public static void main(String[] args) {
        SpringApplication.run(ehrSaaSAdminApplication.class, args);
    }
