<template>
  <app-layout viewName="salstdgwgzgridview" viewTitle="岗位工资标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-stdgwgz-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="岗位工资标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStdgwgzGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdgwgzGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdgwgzService}
     * @memberof SalStdgwgzGridViewBase
     */
	 ...
	 * @memberof SalStdgwgzGridViewBase
	 */
	public viewtag: string = '5c199b2795b1d8e13f8efa3353618b9c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdgwgz.views.gridview.caption',
        srfTitle: 'entities.salstdgwgz.views.gridview.title',
        srfSubTitle: 'entities.salstdgwgz.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStdgwgz");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStdgwgz");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStdgwgz");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStdgwgz");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStdgwgz");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salstdgwgz;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'sal-stdgwgz-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstdgwgz.views.editview.title'),
...
<style lang='less'>
@import './sal-stdgwgz-grid-view.less';
</style>