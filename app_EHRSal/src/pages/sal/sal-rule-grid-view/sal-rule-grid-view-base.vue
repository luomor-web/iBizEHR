<template>
  <app-layout viewName="salrulegridview" viewTitle="薪酬规则表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-rule-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="薪酬规则名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalRuleGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalRuleGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalRuleService}
     * @memberof SalRuleGridViewBase
     */
	 ...
	 * @memberof SalRuleGridViewBase
	 */
	public viewtag: string = 'e713eb5c29d843ac20c1a519648747b6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salrule.views.gridview.caption',
        srfTitle: 'entities.salrule.views.gridview.title',
        srfSubTitle: 'entities.salrule.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-rule-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salrule.views.editview.title'),
...
<style lang='less'>
@import './sal-rule-grid-view.less';
</style>