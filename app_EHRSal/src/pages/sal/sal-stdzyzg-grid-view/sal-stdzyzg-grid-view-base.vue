<template>
  <app-layout viewName="salstdzyzggridview" viewTitle="执业资格津贴标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-stdzyzg-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="执业资格津贴标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStdzyzgGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdzyzgGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdzyzgService}
     * @memberof SalStdzyzgGridViewBase
     */
	 ...
	 * @memberof SalStdzyzgGridViewBase
	 */
	public viewtag: string = 'e2a48b9813f6f75da9a600244d3bb362';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdzyzg.views.gridview.caption',
        srfTitle: 'entities.salstdzyzg.views.gridview.title',
        srfSubTitle: 'entities.salstdzyzg.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salstdzyzg;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'sal-stdzyzg-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstdzyzg.views.editview.title'),
...
<style lang='less'>
@import './sal-stdzyzg-grid-view.less';
</style>