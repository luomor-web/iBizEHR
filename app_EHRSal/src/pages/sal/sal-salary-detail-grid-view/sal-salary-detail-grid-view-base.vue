<template>
  <app-layout viewName="salsalarydetailgridview" viewTitle="员工薪酬明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-salary-detail-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="员工薪酬明细名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalSalaryDetailGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSalaryDetailGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSalaryDetailService}
     * @memberof SalSalaryDetailGridViewBase
     */
	 ...
	 * @memberof SalSalaryDetailGridViewBase
	 */
	public viewtag: string = '8211ae61b7d368f63a74af2bc1c38a57';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salsalarydetail.views.gridview.caption',
        srfTitle: 'entities.salsalarydetail.views.gridview.title',
        srfSubTitle: 'entities.salsalarydetail.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SalSalaryDetailGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salsalarydetail;
        if(args.length >0){
...
<style lang='less'>
@import './sal-salary-detail-grid-view.less';
</style>