<template>
  <app-layout viewName="saltypegridview" viewTitle="薪酬类型表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-type-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="薪酬类型名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalTypeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalTypeGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalTypeService}
     * @memberof SalTypeGridViewBase
     */
	 ...
	 * @memberof SalTypeGridViewBase
	 */
	public viewtag: string = 'ecdae2be14321abf03a8a5498c9d1bf3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.saltype.views.gridview.caption',
        srfTitle: 'entities.saltype.views.gridview.title',
        srfSubTitle: 'entities.saltype.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-type-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.saltype.views.editview.title'),
...
<style lang='less'>
@import './sal-type-grid-view.less';
</style>