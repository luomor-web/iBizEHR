<template>
  <app-layout viewName="salpersonstdgridview" viewTitle="员工薪酬标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-person-std-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="员工薪酬标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalPersonStdGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalPersonStdGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalPersonStdService}
     * @memberof SalPersonStdGridViewBase
     */
	 ...
	 * @memberof SalPersonStdGridViewBase
	 */
	public viewtag: string = 'e409b21fe364b19d387640a3f72f76c3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salpersonstd.views.gridview.caption',
        srfTitle: 'entities.salpersonstd.views.gridview.title',
        srfSubTitle: 'entities.salpersonstd.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salpersonstd;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'sal-person-std-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salpersonstd.views.editview.title'),
...
<style lang='less'>
@import './sal-person-std-grid-view.less';
</style>