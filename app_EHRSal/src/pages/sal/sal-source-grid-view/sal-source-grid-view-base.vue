<template>
  <app-layout viewName="salsourcegridview" viewTitle="薪酬计算源表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-source-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="薪酬计算源名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalSourceGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSourceGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSourceService}
     * @memberof SalSourceGridViewBase
     */
	 ...
	 * @memberof SalSourceGridViewBase
	 */
	public viewtag: string = 'b82a28f98dabe2147523367af496ce8a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salsource.views.gridview.caption',
        srfTitle: 'entities.salsource.views.gridview.title',
        srfSubTitle: 'entities.salsource.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-source-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salsource.views.editview.title'),
...
<style lang='less'>
@import './sal-source-grid-view.less';
</style>