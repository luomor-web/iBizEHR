<template>
  <app-layout viewName="salschemegridview" viewTitle="薪酬方案表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-scheme-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="工资单名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalSchemeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSchemeGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSchemeService}
     * @memberof SalSchemeGridViewBase
     */
	 ...
	 * @memberof SalSchemeGridViewBase
	 */
	public viewtag: string = 'b0359cd7880295cf20f26a6de36b5b7d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salscheme.views.gridview.caption',
        srfTitle: 'entities.salscheme.views.gridview.title',
        srfSubTitle: 'entities.salscheme.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-scheme-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salscheme.views.editview.title'),
...
<style lang='less'>
@import './sal-scheme-grid-view.less';
</style>