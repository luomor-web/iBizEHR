<template>
  <app-layout viewName="salstdxmgzgridview" viewTitle="项目工资标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-std-xmgz-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="项目工资标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStdXmgzGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdXmgzGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdXmgzService}
     * @memberof SalStdXmgzGridViewBase
     */
	 ...
	 * @memberof SalStdXmgzGridViewBase
	 */
	public viewtag: string = 'f169dd9ecee320263c3ff7f3bcf017a2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdxmgz.views.gridview.caption',
        srfTitle: 'entities.salstdxmgz.views.gridview.title',
        srfSubTitle: 'entities.salstdxmgz.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salstdxmgz;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'sal-std-xmgz-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstdxmgz.views.editview.title'),
...
<style lang='less'>
@import './sal-std-xmgz-grid-view.less';
</style>