<template>
  <app-layout viewName="salstddszngridview" viewTitle="独生子女标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-stddszn-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="独生子女标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStddsznGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStddsznGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStddsznService}
     * @memberof SalStddsznGridViewBase
     */
	 ...
	 * @memberof SalStddsznGridViewBase
	 */
	public viewtag: string = '230755e6c3b7c312acdfceabe73487a7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstddszn.views.gridview.caption',
        srfTitle: 'entities.salstddszn.views.gridview.title',
        srfSubTitle: 'entities.salstddszn.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStddszn");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStddszn");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStddszn");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStddszn");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStddszn");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salstddszn;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'sal-stddszn-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstddszn.views.editview.title'),
...
<style lang='less'>
@import './sal-stddszn-grid-view.less';
</style>