<template>
  <app-layout viewName="salparamgridview" viewTitle="薪酬计算指标表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-param-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="薪酬计算指标名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalParamGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalParamGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalParamService}
     * @memberof SalParamGridViewBase
     */
	 ...
	 * @memberof SalParamGridViewBase
	 */
	public viewtag: string = 'd3fa27489dfbda569855b3305c9d8e3a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salparam.views.gridview.caption',
        srfTitle: 'entities.salparam.views.gridview.title',
        srfSubTitle: 'entities.salparam.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-param-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salparam.views.editview.title'),
...
<style lang='less'>
@import './sal-param-grid-view.less';
</style>