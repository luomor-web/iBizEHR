<template>
  <app-layout viewName="salitemgridview" viewTitle="薪酬要素项表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-item-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalItemGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalItemGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalItemService}
     * @memberof SalItemGridViewBase
     */
	 ...
	 * @memberof SalItemGridViewBase
	 */
	public viewtag: string = 'e428ba00da30a0f44c0415a6c294cebb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salitem.views.gridview.caption',
        srfTitle: 'entities.salitem.views.gridview.title',
        srfSubTitle: 'entities.salitem.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
...
<style lang='less'>
@import './sal-item-grid-view.less';
</style>