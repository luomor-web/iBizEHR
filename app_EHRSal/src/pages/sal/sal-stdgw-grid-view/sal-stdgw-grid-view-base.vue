<template>
  <app-layout viewName="salstdgwgridview" viewTitle="高温津贴标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-stdgw-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="高温津贴标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStdgwGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdgwGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdgwService}
     * @memberof SalStdgwGridViewBase
     */
	 ...
	 * @memberof SalStdgwGridViewBase
	 */
	public viewtag: string = '9b03c9156c634921bac245a676899e77';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdgw.views.gridview.caption',
        srfTitle: 'entities.salstdgw.views.gridview.title',
        srfSubTitle: 'entities.salstdgw.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStdgw");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStdgw");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStdgw");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStdgw");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStdgw");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-stdgw-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstdgw.views.editview.title'),
...
<style lang='less'>
@import './sal-stdgw-grid-view.less';
</style>