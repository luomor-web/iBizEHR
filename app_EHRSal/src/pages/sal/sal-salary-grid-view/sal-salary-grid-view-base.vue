<template>
  <app-layout viewName="salsalarygridview" viewTitle="员工薪酬表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-salary-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="员工薪酬名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalSalaryGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSalaryGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSalaryService}
     * @memberof SalSalaryGridViewBase
     */
	 ...
	 * @memberof SalSalaryGridViewBase
	 */
	public viewtag: string = 'de531c75dcb9d45eb7cfcaef9faba852';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salsalary.views.gridview.caption',
        srfTitle: 'entities.salsalary.views.gridview.title',
        srfSubTitle: 'entities.salsalary.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-salary-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salsalary.views.editview.title'),
...
<style lang='less'>
@import './sal-salary-grid-view.less';
</style>