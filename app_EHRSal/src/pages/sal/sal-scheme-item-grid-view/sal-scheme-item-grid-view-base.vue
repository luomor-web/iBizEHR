<template>
  <app-layout viewName="salschemeitemgridview" viewTitle="方案要素项表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-scheme-item-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="要素项" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalSchemeItemGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSchemeItemGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSchemeItemService}
     * @memberof SalSchemeItemGridViewBase
     */
	 ...
	 * @memberof SalSchemeItemGridViewBase
	 */
	public viewtag: string = 'd0908e8c3011c16569051fa365a3678e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salschemeitem.views.gridview.caption',
        srfTitle: 'entities.salschemeitem.views.gridview.title',
        srfSubTitle: 'entities.salschemeitem.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
...
<style lang='less'>
@import './sal-scheme-item-grid-view.less';
</style>