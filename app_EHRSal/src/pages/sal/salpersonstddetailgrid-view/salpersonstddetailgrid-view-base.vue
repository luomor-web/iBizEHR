<template>
  <app-layout viewName="salpersonstddetailgridview" viewTitle="员工薪酬标准明细表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'salpersonstddetailgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="员工薪酬标准明细名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SALPERSONSTDDETAILGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SALPERSONSTDDETAILGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SALPERSONSTDDETAILService}
     * @memberof SALPERSONSTDDETAILGridViewBase
     */
	 ...
	 * @memberof SALPERSONSTDDETAILGridViewBase
	 */
	public viewtag: string = 'fa15d184ebbb47458b833c6e7d867e04';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salpersonstddetail.views.gridview.caption',
        srfTitle: 'entities.salpersonstddetail.views.gridview.title',
        srfSubTitle: 'entities.salpersonstddetail.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SALPERSONSTDDETAILGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.salpersonstddetail;
        if(args.length >0){
...
<style lang='less'>
@import './salpersonstddetailgrid-view.less';
</style>