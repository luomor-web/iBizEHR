<template>
  <app-layout viewName="salstdglgridview" viewTitle="工龄工资标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-stdgl-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="工龄工资标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStdglGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdglGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdglService}
     * @memberof SalStdglGridViewBase
     */
	 ...
	 * @memberof SalStdglGridViewBase
	 */
	public viewtag: string = 'b0d87c562700afae22e6ff83c509c261';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdgl.views.gridview.caption',
        srfTitle: 'entities.salstdgl.views.gridview.title',
        srfSubTitle: 'entities.salstdgl.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-stdgl-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstdgl.views.editview.title'),
...
<style lang='less'>
@import './sal-stdgl-grid-view.less';
</style>