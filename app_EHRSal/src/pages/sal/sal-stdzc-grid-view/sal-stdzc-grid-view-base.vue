<template>
  <app-layout viewName="salstdzcgridview" viewTitle="职称类别标准表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-stdzc-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="技术津贴标准名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalStdzcGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdzcGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdzcService}
     * @memberof SalStdzcGridViewBase
     */
	 ...
	 * @memberof SalStdzcGridViewBase
	 */
	public viewtag: string = 'a203da68bc71c70f227fe602bfabbd56';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdzc.views.gridview.caption',
        srfTitle: 'entities.salstdzc.views.gridview.title',
        srfSubTitle: 'entities.salstdzc.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'sal-stdzc-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.salstdzc.views.editview.title'),
...
<style lang='less'>
@import './sal-stdzc-grid-view.less';
</style>