<template>
  <app-layout viewName="salplangridview" viewTitle="薪酬计算计划表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'sal-plan-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="薪酬计算计划名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SalPlanGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalPlanGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalPlanService}
     * @memberof SalPlanGridViewBase
     */
	 ...
	 * @memberof SalPlanGridViewBase
	 */
	public viewtag: string = '46cfacbff697ee3aa3704bc44efdb3f3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salplan.views.gridview.caption',
        srfTitle: 'entities.salplan.views.gridview.title',
        srfSubTitle: 'entities.salplan.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
...
<style lang='less'>
@import './sal-plan-grid-view.less';
</style>