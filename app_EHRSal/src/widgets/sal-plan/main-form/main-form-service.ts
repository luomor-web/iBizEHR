...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: SalPlanService = new SalPlanService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public salschemeService: SalSchemeService = new SalSchemeService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'SalSchemeService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.salschemeService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'salschemeid', 'salscheme');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.salplanid = PrimaryKey;
        Data.salplan = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.salplanid = PrimaryKey;
