<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='salplan_main' style="">
...
<i-col v-show="detailsModel.nyear.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
 ...
 <dropdown-list 
    ...
    tag='EhrCodeList0115' 
    codelistType='STATIC'
    placeholder='请选择...' style="width:272px;">
 </dropdown-list>
</app-form-item>
...
<i-col v-show="detailsModel.nmonth.visible" :style="{}"  :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
 ...
 <dropdown-list 
    ...
    :localContext ='{ }' 
    :localParam ='{ }' 
    :disabled="detailsModel.nmonth.disabled"  
    tag='CodeList82' 
    codelistType='STATIC'
    placeholder='请选择...' style="width:272px;">
 </dropdown-list>
...
<app-picker 
  ...
  :localContext ='{ }' 
  :localParam ='{ }' 
  :disabled="detailsModel.salschemename.disabled"
  name='salschemename'
  deMajorField='salschemename'
  deKeyField='salscheme'
  :service="service"
  :acParams="{ serviceName: 'SalSchemeService', interfaceName: 'FetchDefault'}"
  valueitem='salschemeid' 
  :value="data.salschemename" 
  editortype="" 
  :pickupView="{ viewname: 'sal-scheme-pickup-view', title: $t('entities.salscheme.views.pickupview.title'), deResParameters: [], parameters: [{ pathName: 'salschemes', parameterName: 'salscheme' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
  style=""  
  @formitemvaluechange="onFormItemValueChange">
</app-picker>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        srfmajortext: [
            { type: 'string', message: '薪酬计算计划名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '薪酬计算计划名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '薪酬计算计划名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '薪酬计算计划名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        salplanname: [
            { type: 'string', message: '薪酬计算计划名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '薪酬计算计划名称 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '薪酬计算计划名称 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '薪酬计算计划名称 值不能为空', trigger: 'blur' },
        ],
        nyear: [
            { type: 'number', message: '年 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '年 值必须为数值类型', trigger: 'blur' },
            { required: true, type: 'number', message: '年 值不能为空', trigger: 'change' },
            { required: true, type: 'number', message: '年 值不能为空', trigger: 'blur' },
        ],
        nmonth: [
            { type: 'number', message: '月 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '月 值必须为数值类型', trigger: 'blur' },
            { required: true, type: 'number', message: '月 值不能为空', trigger: 'change' },
            { required: true, type: 'number', message: '月 值不能为空', trigger: 'blur' },
        ],
        ormorgname: [
        ...
        salschemename: [
            { type: 'string', message: '薪酬方案 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '薪酬方案 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '薪酬方案 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '薪酬方案 值不能为空', trigger: 'blur' },
        ],
        state: [
            { type: 'string', message: '计划状态 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '计划状态 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '计划状态 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '计划状态 值不能为空', trigger: 'blur' },
        ],
        memo: [
        ...
        salschemeid: [
            { type: 'string', message: '薪酬方案标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '薪酬方案标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '薪酬方案标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '薪酬方案标识 值不能为空', trigger: 'blur' },
        ],
    }
...
, 
        srfkey: new FormItemModel({ caption: '薪酬计算计划标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '薪酬计算计划名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        salplanname: new FormItemModel({ caption: '薪酬计算计划名称', detailType: 'FORMITEM', name: 'salplanname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        salschemename: new FormItemModel({ caption: '薪酬方案', detailType: 'FORMITEM', name: 'salschemename', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        state: new FormItemModel({ caption: '计划状态', detailType: 'FORMITEM', name: 'state', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
        salschemeid: new FormItemModel({ caption: '薪酬方案标识', detailType: 'FORMITEM', name: 'salschemeid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.salplan){
            Object.assign(this.context,{salplan:data.salplan})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.salplan = copyData.srfkey;
        copyData.salplanid = copyData.srfkey;
        Object.assign(this.context,{salplan:copyData.salplan})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'salplan_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'SalPlanEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'SalPlanEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'SalPlanEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'SalPlanEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.salplan || Object.is(arg.salplan, '')) {
            return;
        }
