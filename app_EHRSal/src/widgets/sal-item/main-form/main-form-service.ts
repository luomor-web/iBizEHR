...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: SalItemService = new SalItemService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public salsubjectService: SalSubjectService = new SalSubjectService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'SalSubjectService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.salsubjectService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'salsubjectid', 'salsubject');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.salitemid = PrimaryKey;
        Data.salitem = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.salitemid = PrimaryKey;
