 ...
 * @class QZFPService
 */
export default class QZFPService extends ControlService {
     ...
     */
    public appEntityService: ParLdkhqzService = new ParLdkhqzService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of QZFPService.
     * 
     * @param {*} [opts={}]
     * @memberof QZFPService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.parldkhqzid = PrimaryKey;
        Data.parldkhqz = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.parldkhqzid = PrimaryKey;
