<template>
    <i-form :model="this.data" class='app-form info-form-mode' ref='form'  id='parassesstemplate_main2' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.parassesstemplate.main2_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="1" :isInfoGroupMode="true" >    
    <row>
    ...
    <app-form-item name='parassesstemplatename' :itemRules="this.rules.parassesstemplatename" class='' :caption="$t('entities.parassesstemplate.main2_form.details.parassesstemplatename')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.parassesstemplatename.error" :isEmptyCaption="false" labelPos="LEFT">
    
<app-span name='parassesstemplatename' :value="data.parassesstemplatename" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.khdx.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='khdx' :itemRules="this.rules.khdx" class='' :caption="$t('entities.parassesstemplate.main2_form.details.khdx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.khdx.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.nd.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='nd' :itemRules="this.rules.nd" class='' :caption="$t('entities.parassesstemplate.main2_form.details.nd')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.nd.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.sfyx.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='sfyx' :itemRules="this.rules.sfyx" class='' :caption="$t('entities.parassesstemplate.main2_form.details.sfyx')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.sfyx.error" :isEmptyCaption="false" labelPos="LEFT">
    
<app-span name='sfyx' :value="data.sfyx" tag='EhrCodeList0054' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.parassesstemplate.main2_form.details.grouppanel1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="1" :isInfoGroupMode="true" >    
    <row>
    ...
    :localContext ='{}'
    :localParam ='{}'
    parameterName='parassesstemplate'
    parentName="ParAssessTemplate"  
    refviewtype='DEGRIDVIEW' 
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='par-khzcmx-grid-view' 
...
export default class Main2Base extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        parassesstemplatename: [
            { type: 'string', message: '模板名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '模板名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '模板名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '模板名称 值不能为空', trigger: 'blur' },
        ],
        khdx: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '考核模板', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.parassesstemplate.main2_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '考核模板明细', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.parassesstemplate.main2_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '考核模板标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '考核模板名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        parassesstemplatename: new FormItemModel({ caption: '模板名称', detailType: 'FORMITEM', name: 'parassesstemplatename', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        sfyx: new FormItemModel({ caption: '是否有效', detailType: 'FORMITEM', name: 'sfyx', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     */
    @Watch('data.sfyx')
    onSfyxChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'sfyx', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.parassesstemplate){
            Object.assign(this.context,{parassesstemplate:data.parassesstemplate})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.parassesstemplate = copyData.srfkey;
        copyData.parassesstemplateid = copyData.srfkey;
        Object.assign(this.context,{parassesstemplate:copyData.parassesstemplate})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'parassesstemplate_main2',popTitle:'主信息表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'ParAssessTemplateEditView9视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ParAssessTemplateEditView9视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'ParAssessTemplateEditView9视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'ParAssessTemplateEditView9视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.parassesstemplate || Object.is(arg.parassesstemplate, '')) {
            return;
        }
