...
export default class Main2Service extends ControlService {
     ...
     */
    public appEntityService: ParIntegralRuleService = new ParIntegralRuleService({ $store: this.getStore() });
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.parintegralruleid = PrimaryKey;
        Data.parintegralrule = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.parintegralruleid = PrimaryKey;
