<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='parexamcontent_main' style="">
        ...
        @on-click="detailsModel.form.clickPage($event)">
            <tab-pane v-show="detailsModel.formpage1.visible" name='formpage1' :index="0" tab='main' class=''  
                :label="(h) =>{
                    ...
                    $t('entities.parexamcontent.main_form.details.formpage1')
                    ])
                }">
                    
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.parexamcontent.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="1" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.contentcode.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='contentcode' :itemRules="this.rules.contentcode" class='' :caption="$t('entities.parexamcontent.main_form.details.contentcode')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.contentcode.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.contentcode"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.contentcode.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.parexamcontentname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='parexamcontentname' :itemRules="this.rules.parexamcontentname" class='' :caption="$t('entities.parexamcontent.main_form.details.parexamcontentname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.parexamcontentname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.parexamcontentname"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.parexamcontentname.disabled" type='text'  style=""></input-box>
</app-form-item>
            ...
            <tab-pane v-show="detailsModel.formpage2.visible" name='formpage2' :index="1" tab='main' class=''  
                :label="(h) =>{
                    ...
                    $t('entities.parexamcontent.main_form.details.formpage2')
                    ])
                }">
                    
<i-col v-show="detailsModel.group2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.parexamcontent.main_form.details.group2')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.createman.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='createman' :itemRules="this.rules.createman" class='' :caption="$t('entities.parexamcontent.main_form.details.createman')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.createman.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.createdate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='createdate' :itemRules="this.rules.createdate" class='' :caption="$t('entities.parexamcontent.main_form.details.createdate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.createdate.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.updateman.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='updateman' :itemRules="this.rules.updateman" class='' :caption="$t('entities.parexamcontent.main_form.details.updateman')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.updateman.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.updatedate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='updatedate' :itemRules="this.rules.updatedate" class='' :caption="$t('entities.parexamcontent.main_form.details.updatedate')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.updatedate.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public data: any = {
        ...
        srfsourcekey: null,
        contentcode: null,
        parexamcontentname: null,
        createman: null,
        createdate: null,
        updateman: null,
        updatedate: null,
        parexamcontentid: null,
        parexamcontent:null,
    };
    ...
    public rules: any = {
        ...
        contentcode: [
            { type: 'string', message: '内容编码 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '内容编码 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '内容编码 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '内容编码 值不能为空', trigger: 'blur' },
        ],
        parexamcontentname: [
            { type: 'string', message: '考核内容 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考核内容 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '考核内容信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.parexamcontent.main_form', extractMode: 'ITEM', details: [] } })
, 
        formpage1: new FormPageModel({ caption: '基本信息', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this })
, 
        group2: new FormGroupPanelModel({ caption: '操作信息', detailType: 'GROUPPANEL', name: 'group2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.parexamcontent.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        contentcode: new FormItemModel({ caption: '内容编码', detailType: 'FORMITEM', name: 'contentcode', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        parexamcontentname: new FormItemModel({ caption: '考核内容', detailType: 'FORMITEM', name: 'parexamcontentname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        parexamcontentid: new FormItemModel({ caption: '考核内容标识', detailType: 'FORMITEM', name: 'parexamcontentid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    ...
    /**
     * 监控表单属性 contentcode 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.contentcode')
    onContentcodeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'contentcode', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 parexamcontentname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.parexamcontentname')
    onParexamcontentnameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'parexamcontentname', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 parexamcontentid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.parexamcontentid')
    onParexamcontentidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'parexamcontentid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.parexamcontent){
            Object.assign(this.context,{parexamcontent:data.parexamcontent})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.parexamcontent = copyData.srfkey;
        copyData.parexamcontentid = copyData.srfkey;
        Object.assign(this.context,{parexamcontent:copyData.parexamcontent})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'parexamcontent_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'ParExamContentEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ParExamContentEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'ParExamContentEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'ParExamContentEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.parexamcontent || Object.is(arg.parexamcontent, '')) {
            return;
        }
