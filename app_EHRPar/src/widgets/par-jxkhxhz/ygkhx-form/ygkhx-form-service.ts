...
import YGKHXModel from './ygkhx-form-model';
 ...
 * @class YGKHXService
 */
export default class YGKHXService extends ControlService {

    /**
     * 考核内容评分汇总服务对象
     *
     * @type {ParJxkhxhzService}
     * @memberof YGKHXService
     */
    ...
    /**
     * Creates an instance of YGKHXService.
     * 
     * @param {*} [opts={}]
     * @memberof YGKHXService
     */
