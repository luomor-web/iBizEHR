...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: ParJxkhxhzService = new ParJxkhxhzService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public parassesstemplateService: ParAssessTemplateService = new ParAssessTemplateService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'ParAssessTemplateService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.parassesstemplateService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'parassesstemplateid', 'parassesstemplate');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.parjxkhxhzid = PrimaryKey;
        Data.parjxkhxhz = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.parjxkhxhzid = PrimaryKey;
