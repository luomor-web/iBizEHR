...
import NDLHMBKHModel from './ndlhmbkh-form-model';
 ...
 *
 * @export
 * @class NDLHMBKHService
 */
export default class NDLHMBKHService extends ControlService {

    /**
     * 年度量化目标（公司领导类）服务对象
     *
     * @type {ParLdndlhmbService}
     * @memberof NDLHMBKHService
     */
    public appEntityService: ParLdndlhmbService = new ParLdndlhmbService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of NDLHMBKHService.
     * 
     * @param {*} [opts={}]
     * @memberof NDLHMBKHService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.parldndlhmbid = PrimaryKey;
        Data.parldndlhmb = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.parldndlhmbid = PrimaryKey;
