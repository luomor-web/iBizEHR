...
export default class NDLHMBKHBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '年度量化目标（助理总经理级领导 ）标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '年度量化目标（助理总经理级领导 ）标识 值不能为空', trigger: 'blur' },
        ],
    }
