...
import NDLHMBXZModel from './ndlhmbxz-form-model';
 ...
 *
 * @export
 * @class NDLHMBXZService
 */
export default class NDLHMBXZService extends ControlService {

    /**
     * 年度量化目标（公司领导类）服务对象
     *
     * @type {ParLdndlhmbService}
     * @memberof NDLHMBXZService
     */
    ...
    /**
     * Creates an instance of NDLHMBXZService.
     * 
     * @param {*} [opts={}]
     * @memberof NDLHMBXZService
     */
