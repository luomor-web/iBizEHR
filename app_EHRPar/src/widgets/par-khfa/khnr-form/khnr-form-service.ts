...
import KHNRModel from './khnr-form-model';
 ...
 * @class KHNRService
 */
export default class KHNRService extends ControlService {

    /**
     * 考核对象服务对象
     *
     * @type {ParKhfaService}
     * @memberof KHNRService
     */
    public appEntityService: ParKhfaService = new ParKhfaService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of KHNRService.
     * 
     * @param {*} [opts={}]
     * @memberof KHNRService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.parkhfaid = PrimaryKey;
        Data.parkhfa = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.parkhfaid = PrimaryKey;
