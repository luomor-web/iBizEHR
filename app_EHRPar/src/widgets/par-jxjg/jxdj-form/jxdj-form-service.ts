...
import JXDJModel from './jxdj-form-model';
 ...
 * @class JXDJService
 */
export default class JXDJService extends ControlService {

    /**
     * 绩效结果服务对象
     *
     * @type {ParJxjgService}
     * @memberof JXDJService
     */
    public appEntityService: ParJxjgService = new ParJxjgService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of JXDJService.
     * 
     * @param {*} [opts={}]
     * @memberof JXDJService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.parjxjgid = PrimaryKey;
        Data.parjxjg = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.parjxjgid = PrimaryKey;
