 ...
 */
export default class ParJxkhxhzUIServiceBase extends UIService {
     ...
     * @memberof  ParJxkhxhzUIServiceBase
     */
    public dataService:ParJxkhxhzService = new ParJxkhxhzService();
    ...
    /**
     * Creates an instance of  ParJxkhxhzUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ParJxkhxhzUIServiceBase
     */
    ...
    public initViewMap(){
        ...
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'parjxkhxhzs'});
    }
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({parjxkhxhz:srfkey});
