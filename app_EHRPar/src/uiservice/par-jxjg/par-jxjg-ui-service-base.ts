 ...
 *
 * @export
 * @class ParJxjgUIServiceBase
 */
export default class ParJxjgUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  ParJxjgUIServiceBase
     */
     ...
     * @memberof  ParJxjgUIServiceBase
     */
    public dataService:ParJxjgService = new ParJxjgService();
    ...
    /**
     * Creates an instance of  ParJxjgUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ParJxjgUIServiceBase
     */
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'parjxjgs'});
        ...
        this.allViewMap.set('MPICKUPVIEW:',{viewname:'mpickupview',srfappde:'parjxjgs'});
    }
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({parjxjg:srfkey});
