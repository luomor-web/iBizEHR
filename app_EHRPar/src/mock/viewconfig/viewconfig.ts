...
mock.onGet('./assets/json/view-config.json').reply((config: any) => {
    ...
    return [status,{
        ...
        "parldndlhmbmxmpickupview": {
            "title": "年度量化目标明细（助理总经理级领导 ）数据多项选择视图",
        ...
        "parldndlhmbmxpickupview": {
            "title": "年度量化目标明细（助理总经理级领导 ）数据选择视图",
            "caption": "年度量化目标明细（助理总经理级 ）",
            "viewtype": "DEPICKUPVIEW",
            "viewmodule": "PAR",
        ...
        "parldndlhmbkhgridview": {
            "title": "年度量化目标考核（助理总经理级）",
            "caption": "年度量化目标考核（助理总经理级）",
            "viewtype": "DEGRIDVIEW",
            "viewmodule": "PAR",
        ...
        "parldndlhmbmxpickupgridview": {
            "title": "年度量化目标明细（助理总经理级领导 ）选择表格视图",
            "caption": "年度量化目标明细（助理总经理级 ）",
            "viewtype": "DEPICKUPGRIDVIEW",
            "viewmodule": "PAR",
        ...
        "parldndlhmbmpickupview": {
            "title": "年度量化目标（助理总经理级领导 ）数据多项选择视图",
            "caption": "年度量化目标（助理总经理级）",
            "viewtype": "DEMPICKUPVIEW",
            "viewmodule": "PAR",
