<template>
  <app-layout viewName="parldkhqznewgridview" viewTitle="评分权重分配表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldkhqz-new-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParLdkhqzNewGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdkhqzNewGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdkhqzService}
     * @memberof ParLdkhqzNewGridViewBase
     */
	 ...
	 * @memberof ParLdkhqzNewGridViewBase
	 */
	public viewtag: string = '7f59f30064383fc5ee87bcdf3bc42f9b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldkhqz.views.newgridview.caption',
        srfTitle: 'entities.parldkhqz.views.newgridview.title',
        srfSubTitle: 'entities.parldkhqz.views.newgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
...
<style lang='less'>
@import './par-ldkhqz-new-grid-view.less';
</style>