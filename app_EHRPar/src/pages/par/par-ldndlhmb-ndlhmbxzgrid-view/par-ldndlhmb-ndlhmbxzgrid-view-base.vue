<template>
  <app-layout viewName="parldndlhmbndlhmbxzgridview" viewTitle="年度量化目标修正" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmb-ndlhmbxzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="年度量化目标（助理总经理级领导 ）名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParLdndlhmbNDLHMBXZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdndlhmbNDLHMBXZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdndlhmbService}
     * @memberof ParLdndlhmbNDLHMBXZGridViewBase
     */
	 ...
	 * @memberof ParLdndlhmbNDLHMBXZGridViewBase
	 */
	public viewtag: string = '35977acfc0970b347cace0a7d8ccfac5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldndlhmb.views.ndlhmbxzgridview.caption',
        srfTitle: 'entities.parldndlhmb.views.ndlhmbxzgridview.title',
        srfSubTitle: 'entities.parldndlhmb.views.ndlhmbxzgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParLdndlhmbNDLHMBXZGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.parldndlhmb;
        if(args.length >0){
...
<style lang='less'>
@import './par-ldndlhmb-ndlhmbxzgrid-view.less';
</style>