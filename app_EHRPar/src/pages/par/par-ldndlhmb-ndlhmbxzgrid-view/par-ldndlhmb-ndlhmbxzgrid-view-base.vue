<template>
  <app-layout viewName="parldndlhmbndlhmbxzgridview" viewTitle="量化目标修正" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmb-ndlhmbxzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
