<template>
  <app-layout viewName="parjxjgjxpgdjgridview" viewTitle="绩效评估定级" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-jxjg-jxpgdjgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="绩效结果名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParJxjgJXPGDJGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParJxjgJXPGDJGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParJxjgService}
     * @memberof ParJxjgJXPGDJGridViewBase
     */
	 ...
	 * @memberof ParJxjgJXPGDJGridViewBase
	 */
	public viewtag: string = '11beb7ce619d4fa3c5286eba91be6d7a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parjxjg.views.jxpgdjgridview.caption',
        srfTitle: 'entities.parjxjg.views.jxpgdjgridview.title',
        srfSubTitle: 'entities.parjxjg.views.jxpgdjgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParJxjgJXPGDJGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
...
<style lang='less'>
@import './par-jxjg-jxpgdjgrid-view.less';
</style>