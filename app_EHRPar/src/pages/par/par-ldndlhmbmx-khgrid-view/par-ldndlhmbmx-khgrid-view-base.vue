<template>
  <app-layout viewName="parldndlhmbmxkhgridview" viewTitle="量化目标明细考核" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmbmx-khgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParLdndlhmbmxKHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdndlhmbmxKHGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdndlhmbmxService}
     * @memberof ParLdndlhmbmxKHGridViewBase
     */
	 ...
	 * @memberof ParLdndlhmbmxKHGridViewBase
	 */
	public viewtag: string = '6f8eeee8930cde732f5ea274a3ca1dbc';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldndlhmbmx.views.khgridview.caption',
        srfTitle: 'entities.parldndlhmbmx.views.khgridview.title',
        srfSubTitle: 'entities.parldndlhmbmx.views.khgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParLdndlhmbmxKHGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-ldndlhmbmx-khedit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parldndlhmbmx.views.kheditview.title'),
        };
...
<style lang='less'>
@import './par-ldndlhmbmx-khgrid-view.less';
</style>