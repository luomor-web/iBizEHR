<template>
  <app-layout viewName="parldndlhmbmxkhgridview" viewTitle="年度量化目标明细考核" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmbmx-khgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
