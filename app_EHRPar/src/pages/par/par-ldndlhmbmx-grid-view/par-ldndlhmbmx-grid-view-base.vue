<template>
  <app-layout viewName="parldndlhmbmxgridview" viewTitle="量化目标明细（公司领导类 ）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmbmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParLdndlhmbmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdndlhmbmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdndlhmbmxService}
     * @memberof ParLdndlhmbmxGridViewBase
     */
	 ...
	 * @memberof ParLdndlhmbmxGridViewBase
	 */
	public viewtag: string = '6dfdcefce006ad3505558f3babcddcde';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldndlhmbmx.views.gridview.caption',
        srfTitle: 'entities.parldndlhmbmx.views.gridview.title',
        srfSubTitle: 'entities.parldndlhmbmx.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParLdndlhmbmxGridView
     */
...
<style lang='less'>
@import './par-ldndlhmbmx-grid-view.less';
</style>