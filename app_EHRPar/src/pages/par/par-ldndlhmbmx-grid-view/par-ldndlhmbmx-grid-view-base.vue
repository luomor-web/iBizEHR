<template>
  <app-layout viewName="parldndlhmbmxgridview" viewTitle="年度量化目标明细（助理总经理级领导 ）" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmbmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class ParLdndlhmbmxGridViewBase extends GridViewBase {
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.parldndlhmbmx;
        if(args.length >0){
