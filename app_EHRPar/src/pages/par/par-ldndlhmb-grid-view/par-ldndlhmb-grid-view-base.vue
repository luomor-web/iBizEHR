<template>
  <app-layout viewName="parldndlhmbgridview" viewTitle="量化目标填报" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmb-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParLdndlhmbGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdndlhmbGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdndlhmbService}
     * @memberof ParLdndlhmbGridViewBase
     */
	 ...
	 * @memberof ParLdndlhmbGridViewBase
	 */
	public viewtag: string = '99f1bd86d47f8bfefef6803ebda3e437';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldndlhmb.views.gridview.caption',
        srfTitle: 'entities.parldndlhmb.views.gridview.title',
        srfSubTitle: 'entities.parldndlhmb.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-ldndlhmb-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parldndlhmb.views.editview.title'),
        };
...
<style lang='less'>
@import './par-ldndlhmb-grid-view.less';
</style>