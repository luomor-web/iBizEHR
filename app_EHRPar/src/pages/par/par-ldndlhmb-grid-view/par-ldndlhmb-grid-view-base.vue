<template>
  <app-layout viewName="parldndlhmbgridview" viewTitle="年度量化目标（助理总经理级领导 ）表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmb-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
