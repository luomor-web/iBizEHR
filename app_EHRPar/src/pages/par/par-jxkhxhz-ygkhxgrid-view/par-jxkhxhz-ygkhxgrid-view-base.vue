<template>
  <app-layout viewName="parjxkhxhzygkhxgridview" viewTitle="考核方案" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-jxkhxhz-ygkhxgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="绩效考核项得分汇总名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParJxkhxhzYGKHXGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParJxkhxhzYGKHXGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParJxkhxhzService}
     * @memberof ParJxkhxhzYGKHXGridViewBase
     */
	 ...
	 * @memberof ParJxkhxhzYGKHXGridViewBase
	 */
	public viewtag: string = '2c011a5df68fea9e14fd6dd50a31b3da';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parjxkhxhz.views.ygkhxgridview.caption',
        srfTitle: 'entities.parjxkhxhz.views.ygkhxgridview.title',
        srfSubTitle: 'entities.parjxkhxhz.views.ygkhxgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParJxkhxhzYGKHXGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-jxkhxhz-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parjxkhxhz.views.editview.title'),
        };
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { parjxkhxhz: args[0].parjxkhxhz })
            }
...
<style lang='less'>
@import './par-jxkhxhz-ygkhxgrid-view.less';
</style>