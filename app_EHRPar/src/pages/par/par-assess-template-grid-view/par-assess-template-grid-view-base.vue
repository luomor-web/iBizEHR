<template>
  <app-layout viewName="parassesstemplategridview" viewTitle="考核模板表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-assess-template-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考核模板名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParAssessTemplateGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParAssessTemplateGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParAssessTemplateService}
     * @memberof ParAssessTemplateGridViewBase
     */
	 ...
	 * @memberof ParAssessTemplateGridViewBase
	 */
	public viewtag: string = 'e28617a43cd83dbace56537236958b1d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parassesstemplate.views.gridview.caption',
        srfTitle: 'entities.parassesstemplate.views.gridview.title',
        srfSubTitle: 'entities.parassesstemplate.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParAssessTemplateGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParAssessTemplate");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"ParAssessTemplate");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParAssessTemplate");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParAssessTemplate");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.parassesstemplate;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'par-assess-template-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parassesstemplate.views.editview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-assess-template-edit-view9', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parassesstemplate.views.editview9.title'),
        };
        openPopupModal(view, data);
    }
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { parassesstemplate: args[0].parassesstemplate })
            }
...
<style lang='less'>
@import './par-assess-template-grid-view.less';
</style>