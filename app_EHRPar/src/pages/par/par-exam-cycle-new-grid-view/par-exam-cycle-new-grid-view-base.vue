<template>
  <app-layout viewName="parexamcyclenewgridview" viewTitle="考核周期设置" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-exam-cycle-new-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考核周期" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParExamCycleNewGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParExamCycleNewGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParExamCycleService}
     * @memberof ParExamCycleNewGridViewBase
     */
	 ...
	 * @memberof ParExamCycleNewGridViewBase
	 */
	public viewtag: string = 'e184f5db6e3acb31c15469de5437cf75';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parexamcycle.views.newgridview.caption',
        srfTitle: 'entities.parexamcycle.views.newgridview.title',
        srfSubTitle: 'entities.parexamcycle.views.newgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParExamCycleNewGridView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.parexamcycle;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'par-exam-cycle-edit-view', 
            height: 650, 
            width: 850,  
            title: this.$t('entities.parexamcycle.views.editview.title'),
        };
...
<style lang='less'>
@import './par-exam-cycle-new-grid-view.less';
</style>