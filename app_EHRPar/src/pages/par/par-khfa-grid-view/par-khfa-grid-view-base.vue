<template>
  <app-layout viewName="parkhfagridview" viewTitle="考核对象" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-khfa-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考核对象" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParKhfaGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParKhfaGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParKhfaService}
     * @memberof ParKhfaGridViewBase
     */
	 ...
	 * @memberof ParKhfaGridViewBase
	 */
	public viewtag: string = '2698c6c20aa3e029be5d7b71d05d529d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parkhfa.views.gridview.caption',
        srfTitle: 'entities.parkhfa.views.gridview.title',
        srfSubTitle: 'entities.parkhfa.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-khfa-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parkhfa.views.editview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-khfa-edit-view9', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parkhfa.views.editview9.title'),
        };
        openPopupModal(view, data);
    }
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { parkhfa: args[0].parkhfa })
            }
...
<style lang='less'>
@import './par-khfa-grid-view.less';
</style>