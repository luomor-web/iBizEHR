<template>
  <app-layout viewName="parldndlhmbkheditview" viewTitle="年度量化目标考核（助理总经理级）" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-ldndlhmb-khedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
