<template>
  <app-layout viewName="partzgggridview" viewTitle="通知发布" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-tzgg-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="标题" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParTzggGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParTzggGridViewBase extends GridViewBase {
	 ...
	 * @memberof ParTzggGridViewBase
	 */
	public viewtag: string = '4cb79515b9133499fc74b275a26e2da5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.partzgg.views.gridview.caption',
        srfTitle: 'entities.partzgg.views.gridview.title',
        srfSubTitle: 'entities.partzgg.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParTzgg");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ParTzgg");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-tzgg-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.partzgg.views.editview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-tzgg-edit-view9', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.partzgg.views.editview9.title'),
        };
        openPopupModal(view, data);
    }
...
<style lang='less'>
@import './par-tzgg-grid-view.less';
</style>