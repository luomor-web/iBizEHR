<template>
  <app-layout viewName="parexamcyclegridview" viewTitle="考核周期" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-exam-cycle-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParExamCycleGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParExamCycleGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParExamCycleService}
     * @memberof ParExamCycleGridViewBase
     */
	 ...
	 * @memberof ParExamCycleGridViewBase
	 */
	public viewtag: string = '25a6fb2dc9f85ee002bcbeca2f1a8205';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parexamcycle.views.gridview.caption',
        srfTitle: 'entities.parexamcycle.views.gridview.title',
        srfSubTitle: 'entities.parexamcycle.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.parexamcycle;
        if(args.length >0){
...
<style lang='less'>
@import './par-exam-cycle-grid-view.less';
</style>