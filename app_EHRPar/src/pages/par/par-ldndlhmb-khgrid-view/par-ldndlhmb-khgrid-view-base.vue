<template>
  <app-layout viewName="parldndlhmbkhgridview" viewTitle="年度量化目标考核（助理总经理级）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmb-khgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
