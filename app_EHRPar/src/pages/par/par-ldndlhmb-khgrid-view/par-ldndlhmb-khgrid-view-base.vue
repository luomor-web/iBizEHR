<template>
  <app-layout viewName="parldndlhmbkhgridview" viewTitle="年度量化目标考核（公司领导类）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmb-khgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="年度量化目标名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParLdndlhmbKHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdndlhmbKHGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdndlhmbService}
     * @memberof ParLdndlhmbKHGridViewBase
     */
	 ...
	 * @memberof ParLdndlhmbKHGridViewBase
	 */
	public viewtag: string = '51460be10bc6dc74ec79e53ae545e1c7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldndlhmb.views.khgridview.caption',
        srfTitle: 'entities.parldndlhmb.views.khgridview.title',
        srfSubTitle: 'entities.parldndlhmb.views.khgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParLdndlhmbKHGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmb");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmb");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmb");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmb");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmb");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmb");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.parldndlhmb;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'par-ldndlhmb-khedit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parldndlhmb.views.kheditview.title'),
        };
...
<style lang='less'>
@import './par-ldndlhmb-khgrid-view.less';
</style>