<template>
  <app-layout viewName="parjxjggridview" viewTitle="绩效结果表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-jxjg-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParJxjgGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParJxjgGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParJxjgService}
     * @memberof ParJxjgGridViewBase
     */
	 ...
	 * @memberof ParJxjgGridViewBase
	 */
	public viewtag: string = 'b8adaeafac9a1acdbd8f4aef296c22ee';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parjxjg.views.gridview.caption',
        srfTitle: 'entities.parjxjg.views.gridview.title',
        srfSubTitle: 'entities.parjxjg.views.gridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './par-jxjg-grid-view.less';
</style>