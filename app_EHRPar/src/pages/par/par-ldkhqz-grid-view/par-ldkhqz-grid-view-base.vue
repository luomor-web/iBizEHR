<template>
  <app-layout viewName="parldkhqzgridview" viewTitle="评分权重分配表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldkhqz-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="评分规则" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParLdkhqzGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdkhqzGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdkhqzService}
     * @memberof ParLdkhqzGridViewBase
     */
	 ...
	 * @memberof ParLdkhqzGridViewBase
	 */
	public viewtag: string = '11e69b35ff04251d7f8e7295a1d63f06';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldkhqz.views.gridview.caption',
        srfTitle: 'entities.parldkhqz.views.gridview.title',
        srfSubTitle: 'entities.parldkhqz.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'par-ldkhqz-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parldkhqz.views.editview.title'),
        };
...
<style lang='less'>
@import './par-ldkhqz-grid-view.less';
</style>