<template>
  <app-layout viewName="parldndlhmbmxkheditview" viewTitle="年度量化目标明细考核" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-ldndlhmbmx-khedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
