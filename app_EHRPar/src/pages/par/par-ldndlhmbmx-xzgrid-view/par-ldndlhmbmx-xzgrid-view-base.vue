<template>
  <app-layout viewName="parldndlhmbmxxzgridview" viewTitle="量化目标明细修正" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'par-ldndlhmbmx-xzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="量化目标" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class ParLdndlhmbmxXZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdndlhmbmxXZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdndlhmbmxService}
     * @memberof ParLdndlhmbmxXZGridViewBase
     */
	 ...
	 * @memberof ParLdndlhmbmxXZGridViewBase
	 */
	public viewtag: string = '71d989522622828ecb9109e34f8d7af5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldndlhmbmx.views.xzgridview.caption',
        srfTitle: 'entities.parldndlhmbmx.views.xzgridview.title',
        srfSubTitle: 'entities.parldndlhmbmx.views.xzgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParLdndlhmbmxXZGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmbmx");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmbmx");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmbmx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmbmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmbmx");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"ParLdndlhmbmx");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.parldndlhmbmx;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'par-ldndlhmbmx-edit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.parldndlhmbmx.views.editview.title'),
        };
...
<style lang='less'>
@import './par-ldndlhmbmx-xzgrid-view.less';
</style>