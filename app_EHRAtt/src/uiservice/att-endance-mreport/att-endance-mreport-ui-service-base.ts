 ...
 *
 * @export
 * @class AttEndanceMreportUIServiceBase
 */
export default class AttEndanceMreportUIServiceBase extends UIService {
     ...
     * @memberof  AttEndanceMreportUIServiceBase
     */
    public dataService:AttEndanceMreportService = new AttEndanceMreportService();
    ...
    /**
     * Creates an instance of  AttEndanceMreportUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AttEndanceMreportUIServiceBase
     */
     ...
     * @returns {Promise<any>}
     */
    public async AttEndanceMreport_QR(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '确认后将不允许更改考勤月报，是否确认？',
              onOk: () => {resolve(true);},
        ...
        const backend = () => {
            ...
            curService.QR(context,data, true).then((response: any) => {
                ...
                actionContext.$Notice.success({ title: '成功', desc: '确认月报成功！' });
     ...
     * @returns {Promise<any>}
     */
    public async AttEndanceMreport_ExportKQYB(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let data: any = {};
        let parentContext:any = {};
        let parentViewParam:any = {};
        const _this: any = actionContext;
        ...
        const backend = () => {
            const curService:AttEndanceMreportService =  new AttEndanceMreportService();
            curService.ExportKQYB(context,data, true).then((response: any) => {
                if (!response || response.status !== 200) {
                    actionContext.$Notice.error({ title: '错误', desc: response.message });
                    return;
                }
                actionContext.$Notice.success({ title: '成功', desc: '导出月报成功！' });
     ...
     * @returns {Promise<any>}
     */
    public async AttEndanceMreport_SCKQYB(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let data: any = {};
        let parentContext:any = {};
        let parentViewParam:any = {};
        const _this: any = actionContext;
        ...
        const backend = () => {
            const curService:AttEndanceMreportService =  new AttEndanceMreportService();
            curService.SCKQYB(context,data, true).then((response: any) => {
                if (!response || response.status !== 200) {
                    actionContext.$Notice.error({ title: '错误', desc: response.message });
                    return;
                }
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({attendancemreport:srfkey});
