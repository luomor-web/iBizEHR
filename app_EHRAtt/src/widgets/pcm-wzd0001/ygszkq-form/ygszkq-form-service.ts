...
import YGSZKQModel from './ygszkq-form-model';
 ...
 * @class YGSZKQService
 */
export default class YGSZKQService extends ControlService {

    /**
     * 向导实体1服务对象
     *
     * @type {PcmWzd0001Service}
     * @memberof YGSZKQService
     */
    public appEntityService: PcmWzd0001Service = new PcmWzd0001Service({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of YGSZKQService.
     * 
     * @param {*} [opts={}]
     * @memberof YGSZKQService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.wzd0001id = PrimaryKey;
        Data.pcmwzd0001 = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.wzd0001id = PrimaryKey;
