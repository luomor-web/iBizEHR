...
import RYInfoSearchFormModel from './ryinfo-search-form-searchform-model';


/**
 * RYInfoSearchForm 部件服务对象
 *
 * @export
 * @class RYInfoSearchFormService
 */
export default class RYInfoSearchFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof RYInfoSearchFormService
     */
    ...
    /**
     * Creates an instance of RYInfoSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof RYInfoSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYInfoSearchFormModel();
    }
