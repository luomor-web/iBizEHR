...
import JJRTXSBModel from './jjrtxsb-form-model';
 ...
 *
 * @export
 * @class JJRTXSBService
 */
export default class JJRTXSBService extends ControlService {

    /**
     * 考勤规则服务对象
     *
     * @type {VacHolidayRulesService}
     * @memberof JJRTXSBService
     */
    ...
    /**
     * Creates an instance of JJRTXSBService.
     * 
     * @param {*} [opts={}]
     * @memberof JJRTXSBService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.vacholidayrulesid = PrimaryKey;
        Data.vacholidayrules = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.vacholidayrulesid = PrimaryKey;
