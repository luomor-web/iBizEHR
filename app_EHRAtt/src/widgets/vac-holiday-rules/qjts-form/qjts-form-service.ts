...
import QJTSModel from './qjts-form-model';
 ...
 * @class QJTSService
 */
export default class QJTSService extends ControlService {

    /**
     * 考勤规则服务对象
     *
     * @type {VacHolidayRulesService}
     * @memberof QJTSService
     */
    ...
    /**
     * Creates an instance of QJTSService.
     * 
     * @param {*} [opts={}]
     * @memberof QJTSService
     */
