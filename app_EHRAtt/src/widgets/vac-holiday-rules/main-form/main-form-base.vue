<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='vacholidayrules_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.vacholidayrules.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.vacholidayrules.main_form.details.grouppanel2')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.vacholidayrulesname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='vacholidayrulesname' :itemRules="this.rules.vacholidayrulesname" class='' :caption="$t('entities.vacholidayrules.main_form.details.vacholidayrulesname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.vacholidayrulesname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.vacholidayrulesname"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.vacholidayrulesname.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.sbsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='sbsj' :itemRules="this.rules.sbsj" class='' :caption="$t('entities.vacholidayrules.main_form.details.sbsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.sbsj.error" :isEmptyCaption="false" labelPos="LEFT">
     <time-picker :value="data.sbsj" :transfer="true" :disabled="detailsModel.sbsj.disabled" format="HH:mm" placeholder="请选择时间..." style="min-width: 150px; width:70px;width:100%;"  @on-change="(val) => {this.data.sbsj = val}"></time-picker>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.xbsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='xbsj' :itemRules="this.rules.xbsj" class='' :caption="$t('entities.vacholidayrules.main_form.details.xbsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.xbsj.error" :isEmptyCaption="false" labelPos="LEFT">
     <time-picker :value="data.xbsj" :transfer="true" :disabled="detailsModel.xbsj.disabled" format="HH:mm" placeholder="请选择时间..." style="min-width: 150px; width:70px;width:100%;"  @on-change="(val) => {this.data.xbsj = val}"></time-picker>
</app-form-item>
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    paramItem='vacholidayrules' 
    :parentdata='{"srfparentdefname":"VACHOLIDAYRULESID","srfparentdename":"VACHOLIDAYRULES","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_VACHOLIDAY_VACHOLIDAYRULES_VACHOLIDAYRULESID","SRFDER1NID":"DER1N_VACHOLIDAY_VACHOLIDAYRULES_VACHOLIDAYRULESID"}'
    :parameters="[
    ...
    viewname='vac-holiday-jjrtxsbgrid-view' 
...
<i-col v-show="detailsModel.grouppanel3.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    :isForbidLoad="this.data.srfuf === '0'"
    paramItem='vacholidayrules' 
    :parentdata='{"srfparentdefname":"VACHOLIDAYRULESID","srfparentdename":"VACHOLIDAYRULES","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_VACLEAVETIPS_VACHOLIDAYRULES_VACHOLIDAYRULESID","SRFDER1NID":"DER1N_VACLEAVETIPS_VACHOLIDAYRULES_VACHOLIDAYRULESID"}'
    :parameters="[
        { pathName: 'vacholidayrules', parameterName: 'vacholidayrules' },
    ]"
    :context="context"
    ...
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='vac-leave-tips-qjtsgrid-view' 
    :data="JSON.stringify(this.data)" 
    @drdatasaved="drdatasaved($event)"
    style=";overflow: auto;">
</app-form-druipart>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        vacholidayrulesname: [
            { type: 'string', message: '考勤规则名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考勤规则名称 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '考勤规则名称 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '考勤规则名称 值不能为空', trigger: 'blur' },
        ],
        sbsj: [
            { type: 'string', message: '上班时间 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '上班时间 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '上班时间 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '上班时间 值不能为空', trigger: 'blur' },
        ],
        xbsj: [
            { type: 'string', message: '下班时间 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '下班时间 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '下班时间 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '下班时间 值不能为空', trigger: 'blur' },
        ],
        sfqy: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.vacholidayrules.main_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.vacholidayrules.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        grouppanel3: new FormGroupPanelModel({ caption: '温馨提示', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.vacholidayrules.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '考勤规则标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '考勤规则名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        vacholidayrulesname: new FormItemModel({ caption: '考勤规则名称', detailType: 'FORMITEM', name: 'vacholidayrulesname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.vacholidayrules){
            Object.assign(this.context,{vacholidayrules:data.vacholidayrules})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.vacholidayrules = copyData.srfkey;
        copyData.vacholidayrulesid = copyData.srfkey;
        Object.assign(this.context,{vacholidayrules:copyData.vacholidayrules})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'vacholidayrules_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'VacHolidayRulesEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'VacHolidayRulesEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'VacHolidayRulesEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'VacHolidayRulesEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.vacholidayrules || Object.is(arg.vacholidayrules, '')) {
            return;
        }
