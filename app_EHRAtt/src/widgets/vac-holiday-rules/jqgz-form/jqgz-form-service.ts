...
import JQGZModel from './jqgz-form-model';
 ...
 * @class JQGZService
 */
export default class JQGZService extends ControlService {

    /**
     * 考勤规则服务对象
     *
     * @type {VacHolidayRulesService}
     * @memberof JQGZService
     */
    ...
    /**
     * Creates an instance of JQGZService.
     * 
     * @param {*} [opts={}]
     * @memberof JQGZService
     */
