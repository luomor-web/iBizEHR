...
export default class ORMORGBMTreeService extends ControlService {
     ...
     */
    public appEntityService: AttEnsummaryService = new AttEnsummaryService({ $store: this.getStore() });
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.attensummary.ormorgbmtree_treeview.nodes.root' });
