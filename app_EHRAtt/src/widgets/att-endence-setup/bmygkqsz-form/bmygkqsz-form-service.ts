...
import BMYGKQSZModel from './bmygkqsz-form-model';
 ...
 *
 * @export
 * @class BMYGKQSZService
 */
export default class BMYGKQSZService extends ControlService {

    /**
     * 考勤设置服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof BMYGKQSZService
     */
    ...
    /**
     * Creates an instance of BMYGKQSZService.
     * 
     * @param {*} [opts={}]
     * @memberof BMYGKQSZService
     */
