<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard03'  id='attendencesetup_bmygkqsz' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.attendencesetup.bmygkqsz_form.details.grouppanel1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import BMYGKQSZService from './bmygkqsz-form-service';
...
export default class BMYGKQSZBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {BMYGKQSZService}
     * @memberof BMYGKQSZ
     */
    public service: BMYGKQSZService = new BMYGKQSZService({ $store: this.$store });
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '考勤人员', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.attendencesetup.bmygkqsz_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'attendencesetup_bmygkqsz',popTitle:'考勤人员'});
    }
