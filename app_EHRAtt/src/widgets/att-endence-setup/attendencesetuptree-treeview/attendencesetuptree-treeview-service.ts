...
import ATTENDENCESETUPTreeModel from './attendencesetuptree-treeview-model';
...
/**
 * ATTENDENCESETUPTree 部件服务对象
 *
 * @export
 * @class ATTENDENCESETUPTreeService
 */
export default class ATTENDENCESETUPTreeService extends ControlService {

    /**
     * 考勤设置服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof ATTENDENCESETUPTreeService
     */
    ...
    /**
     * Creates an instance of ATTENDENCESETUPTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof ATTENDENCESETUPTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ATTENDENCESETUPTreeModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.attendencesetup.attendencesetuptree_treeview.nodes.root' });
