...
import ATTENDENCESETUPTreeService from './attendencesetuptree-treeview-service';
...
export default class ATTENDENCESETUPTreeBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof ATTENDENCESETUPTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ATTENDENCESETUPTreeService}
     * @memberof ATTENDENCESETUPTreeBase
     */
    public service: ATTENDENCESETUPTreeService = new ATTENDENCESETUPTreeService({ $store: this.$store });
...
<style lang='less'>
@import './attendencesetuptree-treeview.less';
</style>