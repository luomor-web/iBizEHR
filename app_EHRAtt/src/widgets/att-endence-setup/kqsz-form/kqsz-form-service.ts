...
import KQSZModel from './kqsz-form-model';
 ...
 * @class KQSZService
 */
export default class KQSZService extends ControlService {

    /**
     * 考勤设置服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof KQSZService
     */
    ...
    /**
     * Creates an instance of KQSZService.
     * 
     * @param {*} [opts={}]
     * @memberof KQSZService
     */
     ...
     * @memberof KQSZService
     */
    public vacholidayrulesService: VacHolidayRulesService = new VacHolidayRulesService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'VacHolidayRulesService') && Object.is(interfaceName, 'FetchCurOrmorg')) {
            return this.doItems(this.vacholidayrulesService.FetchCurOrmorg(JSON.parse(JSON.stringify(context)),data, isloading), 'vacholidayrulesid', 'vacholidayrules');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.attendencesetupid = PrimaryKey;
        Data.attendencesetup = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.attendencesetupid = PrimaryKey;
