<template>
    <i-form :model="this.data" class='app-form' ref='wizardpanel_form_wizard02'  id='attendencesetup_kqbm' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.attendencesetup.kqbm_form.details.grouppanel1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
import KQBMService from './kqbm-form-service';
...
export default class KQBMBase extends Vue implements ControlInterface {
     ...
     * @memberof KQBM
     */
    public service: KQBMService = new KQBMService({ $store: this.$store });
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '考勤部门', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.attendencesetup.kqbm_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'attendencesetup_kqbm',popTitle:'考勤部门'});
    }
