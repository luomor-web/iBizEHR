...
import KQBMModel from './kqbm-form-model';
 ...
 * @class KQBMService
 */
export default class KQBMService extends ControlService {

    /**
     * 考勤设置服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof KQBMService
     */
    ...
    /**
     * Creates an instance of KQBMService.
     * 
     * @param {*} [opts={}]
     * @memberof KQBMService
     */
