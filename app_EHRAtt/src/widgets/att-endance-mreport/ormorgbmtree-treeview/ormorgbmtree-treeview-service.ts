...
import ORMORGBMTreeModel from './ormorgbmtree-treeview-model';
 ...
 *
 * @export
 * @class ORMORGBMTreeService
 */
export default class ORMORGBMTreeService extends ControlService {

    /**
     * 考勤月报服务对象
     *
     * @type {AttEndanceMreportService}
     * @memberof ORMORGBMTreeService
     */
    public appEntityService: AttEndanceMreportService = new AttEndanceMreportService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ORMORGBMTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof ORMORGBMTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ORMORGBMTreeModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.attendancemreport.ormorgbmtree_treeview.nodes.root' });
