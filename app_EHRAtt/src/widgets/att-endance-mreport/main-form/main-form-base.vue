<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='attendancemreport_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.attendancemreport.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.attendancemreport.main_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.attendancemreport.main_form.details.grouppanel1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
    ...
    viewname='att-endance-mreportmx-grid-view' 
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public data: any = {
        ...
        pimpersonname: null,
        zt: null,
        attendancemreportid: null,
        attendancemreport:null,
    };
    ...
    public rules: any = {
        ...
        srfmajortext: [
            { type: 'string', message: '考勤月报名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考勤月报名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '考勤月报名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '考勤月报名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        yf: [
            ...
            { required: true, type: 'string', message: '月份 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '月份 值不能为空', trigger: 'blur' },
        ],
        attendencesetupid: [
        ...
        attendencesetupname: [
            { type: 'string', message: '考勤表 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考勤表 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '考勤表 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '考勤表 值不能为空', trigger: 'blur' },
        ],
        pimpersonname: [
            { type: 'string', message: '考勤员 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考勤员 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '考勤员 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '考勤员 值不能为空', trigger: 'blur' },
        ],
        zt: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '考勤月报信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.attendancemreport.main_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '考勤月报明细（人员）', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.attendancemreport.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '考勤月报标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '考勤月报名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        yf: new FormItemModel({ caption: '月份', detailType: 'FORMITEM', name: 'yf', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        attendencesetupname: new FormItemModel({ caption: '考勤表', detailType: 'FORMITEM', name: 'attendencesetupname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        pimpersonname: new FormItemModel({ caption: '考勤员', detailType: 'FORMITEM', name: 'pimpersonname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
        attendancemreportid: new FormItemModel({ caption: '考勤月报标识', detailType: 'FORMITEM', name: 'attendancemreportid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    /**
     * 监控表单属性 attendancemreportid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.attendancemreportid')
    onAttendancemreportidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'attendancemreportid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if (Object.is(name, '') || Object.is(name, 'ormorgname')) {
            let ret = false;
            const _ormorgname = this.data.ormorgname;
            if (this.$verify.testCond(_ormorgname, 'ISNULL', '')) {
                ret = true;
            }
            this.detailsModel.ormorgname.setDisabled(!ret);
        }

        if (Object.is(name, '') || Object.is(name, 'zt')) {
            let ret = false;
            const _zt = this.data.zt;
            if (this.$verify.testCond(_zt, 'EQ', '5')) {
                ret = true;
            }
            this.detailsModel.nd.setDisabled(!ret);
        }
        ...
        if (Object.is(name, '') || Object.is(name, 'zt')) {
            ...
            this.detailsModel.yf.setDisabled(!ret);
        }
        ...
        if (Object.is(name, '') || Object.is(name, 'zt')) {
            ...
            this.detailsModel.attendencesetupname.setDisabled(!ret);
        }
        ...
        if(Object.is(name, 'attendencesetupname')){
            const details: string[] = ['pimpersonname'];
            this.updateFormItems('GetAttendencemanOfKQSZ', this.data, details, true);
        }
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.attendancemreport){
            Object.assign(this.context,{attendancemreport:data.attendancemreport})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.attendancemreport = copyData.srfkey;
        copyData.attendancemreportid = copyData.srfkey;
        Object.assign(this.context,{attendancemreport:copyData.attendancemreport})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'attendancemreport_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'AttEndanceMreportEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'AttEndanceMreportEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'AttEndanceMreportEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'AttEndanceMreportEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.attendancemreport || Object.is(arg.attendancemreport, '')) {
            return;
        }
    ...
    */
    ...
    public createDefault(){                    
        if (this.data.hasOwnProperty('zt')) {
            this.data['zt'] = '5';
        }
    }
