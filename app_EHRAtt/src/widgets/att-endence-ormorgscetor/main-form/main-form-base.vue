<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='attendenceormorgscetor_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.attendenceormorgscetor.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.attendencesetupname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='attendencesetupname' :itemRules="this.rules.attendencesetupname" class='' :caption="$t('entities.attendenceormorgscetor.main_form.details.attendencesetupname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.attendencesetupname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.orgname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='orgname' :itemRules="this.rules.orgname" class='' :caption="$t('entities.attendenceormorgscetor.main_form.details.orgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.orgname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgsectorname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormorgsectorname' :itemRules="this.rules.ormorgsectorname" class='' :caption="$t('entities.attendenceormorgscetor.main_form.details.ormorgsectorname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgsectorname.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public data: any = {
        ...
        attendenceormorgsectorid: null,
        attendenceormorgscetor:null,
    };
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '考勤部门标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考勤部门标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '考勤部门标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '考勤部门标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '考勤部门名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '考勤部门名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '考勤部门名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '考勤部门名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '考勤部门基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.attendenceormorgscetor.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '考勤部门标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '考勤部门名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        attendencesetupname: new FormItemModel({ caption: '考勤表名称', detailType: 'FORMITEM', name: 'attendencesetupname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
        ormorgsectorname: new FormItemModel({ caption: '部门名称', detailType: 'FORMITEM', name: 'ormorgsectorname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
        attendenceormorgsectorid: new FormItemModel({ caption: '考勤部门标识', detailType: 'FORMITEM', name: 'attendenceormorgsectorid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    /**
     * 监控表单属性 attendenceormorgsectorid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.attendenceormorgsectorid')
    onAttendenceormorgsectoridChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'attendenceormorgsectorid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.attendenceormorgscetor){
            Object.assign(this.context,{attendenceormorgscetor:data.attendenceormorgscetor})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.attendenceormorgscetor = copyData.srfkey;
        copyData.attendenceormorgsectorid = copyData.srfkey;
        Object.assign(this.context,{attendenceormorgscetor:copyData.attendenceormorgscetor})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'attendenceormorgscetor_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'AttEndenceOrmorgscetorEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'AttEndenceOrmorgscetorEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'AttEndenceOrmorgscetorEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'AttEndenceOrmorgscetorEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.attendenceormorgscetor || Object.is(arg.attendenceormorgscetor, '')) {
            return;
        }
