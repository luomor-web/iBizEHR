<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='vacleavemanage_ytg' style="">
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    viewname='vac-leave-detail-sjqjmx-ck-grid-view' 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'vacleavemanage_ytg',popTitle:'已通过'});
    }
