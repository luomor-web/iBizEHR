<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='vacleavemanage_spz' style="">
...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
  ...
  editortype="" 
  :pickupView="{ viewname: 'pim-person-kqjrypickup-view', title: $t('entities.pimperson.views.kqjrypickupview.title'), deResParameters: [], parameters: [{ pathName: 'pimpeople', parameterName: 'pimperson' }, { pathName: 'kqjrypickupview', parameterName: 'kqjrypickupview' } ], placement:'' }"
  style=""  
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    viewname='vac-leave-detail-jhqjmx-ck-grid-view' 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'vacleavemanage_spz',popTitle:'审批中'});
    }
