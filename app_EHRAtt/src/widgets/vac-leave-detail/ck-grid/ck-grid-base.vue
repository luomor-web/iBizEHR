        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.vacleavedetail.ck_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.pimpersonname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('qjzl')">
                <el-table-column show-overflow-tooltip :prop="'qjzl'" :label="$t('entities.vacleavedetail.ck_grid.columns.qjzl')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.qjzl')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jhqjks')">
                <el-table-column show-overflow-tooltip :prop="'jhqjks'" :label="$t('entities.vacleavedetail.ck_grid.columns.jhqjks')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.jhqjks')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jhqjjs')">
                <el-table-column show-overflow-tooltip :prop="'jhqjjs'" :label="$t('entities.vacleavedetail.ck_grid.columns.jhqjjs')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.jhqjjs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jhts')">
                <el-table-column show-overflow-tooltip :prop="'jhts'" :label="$t('entities.vacleavedetail.ck_grid.columns.jhts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.jhts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('bz')">
                <el-table-column show-overflow-tooltip :prop="'bz'" :label="$t('entities.vacleavedetail.ck_grid.columns.bz')" :min-width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.bz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bz}}</span>
            ...
            <template v-if="getColumnState('sjqjks')">
                <el-table-column show-overflow-tooltip :prop="'sjqjks'" :label="$t('entities.vacleavedetail.ck_grid.columns.sjqjks')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.sjqjks')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sjqjjs')">
                <el-table-column show-overflow-tooltip :prop="'sjqjjs'" :label="$t('entities.vacleavedetail.ck_grid.columns.sjqjjs')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.sjqjjs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sjts')">
                <el-table-column show-overflow-tooltip :prop="'sjts'" :label="$t('entities.vacleavedetail.ck_grid.columns.sjts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.ck_grid.columns.sjts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class CKBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pimpersonname',
            label: '请假人员',
            langtag: 'entities.vacleavedetail.ck_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'qjzl',
            label: '请假种类',
            langtag: 'entities.vacleavedetail.ck_grid.columns.qjzl',
            show: true,
            util: 'PX'
        },
        {
            name: 'jhqjks',
            label: '计划请假开始',
            langtag: 'entities.vacleavedetail.ck_grid.columns.jhqjks',
            show: true,
            util: 'PX'
        },
        {
            name: 'jhqjjs',
            label: '计划请假结束',
            langtag: 'entities.vacleavedetail.ck_grid.columns.jhqjjs',
            show: true,
            util: 'PX'
        },
        {
            name: 'jhts',
            label: '计划天数',
            langtag: 'entities.vacleavedetail.ck_grid.columns.jhts',
            show: true,
            util: 'PX'
        },
        {
            name: 'bz',
            label: '备注',
            langtag: 'entities.vacleavedetail.ck_grid.columns.bz',
            show: true,
            util: 'STAR'
        },
        {
            name: 'sjqjks',
            label: '实际请假开始',
            langtag: 'entities.vacleavedetail.ck_grid.columns.sjqjks',
            show: true,
            util: 'PX'
        },
        {
            name: 'sjqjjs',
            label: '实际请假结束',
            langtag: 'entities.vacleavedetail.ck_grid.columns.sjqjjs',
            show: true,
            util: 'PX'
        },
        {
            name: 'sjts',
            label: '实际天数',
            langtag: 'entities.vacleavedetail.ck_grid.columns.sjts',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'VacLeaveDetailJHQJMX_CK_GridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'VacLeaveDetailJHQJMX_CK_GridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('vacleavedetail_ck_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('vacleavedetail_ck_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'VacLeaveDetailJHQJMX_CK_GridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'VacLeaveDetailJHQJMX_CK_GridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
