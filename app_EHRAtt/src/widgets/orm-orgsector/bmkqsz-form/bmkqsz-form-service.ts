...
import BMKQSZModel from './bmkqsz-form-model';
 ...
 * @class BMKQSZService
 */
export default class BMKQSZService extends ControlService {

    /**
     * 部门管理服务对象
     *
     * @type {OrmOrgsectorService}
     * @memberof BMKQSZService
     */
    ...
    /**
     * Creates an instance of BMKQSZService.
     * 
     * @param {*} [opts={}]
     * @memberof BMKQSZService
     */
