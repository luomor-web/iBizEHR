<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='ormorgsector_bmkqsz' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.ormorgsector.bmkqsz_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.zzdzs.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zzdzs' :itemRules="this.rules.zzdzs" class='' :caption="$t('entities.ormorgsector.bmkqsz_form.details.zzdzs')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zzdzs.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.zzdzs"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.zzdzs.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.orgsectorname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='orgsectorname' :itemRules="this.rules.orgsectorname" class='' :caption="$t('entities.ormorgsector.bmkqsz_form.details.orgsectorname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.orgsectorname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.ormorgsector.bmkqsz_form.details.grouppanel1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
    ...
    viewname='orm-bmkqdz-bmkqdzgrid-view' 
...
export default class BMKQSZBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        orgsectorname: [
            ...
            { required: true, type: 'string', message: '部门/项目部 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '部门/项目部 值不能为空', trigger: 'blur' },
        ],
        orgsectorid: [
            { type: 'string', message: '部门标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '部门标识 值必须为字符串类型', trigger: 'blur' },
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '部门考勤地址', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.ormorgsector.bmkqsz_form', extractMode: 'ITEM', details: [] } })
, 
        formpage1: new FormPageModel({ caption: '部门考勤设置', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this })
, 
...
, 
        zzdzs: new FormItemModel({ caption: '组织', detailType: 'FORMITEM', name: 'zzdzs', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
        orgsectorname: new FormItemModel({ caption: '部门/项目部', detailType: 'FORMITEM', name: 'orgsectorname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
    ...
    onZzdzsChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'zzdzs', newVal: newVal, oldVal: oldVal });
    }
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'ormorgsector_bmkqsz',popTitle:'部门考勤设置'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'OrmOrgsectorBMKQSZEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'OrmOrgsectorBMKQSZEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'OrmOrgsectorBMKQSZEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'OrmOrgsectorBMKQSZEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    */
    ...
    public createDefault(){                    
        if (this.data.hasOwnProperty('orgsectorname')) {
            this.data['orgsectorname'] = this.viewparams['srfparentkey'];
        }
    }
