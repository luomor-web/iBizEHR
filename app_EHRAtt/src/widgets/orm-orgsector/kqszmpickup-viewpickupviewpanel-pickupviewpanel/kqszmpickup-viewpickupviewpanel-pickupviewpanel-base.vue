...
import KQSZMPickupViewpickupviewpanelService from './kqszmpickup-viewpickupviewpanel-pickupviewpanel-service';

import KQSZMPickupViewpickupviewpanelModel from './kqszmpickup-viewpickupviewpanel-pickupviewpanel-model';
...
export default class KQSZMPickupViewpickupviewpanelBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof KQSZMPickupViewpickupviewpanel
     */
     ...
     * 建构部件服务对象
     *
     * @type {KQSZMPickupViewpickupviewpanelService}
     * @memberof KQSZMPickupViewpickupviewpanel
     */
    public service: KQSZMPickupViewpickupviewpanelService = new KQSZMPickupViewpickupviewpanelService({ $store: this.$store });
     ...
     */
    protected view: any = {
        viewname: 'orm-orgsector-cur-zzbm-kqszpickup-grid-view',
        data: {},
    }
...
<style lang='less'>
@import './kqszmpickup-viewpickupviewpanel-pickupviewpanel.less';
</style>