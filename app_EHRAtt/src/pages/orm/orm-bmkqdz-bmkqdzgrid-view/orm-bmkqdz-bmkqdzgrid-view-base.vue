<template>
  <app-layout viewName="ormbmkqdzbmkqdzgridview" viewTitle="考勤地址信息" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'orm-bmkqdz-bmkqdzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class OrmBmkqdzBMKQDZGridViewBase extends GridViewBase {
	 ...
	 * @memberof OrmBmkqdzBMKQDZGridViewBase
	 */
	public viewtag: string = 'bf16301c592e499ae98c922b6a4b54bd';
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"OrmBmkqdz");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"OrmBmkqdz");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'orm-bmkqdz-bmkqdzedit-view', 
            height: 0, 
            width: 0,  
...
<style lang='less'>
@import './orm-bmkqdz-bmkqdzgrid-view.less';
</style>