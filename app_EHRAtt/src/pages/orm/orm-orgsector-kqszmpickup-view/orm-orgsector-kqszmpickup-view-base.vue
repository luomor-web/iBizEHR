<template>
  <app-layout viewName="ormorgsectorkqszmpickupview" viewTitle="部门管理数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'orm-orgsector-kqszmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class OrmOrgsectorKQSZMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class OrmOrgsectorKQSZMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmOrgsectorService}
     * @memberof OrmOrgsectorKQSZMPickupViewBase
     */
	 ...
	 * @memberof OrmOrgsectorKQSZMPickupViewBase
	 */
	public viewtag: string = 'efb6d23ba2d645798922bd74edd568ce';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorgsector.views.kqszmpickupview.caption',
        srfTitle: 'entities.ormorgsector.views.kqszmpickupview.title',
        srfSubTitle: 'entities.ormorgsector.views.kqszmpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof OrmOrgsectorKQSZMPickupView
     */
...
<style lang='less'>
@import './orm-orgsector-kqszmpickup-view.less';
</style>