<template>
  <app-layout viewName="attensummarygridview" viewTitle="考勤汇总" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-ensummary-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEnsummaryGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEnsummaryGridViewBase extends GridViewBase {
	 ...
	 * @memberof AttEnsummaryGridViewBase
	 */
	public viewtag: string = '84cae1f3f8f9a64e17f8889bc7dc1b2d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attensummary.views.gridview.caption',
        srfTitle: 'entities.attensummary.views.gridview.title',
        srfSubTitle: 'entities.attensummary.views.gridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './att-ensummary-grid-view.less';
</style>