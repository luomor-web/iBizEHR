<template>
  <app-layout viewName="attendancerecordgridview" viewTitle="考勤记录表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endance-record-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考勤记录名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class AttEndanceRecordGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceRecordGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceRecordService}
     * @memberof AttEndanceRecordGridViewBase
     */
	 ...
	 * @memberof AttEndanceRecordGridViewBase
	 */
	public viewtag: string = 'a02235606b74a1e7ea69396bd40e14c8';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancerecord.views.gridview.caption',
        srfTitle: 'entities.attendancerecord.views.gridview.title',
        srfSubTitle: 'entities.attendancerecord.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndanceRecordGridView
     */
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
...
<style lang='less'>
@import './att-endance-record-grid-view.less';
</style>