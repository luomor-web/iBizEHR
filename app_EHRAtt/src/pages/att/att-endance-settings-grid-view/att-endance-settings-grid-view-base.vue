<template>
  <app-layout viewName="attendancesettingsgridview" viewTitle="考勤人员" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endance-settings-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndanceSettingsGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceSettingsGridViewBase extends GridViewBase {
	 ...
	 * @memberof AttEndanceSettingsGridViewBase
	 */
	public viewtag: string = '49181fed112a6e7d9c86a8a261583959';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancesettings.views.gridview.caption',
        srfTitle: 'entities.attendancesettings.views.gridview.title',
        srfSubTitle: 'entities.attendancesettings.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceSettings");
    }
...
<style lang='less'>
@import './att-endance-settings-grid-view.less';
</style>