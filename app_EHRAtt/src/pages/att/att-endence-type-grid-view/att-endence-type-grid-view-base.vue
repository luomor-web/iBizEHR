<template>
  <app-layout viewName="attendencetypegridview" viewTitle="考勤类型表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endence-type-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考勤类型名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class AttEndenceTypeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceTypeGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceTypeService}
     * @memberof AttEndenceTypeGridViewBase
     */
	 ...
	 * @memberof AttEndenceTypeGridViewBase
	 */
	public viewtag: string = '641ae929e09d36459bd7fa494f762d04';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencetype.views.gridview.caption',
        srfTitle: 'entities.attendencetype.views.gridview.title',
        srfSubTitle: 'entities.attendencetype.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndenceTypeGridView
     */
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
...
<style lang='less'>
@import './att-endence-type-grid-view.less';
</style>