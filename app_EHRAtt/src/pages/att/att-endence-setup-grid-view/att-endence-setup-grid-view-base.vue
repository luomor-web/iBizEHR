<template>
  <app-layout viewName="attendencesetupgridview" viewTitle="考勤设置表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endence-setup-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceSetupGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceSetupGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof AttEndenceSetupGridViewBase
     */
	 ...
	 * @memberof AttEndenceSetupGridViewBase
	 */
	public viewtag: string = '77e4fa1cbbb1ba59a3fe409f9fdd5a69';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencesetup.views.gridview.caption',
        srfTitle: 'entities.attendencesetup.views.gridview.title',
        srfSubTitle: 'entities.attendencesetup.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndenceSetupGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.attendencesetup;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'att-endence-setup-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.attendencesetup.views.editview.title'),
...
<style lang='less'>
@import './att-endence-setup-grid-view.less';
</style>