<template>
  <app-layout viewName="attendancemreportmxgridview" viewTitle="考勤月报明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endance-mreportmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndanceMreportmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceMreportmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceMreportmxService}
     * @memberof AttEndanceMreportmxGridViewBase
     */
	 ...
	 * @memberof AttEndanceMreportmxGridViewBase
	 */
	public viewtag: string = '729c5fcb6684b43de26f6004de2ae301';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancemreportmx.views.gridview.caption',
        srfTitle: 'entities.attendancemreportmx.views.gridview.title',
        srfSubTitle: 'entities.attendancemreportmx.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem14_export2excel_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.attendancemreportmx;
        if(args.length >0){
            Object.assign(tempContext,args[0]);
        }
        let deResParameters: any[] = [];
        if(tempContext.attendancemreport && true){
            deResParameters = [
...
<style lang='less'>
@import './att-endance-mreportmx-grid-view.less';
</style>