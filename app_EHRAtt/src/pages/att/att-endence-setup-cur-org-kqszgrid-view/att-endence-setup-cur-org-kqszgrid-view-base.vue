<template>
  <app-layout viewName="attendencesetupcurorgkqszgridview" viewTitle="考勤设置表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endence-setup-cur-org-kqszgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考勤表名称，组织名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class AttEndenceSetupCurOrgKQSZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceSetupCurOrgKQSZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof AttEndenceSetupCurOrgKQSZGridViewBase
     */
	 ...
	 * @memberof AttEndenceSetupCurOrgKQSZGridViewBase
	 */
	public viewtag: string = '0e3c8ea0609ff239614c28a75a94ea87';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencesetup.views.curorgkqszgridview.caption',
        srfTitle: 'entities.attendencesetup.views.curorgkqszgridview.title',
        srfSubTitle: 'entities.attendencesetup.views.curorgkqszgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndenceSetupCurOrgKQSZGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
...
<style lang='less'>
@import './att-endence-setup-cur-org-kqszgrid-view.less';
</style>