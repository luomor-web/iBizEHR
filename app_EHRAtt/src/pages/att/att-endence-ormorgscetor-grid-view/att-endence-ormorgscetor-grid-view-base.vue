<template>
  <app-layout viewName="attendenceormorgscetorgridview" viewTitle="考勤部门" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endence-ormorgscetor-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceOrmorgscetorGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceOrmorgscetorGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceOrmorgscetorService}
     * @memberof AttEndenceOrmorgscetorGridViewBase
     */
	 ...
	 * @memberof AttEndenceOrmorgscetorGridViewBase
	 */
	public viewtag: string = '8994b647b6c3896f2b2a29a78ffffccb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendenceormorgscetor.views.gridview.caption',
        srfTitle: 'entities.attendenceormorgscetor.views.gridview.title',
        srfSubTitle: 'entities.attendenceormorgscetor.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
...
<style lang='less'>
@import './att-endence-ormorgscetor-grid-view.less';
</style>