<template>
  <app-layout viewName="attendancesettingsygszkqgridview" viewTitle="员工设置考勤" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-endance-settings-ygszkqgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
import AttEndanceSettingsUIService from '@/uiservice/att-endance-settings/att-endance-settings-ui-service';
 ...
 *
 * @export
 * @class AttEndanceSettingsYGSZKQGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceSettingsYGSZKQGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceSettingsService}
     * @memberof AttEndanceSettingsYGSZKQGridViewBase
     */
	 ...
	 * @memberof AttEndanceSettingsYGSZKQGridViewBase
	 */
	public viewtag: string = 'f1bf8f7a05fdca378d78e966738be76c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancesettings.views.ygszkqgridview.caption',
        srfTitle: 'entities.attendancesettings.views.ygszkqgridview.title',
        srfSubTitle: 'entities.attendancesettings.views.ygszkqgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_addtokqz')) {
            this.toolbar_tbitem1_addtokqz_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_addtokqz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:AttEndanceSettingsUIService  = new AttEndanceSettingsUIService();
        curUIService.AttEndanceSettings_AddToKqz(datas,contextJO, paramJO,  $event, xData,this,"AttEndanceSettings");
    }
...
<style lang='less'>
@import './att-endance-settings-ygszkqgrid-view.less';
</style>