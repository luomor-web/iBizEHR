<template>
  <app-layout viewName="attensummarycurzzkqhzgridview" viewTitle="考勤汇总" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'att-ensummary-cur-zzkqhzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考勤汇总名称，组织名称，员工姓名" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class AttEnsummaryCurZZKQHZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEnsummaryCurZZKQHZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEnsummaryService}
     * @memberof AttEnsummaryCurZZKQHZGridViewBase
     */
	 ...
	 * @memberof AttEnsummaryCurZZKQHZGridViewBase
	 */
	public viewtag: string = '64d9d612dfb1fcc1a6f5f599e5f62308';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attensummary.views.curzzkqhzgridview.caption',
        srfTitle: 'entities.attensummary.views.curzzkqhzgridview.title',
        srfSubTitle: 'entities.attensummary.views.curzzkqhzgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEnsummaryCurZZKQHZGridView
     */
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: '数据导出','isShowCaption':true,'isShowIcon':true, tooltip: '数据导出', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"AttEnsummary");
    }
    ...
    public toolbar_tbitem23_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"AttEnsummary");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"AttEnsummary");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEnsummary");
    }
...
<style lang='less'>
@import './att-ensummary-cur-zzkqhzgrid-view.less';
</style>