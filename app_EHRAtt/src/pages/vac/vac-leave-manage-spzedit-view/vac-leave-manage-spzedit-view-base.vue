<template>
  <app-layout viewName="vacleavemanagespzeditview" viewTitle="请假管理" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-leave-manage-spzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveManageSPZEditViewBase extends EditViewBase {
	 ...
	 * @memberof VacLeaveManageSPZEditViewBase
	 */
	public viewtag: string = '0bb928071e5b4c7d12b658219559994f';
...
<style lang='less'>
@import './vac-leave-manage-spzedit-view.less';
</style>