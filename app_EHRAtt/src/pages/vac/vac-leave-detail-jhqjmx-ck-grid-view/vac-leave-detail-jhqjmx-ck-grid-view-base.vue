<template>
  <app-layout viewName="vacleavedetailjhqjmx_ck_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-leave-detail-jhqjmx-ck-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveDetailJHQJMX_CK_GridViewBase extends GridViewBase {
	 ...
	 * @memberof VacLeaveDetailJHQJMX_CK_GridViewBase
	 */
	public viewtag: string = '9971376d76b7b06e5a2d38291f7805e6';
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vac-leave-detail-jhqjmx-ck-edit-view', 
            height: 700, 
            width: 0,  
...
<style lang='less'>
@import './vac-leave-detail-jhqjmx-ck-grid-view.less';
</style>