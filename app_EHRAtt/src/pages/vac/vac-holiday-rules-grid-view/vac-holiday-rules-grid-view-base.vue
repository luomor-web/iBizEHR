<template>
  <app-layout viewName="vacholidayrulesgridview" viewTitle="考勤规则" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-holiday-rules-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="考勤规则名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class VacHolidayRulesGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacHolidayRulesGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacHolidayRulesService}
     * @memberof VacHolidayRulesGridViewBase
     */
	 ...
	 * @memberof VacHolidayRulesGridViewBase
	 */
	public viewtag: string = 'cfe9d69998fd484c2c7bcb0cd98b60d7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacholidayrules.views.gridview.caption',
        srfTitle: 'entities.vacholidayrules.views.gridview.title',
        srfSubTitle: 'entities.vacholidayrules.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VacHolidayRulesGridView
     */
    public toolBarModels: any = {
        ...
        deuiaction1: { name: 'deuiaction1', caption: '复制','isShowCaption':true,'isShowIcon':true, tooltip: '复制', iconcls: 'fa fa-copy', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Copy', target: 'SINGLEKEY' }, class: '' },
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Copy(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"VacHolidayRules");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.vacholidayrules;
        if(args.length >0){
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vac-holiday-rules-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.vacholidayrules.views.editview.title'),
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { vacholidayrules: args[0].vacholidayrules })
            }
...
<style lang='less'>
@import './vac-holiday-rules-grid-view.less';
</style>