<template>
  <app-layout viewName="vacsynjcxgridview" viewTitle="年休假查询" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-synjcx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="年休假查询名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class VacSynjcxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacSynjcxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacSynjcxService}
     * @memberof VacSynjcxGridViewBase
     */
	 ...
	 * @memberof VacSynjcxGridViewBase
	 */
	public viewtag: string = '332ebe6a595ac81f1e42a327e3c911e1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacsynjcx.views.gridview.caption',
        srfTitle: 'entities.vacsynjcx.views.gridview.title',
        srfSubTitle: 'entities.vacsynjcx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
...
<style lang='less'>
@import './vac-synjcx-grid-view.less';
</style>