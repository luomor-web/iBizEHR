<template>
  <app-layout viewName="vacleavedetailsjqjmx_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-leave-detail-sjqjmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveDetailSJQJMX_GridViewBase extends GridViewBase {
	 ...
	 * @memberof VacLeaveDetailSJQJMX_GridViewBase
	 */
	public viewtag: string = 'a6f62d2019e0803c18258a097fbb4e78';
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vac-leave-detail-sjqjmx-edit-view', 
            height: 700, 
            width: 0,  
...
<style lang='less'>
@import './vac-leave-detail-sjqjmx-grid-view.less';
</style>