<template>
  <app-layout viewName="vacleavedetailsjqjmx_ck_editview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-leave-detail-sjqjmx-ck-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveDetailSJQJMX_CK_EditViewBase extends EditViewBase {
	 ...
	 * @memberof VacLeaveDetailSJQJMX_CK_EditViewBase
	 */
	public viewtag: string = '4f0a59a47a9f69d0c45d34c921233032';
...
<style lang='less'>
@import './vac-leave-detail-sjqjmx-ck-edit-view.less';
</style>