<template>
  <app-layout viewName="vacleavemanagexjeditview" viewTitle="销假" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-leave-manage-xjedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveManageXJEditViewBase extends EditViewBase {
	 ...
	 * @memberof VacLeaveManageXJEditViewBase
	 */
	public viewtag: string = 'e9af4f629b977549a5ec1ff26085c67d';
...
<style lang='less'>
@import './vac-leave-manage-xjedit-view.less';
</style>