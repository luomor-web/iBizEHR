<template>
  <app-layout viewName="vacleavemanageybheditview" viewTitle="请假管理" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-leave-manage-ybhedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveManageYBHEditViewBase extends EditViewBase {
	 ...
	 * @memberof VacLeaveManageYBHEditViewBase
	 */
	public viewtag: string = 'c9775c254d7a9feb29196a8b41d9bc26';
...
<style lang='less'>
@import './vac-leave-manage-ybhedit-view.less';
</style>