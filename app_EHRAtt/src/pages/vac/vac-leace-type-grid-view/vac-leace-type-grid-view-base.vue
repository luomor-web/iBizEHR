<template>
  <app-layout viewName="vacleacetypegridview" viewTitle="休假类型管理表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-leace-type-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="休假类型管理名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class VacLeaceTypeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacLeaceTypeGridViewBase extends GridViewBase {
	 ...
	 * @memberof VacLeaceTypeGridViewBase
	 */
	public viewtag: string = 'e0aef4185645d7c736afe9da6e2de2a7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleacetype.views.gridview.caption',
        srfTitle: 'entities.vacleacetype.views.gridview.title',
        srfSubTitle: 'entities.vacleacetype.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"VacLeaceType");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.vacleacetype;
        if(args.length >0){
...
<style lang='less'>
@import './vac-leace-type-grid-view.less';
</style>