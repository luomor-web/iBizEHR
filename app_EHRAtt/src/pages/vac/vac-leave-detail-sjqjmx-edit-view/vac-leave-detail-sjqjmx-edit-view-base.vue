<template>
  <app-layout viewName="vacleavedetailsjqjmx_editview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-leave-detail-sjqjmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VacLeaveDetailSJQJMX_EditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacLeaveDetailSJQJMX_EditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof VacLeaveDetailSJQJMX_EditViewBase
     */
	 ...
	 * @memberof VacLeaveDetailSJQJMX_EditViewBase
	 */
	public viewtag: string = '3262fd74050152966a989a7aa4f46db0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavedetail.views.sjqjmx_editview.caption',
        srfTitle: 'entities.vacleavedetail.views.sjqjmx_editview.title',
        srfSubTitle: 'entities.vacleavedetail.views.sjqjmx_editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VacLeaveDetailSJQJMX_EditView
     */
...
<style lang='less'>
@import './vac-leave-detail-sjqjmx-edit-view.less';
</style>