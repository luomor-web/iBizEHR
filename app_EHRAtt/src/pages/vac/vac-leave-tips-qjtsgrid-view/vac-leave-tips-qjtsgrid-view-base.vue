  ...
  <app-layout viewName="vacleavetipsqjtsgridview" viewTitle="请假提示" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-leave-tips-qjtsgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请假提示名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
...
export default class VacLeaveTipsQJTSGridViewBase extends GridViewBase {
	 ...
	 * @memberof VacLeaveTipsQJTSGridViewBase
	 */
	public viewtag: string = '1964763f853ddc6c622f5de9e7b36f39';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavetips.views.qjtsgridview.caption',
        srfTitle: 'entities.vacleavetips.views.qjtsgridview.title',
        srfSubTitle: 'entities.vacleavetips.views.qjtsgridview.subtitle',
        dataInfo: ''
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vac-leave-tips-edit-view', 
            height: 500, 
            width: 800,  
            title: this.$t('entities.vacleavetips.views.editview.title'),
        };
...
<style lang='less'>
@import './vac-leave-tips-qjtsgrid-view.less';
</style>