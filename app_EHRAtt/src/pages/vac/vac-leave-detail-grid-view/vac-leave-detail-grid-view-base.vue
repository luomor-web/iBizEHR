<template>
  <app-layout viewName="vacleavedetailgridview" viewTitle="请销假明细表格视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-leave-detail-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请销假明细名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class VacLeaveDetailGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacLeaveDetailGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof VacLeaveDetailGridViewBase
     */
	 ...
	 * @memberof VacLeaveDetailGridViewBase
	 */
	public viewtag: string = 'a61f579d24205c8f6693d783563a54ad';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavedetail.views.gridview.caption',
        srfTitle: 'entities.vacleavedetail.views.gridview.title',
        srfSubTitle: 'entities.vacleavedetail.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VacLeaveDetailGridView
     */
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"VacLeaveDetail");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"VacLeaveDetail");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"VacLeaveDetail");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.vacleavedetail;
        if(args.length >0){
...
<style lang='less'>
@import './vac-leave-detail-grid-view.less';
</style>