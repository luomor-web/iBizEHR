<template>
  <app-layout viewName="vacleavedetailsjqjmx_ck_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vac-leave-detail-sjqjmx-ck-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VacLeaveDetailSJQJMX_CK_GridViewBase extends GridViewBase {
	 ...
	 * @memberof VacLeaveDetailSJQJMX_CK_GridViewBase
	 */
	public viewtag: string = '5504fe93683e145068c188c9e43ccb68';
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vac-leave-detail-sjqjmx-ck-edit-view', 
            height: 700, 
            width: 0,  
...
<style lang='less'>
@import './vac-leave-detail-sjqjmx-ck-grid-view.less';
</style>