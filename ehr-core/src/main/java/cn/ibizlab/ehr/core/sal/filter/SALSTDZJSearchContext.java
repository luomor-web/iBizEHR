...
@NoArgsConstructor
@AllArgsConstructor
public class SALSTDZJSearchContext extends QueryWrapperContext<SALSTDZJ> {

	private String n_zj_eq;//[专家类别]
	...
	private String n_salstdzjname_like;//[专家津贴标准名称]
	public void setN_salstdzjname_like(String n_salstdzjname_like) {
        this.n_salstdzjname_like = n_salstdzjname_like;
        if(!ObjectUtils.isEmpty(this.n_salstdzjname_like)){
            this.getSelectCond().like("salstdzjname", n_salstdzjname_like);
        }
    }
	...
	public void setQuery(String query)
	{
		 ...
		 if(!StringUtils.isEmpty(query)){
			this.getSelectCond().or().like("salstdzjname",query);
		 }
	}
}
