...
public interface UniResMapper extends BaseMapper<UniRes>{
    ...
    Page<UniRes> searchDefault(IPage page, @Param("srf") UniResSearchContext context, @Param("ew") Wrapper<UniRes> wrapper) ;
    @Override
    ...
    @Override
    int update(@Param(Constants.ENTITY) UniRes entity, @Param("ew") Wrapper<UniRes> updateWrapper);
    @Override
