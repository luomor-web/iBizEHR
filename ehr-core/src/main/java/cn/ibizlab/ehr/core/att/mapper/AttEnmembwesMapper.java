...
public interface AttEnmembwesMapper extends BaseMapper<AttEnmembwes>{

    Page<AttEnmembwes> searchDefault(IPage page, @Param("srf") AttEnmembwesSearchContext context, @Param("ew") Wrapper<AttEnmembwes> wrapper) ;
    @Override
    AttEnmembwes selectById(Serializable id);
    @Override
    int insert(AttEnmembwes entity);
    @Override
