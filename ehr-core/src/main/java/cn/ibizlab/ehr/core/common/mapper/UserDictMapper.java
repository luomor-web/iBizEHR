...
public interface UserDictMapper extends BaseMapper<UserDict>{
    ...
    Page<UserDict> searchDefault(IPage page, @Param("srf") UserDictSearchContext context, @Param("ew") Wrapper<UserDict> wrapper) ;
    @Override
    UserDict selectById(Serializable id);
    @Override
    int insert(UserDict entity);
    @Override
