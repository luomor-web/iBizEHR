...
public interface AttEndenceTypeMapper extends BaseMapper<AttEndenceType>{

    Page<AttEndenceType> searchDefault(IPage page, @Param("srf") AttEndenceTypeSearchContext context, @Param("ew") Wrapper<AttEndenceType> wrapper) ;
    @Override
    AttEndenceType selectById(Serializable id);
    @Override
    int insert(AttEndenceType entity);
    @Override
