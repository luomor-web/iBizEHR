...
public interface WXAccessTokenMapper extends BaseMapper<WXAccessToken>{
    ...
    Page<WXAccessToken> searchDefault(IPage page, @Param("srf") WXAccessTokenSearchContext context, @Param("ew") Wrapper<WXAccessToken> wrapper) ;
    @Override
    WXAccessToken selectById(Serializable id);
    @Override
    int insert(WXAccessToken entity);
    @Override
    ...
    */
    ...
    List<WXAccessToken> selectByWxaccountid(@Param("wxaccountid") Serializable wxaccountid) ;
