...
public class TRMPLANFORMUSearchContext extends QueryWrapperContext<TRMPLANFORMU> {
	...
	private String n_pxzzf_eq;//[培训组织方]
	public void setN_pxzzf_eq(String n_pxzzf_eq) {
        this.n_pxzzf_eq = n_pxzzf_eq;
        if(!ObjectUtils.isEmpty(this.n_pxzzf_eq)){
            this.getSelectCond().eq("pxzzf", n_pxzzf_eq);
        }
    }
	...
	private String n_trmplanformuname_like;//[培训计划制定名称]
	...
	private String n_ormorgname_eq;//[填报单位]
	...
	private String n_ormorgname_like;//[填报单位]
	...
	private String n_pimpersonname_eq;//[编制人]
	...
	private String n_pimpersonname_like;//[编制人]
