...
public class OrmQyglSearchContext extends QueryWrapperContext<OrmQygl> {
	...
	public void setN_ormqyglname_like(String n_ormqyglname_like) {
        this.n_ormqyglname_like = n_ormqyglname_like;
        if(!ObjectUtils.isEmpty(this.n_ormqyglname_like)){
            this.getSearchCond().like("ormqyglname", n_ormqyglname_like);
        }
    }
