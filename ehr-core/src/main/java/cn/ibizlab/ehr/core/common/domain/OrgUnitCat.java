 ...
 */
@Data
@TableName(value = "T_SRFORGUNITCAT",resultMap = "OrgUnitCatResultMap")
public class OrgUnitCat extends EntityMP implements Serializable {
    ...
    @TableId(value= "orgunitcatid",type=IdType.UUID)
    @JSONField(name = "orgunitcatid")
    @JsonProperty("orgunitcatid")
     ...
     * 组织单元类别名称
     */
    @TableField(value = "orgunitcatname")
    @JSONField(name = "orgunitcatname")
    @JsonProperty("orgunitcatname")
    ...
    public void setOrgunitcatname(String orgunitcatname){
        ...
        this.modify("orgunitcatname",orgunitcatname);
    }
    /**
     * 设置 [启用标志]
     */
