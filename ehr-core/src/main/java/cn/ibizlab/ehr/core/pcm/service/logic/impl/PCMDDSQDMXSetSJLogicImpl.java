...
import cn.ibizlab.ehr.core.pcm.service.logic.IPCMDDSQDMXSetSJLogic;
...
@Slf4j
@Service
public class PCMDDSQDMXSetSJLogicImpl implements IPCMDDSQDMXSetSJLogic{
    ...
    public void execute(PCMDDSQDMX et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmddsqdmxsetsjdefault",et);
           kieSession.setGlobal("iBzSysPcmddsqdmxDefaultService",iBzSysDefaultService);
           kieSession.setGlobal("curuser", cn.ibizlab.ehr.util.security.AuthenticationUser.getAuthenticationUser());
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmddsqdmxsetsj");

        }catch(Exception e){
            throw new RuntimeException("执行[设置其他时间为生效日期]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
