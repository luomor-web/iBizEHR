...
@NoArgsConstructor
@AllArgsConstructor
public class PCMYDJDMXSearchContext extends QueryWrapperContext<PCMYDJDMX> {
	...
	public void setN_pcmydjdmxname_like(String n_pcmydjdmxname_like) {
        ...
        if(!ObjectUtils.isEmpty(this.n_pcmydjdmxname_like)){
            this.getSelectCond().like("pcmydjdmxname", n_pcmydjdmxname_like);
        }
    }
	private String n_ormorgname_eq;//[借调组织]
	...
	private String n_ormorgname_like;//[借调组织]
	...
	private String n_ormdutyname_eq;//[借调职务]
	...
	private String n_ormdutyname_like;//[借调职务]
	...
	private String n_ormpostname_eq;//[借调岗位]
	...
	private String n_ormpostname_like;//[借调岗位]
	...
	private String n_ormorgsectorname_eq;//[借调部门]
	...
	private String n_ormorgsectorname_like;//[借调部门]
	...
	private String n_ormorgsectorid_eq;//[借调部门标识]
	...
	private String n_ormdutyid_eq;//[借调职务标识]
	...
	private String n_ormorgid_eq;//[借调组织标识]
	...
	private String n_ormpostid_eq;//[借调岗位标识]
	...
	public void setN_pimdistirbutionid_eq(String n_pimdistirbutionid_eq) {
        ...
        if(!ObjectUtils.isEmpty(this.n_pimdistirbutionid_eq)){
            this.getSelectCond().eq("pimdistirbutionid", n_pimdistirbutionid_eq);
        }
    }
	...
	public void setQuery(String query)
	{
		 ...
		 if(!StringUtils.isEmpty(query)){
			...
			this.getSelectCond().or().like("pcmydjdmxname",query);
		 }
	}
}
