...
import cn.ibizlab.ehr.core.pcm.service.logic.IPcmProfileForwardLogic;
...
@Slf4j
@Service
public class PcmProfileForwardLogicImpl implements IPcmProfileForwardLogic{
    ...
    public void execute(PcmProfile et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmprofileforwarddefault",et);
           ...
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmprofileforward");

        }catch(Exception e){
            throw new RuntimeException("执行[上报]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
