...
public class SysAdmin extends EntityMP implements Serializable {
    ...
    @TableId(value= "sysadminid",type=IdType.UUID)
    ...
    public void setAdminobject(String adminobject){
        ...
        this.modify("adminobject",adminobject);
    }
    /**
     * 设置 [保留字段2]
     */
    ...
    public void setSysadminname(String sysadminname){
        ...
        this.modify("sysadminname",sysadminname);
    }
    /**
     * 设置 [保留字段4]
     */
