...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "T_VACLEAVESYSTEMDETAIL",resultMap = "VACLEAVESYSTEMDETAILResultMap")
public class VACLEAVESYSTEMDETAIL extends EntityMP implements Serializable {
    ...
    @TableId(value= "vacleavesystemdetailid",type=IdType.UUID)
