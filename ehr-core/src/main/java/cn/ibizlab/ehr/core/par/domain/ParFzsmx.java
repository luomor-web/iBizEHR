...
@TableName(value = "T_PARFZSMX",resultMap = "ParFzsmxResultMap")
public class ParFzsmx extends EntityMP implements Serializable {
    ...
    @TableId(value= "parfzsmxid",type=IdType.ASSIGN_UUID)
