...
@TableName(value = "T_SGQMGR",resultMap = "PcmPcmSgqMgrResultMap")
public class PcmPcmSgqMgr extends EntityMP implements Serializable {
    ...
    @TableId(value= "sgqmgrid",type=IdType.ASSIGN_UUID)
