...
public interface PimFilebatvhuploadMapper extends BaseMapper<PimFilebatvhupload>{

    Page<PimFilebatvhupload> searchDefault(IPage page, @Param("srf") PimFilebatvhuploadSearchContext context, @Param("ew") Wrapper<PimFilebatvhupload> wrapper) ;
    @Override
    PimFilebatvhupload selectById(Serializable id);
    @Override
    int insert(PimFilebatvhupload entity);
    @Override
