...
public interface OrgUnitCatMapper extends BaseMapper<OrgUnitCat>{

    Page<OrgUnitCat> searchDefault(IPage page, @Param("srf") OrgUnitCatSearchContext context, @Param("ew") Wrapper<OrgUnitCat> wrapper) ;
    @Override
    OrgUnitCat selectById(Serializable id);
    @Override
    int insert(OrgUnitCat entity);
    @Override
