...
public interface PcmReasonMapper extends BaseMapper<PcmReason>{

    Page<PcmReason> searchDefault(IPage page, @Param("srf") PcmReasonSearchContext context, @Param("ew") Wrapper<PcmReason> wrapper) ;
    @Override
    PcmReason selectById(Serializable id);
    @Override
    int insert(PcmReason entity);
    @Override
