...
import cn.ibizlab.ehr.core.trm.service.logic.ITrmTrainPlanSetApprovalStatusLogic;
...
@Slf4j
@Service
public class TrmTrainPlanSetApprovalStatusLogicImpl implements ITrmTrainPlanSetApprovalStatusLogic{
    ...
    public void execute(TrmTrainPlan et){
        ...
        try{
           ...
           kieSession.startProcess("cn.ibizlab.ehr.core.trm.service.logic.trmtrainplansetapprovalstatus");
            ...
            throw new RuntimeException("执行[设置审核通过状态]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
