...
import cn.ibizlab.ehr.core.pcm.service.logic.IPcmProfilePreCheckInLogic;
...
@Slf4j
@Service
public class PcmProfilePreCheckInLogicImpl implements IPcmProfilePreCheckInLogic{
    ...
    public void execute(PcmProfile et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmprofileprecheckindefault",et);
           ...
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmprofileprecheckin");

        }catch(Exception e){
            throw new RuntimeException("执行[生成编号]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
