...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "T_TRMEMPLOYEERETION",resultMap = "TRMEMPLOYRETIONResultMap")
public class TRMEMPLOYRETION extends EntityMP implements Serializable {
    ...
    @TableId(value= "trmemployeeretionid",type=IdType.UUID)
