...
import cn.ibizlab.ehr.core.pcm.service.logic.IPcmProfileInvalidLogic;
...
@Slf4j
@Service
public class PcmProfileInvalidLogicImpl implements IPcmProfileInvalidLogic{
    ...
    public void execute(PcmProfile et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmprofileinvaliddefault",et);
           ...
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmprofileinvalid");

        }catch(Exception e){
            throw new RuntimeException("执行[失效]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
