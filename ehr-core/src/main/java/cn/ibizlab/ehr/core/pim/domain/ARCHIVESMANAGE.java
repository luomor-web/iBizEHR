 ...
 */
@Data
@TableName(value = "T_ARCHIVESMANAGE",resultMap = "ARCHIVESMANAGEResultMap")
public class ARCHIVESMANAGE extends EntityMP implements Serializable {
    ...
    @TableId(value= "archivesmanageid",type=IdType.UUID)
