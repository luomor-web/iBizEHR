 ...
 */
@Data
@TableName(value = "T_SRFTSSDENGINE",resultMap = "TSSDEngineResultMap")
public class TSSDEngine extends EntityMP implements Serializable {
     ...
     * 任务调度引擎名称
     */
    @TableField(value = "tssdenginename")
    ...
    @TableId(value= "tssdengineid",type=IdType.UUID)
