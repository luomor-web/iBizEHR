...
public interface WFInstanceMapper extends BaseMapper<WFInstance>{
    ...
    Page<WFInstance> searchDefault(IPage page, @Param("srf") WFInstanceSearchContext context, @Param("ew") Wrapper<WFInstance> wrapper) ;
    @Override
    WFInstance selectById(Serializable id);
    @Override
    ...
    */
    ...
    List<WFInstance> selectByOrgid(@Param("orgid") Serializable orgid) ;

    List<WFInstance> selectByPwfinstanceid(@Param("wfinstanceid") Serializable wfinstanceid) ;

    List<WFInstance> selectByWfworkflowid(@Param("wfworkflowid") Serializable wfworkflowid) ;
