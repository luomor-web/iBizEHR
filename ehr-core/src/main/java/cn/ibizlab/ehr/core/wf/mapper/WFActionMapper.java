...
public interface WFActionMapper extends BaseMapper<WFAction>{
    ...
    Page<WFAction> searchDefault(IPage page, @Param("srf") WFActionSearchContext context, @Param("ew") Wrapper<WFAction> wrapper) ;
    @Override
    WFAction selectById(Serializable id);
    @Override
    int insert(WFAction entity);
    @Override
    ...
    */
    ...
    List<WFAction> selectByWfworkflowid(@Param("wfworkflowid") Serializable wfworkflowid) ;
