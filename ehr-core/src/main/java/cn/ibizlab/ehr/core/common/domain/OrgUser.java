 ...
 */
@Data
@TableName(value = "T_SRFORGUSER",resultMap = "OrgUserResultMap")
public class OrgUser extends EntityMP implements Serializable {
     ...
     * 人员级别
     */
    @TableField(value = "orguserlevelname")
     ...
     * 人员级别
     */
    @TableField(value = "orguserlevelid")
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private cn.ibizlab.ehr.core.common.domain.OrgUserLevel orguserlevel;
