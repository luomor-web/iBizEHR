...
import cn.ibizlab.ehr.core.pcm.service.logic.IPCMBDSQDMXSetSJLogic;
...
@Slf4j
@Service
public class PCMBDSQDMXSetSJLogicImpl implements IPCMBDSQDMXSetSJLogic{
    ...
    public void execute(PCMBDSQDMX et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmbdsqdmxsetsjdefault",et);
           kieSession.setGlobal("iBzSysPcmbdsqdmxDefaultService",iBzSysDefaultService);
           kieSession.setGlobal("curuser", cn.ibizlab.ehr.util.security.AuthenticationUser.getAuthenticationUser());
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmbdsqdmxsetsj");

        }catch(Exception e){
            throw new RuntimeException("执行[设置其他时间的值为生效日期]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
