...
public interface SocArchivesMapper extends BaseMapper<SocArchives>{
    ...
    @Override
    SocArchives selectById(Serializable id);
    @Override
    int insert(SocArchives entity);
    @Override
    int updateById(@Param(Constants.ENTITY) SocArchives entity);
    @Override
    int update(@Param(Constants.ENTITY) SocArchives entity, @Param("ew") Wrapper<SocArchives> updateWrapper);
    @Override
