...
import cn.ibizlab.ehr.core.pcm.service.logic.IPcmProfileSubmitLogic;
...
@Slf4j
@Service
public class PcmProfileSubmitLogicImpl implements IPcmProfileSubmitLogic{
    ...
    public void execute(PcmProfile et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmprofilesubmitdefault",et);
           ...
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmprofilesubmit");

        }catch(Exception e){
            throw new RuntimeException("执行[提交]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
