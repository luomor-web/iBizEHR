...
public interface OrgTypeMapper extends BaseMapper<OrgType>{
    ...
    Page<OrgType> searchDefault(IPage page, @Param("srf") OrgTypeSearchContext context, @Param("ew") Wrapper<OrgType> wrapper) ;
    @Override
    OrgType selectById(Serializable id);
    @Override
    int insert(OrgType entity);
    @Override
