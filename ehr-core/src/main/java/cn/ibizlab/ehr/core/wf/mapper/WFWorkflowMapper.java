...
public interface WFWorkflowMapper extends BaseMapper<WFWorkflow>{
    ...
    Page<WFWorkflow> searchDefault(IPage page, @Param("srf") WFWorkflowSearchContext context, @Param("ew") Wrapper<WFWorkflow> wrapper) ;
    @Override
    WFWorkflow selectById(Serializable id);
    @Override
    int insert(WFWorkflow entity);
    @Override
    ...
    */
    ...
    List<WFWorkflow> selectByRemindmsgtemplid(@Param("msgtemplateid") Serializable msgtemplateid) ;
