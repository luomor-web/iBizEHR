...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "T_ATTENDENCEORMORGSECTOR",resultMap = "ATTENDENCEORMORGSECTORResultMap")
public class ATTENDENCEORMORGSECTOR extends EntityMP implements Serializable {
    ...
    @TableId(value= "attendenceormorgsectorid",type=IdType.UUID)
