...
public interface VacWorkDayMapper extends BaseMapper<VacWorkDay>{

    Page<VacWorkDay> searchDefault(IPage page, @Param("srf") VacWorkDaySearchContext context, @Param("ew") Wrapper<VacWorkDay> wrapper) ;
    @Override
    VacWorkDay selectById(Serializable id);
    @Override
    int insert(VacWorkDay entity);
    @Override
