...
public interface TSSDPolicyMapper extends BaseMapper<TSSDPolicy>{

    Page<TSSDPolicy> searchDefault(IPage page, @Param("srf") TSSDPolicySearchContext context, @Param("ew") Wrapper<TSSDPolicy> wrapper) ;
    @Override
    TSSDPolicy selectById(Serializable id);
    @Override
    int insert(TSSDPolicy entity);
    @Override
