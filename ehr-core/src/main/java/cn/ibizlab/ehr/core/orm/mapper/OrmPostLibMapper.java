...
public interface OrmPostLibMapper extends BaseMapper<OrmPostLib>{
    ...
    Page<OrmPostLib> searchDefault(IPage page, @Param("srf") OrmPostLibSearchContext context, @Param("ew") Wrapper<OrmPostLib> wrapper) ;
    @Override
    OrmPostLib selectById(Serializable id);
    @Override
    int insert(OrmPostLib entity);
    @Override
