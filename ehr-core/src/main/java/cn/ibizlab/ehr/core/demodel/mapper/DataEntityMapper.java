...
public interface DataEntityMapper extends BaseMapper<DataEntity>{
    ...
    Page<DataEntity> searchDefault(IPage page, @Param("srf") DataEntitySearchContext context, @Param("ew") Wrapper<DataEntity> wrapper) ;
    @Override
    ...
    */
    ...
    List<DataEntity> selectByDer11deid(@Param("deid") Serializable deid) ;

    List<DataEntity> selectByAcquerymodelid(@Param("querymodelid") Serializable querymodelid) ;
