...
public class SalStdglSearchContext extends QueryWrapperContext<SalStdgl> {
	...
	public void setN_salstdglname_like(String n_salstdglname_like) {
        this.n_salstdglname_like = n_salstdglname_like;
        if(!ObjectUtils.isEmpty(this.n_salstdglname_like)){
            this.getSearchCond().like("salstdglname", n_salstdglname_like);
        }
    }
