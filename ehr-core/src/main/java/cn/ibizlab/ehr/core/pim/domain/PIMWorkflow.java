 ...
 */
@Data
@TableName(value = "T_PIMWORKFLOW",resultMap = "PIMWorkflowResultMap")
public class PIMWorkflow extends EntityMP implements Serializable {
     ...
     * 流程配置
     */
    @TableField(value = "pimworkflowname")
    ...
    @TableId(value= "pimworkflowid",type=IdType.UUID)
     ...
     * 设置 [流程配置]
     */
    public void setPimworkflowname(String pimworkflowname){
