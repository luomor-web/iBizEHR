...
public interface DEDataChg2Mapper extends BaseMapper<DEDataChg2>{

    Page<DEDataChg2> searchDefault(IPage page, @Param("srf") DEDataChg2SearchContext context, @Param("ew") Wrapper<DEDataChg2> wrapper) ;
    @Override
    DEDataChg2 selectById(Serializable id);
    @Override
    int insert(DEDataChg2 entity);
    @Override
    ...
    */
    ...
    List<DEDataChg2> selectByDeid(@Param("deid") Serializable deid) ;
