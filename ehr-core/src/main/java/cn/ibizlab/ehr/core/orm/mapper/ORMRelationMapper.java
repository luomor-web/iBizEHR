...
public interface ORMRelationMapper extends BaseMapper<ORMRelation>{

    Page<ORMRelation> searchDefault(IPage page, @Param("srf") ORMRelationSearchContext context, @Param("ew") Wrapper<ORMRelation> wrapper) ;
    @Override
    ORMRelation selectById(Serializable id);
    @Override
    int insert(ORMRelation entity);
    @Override
