...
public interface WFSystemUserMapper extends BaseMapper<WFSystemUser>{

    Page<WFSystemUser> searchDefault(IPage page, @Param("srf") WFSystemUserSearchContext context, @Param("ew") Wrapper<WFSystemUser> wrapper) ;
    @Override
    WFSystemUser selectById(Serializable id);
    @Override
    int insert(WFSystemUser entity);
    @Override
