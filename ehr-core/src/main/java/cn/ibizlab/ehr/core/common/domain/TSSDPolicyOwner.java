 ...
 */
@Data
@TableName(value = "T_SRFTSSDPOLICYOWNER",resultMap = "TSSDPolicyOwnerResultMap")
public class TSSDPolicyOwner extends EntityMP implements Serializable {
     ...
     * 任务时刻策略所有者名称
     */
    @TableField(value = "tssdpolicyownername")
     ...
     * 实际主键
     */
    @TableField(value = "tssdpolicyownerid2")
     ...
     * 所有者类型
     */
    @TableField(value = "tssdpolicyownertype")
    ...
    @TableId(value= "tssdpolicyownerid",type=IdType.UUID)
