...
public interface PcmMonthMapper extends BaseMapper<PcmMonth>{

    Page<PcmMonth> searchDefault(IPage page, @Param("srf") PcmMonthSearchContext context, @Param("ew") Wrapper<PcmMonth> wrapper) ;
    @Override
    PcmMonth selectById(Serializable id);
    @Override
    int insert(PcmMonth entity);
    @Override
