 ...
 */
@Data
@TableName(value = "T_SALITEM",resultMap = "SALITEMResultMap")
public class SALITEM extends EntityMP implements Serializable {
    ...
    @TableId(value= "salitemid",type=IdType.UUID)
