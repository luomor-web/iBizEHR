...
public interface DataSyncAgentMapper extends BaseMapper<DataSyncAgent>{

    Page<DataSyncAgent> searchDefault(IPage page, @Param("srf") DataSyncAgentSearchContext context, @Param("ew") Wrapper<DataSyncAgent> wrapper) ;
    @Override
    DataSyncAgent selectById(Serializable id);
    @Override
    int insert(DataSyncAgent entity);
    @Override
