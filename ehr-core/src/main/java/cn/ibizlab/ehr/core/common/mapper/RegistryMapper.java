...
public interface RegistryMapper extends BaseMapper<Registry>{
    ...
    Page<Registry> searchDefault(IPage page, @Param("srf") RegistrySearchContext context, @Param("ew") Wrapper<Registry> wrapper) ;
    @Override
    Registry selectById(Serializable id);
    @Override
    int insert(Registry entity);
    @Override
