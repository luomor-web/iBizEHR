 ...
 */
@Data
@TableName(value = "T_SRFORGUSERLEVEL",resultMap = "OrgUserLevelResultMap")
public class OrgUserLevel extends EntityMP implements Serializable {
    ...
    @TableId(value= "orguserlevelid",type=IdType.UUID)
