...
public interface PcmTxbzMapper extends BaseMapper<PcmTxbz>{

    Page<PcmTxbz> searchDefault(IPage page, @Param("srf") PcmTxbzSearchContext context, @Param("ew") Wrapper<PcmTxbz> wrapper) ;
    @Override
    PcmTxbz selectById(Serializable id);
    @Override
    int insert(PcmTxbz entity);
    @Override
