...
/**
 * 关系型数据实体[SocAccount] 查询条件对象
 */
@Slf4j
@Data
public class SocAccountSearchContext extends QueryWrapperContext<SocAccount> {

	private String n_socaccountname_like;//[参保账户名称]
	...
	public void setQuery(String query)
	{
		 ...
		 if(!StringUtils.isEmpty(query)){
            this.getSearchCond().and( wrapper ->
                     wrapper.like("socaccountname", query)   
            );
		 }
	}
}
