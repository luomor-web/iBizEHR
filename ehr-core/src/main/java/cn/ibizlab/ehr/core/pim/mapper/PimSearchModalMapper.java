...
public interface PimSearchModalMapper extends BaseMapper<PimSearchModal>{

    Page<PimSearchModal> searchDefault(IPage page, @Param("srf") PimSearchModalSearchContext context, @Param("ew") Wrapper<PimSearchModal> wrapper) ;
    @Override
    PimSearchModal selectById(Serializable id);
    @Override
    int insert(PimSearchModal entity);
    @Override
