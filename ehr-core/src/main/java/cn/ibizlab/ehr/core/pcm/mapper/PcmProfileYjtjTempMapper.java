...
public interface PcmProfileYjtjTempMapper extends BaseMapper<PcmProfileYjtjTemp>{

    Page<PcmProfileYjtjTemp> searchDefault(IPage page, @Param("srf") PcmProfileYjtjTempSearchContext context, @Param("ew") Wrapper<PcmProfileYjtjTemp> wrapper) ;
    @Override
    PcmProfileYjtjTemp selectById(Serializable id);
    @Override
    int insert(PcmProfileYjtjTemp entity);
    @Override
