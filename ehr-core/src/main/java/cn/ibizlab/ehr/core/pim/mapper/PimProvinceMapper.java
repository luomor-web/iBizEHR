...
public interface PimProvinceMapper extends BaseMapper<PimProvince>{

    Page<PimProvince> searchDefault(IPage page, @Param("srf") PimProvinceSearchContext context, @Param("ew") Wrapper<PimProvince> wrapper) ;
    @Override
    PimProvince selectById(Serializable id);
    @Override
    int insert(PimProvince entity);
    @Override
