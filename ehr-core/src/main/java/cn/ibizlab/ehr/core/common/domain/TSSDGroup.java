 ...
 */
@Data
@TableName(value = "T_SRFTSSDGROUP",resultMap = "TSSDGroupResultMap")
public class TSSDGroup extends EntityMP implements Serializable {
    ...
    @TableId(value= "tssdgroupid",type=IdType.UUID)
     ...
     * 任务时刻策略组名称
     */
    @TableField(value = "tssdgroupname")
    ...
    public void setTssdgroupname(String tssdgroupname){
        ...
        this.modify("tssdgroupname",tssdgroupname);
    }
    /**
     * 设置 [保留字段]
     */
