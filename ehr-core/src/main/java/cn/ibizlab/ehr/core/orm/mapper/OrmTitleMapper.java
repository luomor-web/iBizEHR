...
public interface OrmTitleMapper extends BaseMapper<OrmTitle>{

    Page<OrmTitle> searchDefault(IPage page, @Param("srf") OrmTitleSearchContext context, @Param("ew") Wrapper<OrmTitle> wrapper) ;
    @Override
    OrmTitle selectById(Serializable id);
    @Override
    int insert(OrmTitle entity);
    @Override
