...
public interface ARCHIVESMANAGEMapper extends BaseMapper<ARCHIVESMANAGE>{

    Page<ARCHIVESMANAGE> searchDefault(IPage page, @Param("srf") ARCHIVESMANAGESearchContext context, @Param("ew") Wrapper<ARCHIVESMANAGE> wrapper) ;
    @Override
    ARCHIVESMANAGE selectById(Serializable id);
    @Override
    int insert(ARCHIVESMANAGE entity);
    @Override
