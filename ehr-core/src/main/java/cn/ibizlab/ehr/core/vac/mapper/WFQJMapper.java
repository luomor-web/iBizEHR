...
public interface WFQJMapper extends BaseMapper<WFQJ>{

    Page<WFQJ> searchDefault(IPage page, @Param("srf") WFQJSearchContext context, @Param("ew") Wrapper<WFQJ> wrapper) ;
    @Override
    WFQJ selectById(Serializable id);
    @Override
    int insert(WFQJ entity);
    @Override
