...
public interface ParTzggMapper extends BaseMapper<ParTzgg>{

    Page<ParTzgg> searchDefault(IPage page, @Param("srf") ParTzggSearchContext context, @Param("ew") Wrapper<ParTzgg> wrapper) ;
    @Override
    ParTzgg selectById(Serializable id);
    @Override
    int insert(ParTzgg entity);
    @Override
