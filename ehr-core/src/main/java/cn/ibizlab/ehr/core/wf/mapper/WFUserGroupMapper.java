...
public interface WFUserGroupMapper extends BaseMapper<WFUserGroup>{
    ...
    Page<WFUserGroup> searchDefault(IPage page, @Param("srf") WFUserGroupSearchContext context, @Param("ew") Wrapper<WFUserGroup> wrapper) ;
    @Override
    WFUserGroup selectById(Serializable id);
    @Override
    int insert(WFUserGroup entity);
    @Override
