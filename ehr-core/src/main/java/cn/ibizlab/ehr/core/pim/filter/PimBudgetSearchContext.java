...
/**
 * 关系型数据实体[PimBudget] 查询条件对象
 */
@Slf4j
@Data
public class PimBudgetSearchContext extends QueryWrapperContext<PimBudget> {
	...
	private String n_budgetname_like;//[年度预算名称]
	public void setN_budgetname_like(String n_budgetname_like) {
        this.n_budgetname_like = n_budgetname_like;
        if(!ObjectUtils.isEmpty(this.n_budgetname_like)){
            this.getSearchCond().like("budgetname", n_budgetname_like);
        }
    }
