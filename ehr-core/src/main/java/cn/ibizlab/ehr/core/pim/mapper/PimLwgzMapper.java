...
public interface PimLwgzMapper extends BaseMapper<PimLwgz>{

    Page<PimLwgz> searchDefault(IPage page, @Param("srf") PimLwgzSearchContext context, @Param("ew") Wrapper<PimLwgz> wrapper) ;
    @Override
    PimLwgz selectById(Serializable id);
    @Override
    int insert(PimLwgz entity);
    @Override
