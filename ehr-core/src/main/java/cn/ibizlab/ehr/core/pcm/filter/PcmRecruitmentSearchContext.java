...
public class PcmRecruitmentSearchContext extends QueryWrapperContext<PcmRecruitment> {
	...
	public void setN_pcmrecruitmentname_like(String n_pcmrecruitmentname_like) {
        this.n_pcmrecruitmentname_like = n_pcmrecruitmentname_like;
        if(!ObjectUtils.isEmpty(this.n_pcmrecruitmentname_like)){
            this.getSearchCond().like("pcmrecruitmentname", n_pcmrecruitmentname_like);
        }
    }
	private String n_recruitmenttype_eq;//[招聘类型]
	public void setN_recruitmenttype_eq(String n_recruitmenttype_eq) {
        this.n_recruitmenttype_eq = n_recruitmenttype_eq;
        if(!ObjectUtils.isEmpty(this.n_recruitmenttype_eq)){
            this.getSearchCond().eq("recruitmenttype", n_recruitmenttype_eq);
        }
    }
