...
public interface WFUIWizardMapper extends BaseMapper<WFUIWizard>{

    Page<WFUIWizard> searchDefault(IPage page, @Param("srf") WFUIWizardSearchContext context, @Param("ew") Wrapper<WFUIWizard> wrapper) ;
    @Override
    WFUIWizard selectById(Serializable id);
    @Override
    int insert(WFUIWizard entity);
    @Override
