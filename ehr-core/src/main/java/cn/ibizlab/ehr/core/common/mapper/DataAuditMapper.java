...
public interface DataAuditMapper extends BaseMapper<DataAudit>{
    ...
    Page<DataAudit> searchDefault(IPage page, @Param("srf") DataAuditSearchContext context, @Param("ew") Wrapper<DataAudit> wrapper) ;
    @Override
    DataAudit selectById(Serializable id);
    @Override
    int insert(DataAudit entity);
    @Override
