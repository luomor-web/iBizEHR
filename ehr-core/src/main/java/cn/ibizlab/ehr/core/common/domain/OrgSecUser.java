 ...
 */
@Data
@TableName(value = "T_ORGSECUSER",resultMap = "OrgSecUserResultMap")
public class OrgSecUser extends EntityMP implements Serializable {
     ...
     * 组织部门人员名称
     */
    @TableField(value = "orgsecusername")
    @JSONField(name = "orgsecusername")
    @JsonProperty("orgsecusername")
    ...
    @TableId(value= "orgsecuserid",type=IdType.UUID)
    @JSONField(name = "orgsecuserid")
    @JsonProperty("orgsecuserid")
     ...
     * 部门人员关系
     */
    @TableField(value = "orgsecusertypename")
     ...
     * 部门人员关系
     */
    @TableField(value = "orgsecusertypeid")
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private cn.ibizlab.ehr.core.common.domain.OrgSecUserType orgsecusertype;
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private cn.ibizlab.ehr.core.common.domain.OrgUser orguser;
    ...
    public void setOrgsecusername(String orgsecusername){
        ...
        this.modify("orgsecusername",orgsecusername);
    }
    /**
     * 设置 [保留字段21]
     */
