...
public interface OrmEditionMapper extends BaseMapper<OrmEdition>{

    Page<OrmEdition> searchDefault(IPage page, @Param("srf") OrmEditionSearchContext context, @Param("ew") Wrapper<OrmEdition> wrapper) ;
    @Override
    OrmEdition selectById(Serializable id);
    @Override
    int insert(OrmEdition entity);
    @Override
