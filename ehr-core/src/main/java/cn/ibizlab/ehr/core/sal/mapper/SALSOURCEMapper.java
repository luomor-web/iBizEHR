...
public interface SALSOURCEMapper extends BaseMapper<SALSOURCE>{

    Page<SALSOURCE> searchDefault(IPage page, @Param("srf") SALSOURCESearchContext context, @Param("ew") Wrapper<SALSOURCE> wrapper) ;
    @Override
    SALSOURCE selectById(Serializable id);
    @Override
    int insert(SALSOURCE entity);
    @Override
