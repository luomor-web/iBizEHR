...
public interface MsgSendQueueHisMapper extends BaseMapper<MsgSendQueueHis>{

    Page<MsgSendQueueHis> searchDefault(IPage page, @Param("srf") MsgSendQueueHisSearchContext context, @Param("ew") Wrapper<MsgSendQueueHis> wrapper) ;
    @Override
    MsgSendQueueHis selectById(Serializable id);
    @Override
    int insert(MsgSendQueueHis entity);
    @Override
