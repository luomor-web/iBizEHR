...
@TableName(value = "T_TRMSTAFFNODES",resultMap = "TrmStaffnodesResultMap")
public class TrmStaffnodes extends EntityMP implements Serializable {
     ...
     * 员工需求填报名称
     */
    @TableField(value = "trmstaffnodesname")
    ...
    @TableId(value= "trmstaffnodesid",type=IdType.ASSIGN_UUID)
    ...
    @TableField(exist = false)
    private cn.ibizlab.ehr.core.trm.domain.TrmStaff trmstaff;
