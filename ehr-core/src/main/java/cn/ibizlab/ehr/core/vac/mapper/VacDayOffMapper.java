...
public interface VacDayOffMapper extends BaseMapper<VacDayOff>{

    Page<VacDayOff> searchDefault(IPage page, @Param("srf") VacDayOffSearchContext context, @Param("ew") Wrapper<VacDayOff> wrapper) ;
    @Override
    VacDayOff selectById(Serializable id);
    @Override
    int insert(VacDayOff entity);
    @Override
