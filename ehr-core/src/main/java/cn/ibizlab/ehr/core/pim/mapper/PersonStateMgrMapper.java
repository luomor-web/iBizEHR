...
public interface PersonStateMgrMapper extends BaseMapper<PersonStateMgr>{

    Page<PersonStateMgr> searchDefault(IPage page, @Param("srf") PersonStateMgrSearchContext context, @Param("ew") Wrapper<PersonStateMgr> wrapper) ;
    @Override
    PersonStateMgr selectById(Serializable id);
    @Override
    int insert(PersonStateMgr entity);
    @Override
