...
public interface PimMajorSetypeMapper extends BaseMapper<PimMajorSetype>{

    Page<PimMajorSetype> searchDefault(IPage page, @Param("srf") PimMajorSetypeSearchContext context, @Param("ew") Wrapper<PimMajorSetype> wrapper) ;
    @Override
    PimMajorSetype selectById(Serializable id);
    @Override
    int insert(PimMajorSetype entity);
    @Override
