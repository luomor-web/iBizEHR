...
public class VacInitnxjSearchContext extends QueryWrapperContext<VacInitnxj> {
	...
	public void setN_vacinitnxjname_like(String n_vacinitnxjname_like) {
        this.n_vacinitnxjname_like = n_vacinitnxjname_like;
        if(!ObjectUtils.isEmpty(this.n_vacinitnxjname_like)){
            this.getSearchCond().like("vacinitnxjname", n_vacinitnxjname_like);
        }
    }
