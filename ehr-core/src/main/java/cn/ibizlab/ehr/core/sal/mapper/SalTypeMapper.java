...
public interface SalTypeMapper extends BaseMapper<SalType>{

    Page<SalType> searchDefault(IPage page, @Param("srf") SalTypeSearchContext context, @Param("ew") Wrapper<SalType> wrapper) ;
    @Override
    SalType selectById(Serializable id);
    @Override
    int insert(SalType entity);
    @Override
