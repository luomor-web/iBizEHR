...
public interface PimExaminationResultsMapper extends BaseMapper<PimExaminationResults>{

    Page<PimExaminationResults> searchDefault(IPage page, @Param("srf") PimExaminationResultsSearchContext context, @Param("ew") Wrapper<PimExaminationResults> wrapper) ;
    @Override
    PimExaminationResults selectById(Serializable id);
    @Override
    int insert(PimExaminationResults entity);
    @Override
