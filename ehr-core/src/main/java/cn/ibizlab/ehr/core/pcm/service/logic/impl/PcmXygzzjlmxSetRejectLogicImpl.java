...
import cn.ibizlab.ehr.core.pcm.service.logic.IPcmXygzzjlmxSetRejectLogic;
...
@Slf4j
@Service
public class PcmXygzzjlmxSetRejectLogicImpl implements IPcmXygzzjlmxSetRejectLogic{
    ...
    public void execute(PcmXygzzjlmx et){
        ...
        try{
           ...
           kieSession.setGlobal("pcmxygzzjlmxsetrejectdefault",et);
           kieSession.setGlobal("iBzSysPcmxygzzjlmxDefaultService",iBzSysDefaultService);
           kieSession.setGlobal("curuser", cn.ibizlab.ehr.util.security.AuthenticationUser.getAuthenticationUser());
           kieSession.startProcess("cn.ibizlab.ehr.core.pcm.service.logic.pcmxygzzjlmxsetreject");
