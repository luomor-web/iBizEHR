...
@TableName(value = "T_PIMLWGZ",resultMap = "PimLwgzResultMap")
public class PimLwgz extends EntityMP implements Serializable {
    ...
    @TableId(value= "pimlwgzid",type=IdType.ASSIGN_UUID)
