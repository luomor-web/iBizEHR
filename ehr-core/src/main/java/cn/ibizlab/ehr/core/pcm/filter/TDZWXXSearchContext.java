...
/**
 * 关系型数据实体[TDZWXX] 查询条件对象
 */
@Slf4j
@Data
public class TDZWXXSearchContext extends QueryWrapperContext<TDZWXX> {
	...
	public void setN_tdzwxxname_like(String n_tdzwxxname_like) {
        ...
        if(!ObjectUtils.isEmpty(this.n_tdzwxxname_like)){
            this.getSelectCond().like("tdzwxxname", n_tdzwxxname_like);
        }
    }
	...
	public void setQuery(String query)
	{
		 ...
		 if(!StringUtils.isEmpty(query)){
			this.getSelectCond().or().like("tdzwxxname",query);
		 }
	}
}
