...
/**
 * 关系型数据实体[SocArea] 查询条件对象
 */
@Slf4j
@Data
public class SocAreaSearchContext extends QueryWrapperContext<SocArea> {

	private String n_socareaname_like;//[参保地名称]
	...
	public void setQuery(String query)
	{
		 ...
		 if(!StringUtils.isEmpty(query)){
            this.getSearchCond().and( wrapper ->
                     wrapper.like("socareaname", query)   
            );
		 }
	}
}
