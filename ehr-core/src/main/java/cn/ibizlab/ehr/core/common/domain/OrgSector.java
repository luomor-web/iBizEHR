...
public class OrgSector extends EntityMP implements Serializable {
     ...
     * 上级部门
     */
    @TableField(value = "porgsectorname")
     ...
     * 汇报部门
     */
    @TableField(value = "reporgsectorname")
    @JSONField(name = "reporgsectorname")
    @JsonProperty("reporgsectorname")
     ...
     * 汇报部门
     */
    @TableField(value = "reporgsectorid")
    @JSONField(name = "reporgsectorid")
    @JsonProperty("reporgsectorid")
    ...
    private cn.ibizlab.ehr.core.common.domain.OrgSector porgsector;
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private cn.ibizlab.ehr.core.common.domain.OrgSector reporgsector;
    ...
    public void setPorgsectorname(String porgsectorname){
        ...
        this.modify("porgsectorname",porgsectorname);
    }
    /**
     * 设置 [汇报部门]
     */
    public void setReporgsectorname(String reporgsectorname){
        ...
        this.modify("reporgsectorname",reporgsectorname);
    }
    /**
     * 设置 [汇报部门]
     */
    public void setReporgsectorid(String reporgsectorid){
        ...
        this.modify("reporgsectorid",reporgsectorid);
    }
    /**
     * 设置 [上级部门]
     */
