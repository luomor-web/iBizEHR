...
public interface PimGwTypeMapper extends BaseMapper<PimGwType>{

    Page<PimGwType> searchDefault(IPage page, @Param("srf") PimGwTypeSearchContext context, @Param("ew") Wrapper<PimGwType> wrapper) ;
    @Override
    PimGwType selectById(Serializable id);
    @Override
    int insert(PimGwType entity);
    @Override
