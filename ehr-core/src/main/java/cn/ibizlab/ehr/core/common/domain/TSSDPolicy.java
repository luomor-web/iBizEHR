 ...
 */
@Data
@TableName(value = "T_SRFTSSDPOLICY",resultMap = "TSSDPolicyResultMap")
public class TSSDPolicy extends EntityMP implements Serializable {
     ...
     * 任务时刻策略名称
     */
    @TableField(value = "tssdpolicyname")
    ...
    @TableId(value= "tssdpolicyid",type=IdType.UUID)
     ...
     * 策略类型
     */
    @TableField(value = "tssdpolicytype")
    @JSONField(name = "tssdpolicytype")
    @JsonProperty("tssdpolicytype")
    ...
    public void setTssdpolicyname(String tssdpolicyname){
        ...
        this.modify("tssdpolicyname",tssdpolicyname);
    }
    /**
     * 设置 [保留字段4]
     */
    ...
    public void setTssdpolicytype(String tssdpolicytype){
        ...
        this.modify("tssdpolicytype",tssdpolicytype);
    }
