...
import OrmOrgTreeService from './orm-org-tree-treeview-service';
...
export default class OrmOrgTreeBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof OrmOrgTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {OrmOrgTreeService}
     * @memberof OrmOrgTreeBase
     */
    public service: OrmOrgTreeService = new OrmOrgTreeService({ $store: this.$store });
...
<style lang='less'>
@import './orm-org-tree-treeview.less';
</style>