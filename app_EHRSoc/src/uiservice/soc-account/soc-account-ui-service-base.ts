 ...
 *
 * @export
 * @class SocAccountUIServiceBase
 */
export default class SocAccountUIServiceBase extends UIService {
     ...
     * @memberof  SocAccountUIServiceBase
     */
    public dataService:SocAccountService = new SocAccountService();
    ...
    /**
     * Creates an instance of  SocAccountUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  SocAccountUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({socaccount:srfkey});
