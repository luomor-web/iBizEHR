...
export default class PimPersonUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set(':',{viewname:'setsocarchivesgridview',srfappde:'pimpeople'});
     ...
     * @returns {Promise<any>}
     */
    public async PimPerson_OpenSocAInfoView(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
    
        let data: any = {};
        let parentContext:any = {};
        let parentViewParam:any = {};
        const _this: any = actionContext;
        Object.assign(params,{socarchives:"%pimpersonid%"});
     ...
     * @returns {Promise<any>}
     */
    public async PimPerson_QuickCreateSocArchives(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const openPopupModal = (view: any, data: any) => {
                ...
                container.subscribe((result: any) => {
                    ...
                    if (this.PimPerson_OpenSocAInfoView && this.PimPerson_OpenSocAInfoView instanceof Function) {
                        this.PimPerson_OpenSocAInfoView(result.datas,context, params, $event, xData,actionContext);
                    }
                    if(window.opener){
                        window.opener.postMessage({status:'OK',identification:'WF'},Environment.uniteAddress);
                        window.close();
