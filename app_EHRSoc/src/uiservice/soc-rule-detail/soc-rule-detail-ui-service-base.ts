 ...
 *
 * @export
 * @class SocRuleDetailUIServiceBase
 */
export default class SocRuleDetailUIServiceBase extends UIService {
     ...
     * @memberof  SocRuleDetailUIServiceBase
     */
    public dataService:SocRuleDetailService = new SocRuleDetailService();
    ...
    /**
     * Creates an instance of  SocRuleDetailUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  SocRuleDetailUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({socruledetail:srfkey});
