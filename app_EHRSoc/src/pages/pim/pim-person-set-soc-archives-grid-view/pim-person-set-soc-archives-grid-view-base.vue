...
export default class PimPersonSetSocArchivesGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        tbitem1_quickcreatesocarchives: { name: 'tbitem1_quickcreatesocarchives', caption: '新建社保档案','isShowCaption':true,'isShowIcon':true, tooltip: '新建社保档案', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'QuickCreateSocArchives', target: 'SINGLEKEY' }, class: '' },
