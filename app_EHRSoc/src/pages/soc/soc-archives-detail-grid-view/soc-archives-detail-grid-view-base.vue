<template>
  <app-layout viewName="socarchivesdetailgridview" viewTitle="社保档案明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'soc-archives-detail-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SocArchivesDetailGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocArchivesDetailGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocArchivesDetailService}
     * @memberof SocArchivesDetailGridViewBase
     */
	 ...
	 * @memberof SocArchivesDetailGridViewBase
	 */
	public viewtag: string = 'aa42ee6a3edbf6fc9c11a80fcac3d365';
     ...
     */
    public model: any = {
        srfCaption: 'entities.socarchivesdetail.views.gridview.caption',
        srfTitle: 'entities.socarchivesdetail.views.gridview.title',
        srfSubTitle: 'entities.socarchivesdetail.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SocArchivesDetailGridView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"SocArchivesDetail");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"SocArchivesDetail");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SocArchivesDetail");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"SocArchivesDetail");
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SocArchivesDetail");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.socarchivesdetail;
        if(args.length >0){
...
<style lang='less'>
@import './soc-archives-detail-grid-view.less';
</style>