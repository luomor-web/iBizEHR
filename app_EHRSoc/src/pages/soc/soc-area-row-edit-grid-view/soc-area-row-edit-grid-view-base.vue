<template>
  <app-layout viewName="socarearoweditgridview" viewTitle="参保地表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'soc-area-row-edit-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="参保地名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class SocAreaRowEditGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocAreaRowEditGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocAreaService}
     * @memberof SocAreaRowEditGridViewBase
     */
	 ...
	 * @memberof SocAreaRowEditGridViewBase
	 */
	public viewtag: string = '8560a1fd46139dfc5f1fc71b0a3f59b0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.socarea.views.roweditgridview.caption',
        srfTitle: 'entities.socarea.views.roweditgridview.title',
        srfSubTitle: 'entities.socarea.views.roweditgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SocAreaRowEditGridView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'soc-area-edit-view', 
            height: 600, 
            width: 1024,  
            title: this.$t('entities.socarea.views.editview.title'),
        };
...
<style lang='less'>
@import './soc-area-row-edit-grid-view.less';
</style>