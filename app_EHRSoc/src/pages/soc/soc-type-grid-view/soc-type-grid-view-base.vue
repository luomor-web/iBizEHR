<template>
  <app-layout viewName="soctypegridview" viewTitle="保险类型表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'soc-type-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SocTypeGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocTypeGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocTypeService}
     * @memberof SocTypeGridViewBase
     */
	 ...
	 * @memberof SocTypeGridViewBase
	 */
	public viewtag: string = 'a91ca0b2a35fc0bc1c22a613b0af0f04';
     ...
     */
    public model: any = {
        srfCaption: 'entities.soctype.views.gridview.caption',
        srfTitle: 'entities.soctype.views.gridview.title',
        srfSubTitle: 'entities.soctype.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"SocType");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"SocType");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SocType");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"SocType");
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SocType");
    }
...
<style lang='less'>
@import './soc-type-grid-view.less';
</style>