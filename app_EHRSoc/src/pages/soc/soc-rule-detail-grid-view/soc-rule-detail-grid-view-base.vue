<template>
  <app-layout viewName="socruledetailgridview" viewTitle="社保规则明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'soc-rule-detail-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SocRuleDetailGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocRuleDetailGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocRuleDetailService}
     * @memberof SocRuleDetailGridViewBase
     */
	 ...
	 * @memberof SocRuleDetailGridViewBase
	 */
	public viewtag: string = 'b90f6f466753e0b928ea594d2a38ab73';
     ...
     */
    public model: any = {
        srfCaption: 'entities.socruledetail.views.gridview.caption',
        srfTitle: 'entities.socruledetail.views.gridview.title',
        srfSubTitle: 'entities.socruledetail.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SocRuleDetailGridView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"SocRuleDetail");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"SocRuleDetail");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SocRuleDetail");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"SocRuleDetail");
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"SocRuleDetail");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.socruledetail;
        if(args.length >0){
...
<style lang='less'>
@import './soc-rule-detail-grid-view.less';
</style>