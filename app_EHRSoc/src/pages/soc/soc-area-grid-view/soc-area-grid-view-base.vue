<template>
  <app-layout viewName="socareagridview" viewTitle="参保地表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'soc-area-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SocAreaGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocAreaGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocAreaService}
     * @memberof SocAreaGridViewBase
     */
	 ...
	 * @memberof SocAreaGridViewBase
	 */
	public viewtag: string = '1a1326e28ef5ec3d85b45c0d9ecf9684';
     ...
     */
    public model: any = {
        srfCaption: 'entities.socarea.views.gridview.caption',
        srfTitle: 'entities.socarea.views.gridview.title',
        srfSubTitle: 'entities.socarea.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SocArea");
    }
...
<style lang='less'>
@import './soc-area-grid-view.less';
</style>