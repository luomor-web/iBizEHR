...
export default class PimPersonUIServiceBase extends UIService {
    ...
    public initViewMap(){
        ...
        this.allViewMap.set(':',{viewname:'txglgridview',srfappde:'pimpeople'});
        ...
        this.allViewMap.set(':',{viewname:'txryeditview',srfappde:'pimpeople'});
        this.allViewMap.set(':',{viewname:'txqreditview',srfappde:'pimpeople'});
        this.allViewMap.set(':',{viewname:'editview9',srfappde:'pimpeople'});
     ...
     * @returns {Promise<any>}
     */
    public async PimPerson_CKTXJL(args: any[], context:any = {} ,params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        let data: any = {};
     ...
     * @returns {Promise<any>}
     */
    public async PimPerson_OpenTxEditView(args: any[], context:any = {} ,params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        let data: any = {};
        const _args: any[] = Util.deepCopy(args);
        const _this: any = actionContext;
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                ...
                height: 750, 
                width: 0,  
                title: actionContext.$t('entities.pimperson.views.txryeditview.title'),
            };
    ...
    public async PimPerson_SQJXSZZ(args: any[], context:any = {} ,params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                ...
                height: 750, 
                width: 0,  
                title: actionContext.$t('entities.pcmjxsygzzjlmx.views.xzeditview.title'),
            };
            openPopupModal(view, data);
    }
     ...
     * @returns {Promise<any>}
     */
    public async PimPerson_QRTX(args: any[], context:any = {} ,params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        let data: any = {};
        const _args: any[] = Util.deepCopy(args);
        const _this: any = actionContext;
        const actionTarget: string | null = 'SINGLEKEY';
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'pim-person-txqredit-view', 
                height: 400, 
                width: 500,  
