<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmddsqd_pldd' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmddsqd.pldd_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.druipart1.visible" :style="{'height': '650px !important',}"  :lg="{ span: 24, offset: 0 }">
    <app-form-druipart
    
    :formState="formState"
    :isForbidLoad="this.data.srfuf === '0'"
    paramItem='pcmddsqd' 
    :parentdata='{"srfparentdefname":"PCMDDSQDID","srfparentdename":"PCMDDSQD","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_PCMDDSQDMX_PCMDDSQD_PCMDDSQDID","SRFDER1NID":"DER1N_PCMDDSQDMX_PCMDDSQD_PCMDDSQDID"}'
    :parameters="[
    ...
    :localContext ='{}'
    :localParam ='{}'
    parameterName='pcmddsqd'
    parentName="PcmDdsqd"  
    refviewtype='DEGRIDVIEW' 
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='pcm-ddsqdmx-pddgrid-view' 
...
export default class PLDDBase extends Vue implements ControlInterface {
...
, 
        group1: new FormGroupPanelModel({ caption: '调动明细', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmddsqd.pldd_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '调动申请单标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pcmddsqd){
            Object.assign(this.context,{pcmddsqd:data.pcmddsqd})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pcmddsqd = copyData.srfkey;
        copyData.pcmddsqdid = copyData.srfkey;
        Object.assign(this.context,{pcmddsqd:copyData.pcmddsqd})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmddsqd_pldd',popTitle:'批量调动'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdXZPDDEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdXZPDDEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdXZPDDEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PcmDdsqdXZPDDEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pcmddsqd || Object.is(arg.pcmddsqd, '')) {
            return;
        }
