...
import PLDDModel from './pldd-form-model';
 ...
 * @class PLDDService
 */
export default class PLDDService extends ControlService {

    /**
     * 调动申请单服务对象
     *
     * @type {PcmDdsqdService}
     * @memberof PLDDService
     */
    public appEntityService: PcmDdsqdService = new PcmDdsqdService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of PLDDService.
     * 
     * @param {*} [opts={}]
     * @memberof PLDDService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmddsqdid = PrimaryKey;
        Data.pcmddsqd = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmddsqdid = PrimaryKey;
