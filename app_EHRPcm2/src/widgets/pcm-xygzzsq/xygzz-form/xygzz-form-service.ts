...
import XYGZZModel from './xygzz-form-model';
 ...
 * @class XYGZZService
 */
export default class XYGZZService extends ControlService {

    /**
     * 试用期员工转正申请服务对象
     *
     * @type {PcmXygzzsqService}
     * @memberof XYGZZService
     */
    public appEntityService: PcmXygzzsqService = new PcmXygzzsqService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of XYGZZService.
     * 
     * @param {*} [opts={}]
     * @memberof XYGZZService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmxygzzsqid = PrimaryKey;
        Data.pcmxygzzsq = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmxygzzsqid = PrimaryKey;
