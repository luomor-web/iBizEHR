...
import TXEditFormModel from './txedit-form-form-model';
 ...
 *
 * @export
 * @class TXEditFormService
 */
export default class TXEditFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof TXEditFormService
     */
    ...
    /**
     * Creates an instance of TXEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof TXEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TXEditFormModel();
    }
