...
import TXQREditFormModel from './txqredit-form-form-model';
 ...
 *
 * @export
 * @class TXQREditFormService
 */
export default class TXQREditFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof TXQREditFormService
     */
    ...
    /**
     * Creates an instance of TXQREditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof TXQREditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TXQREditFormModel();
    }
     ...
     * @memberof TXQREditFormService
     */
    public pimfaminfoService: PimFaminfoService = new PimFaminfoService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'PimFaminfoService') && Object.is(interfaceName, 'FetchJTLXR')) {
            return this.doItems(this.pimfaminfoService.FetchJTLXR(JSON.parse(JSON.stringify(context)),data, isloading), 'pimfaminfoid', 'pimfaminfo');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimpersonid = PrimaryKey;
        Data.pimperson = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimpersonid = PrimaryKey;
