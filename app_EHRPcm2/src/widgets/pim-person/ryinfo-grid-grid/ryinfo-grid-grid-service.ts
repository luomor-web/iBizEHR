...
import RYInfoGridModel from './ryinfo-grid-grid-model';
 ...
 *
 * @export
 * @class RYInfoGridService
 */
export default class RYInfoGridService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof RYInfoGridService
     */
    ...
    /**
     * Creates an instance of RYInfoGridService.
     * 
     * @param {*} [opts={}]
     * @memberof RYInfoGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYInfoGridModel();
    }
