<template>
    <i-form :model="this.data" class='app-form info-form-mode' ref='form'  id='pimperson_jxsyeditform' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimperson.jxsyeditform_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="1" :isInfoGroupMode="true" >    
    <row>
...
import JXSYEditFormService from './jxsyedit-form-form-service';
...
export default class JXSYEditFormBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof JXSYEditFormBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {JXSYEditFormService}
     * @memberof JXSYEditFormBase
     */
    public service: JXSYEditFormService = new JXSYEditFormService({ $store: this.$store });
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '详细信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimperson.jxsyeditform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        duration: new FormItemModel({ caption: '实习/试用期限', detailType: 'FORMITEM', name: 'duration', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 1 })
, 
...
, 
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof JXSYEditFormBase
     */
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimperson_jxsyeditform',popTitle:'见习试用编辑'});
    }
...
<style lang='less'>
@import './jxsyedit-form-form.less';
</style>