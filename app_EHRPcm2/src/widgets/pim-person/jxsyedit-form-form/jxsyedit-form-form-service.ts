...
import JXSYEditFormModel from './jxsyedit-form-form-model';
 ...
 *
 * @export
 * @class JXSYEditFormService
 */
export default class JXSYEditFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof JXSYEditFormService
     */
    ...
    /**
     * Creates an instance of JXSYEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof JXSYEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new JXSYEditFormModel();
    }
