...
import YDRYInfoSearchFormModel from './ydryinfo-search-form-searchform-model';


/**
 * YDRYInfoSearchForm 部件服务对象
 *
 * @export
 * @class YDRYInfoSearchFormService
 */
export default class YDRYInfoSearchFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof YDRYInfoSearchFormService
     */
    ...
    /**
     * Creates an instance of YDRYInfoSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof YDRYInfoSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new YDRYInfoSearchFormModel();
    }
