...
import SYQYGSearchFormModel from './syqygsearch-form-searchform-model';


/**
 * SYQYGSearchForm 部件服务对象
 *
 * @export
 * @class SYQYGSearchFormService
 */
export default class SYQYGSearchFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof SYQYGSearchFormService
     */
    ...
    /**
     * Creates an instance of SYQYGSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof SYQYGSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new SYQYGSearchFormModel();
    }
