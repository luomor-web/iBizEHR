...
import JXQYGSearchFormModel from './jxqygsearch-form-searchform-model';


/**
 * JXQYGSearchForm 部件服务对象
 *
 * @export
 * @class JXQYGSearchFormService
 */
export default class JXQYGSearchFormService extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof JXQYGSearchFormService
     */
    ...
    /**
     * Creates an instance of JXQYGSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof JXQYGSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new JXQYGSearchFormModel();
    }
