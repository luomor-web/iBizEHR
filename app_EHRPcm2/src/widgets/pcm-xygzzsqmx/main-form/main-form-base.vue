<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmxygzzsqmx_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmxygzzsqmx.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pcmxygzzsqmx.main_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zz' :itemRules="this.rules.zz" class='' :caption="$t('entities.pcmxygzzsqmx.main_form.details.zz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.bm.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='bm' :itemRules="this.rules.bm" class='' :caption="$t('entities.pcmxygzzsqmx.main_form.details.bm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bm.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.bm"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.bm.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.zj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zj' :itemRules="this.rules.zj" class='' :caption="$t('entities.pcmxygzzsqmx.main_form.details.zj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zj.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.zj"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.zj.disabled" type='text'  style=""></input-box>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.zw.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='zw' :itemRules="this.rules.zw" class='' :caption="$t('entities.pcmxygzzsqmx.main_form.details.zw')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zw.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.gw.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='gw' :itemRules="this.rules.gw" class='' :caption="$t('entities.pcmxygzzsqmx.main_form.details.gw')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.gw.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '试用期员工转正申请明细标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '试用期员工转正申请明细标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '试用期员工转正申请明细标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '试用期员工转正申请明细标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '试用期员工转正申请明细名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '试用期员工转正申请明细名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '试用期员工转正申请明细名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '试用期员工转正申请明细名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '试用期员工转正申请明细基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmxygzzsqmx.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '试用期员工转正申请明细标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '试用期员工转正申请明细名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimpersonname: new FormItemModel({ caption: '员工', detailType: 'FORMITEM', name: 'pimpersonname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        zj: new FormItemModel({ caption: '职级', detailType: 'FORMITEM', name: 'zj', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
        pcmxygzzsqmxid: new FormItemModel({ caption: '试用期员工转正申请明细标识', detailType: 'FORMITEM', name: 'pcmxygzzsqmxid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    /**
     * 监控表单属性 pcmxygzzsqmxid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.pcmxygzzsqmxid')
    onPcmxygzzsqmxidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pcmxygzzsqmxid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pcmxygzzsqmx){
            Object.assign(this.context,{pcmxygzzsqmx:data.pcmxygzzsqmx})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pcmxygzzsqmx = copyData.srfkey;
        copyData.pcmxygzzsqmxid = copyData.srfkey;
        Object.assign(this.context,{pcmxygzzsqmx:copyData.pcmxygzzsqmx})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmxygzzsqmx_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PcmXygzzsqmxEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmXygzzsqmxEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PcmXygzzsqmxEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PcmXygzzsqmxEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pcmxygzzsqmx || Object.is(arg.pcmxygzzsqmx, '')) {
            return;
        }
