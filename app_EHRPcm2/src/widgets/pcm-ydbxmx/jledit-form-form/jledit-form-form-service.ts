 ...
 *
 * @export
 * @class JLEditFormService
 */
export default class JLEditFormService extends ControlService {
    ...
    /**
     * Creates an instance of JLEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof JLEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new JLEditFormModel();
    }
