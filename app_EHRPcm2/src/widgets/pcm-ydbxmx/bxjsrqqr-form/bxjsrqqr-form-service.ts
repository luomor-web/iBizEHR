...
import BXJSRQQRModel from './bxjsrqqr-form-model';
 ...
 *
 * @export
 * @class BXJSRQQRService
 */
export default class BXJSRQQRService extends ControlService {

    /**
     * 异动病休明细服务对象
     *
     * @type {PcmYdbxmxService}
     * @memberof BXJSRQQRService
     */
    public appEntityService: PcmYdbxmxService = new PcmYdbxmxService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of BXJSRQQRService.
     * 
     * @param {*} [opts={}]
     * @memberof BXJSRQQRService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmydbxmxid = PrimaryKey;
        Data.pcmydbxmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmydbxmxid = PrimaryKey;
