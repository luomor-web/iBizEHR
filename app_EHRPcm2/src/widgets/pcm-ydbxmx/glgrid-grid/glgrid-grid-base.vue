    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('cz')">
                <el-table-column show-overflow-tooltip :prop="'cz'" :label="$t('entities.pcmydbxmx.glgrid_grid.columns.cz')" :width="100"  :align="'center'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydbxmx.glgrid_grid.columns.cz')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmydbxmx.glgrid_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pcmydbxmx.glgrid_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pcmydbxmx.glgrid_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
    ...
    public allColumns: any[] = [
        {
            name: 'cz',
            label: '操作',
            langtag: 'entities.pcmydbxmx.glgrid_grid.columns.cz',
            show: true,
            util: 'PX'
        },
        {
