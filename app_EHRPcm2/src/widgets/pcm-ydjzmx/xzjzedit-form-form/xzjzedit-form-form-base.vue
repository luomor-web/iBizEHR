<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmydjzmx_xzjzeditform' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ygbh.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ygbh' :itemRules="this.rules.ygbh" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ygbh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ygbh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zz.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='zz' :itemRules="this.rules.zz" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.zz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.bm.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='bm' :itemRules="this.rules.bm" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.bm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ygw.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ygw' :itemRules="this.rules.ygw" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ygw')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ygw.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.yzw.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='yzw' :itemRules="this.rules.yzw" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.yzw')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.yzw.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.grouppanel1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.ksrq.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ksrq' :itemRules="this.rules.ksrq" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ksrq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ksrq.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.jsrq.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='jsrq' :itemRules="this.rules.jsrq" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.jsrq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jsrq.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormorgname' :itemRules="this.rules.ormorgname" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ormorgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgsectorname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormorgsectorname' :itemRules="this.rules.ormorgsectorname" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ormorgsectorname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgsectorname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormpostname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormpostname' :itemRules="this.rules.ormpostname" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ormpostname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormpostname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormdutyname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormdutyname' :itemRules="this.rules.ormdutyname" class='' :caption="$t('entities.pcmydjzmx.xzjzeditform_form.details.ormdutyname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormdutyname.error" :isEmptyCaption="false" labelPos="LEFT">
...
import XZJZEditFormService from './xzjzedit-form-form-service';
...
export default class XZJZEditFormBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof XZJZEditFormBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {XZJZEditFormService}
     * @memberof XZJZEditFormBase
     */
    public service: XZJZEditFormService = new XZJZEditFormService({ $store: this.$store });
    ...
    public rules: any = {
        ...
        srfkey: [
            ...
            { type: 'string', message: '异动兼职明细标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '异动兼职明细标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '异动兼职明细标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '异动兼职明细名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '异动兼职明细名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '异动兼职明细名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '异动兼职明细名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        ormorgid: [
            ...
            { type: 'string', message: '兼职组织标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '兼职组织标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '兼职组织标识 值不能为空', trigger: 'blur' },
        ],
        ormorgsectorname: [
        ...
        ormorgsectorid: [
            ...
            { type: 'string', message: '兼职部门标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '兼职部门标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '兼职部门标识 值不能为空', trigger: 'blur' },
        ],
        ormpostname: [
            { type: 'string', message: '兼职岗位 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '兼职岗位 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '兼职岗位 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '兼职岗位 值不能为空', trigger: 'blur' },
        ],
        ormpostid: [
            { type: 'string', message: '兼职岗位管理标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '兼职岗位管理标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '兼职岗位管理标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '兼职岗位管理标识 值不能为空', trigger: 'blur' },
        ],
        ormdutyid: [
            { type: 'string', message: '兼职职务标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '兼职职务标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '兼职职务标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '兼职职务标识 值不能为空', trigger: 'blur' },
        ],
        ormdutyname: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '人员信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjzmx.xzjzeditform_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '兼职信息', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjzmx.xzjzeditform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '异动兼职明细标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '异动兼职明细名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ksrq: new FormItemModel({ caption: '兼职开始日期', detailType: 'FORMITEM', name: 'ksrq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        jsrq: new FormItemModel({ caption: '兼职结束日期', detailType: 'FORMITEM', name: 'jsrq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgname: new FormItemModel({ caption: '兼职组织', detailType: 'FORMITEM', name: 'ormorgname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgid: new FormItemModel({ caption: '兼职组织标识', detailType: 'FORMITEM', name: 'ormorgid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgsectorname: new FormItemModel({ caption: '兼职部门', detailType: 'FORMITEM', name: 'ormorgsectorname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgsectorid: new FormItemModel({ caption: '兼职部门标识', detailType: 'FORMITEM', name: 'ormorgsectorid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ormpostid: new FormItemModel({ caption: '兼职岗位管理标识', detailType: 'FORMITEM', name: 'ormpostid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     * @memberof XZJZEditFormBase
     */
    @Watch('data.pcmydjzmxid')
    onPcmydjzmxidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pcmydjzmxid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if(Object.is(name, 'pimpersonid')){
            const details: string[] = ['bmid', 'zz', 'zzid', 'ygbh', 'pimpersonname', 'yzw', 'ygw', 'bm'];
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pcmydjzmx){
            Object.assign(this.context,{pcmydjzmx:data.pcmydjzmx})
        }
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof XZJZEditFormBase
     */
    public copy(srfkey: string): void {
        let copyData = this.$store.getters.getCopyData(srfkey);
        copyData.srfkey = Util.createUUID();
        copyData.pcmydjzmx = copyData.srfkey;
        copyData.pcmydjzmxid = copyData.srfkey;
        Object.assign(this.context,{pcmydjzmx:copyData.pcmydjzmx})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmydjzmx_xzjzeditform',popTitle:'新增兼职表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxXZEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxXZEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxXZEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxXZEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pcmydjzmx || Object.is(arg.pcmydjzmx, '')) {
            return;
        }
...
<style lang='less'>
@import './xzjzedit-form-form.less';
</style>