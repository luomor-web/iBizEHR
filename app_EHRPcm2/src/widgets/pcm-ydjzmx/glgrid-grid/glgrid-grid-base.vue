    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('cz')">
                <el-table-column show-overflow-tooltip :prop="'cz'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.cz')" :width="100"  :align="'center'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.cz')}}
                      </span>
                    </template>
    ...
    public allColumns: any[] = [
        {
            name: 'cz',
            label: '操作',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.cz',
            show: true,
            util: 'PX'
        },
        {
