...
import JZJSQRModel from './jzjsqr-form-model';
 ...
 * @class JZJSQRService
 */
export default class JZJSQRService extends ControlService {

    /**
     * 异动兼职明细服务对象
     *
     * @type {PcmYdjzmxService}
     * @memberof JZJSQRService
     */
    ...
    /**
     * Creates an instance of JZJSQRService.
     * 
     * @param {*} [opts={}]
     * @memberof JZJSQRService
     */
