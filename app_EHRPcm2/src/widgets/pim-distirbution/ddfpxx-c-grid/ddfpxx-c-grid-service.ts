...
import DDFPXX_CModel from './ddfpxx-c-grid-model';
 ...
 *
 * @export
 * @class DDFPXX_CService
 */
export default class DDFPXX_CService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof DDFPXX_CService
     */
    ...
    /**
     * Creates an instance of DDFPXX_CService.
     * 
     * @param {*} [opts={}]
     * @memberof DDFPXX_CService
     */
