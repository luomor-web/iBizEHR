...
import MaturityDueEditFormModel from './maturity-due-edit-form-form-model';
...
/**
 * MaturityDueEditForm 部件服务对象
 *
 * @export
 * @class MaturityDueEditFormService
 */
export default class MaturityDueEditFormService extends ControlService {
    ...
    /**
     * Creates an instance of MaturityDueEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof MaturityDueEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MaturityDueEditFormModel();
    }
