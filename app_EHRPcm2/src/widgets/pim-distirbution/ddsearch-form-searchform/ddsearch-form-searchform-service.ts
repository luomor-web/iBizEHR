...
import DDSearchFormModel from './ddsearch-form-searchform-model';
 ...
 *
 * @export
 * @class DDSearchFormService
 */
export default class DDSearchFormService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof DDSearchFormService
     */
    ...
    /**
     * Creates an instance of DDSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof DDSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DDSearchFormModel();
    }
