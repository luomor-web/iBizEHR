...
import DDFPXXModel from './ddfpxx-grid-model';
 ...
 * @class DDFPXXService
 */
export default class DDFPXXService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof DDFPXXService
     */
    ...
    /**
     * Creates an instance of DDFPXXService.
     * 
     * @param {*} [opts={}]
     * @memberof DDFPXXService
     */
