...
import MaturityDueGridModel from './maturity-due-grid-grid-model';
import OrmPostService from '@/service/orm-post/orm-post-service';
import OrmDutyService from '@/service/orm-duty/orm-duty-service';


/**
 * MaturityDueGrid 部件服务对象
 *
 * @export
 * @class MaturityDueGridService
 */
export default class MaturityDueGridService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof MaturityDueGridService
     */
    ...
    /**
     * Creates an instance of MaturityDueGridService.
     * 
     * @param {*} [opts={}]
     * @memberof MaturityDueGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MaturityDueGridModel();
    }
