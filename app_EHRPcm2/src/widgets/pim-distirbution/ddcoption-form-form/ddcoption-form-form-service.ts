...
import DDCOptionFormModel from './ddcoption-form-form-model';


/**
 * DDCOptionForm 部件服务对象
 *
 * @export
 * @class DDCOptionFormService
 */
export default class DDCOptionFormService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof DDCOptionFormService
     */
    ...
    /**
     * Creates an instance of DDCOptionFormService.
     * 
     * @param {*} [opts={}]
     * @memberof DDCOptionFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DDCOptionFormModel();
    }
