...
export default class OrmOrgSectorPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     *
     * @type {string}
     * @memberof OrmOrgSectorPickupViewpickupviewpanelBase
     */
     ...
     * @memberof OrmOrgSectorPickupViewpickupviewpanelBase
     */
    public service: OrmOrgSectorPickupViewpickupviewpanelService = new OrmOrgSectorPickupViewpickupviewpanelService({ $store: this.$store });
     ...
     */
    public view: any = {
        viewname: 'orm-duty-orm-org-sector-pickup-grid-view',
        data: {},
    }
