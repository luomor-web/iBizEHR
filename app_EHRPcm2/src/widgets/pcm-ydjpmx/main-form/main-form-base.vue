<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmydjpmx_main' style="">
...
<i-col v-show="detailsModel.zz.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='zz' :itemRules="this.rules.zz" class='' :caption="$t('entities.pcmydjpmx.main_form.details.zz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.bm.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='bm' :itemRules="this.rules.bm" class='' :caption="$t('entities.pcmydjpmx.main_form.details.bm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.lxdh.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='lxdh' :itemRules="this.rules.lxdh" class='' :caption="$t('entities.pcmydjpmx.main_form.details.lxdh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.lxdh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.jpfj.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='jpfj' :itemRules="this.rules.jpfj" class='' :caption="$t('entities.pcmydjpmx.main_form.details.jpfj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jpfj.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-file-upload :formState="formState" :ignorefieldvaluechange="ignorefieldvaluechange" @formitemvaluechange="onFormItemValueChange" :data="JSON.stringify(this.data)" name='jpfj' :value="data.jpfj" :disabled="detailsModel.jpfj.disabled" uploadparams='' exportparams='' :customparams="{}" style="overflow: auto;"></app-file-upload>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.bz.visible" :style="{}"  :md="{ span: 24, offset: 0 }" :lg="{ span: 24, offset: 0 }" :xl="{ span: 24, offset: 0 }">
    <app-form-item name='bz' :itemRules="this.rules.bz" class='' :caption="$t('entities.pcmydjpmx.main_form.details.bz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.remarks.visible" :style="{}"  :md="{ span: 24, offset: 0 }" :lg="{ span: 24, offset: 0 }" :xl="{ span: 24, offset: 0 }">
    <app-form-item name='remarks' :itemRules="this.rules.remarks" class='' :caption="$t('entities.pcmydjpmx.main_form.details.remarks')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.remarks.error" :isEmptyCaption="false" labelPos="LEFT">
    <div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type">
...
<i-col v-show="detailsModel.bcjse.visible" :style="{}"  :md="{ span: 8, offset: 0 }" :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='bcjse' :itemRules="this.rules.bcjse" class='' :caption="$t('entities.pcmydjpmx.main_form.details.bcjse')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bcjse.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.bcjse"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.bcjse.disabled" type='number'  style=""></input-box>
</app-form-item>
...
<i-col v-show="detailsModel.grouppanel4.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel4.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmydjpmx.main_form.details.grouppanel4')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
<i-col v-show="detailsModel.pcjse.visible" :style="{}"  :md="{ span: 8, offset: 0 }" :lg="{ span: 8, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='pcjse' :itemRules="this.rules.pcjse" class='' :caption="$t('entities.pcmydjpmx.main_form.details.pcjse')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pcjse.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box v-model="data.pcjse"  @enter="onEnter($event)"   unit=""  :disabled="detailsModel.pcjse.disabled" type='number'  style=""></input-box>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        sxrq: [
            ...
            { required: true, type: 'string', message: '解聘日期 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '解聘日期 值不能为空', trigger: 'blur' },
        ],
        sfhmd: [
            { type: 'number', message: '是否加黑名单 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '是否加黑名单 值必须为数值类型', trigger: 'blur' },
            { required: true, type: 'number', message: '是否加黑名单 值不能为空', trigger: 'change' },
            { required: true, type: 'number', message: '是否加黑名单 值不能为空', trigger: 'blur' },
        ],
        reason: [
            { type: 'string', message: '解聘原因 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '解聘原因 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '解聘原因 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '解聘原因 值不能为空', trigger: 'blur' },
        ],
        jpfj: [
        ...
        sfzfbcj: [
            ...
            { type: 'number', message: '是否支付补偿金 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '是否支付补偿金 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '是否支付补偿金 值不能为空', trigger: 'blur' },
        ],
        bcjse: [
        ...
        sfldzy: [
            { type: 'number', message: '是否有劳动争议 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '是否有劳动争议 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '是否有劳动争议 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '是否有劳动争议 值不能为空', trigger: 'blur' },
        ],
        ldzytype: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '人员信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjpmx.main_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '解聘信息', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjpmx.main_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel3: new FormGroupPanelModel({ caption: '补偿', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjpmx.main_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel4: new FormGroupPanelModel({ caption: '劳动争议', detailType: 'GROUPPANEL', name: 'grouppanel4', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjpmx.main_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '赔偿信息', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjpmx.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if(Object.is(name, 'pimpersonid')){
            const details: string[] = ['zzid', 'ygw', 'yrank', 'bm', 'bmid', 'zz', 'yzw', 'lxdh', 'ygbh'];
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmydjpmx_main',popTitle:'主编辑表单'});
    }
