...
import JTLXRPickupViewpickupviewpanelModel from './jtlxrpickup-viewpickupviewpanel-pickupviewpanel-model';
...
export default class JTLXRPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
...
<style lang='less'>
@import './jtlxrpickup-viewpickupviewpanel-pickupviewpanel.less';
</style>