...
import LXRGridModel from './lxrgrid-grid-model';
 ...
 *
 * @export
 * @class LXRGridService
 */
export default class LXRGridService extends ControlService {

    /**
     * 家庭情况服务对象
     *
     * @type {PimFaminfoService}
     * @memberof LXRGridService
     */
    ...
    /**
     * Creates an instance of LXRGridService.
     * 
     * @param {*} [opts={}]
     * @memberof LXRGridService
     */
