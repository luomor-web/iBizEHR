...
import DDGXGZFormModel from './ddgxgzform-form-model';
 ...
 *
 * @export
 * @class DDGXGZFormService
 */
export default class DDGXGZFormService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof DDGXGZFormService
     */
    ...
    /**
     * Creates an instance of DDGXGZFormService.
     * 
     * @param {*} [opts={}]
     * @memberof DDGXGZFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DDGXGZFormModel();
    }
