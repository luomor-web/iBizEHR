...
import ZWBDSQMXModel from './zwbdsqmx-form-model';
 ...
 *
 * @export
 * @class ZWBDSQMXService
 */
export default class ZWBDSQMXService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof ZWBDSQMXService
     */
    ...
    /**
     * Creates an instance of ZWBDSQMXService.
     * 
     * @param {*} [opts={}]
     * @memberof ZWBDSQMXService
     */
