...
import LGSQMXModel from './lgsqmx-form-model';
 ...
 * @class LGSQMXService
 */
export default class LGSQMXService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof LGSQMXService
     */
    ...
    /**
     * Creates an instance of LGSQMXService.
     * 
     * @param {*} [opts={}]
     * @memberof LGSQMXService
     */
