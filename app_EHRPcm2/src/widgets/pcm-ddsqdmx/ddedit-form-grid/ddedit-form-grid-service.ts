...
import DDEditFormModel from './ddedit-form-grid-model';
 ...
 *
 * @export
 * @class DDEditFormService
 */
export default class DDEditFormService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof DDEditFormService
     */
    ...
    /**
     * Creates an instance of DDEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof DDEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DDEditFormModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.pcmddsqdmxid = Util.createUUID();
                }
