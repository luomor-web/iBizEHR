...
import JZSQMXModel from './jzsqmx-form-model';
 ...
 * @class JZSQMXService
 */
export default class JZSQMXService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof JZSQMXService
     */
    ...
    /**
     * Creates an instance of JZSQMXService.
     * 
     * @param {*} [opts={}]
     * @memberof JZSQMXService
     */
