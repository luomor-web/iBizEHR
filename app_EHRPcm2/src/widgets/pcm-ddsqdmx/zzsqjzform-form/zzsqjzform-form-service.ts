...
import ZZSQJZFormModel from './zzsqjzform-form-model';
 ...
 *
 * @export
 * @class ZZSQJZFormService
 */
export default class ZZSQJZFormService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof ZZSQJZFormService
     */
    public appEntityService: PcmDdsqdmxService = new PcmDdsqdmxService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ZZSQJZFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ZZSQJZFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ZZSQJZFormModel();
    }
     ...
     * @memberof ZZSQJZFormService
     */
    public pimdistirbutionService: PimDistirbutionService = new PimDistirbutionService();
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmddsqdmxid = PrimaryKey;
        Data.pcmddsqdmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmddsqdmxid = PrimaryKey;
