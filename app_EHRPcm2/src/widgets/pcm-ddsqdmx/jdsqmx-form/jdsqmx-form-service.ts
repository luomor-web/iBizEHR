...
import JDSQMXModel from './jdsqmx-form-model';
 ...
 * @class JDSQMXService
 */
export default class JDSQMXService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof JDSQMXService
     */
    ...
    /**
     * Creates an instance of JDSQMXService.
     * 
     * @param {*} [opts={}]
     * @memberof JDSQMXService
     */
