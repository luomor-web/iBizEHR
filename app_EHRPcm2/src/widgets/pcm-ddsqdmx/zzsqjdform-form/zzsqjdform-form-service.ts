...
import ZZSQJDFormModel from './zzsqjdform-form-model';
 ...
 *
 * @export
 * @class ZZSQJDFormService
 */
export default class ZZSQJDFormService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof ZZSQJDFormService
     */
    ...
    /**
     * Creates an instance of ZZSQJDFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ZZSQJDFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ZZSQJDFormModel();
    }
