...
import ZZSQDDFormModel from './zzsqddform-form-model';
 ...
 *
 * @export
 * @class ZZSQDDFormService
 */
export default class ZZSQDDFormService extends ControlService {

    /**
     * 调动申请单明细服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof ZZSQDDFormService
     */
    ...
    /**
     * Creates an instance of ZZSQDDFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ZZSQDDFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ZZSQDDFormModel();
    }
