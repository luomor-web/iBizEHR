...
import GLSearchFormModel from './glsearch-form-searchform-model';
 ...
 *
 * @export
 * @class GLSearchFormService
 */
export default class GLSearchFormService extends ControlService {

    /**
     * 异动离职明细服务对象
     *
     * @type {PcmYdlzmxService}
     * @memberof GLSearchFormService
     */
    ...
    /**
     * Creates an instance of GLSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GLSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GLSearchFormModel();
    }
