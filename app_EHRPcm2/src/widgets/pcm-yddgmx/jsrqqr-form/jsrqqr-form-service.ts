...
import JSRQQRModel from './jsrqqr-form-model';
 ...
 * @class JSRQQRService
 */
export default class JSRQQRService extends ControlService {

    /**
     * 异动待岗明细服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof JSRQQRService
     */
    public appEntityService: PcmYddgmxService = new PcmYddgmxService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of JSRQQRService.
     * 
     * @param {*} [opts={}]
     * @memberof JSRQQRService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmyddgmxid = PrimaryKey;
        Data.pcmyddgmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmyddgmxid = PrimaryKey;
