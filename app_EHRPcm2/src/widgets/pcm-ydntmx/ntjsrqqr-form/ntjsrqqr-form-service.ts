...
import NTJSRQQRModel from './ntjsrqqr-form-model';
 ...
 *
 * @export
 * @class NTJSRQQRService
 */
export default class NTJSRQQRService extends ControlService {

    /**
     * 异动内退明细服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof NTJSRQQRService
     */
    public appEntityService: PcmYdntmxService = new PcmYdntmxService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of NTJSRQQRService.
     * 
     * @param {*} [opts={}]
     * @memberof NTJSRQQRService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmydntmxid = PrimaryKey;
        Data.pcmydntmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmydntmxid = PrimaryKey;
