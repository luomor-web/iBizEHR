...
export default class NTCKBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        jsrq: [
            ...
            { type: 'string', message: '内退结束日期 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '内退结束日期 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '内退结束日期 值不能为空', trigger: 'blur' },
        ],
        reason: [
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '内退信息', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydntmx.ntck_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if(Object.is(name, 'pimpersonid')){
            const details: string[] = ['yzw', 'ygbh', 'zzid', 'pimpersonname', 'lxdh', 'bm', 'yrank', 'ygw', 'bmid', 'zz'];
