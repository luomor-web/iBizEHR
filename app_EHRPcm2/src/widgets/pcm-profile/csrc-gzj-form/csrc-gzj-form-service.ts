...
import CSRC_GZJModel from './csrc-gzj-form-model';
 ...
 *
 * @export
 * @class CSRC_GZJService
 */
export default class CSRC_GZJService extends ControlService {

    /**
     * 应聘者基本信息服务对象
     *
     * @type {PcmProfileService}
     * @memberof CSRC_GZJService
     */
    ...
    /**
     * Creates an instance of CSRC_GZJService.
     * 
     * @param {*} [opts={}]
     * @memberof CSRC_GZJService
     */
