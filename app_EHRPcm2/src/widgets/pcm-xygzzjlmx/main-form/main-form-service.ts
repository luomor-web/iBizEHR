...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: PcmXygzzjlmxService = new PcmXygzzjlmxService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public pcmxygzzkhjgjlService: PcmXygzzkhjgjlService = new PcmXygzzkhjgjlService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'PcmXygzzkhjgjlService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.pcmxygzzkhjgjlService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'pcmxygzzkhjgjlid', 'pcmxygzzkhjgjl');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmxygzzjlmxid = PrimaryKey;
        Data.pcmxygzzjlmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmxygzzjlmxid = PrimaryKey;
