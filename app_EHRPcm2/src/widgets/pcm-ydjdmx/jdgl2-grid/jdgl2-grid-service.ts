...
import JDGL2Model from './jdgl2-grid-model';
 ...
 * @class JDGL2Service
 */
export default class JDGL2Service extends ControlService {

    /**
     * 异动借调明细服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof JDGL2Service
     */
    ...
    /**
     * Creates an instance of JDGL2Service.
     * 
     * @param {*} [opts={}]
     * @memberof JDGL2Service
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.pcmydjdmxid = Util.createUUID();
                }
