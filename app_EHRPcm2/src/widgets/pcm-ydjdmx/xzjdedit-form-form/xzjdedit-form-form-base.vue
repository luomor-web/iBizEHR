<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pcmydjdmx_xzjdeditform' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.grouppanel1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ygbh.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ygbh' :itemRules="this.rules.ygbh" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.ygbh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ygbh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.zz.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='zz' :itemRules="this.rules.zz" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.zz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.zz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.bm.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='bm' :itemRules="this.rules.bm" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.bm')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bm.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.grouppanel2')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.jdksrq.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='jdksrq' :itemRules="this.rules.jdksrq" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.jdksrq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jdksrq.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.jdjsrq.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='jdjsrq' :itemRules="this.rules.jdjsrq" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.jdjsrq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jdjsrq.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormorgname' :itemRules="this.rules.ormorgname" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.ormorgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgsectorname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormorgsectorname' :itemRules="this.rules.ormorgsectorname" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.ormorgsectorname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgsectorname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormdutyname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormdutyname' :itemRules="this.rules.ormdutyname" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.ormdutyname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormdutyname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormpostname.visible" :style="{}"  :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='ormpostname' :itemRules="this.rules.ormpostname" class='' :caption="$t('entities.pcmydjdmx.xzjdeditform_form.details.ormpostname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormpostname.error" :isEmptyCaption="false" labelPos="LEFT">
...
import XZJDEditFormService from './xzjdedit-form-form-service';
...
export default class XZJDEditFormBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof XZJDEditFormBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {XZJDEditFormService}
     * @memberof XZJDEditFormBase
     */
    public service: XZJDEditFormService = new XZJDEditFormService({ $store: this.$store });
    ...
    public rules: any = {
        ...
        srfmajortext: [
            { type: 'string', message: '异动借调明细名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '异动借调明细名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '异动借调明细名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '异动借调明细名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        ormorgid: [
            ...
            { type: 'string', message: '借调组织标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '借调组织标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '借调组织标识 值不能为空', trigger: 'blur' },
        ],
        ormorgsectorname: [
        ...
        ormorgsectorid: [
            ...
            { type: 'string', message: '借调部门标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '借调部门标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '借调部门标识 值不能为空', trigger: 'blur' },
        ],
        ormdutyname: [
        ...
        ormdutyid: [
            { type: 'string', message: '借调职务标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '借调职务标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '借调职务标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '借调职务标识 值不能为空', trigger: 'blur' },
        ],
        ormpostname: [
        ...
        ormpostid: [
            { type: 'string', message: '借调岗位标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '借调岗位标识 值必须为字符串类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '人员信息', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjdmx.xzjdeditform_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '借调信息', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.pcmydjdmx.xzjdeditform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '异动借调明细标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '异动借调明细名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        jdksrq: new FormItemModel({ caption: '借调开始日期', detailType: 'FORMITEM', name: 'jdksrq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ormorgname: new FormItemModel({ caption: '借调组织', detailType: 'FORMITEM', name: 'ormorgname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgid: new FormItemModel({ caption: '借调组织标识', detailType: 'FORMITEM', name: 'ormorgid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgsectorname: new FormItemModel({ caption: '借调部门', detailType: 'FORMITEM', name: 'ormorgsectorname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormorgsectorid: new FormItemModel({ caption: '借调部门标识', detailType: 'FORMITEM', name: 'ormorgsectorid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormdutyname: new FormItemModel({ caption: '借调职务', detailType: 'FORMITEM', name: 'ormdutyname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        ormdutyid: new FormItemModel({ caption: '借调职务标识', detailType: 'FORMITEM', name: 'ormdutyid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    onJdksrqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'jdksrq', newVal: newVal, oldVal: oldVal });
    }
    ...
    onJdjsrqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'jdjsrq', newVal: newVal, oldVal: oldVal });
    }
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if(Object.is(name, 'pimpersonid')){
            const details: string[] = ['zzid', 'yzw', 'ygw', 'pimpersonname', 'ygbh', 'bm', 'zz', 'bmid'];
            this.updateFormItems('PersonInfo', this.data, details, true);
        }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pcmydjdmx){
            Object.assign(this.context,{pcmydjdmx:data.pcmydjdmx})
        }
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof XZJDEditFormBase
     */
    public copy(srfkey: string): void {
        let copyData = this.$store.getters.getCopyData(srfkey);
        copyData.srfkey = Util.createUUID();
        copyData.pcmydjdmx = copyData.srfkey;
        copyData.pcmydjdmxid = copyData.srfkey;
        Object.assign(this.context,{pcmydjdmx:copyData.pcmydjdmx})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pcmydjdmx_xzjdeditform',popTitle:'新增借调表单'});
    }
    ...
    */
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pcmydjdmx || Object.is(arg.pcmydjdmx, '')) {
            return;
        }
...
<style lang='less'>
@import './xzjdedit-form-form.less';
</style>