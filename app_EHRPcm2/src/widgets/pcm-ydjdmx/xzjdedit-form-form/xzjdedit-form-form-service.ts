...
import XZJDEditFormModel from './xzjdedit-form-form-model';
 ...
 *
 * @export
 * @class XZJDEditFormService
 */
export default class XZJDEditFormService extends ControlService {

    /**
     * 异动借调明细服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof XZJDEditFormService
     */
    public appEntityService: PcmYdjdmxService = new PcmYdjdmxService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of XZJDEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof XZJDEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new XZJDEditFormModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmydjdmxid = PrimaryKey;
        Data.pcmydjdmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmydjdmxid = PrimaryKey;
