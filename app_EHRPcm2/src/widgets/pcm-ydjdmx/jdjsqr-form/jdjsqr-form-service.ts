...
import JDJSQRModel from './jdjsqr-form-model';
 ...
 * @class JDJSQRService
 */
export default class JDJSQRService extends ControlService {

    /**
     * 异动借调明细服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof JDJSQRService
     */
    ...
    /**
     * Creates an instance of JDJSQRService.
     * 
     * @param {*} [opts={}]
     * @memberof JDJSQRService
     */
