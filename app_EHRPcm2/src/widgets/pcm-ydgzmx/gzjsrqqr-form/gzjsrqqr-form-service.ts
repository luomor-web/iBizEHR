...
import GZJSRQQRModel from './gzjsrqqr-form-model';
 ...
 *
 * @export
 * @class GZJSRQQRService
 */
export default class GZJSRQQRService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZJSRQQRService
     */
    ...
    /**
     * Creates an instance of GZJSRQQRService.
     * 
     * @param {*} [opts={}]
     * @memberof GZJSRQQRService
     */
