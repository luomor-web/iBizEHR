...
import GZCJLSearchFormModel from './gzcjlsearch-form-searchform-model';


/**
 * GZCJLSearchForm 部件服务对象
 *
 * @export
 * @class GZCJLSearchFormService
 */
export default class GZCJLSearchFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZCJLSearchFormService
     */
    ...
    /**
     * Creates an instance of GZCJLSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GZCJLSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GZCJLSearchFormModel();
    }
