...
import GZJGLSearchFormModel from './gzjglsearch-form-searchform-model';


/**
 * GZJGLSearchForm 部件服务对象
 *
 * @export
 * @class GZJGLSearchFormService
 */
export default class GZJGLSearchFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZJGLSearchFormService
     */
    ...
    /**
     * Creates an instance of GZJGLSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GZJGLSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GZJGLSearchFormModel();
    }
