...
import GZCEditFormModel from './gzcedit-form-form-model';
 ...
 *
 * @export
 * @class GZCEditFormService
 */
export default class GZCEditFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZCEditFormService
     */
    ...
    /**
     * Creates an instance of GZCEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GZCEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GZCEditFormModel();
    }
