...
import GZCGLSearchFormModel from './gzcglsearch-form-searchform-model';


/**
 * GZCGLSearchForm 部件服务对象
 *
 * @export
 * @class GZCGLSearchFormService
 */
export default class GZCGLSearchFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZCGLSearchFormService
     */
    public appEntityService: PcmYdgzmxService = new PcmYdgzmxService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of GZCGLSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GZCGLSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GZCGLSearchFormModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pcmydgzmxid = PrimaryKey;
        Data.pcmydgzmx = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pcmydgzmxid = PrimaryKey;
