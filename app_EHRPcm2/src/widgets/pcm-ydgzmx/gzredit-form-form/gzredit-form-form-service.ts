...
import GZREditFormModel from './gzredit-form-form-model';
 ...
 *
 * @export
 * @class GZREditFormService
 */
export default class GZREditFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZREditFormService
     */
    ...
    /**
     * Creates an instance of GZREditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GZREditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GZREditFormModel();
    }
