...
import XZGZCEditFormModel from './xzgzcedit-form-form-model';
import PimPersonService from '@/service/pim-person/pim-person-service';


/**
 * XZGZCEditForm 部件服务对象
 *
 * @export
 * @class XZGZCEditFormService
 */
export default class XZGZCEditFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof XZGZCEditFormService
     */
    ...
    /**
     * Creates an instance of XZGZCEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof XZGZCEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new XZGZCEditFormModel();
    }
