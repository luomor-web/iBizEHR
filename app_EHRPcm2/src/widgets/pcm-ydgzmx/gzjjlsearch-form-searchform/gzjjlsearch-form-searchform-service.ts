...
import GZJJLSearchFormModel from './gzjjlsearch-form-searchform-model';


/**
 * GZJJLSearchForm 部件服务对象
 *
 * @export
 * @class GZJJLSearchFormService
 */
export default class GZJJLSearchFormService extends ControlService {

    /**
     * 异动挂职明细服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof GZJJLSearchFormService
     */
    ...
    /**
     * Creates an instance of GZJJLSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GZJJLSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GZJJLSearchFormModel();
    }
