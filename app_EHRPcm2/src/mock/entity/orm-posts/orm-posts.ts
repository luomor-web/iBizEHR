...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrpcm2\/ormposts\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrpcm2\/ormposts\/process-definitions-nodes$/)).reply((config: any) => {
