...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrpcm2\/pcmxygzzjlmxes\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: getwflink");
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrpcm2\/pcmxygzzjlmxes\/process-definitions-nodes$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: getwfstep");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// createBatch
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: createBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// updateBatch
mock.onPut(new RegExp(/^\/pcmxygzzjlmxes\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: updateBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// removeBatch
mock.onDelete(new RegExp(/^\/pcmxygzzjlmxes\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: removeBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    ...
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// XYGZZCZ
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})\/xygzzcz$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: XYGZZCZ");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['pcmxygzzjlmxid'];
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/xygzzcz$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})\/shtg$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['pcmxygzzjlmxid'];
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/shtg$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// FillPersonInfo
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})\/fillpersoninfo$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FillPersonInfo");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['pcmxygzzjlmxid'];
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/fillpersoninfo$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// CheckKey
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['pcmxygzzjlmxid'];
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Update
mock.onPut(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: Update");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// SHBTG
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})\/shbtg$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: SHBTG");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['pcmxygzzjlmxid'];
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/shbtg$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
mock.onPost(new RegExp(/^\/pcmxygzzjlmxes\/?([a-zA-Z0-9\-\;]{0,35})\/save$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['pcmxygzzjlmxid'];
    const matchArray:any = new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})\/save$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// FetchZZWSHDS
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/fetchzzwshds$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FetchZZWSHDS");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// FetchZZWSHDS
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/fetchzzwshds(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FetchZZWSHDS");
    console.table({url:config.url, method: config.method, data:config.data});
...
// FetchALLDS
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/fetchallds(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FetchALLDS");
    console.table({url:config.url, method: config.method, data:config.data});
    if(config.url.includes('page')){
        let url = config.url.split('?')[1];
...
// FetchSYQZZJL
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/fetchsyqzzjl$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FetchSYQZZJL");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// FetchSYQZZJL
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/fetchsyqzzjl(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FetchSYQZZJL");
    console.table({url:config.url, method: config.method, data:config.data});
    if(config.url.includes('page')){
        let url = config.url.split('?')[1];
...
// FetchDefault
mock.onGet(new RegExp(/^\/pcmxygzzjlmxes\/fetchdefault(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: FetchDefault");
    console.table({url:config.url, method: config.method, data:config.data});
    if(config.url.includes('page')){
        let url = config.url.split('?')[1];
...
// Remove
mock.onDelete(new RegExp(/^\/pcmxygzzjlmxes\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:pcmxygzzjlmx 方法: Remove");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
