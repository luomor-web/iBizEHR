<template>
  <app-layout viewName="pcmddsqdmxpddgridview" viewTitle="调动明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-pddgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxPDDGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxPDDGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxPDDGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxPDDGridViewBase
	 */
	public viewtag: string = '8f3eaf9fc89117b038d501fbb05d44db';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.pddgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.pddgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.pddgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PcmDdsqdmx");
    }
    ...
    public toolbar2_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmDdsqdmx");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pcm-ddsqdmx-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmddsqdmx.views.editview.title'),
        };
...
<style lang='less'>
@import './pcm-ddsqdmx-pddgrid-view.less';
</style>