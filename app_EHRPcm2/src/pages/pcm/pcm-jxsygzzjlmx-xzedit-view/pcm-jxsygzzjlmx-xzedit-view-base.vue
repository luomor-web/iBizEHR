<template>
  <app-layout viewName="pcmjxsygzzjlmxxzeditview" viewTitle="见习生员工转正记录引用明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-jxsygzzjlmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
