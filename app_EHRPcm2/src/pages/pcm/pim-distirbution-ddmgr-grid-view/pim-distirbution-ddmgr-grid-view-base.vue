<template>
  <app-layout viewName="pimdistirbutionddmgrgridview" viewTitle="调动管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-ddmgr-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionDDMgrGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionDDMgrGridViewBase extends GridViewBase {
	 ...
	 * @memberof PimDistirbutionDDMgrGridViewBase
	 */
	public viewtag: string = '559fd7ee3353c55129a761c38f68b6fd';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.ddmgrgridview.caption',
        srfTitle: 'entities.pimdistirbution.views.ddmgrgridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.ddmgrgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        deuiaction1_ddczc: { name: 'deuiaction1_ddczc', caption: '调出','isShowCaption':true,'isShowIcon':true, tooltip: '调出', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: 'SRFUR__GSBMJL', uiaction: { tag: 'DDCZC', target: 'SINGLEKEY' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_ddczc')) {
            this.toolbar_deuiaction1_ddczc_click(null, '', $event2);
        }
        ...
        if (Object.is($event.tag, 'deuiaction4_ddjl')) {
            this.toolbar_deuiaction4_ddjl_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_ddczc_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PimDistirbution_DDCZC(datas,contextJO, paramJO,  $event, xData,this,"PimDistirbution");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction4_ddjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
...
<style lang='less'>
@import './pim-distirbution-ddmgr-grid-view.less';
</style>