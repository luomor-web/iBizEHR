<template>
  <app-layout viewName="pcmydjzmxlsjlgridview" viewTitle="兼职记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjzmx-lsjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjzmxLSJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjzmxLSJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjzmxService}
     * @memberof PcmYdjzmxLSJLGridViewBase
     */
	 ...
	 * @memberof PcmYdjzmxLSJLGridViewBase
	 */
	public viewtag: string = '5a09e844d1a4abd40c599b0d1673495b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjzmx.views.lsjlgridview.caption',
        srfTitle: 'entities.pcmydjzmx.views.lsjlgridview.title',
        srfSubTitle: 'entities.pcmydjzmx.views.lsjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdjzmxLSJLGridView
     */
...
<style lang='less'>
@import './pcm-ydjzmx-lsjlgrid-view.less';
</style>