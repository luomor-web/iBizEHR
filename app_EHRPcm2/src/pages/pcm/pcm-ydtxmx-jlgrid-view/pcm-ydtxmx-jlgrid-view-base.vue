<template>
  <app-layout viewName="pcmydtxmxjlgridview" viewTitle="退休记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydtxmx-jlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdtxmxJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdtxmxJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdtxmxService}
     * @memberof PcmYdtxmxJLGridViewBase
     */
	 ...
	 * @memberof PcmYdtxmxJLGridViewBase
	 */
	public viewtag: string = 'd531e69b24c75cc779f57c2a45152243';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydtxmx.views.jlgridview.caption',
        srfTitle: 'entities.pcmydtxmx.views.jlgridview.title',
        srfSubTitle: 'entities.pcmydtxmx.views.jlgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydtxmx-jlgrid-view.less';
</style>