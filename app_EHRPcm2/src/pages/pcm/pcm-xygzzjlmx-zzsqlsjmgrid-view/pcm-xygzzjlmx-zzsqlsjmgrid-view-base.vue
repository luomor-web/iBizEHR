<template>
  <app-layout viewName="pcmxygzzjlmxzzsqlsjmgridview" viewTitle="试用期员工转正结果引用明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-xygzzjlmx-zzsqlsjmgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmXygzzjlmxZZSQLSJMGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzjlmxZZSQLSJMGridViewBase extends GridViewBase {
	 ...
	 * @memberof PcmXygzzjlmxZZSQLSJMGridViewBase
	 */
	public viewtag: string = '64778fdae321216fbcccab69d0ae73d7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzjlmx.views.zzsqlsjmgridview.caption',
        srfTitle: 'entities.pcmxygzzjlmx.views.zzsqlsjmgridview.title',
        srfSubTitle: 'entities.pcmxygzzjlmx.views.zzsqlsjmgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmXygzzjlmxZZSQLSJMGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzjlmx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzjlmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzjlmx");
    }
...
<style lang='less'>
@import './pcm-xygzzjlmx-zzsqlsjmgrid-view.less';
</style>