<template>
  <app-layout viewName="pcmydntmxntglgridview" viewTitle="内退管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydntmx-ntglgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="异动内退明细名称，员工编号，员工姓名" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PcmYdntmxNTGLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxNTGLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxNTGLGridViewBase
     */
	 ...
	 * @memberof PcmYdntmxNTGLGridViewBase
	 */
	public viewtag: string = 'dbdb48c6a8f3668e25609bac1c4d73de';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.ntglgridview.caption',
        srfTitle: 'entities.pcmydntmx.views.ntglgridview.title',
        srfSubTitle: 'entities.pcmydntmx.views.ntglgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdntmxNTGLGridView
     */
    public toolBarModels: any = {
        ...
        deuiaction1_ntjl: { name: 'deuiaction1_ntjl', caption: '内退记录','isShowCaption':true,'isShowIcon':true, tooltip: '内退记录', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'NTJL', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'deuiaction1_ntjl')) {
            this.toolbar_deuiaction1_ntjl_click(null, '', $event2);
        }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
    ...
    public toolbar_deuiaction1_xz_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.PcmYdntmx_XZ(datas,contextJO, paramJO,  $event, xData,this,"PcmYdntmx");
    }
    ...
    public toolbar_deuiaction1_remove_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_ntjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PcmYdntmxUIService  = new PcmYdntmxUIService();
        curUIService.PcmYdntmx_NTJL(datas,contextJO, paramJO,  $event, xData,this,"PcmYdntmx");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
    ...
    public toolbar_deuiaction6_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
...
<style lang='less'>
@import './pcm-ydntmx-ntglgrid-view.less';
</style>