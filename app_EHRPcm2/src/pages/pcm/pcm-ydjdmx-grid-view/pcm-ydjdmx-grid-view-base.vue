<template>
  <app-layout viewName="pcmydjdmxgridview" viewTitle="异动借调明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjdmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjdmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjdmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof PcmYdjdmxGridViewBase
     */
	 ...
	 * @memberof PcmYdjdmxGridViewBase
	 */
	public viewtag: string = 'ad351fd0541b6454efcf60e840fc6e39';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjdmx.views.gridview.caption',
        srfTitle: 'entities.pcmydjdmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydjdmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjdmx");
    }
...
<style lang='less'>
@import './pcm-ydjdmx-grid-view.less';
</style>