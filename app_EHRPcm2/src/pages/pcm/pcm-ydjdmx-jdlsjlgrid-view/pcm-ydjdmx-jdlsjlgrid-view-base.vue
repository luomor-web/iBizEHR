<template>
  <app-layout viewName="pcmydjdmxjdlsjlgridview" viewTitle="借调记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjdmx-jdlsjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjdmxJDLSJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjdmxJDLSJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof PcmYdjdmxJDLSJLGridViewBase
     */
	 ...
	 * @memberof PcmYdjdmxJDLSJLGridViewBase
	 */
	public viewtag: string = '2089403d59596a77197ffc33d0ee717e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjdmx.views.jdlsjlgridview.caption',
        srfTitle: 'entities.pcmydjdmx.views.jdlsjlgridview.title',
        srfSubTitle: 'entities.pcmydjdmx.views.jdlsjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdjdmxJDLSJLGridView
     */
...
<style lang='less'>
@import './pcm-ydjdmx-jdlsjlgrid-view.less';
</style>