<template>
  <app-layout viewName="pcmydbxmxgridview" viewTitle="异动病休明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydbxmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdbxmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdbxmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdbxmxService}
     * @memberof PcmYdbxmxGridViewBase
     */
	 ...
	 * @memberof PcmYdbxmxGridViewBase
	 */
	public viewtag: string = '42964fbb39c05ff14badfaa4e2f2b2c6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydbxmx.views.gridview.caption',
        srfTitle: 'entities.pcmydbxmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydbxmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
...
<style lang='less'>
@import './pcm-ydbxmx-grid-view.less';
</style>