<template>
  <app-layout viewName="pcmydbxmxjlgridview" viewTitle="病休记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydbxmx-jlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdbxmxJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdbxmxJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdbxmxService}
     * @memberof PcmYdbxmxJLGridViewBase
     */
	 ...
	 * @memberof PcmYdbxmxJLGridViewBase
	 */
	public viewtag: string = '98ce229597cc6cfcd912f4e9aeb22044';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydbxmx.views.jlgridview.caption',
        srfTitle: 'entities.pcmydbxmx.views.jlgridview.title',
        srfSubTitle: 'entities.pcmydbxmx.views.jlgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydbxmx-jlgrid-view.less';
</style>