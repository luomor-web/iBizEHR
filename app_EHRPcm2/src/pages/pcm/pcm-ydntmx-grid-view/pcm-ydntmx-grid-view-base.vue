<template>
  <app-layout viewName="pcmydntmxgridview" viewTitle="异动内退明细表" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydntmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxGridViewBase
     */
	 ...
	 * @memberof PcmYdntmxGridViewBase
	 */
	public viewtag: string = 'e8c3c785a43c571c649829ad78a99f44';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.gridview.caption',
        srfTitle: 'entities.pcmydntmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydntmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
...
<style lang='less'>
@import './pcm-ydntmx-grid-view.less';
</style>