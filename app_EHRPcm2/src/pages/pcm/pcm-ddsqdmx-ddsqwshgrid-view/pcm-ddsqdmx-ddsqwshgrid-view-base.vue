<template>
  <app-layout viewName="pcmddsqdmxddsqwshgridview" viewTitle="调动查看" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-ddsqwshgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxDDSQWSHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxDDSQWSHGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxDDSQWSHGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxDDSQWSHGridViewBase
	 */
	public viewtag: string = 'c3fe6d0bf42e7bfa5db3e5ff7f1c76c8';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.ddsqwshgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.ddsqwshgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.ddsqwshgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxDDSQWSHGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const parameters: any[] = [
            ...
            { pathName: 'ddsqsheditview', parameterName: 'ddsqsheditview' },
        ];
        const _this: any = this;
...
<style lang='less'>
@import './pcm-ddsqdmx-ddsqwshgrid-view.less';
</style>