<template>
  <app-layout viewName="pimpersontxglgridview" viewTitle="退休管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-person-txglgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimPersonTXGLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimPersonTXGLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PimPersonTXGLGridViewBase
     */
	 ...
	 * @memberof PimPersonTXGLGridViewBase
	 */
	public viewtag: string = '4abb758e93c0bb397ee7084592bbd4e4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.txglgridview.caption',
        srfTitle: 'entities.pimperson.views.txglgridview.title',
        srfSubTitle: 'entities.pimperson.views.txglgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimPersonTXGLGridView
     */
    public toolBarModels: any = {
        deuiaction1_cktxjl: { name: 'deuiaction1_cktxjl', caption: '退休记录','isShowCaption':true,'isShowIcon':true, tooltip: '退休记录', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'CKTXJL', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_cktxjl')) {
            this.toolbar_deuiaction1_cktxjl_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_cktxjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PimPerson_CKTXJL(datas,contextJO, paramJO,  $event, xData,this,"PimPerson");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pim-person-txryedit-view', 
            height: 750, 
            width: 0,  
            title: this.$t('entities.pimperson.views.txryeditview.title'),
        };
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pim-person-edit-view9', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.pimperson.views.editview9.title'),
...
<style lang='less'>
@import './pim-person-txglgrid-view.less';
</style>