<template>
  <app-layout viewName="pcmddsqdmxlgsqmxgridview" viewTitle="轮岗申请明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-lgsqmxgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxLGSQMXGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxLGSQMXGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxLGSQMXGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxLGSQMXGridViewBase
	 */
	public viewtag: string = '49fd2453df7be3b6ad898090da019d3c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.lgsqmxgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.lgsqmxgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.lgsqmxgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxLGSQMXGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const parameters: any[] = [
            ...
            { pathName: 'lgsqmxeditview', parameterName: 'lgsqmxeditview' },
        ];
        const _this: any = this;
...
<style lang='less'>
@import './pcm-ddsqdmx-lgsqmxgrid-view.less';
</style>