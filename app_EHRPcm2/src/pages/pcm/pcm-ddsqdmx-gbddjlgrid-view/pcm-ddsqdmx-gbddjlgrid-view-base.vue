<template>
  <app-layout viewName="pcmddsqdmxgbddjlgridview" viewTitle="干部调动记录" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-gbddjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxGBDDJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxGBDDJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxGBDDJLGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxGBDDJLGridViewBase
	 */
	public viewtag: string = '158ab469934d6f022890315eca194b2d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.gbddjlgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.gbddjlgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.gbddjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxGBDDJLGridView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-gbddjlgrid-view.less';
</style>