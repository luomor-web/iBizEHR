<template>
  <app-layout viewName="pcmxygzzsqgridview" viewTitle="试用期员工转正申请表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-xygzzsq-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="试用期员工转正申请名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PcmXygzzsqGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzsqGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzsqService}
     * @memberof PcmXygzzsqGridViewBase
     */
	 ...
	 * @memberof PcmXygzzsqGridViewBase
	 */
	public viewtag: string = '34f739b4b59de8e527e14833b2ac55b8';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzsq.views.gridview.caption',
        srfTitle: 'entities.pcmxygzzsq.views.gridview.title',
        srfSubTitle: 'entities.pcmxygzzsq.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsq");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsq");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsq");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsq");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsq");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pcmxygzzsq;
        if(args.length >0){
...
<style lang='less'>
@import './pcm-xygzzsq-grid-view.less';
</style>