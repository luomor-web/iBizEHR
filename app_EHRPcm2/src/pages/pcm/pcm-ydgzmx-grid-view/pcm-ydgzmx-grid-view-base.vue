<template>
  <app-layout viewName="pcmydgzmxgridview" viewTitle="异动挂职明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydgzmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxGridViewBase
     */
	 ...
	 * @memberof PcmYdgzmxGridViewBase
	 */
	public viewtag: string = 'a1b90688c0eb8088983aa55ae0f468b3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.gridview.caption',
        srfTitle: 'entities.pcmydgzmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdgzmx");
    }
...
<style lang='less'>
@import './pcm-ydgzmx-grid-view.less';
</style>