<template>
  <app-layout viewName="pcmddsqdmxtyddgridview" viewTitle="调动申请明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-tyddgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxTYDDGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxTYDDGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxTYDDGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxTYDDGridViewBase
	 */
	public viewtag: string = '47846056d086cc6505ba79ac3c076faf';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.tyddgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.tyddgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.tyddgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxTYDDGridView
     */
    ...
    public toolbar_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'tbitem1_tydd')) {
            this.toolbar_tbitem1_tydd_click(null, '', $event2);
        }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmDdsqdmx");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_tydd_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PcmDdsqdmx_TYDD(datas,contextJO, paramJO,  $event, xData,this,"PcmDdsqdmx");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmDdsqdmx");
    }
...
<style lang='less'>
@import './pcm-ddsqdmx-tyddgrid-view.less';
</style>