...
export default class PimPersonSQSYQZZGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction1_sqsyqzz: { name: 'deuiaction1_sqsyqzz', caption: '转正','isShowCaption':true,'isShowIcon':true, tooltip: '转正', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'SQSYQZZ', target: 'MULTIKEY' }, class: '' },
