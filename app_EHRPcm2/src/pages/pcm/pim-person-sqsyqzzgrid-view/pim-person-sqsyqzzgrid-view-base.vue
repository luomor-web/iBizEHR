...
export default class PimPersonSQSYQZZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PimPersonSQSYQZZGridViewBase
     */
	 ...
	 * @memberof PimPersonSQSYQZZGridViewBase
	 */
	public viewtag: string = 'f88aeef09f6cf239b0d9fad901c62efd';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.sqsyqzzgridview.caption',
        srfTitle: 'entities.pimperson.views.sqsyqzzgridview.title',
        srfSubTitle: 'entities.pimperson.views.sqsyqzzgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimPersonSQSYQZZGridView
     */
    public toolBarModels: any = {
        deuiaction1_sqsyqzz: { name: 'deuiaction1_sqsyqzz', caption: '转正','isShowCaption':true,'isShowIcon':true, tooltip: '转正', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'SQSYQZZ', target: 'SINGLEKEY' }, class: '' },

        deuiaction4_syqzzjl: { name: 'deuiaction4_syqzzjl', caption: '试用期转正记录','isShowCaption':true,'isShowIcon':true, tooltip: '试用期转正记录', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'SYQZZJL', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_sqsyqzz')) {
            this.toolbar_deuiaction1_sqsyqzz_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'deuiaction4_syqzzjl')) {
            this.toolbar_deuiaction4_syqzzjl_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_sqsyqzz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        let paramJO:any = {"PCMXYGZZJLMX":"%pimpersonid%"};
        Object.assign(paramJO,{"PCMXYGZZJLMX":"%pimpersonid%"});
        let contextJO:any = {};
        ...
        curUIService.PimPerson_SQSYQZZ(datas,contextJO, paramJO,  $event, xData,this,"PimPerson");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction4_syqzzjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PimPersonUIService  = new PimPersonUIService();
        curUIService.PimPerson_SYQZZJL(datas,contextJO, paramJO,  $event, xData,this,"PimPerson");
    }
...
<style lang='less'>
@import './pim-person-sqsyqzzgrid-view.less';
</style>