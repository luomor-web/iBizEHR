<template>
  <app-layout viewName="pimdistirbutionddrmgrgridview" viewTitle="调入管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-ddrmgr-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionDDRMgrGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionDDRMgrGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof PimDistirbutionDDRMgrGridViewBase
     */
	 ...
	 * @memberof PimDistirbutionDDRMgrGridViewBase
	 */
	public viewtag: string = '77ebb4c718553020312d2622c5041415';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.ddrmgrgridview.caption',
        srfTitle: 'entities.pimdistirbution.views.ddrmgrgridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.ddrmgrgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionDDRMgrGridView
     */
    public toolBarModels: any = {
        deuiaction1_xzpdd: { name: 'deuiaction1_xzpdd', caption: '新增批调动','isShowCaption':true,'isShowIcon':true, tooltip: '新增批调动', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'XZPDD', target: 'NONE' }, class: '' },

        deuiaction1_sqdd: { name: 'deuiaction1_sqdd', caption: '调动','isShowCaption':true,'isShowIcon':true, tooltip: '调动', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'SQDD', target: 'SINGLEKEY' }, class: '' },

        deuiaction1_ddjl: { name: 'deuiaction1_ddjl', caption: '调动记录','isShowCaption':true,'isShowIcon':true, tooltip: '调动记录', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'DDJL', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_xzpdd')) {
            this.toolbar_deuiaction1_xzpdd_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'deuiaction1_sqdd')) {
            this.toolbar_deuiaction1_sqdd_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'deuiaction1_ddjl')) {
            this.toolbar_deuiaction1_ddjl_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_xzpdd_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_sqdd_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PimDistirbutionUIService  = new PimDistirbutionUIService();
        curUIService.PimDistirbution_SQDD(datas,contextJO, paramJO,  $event, xData,this,"PimDistirbution");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_ddjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PimDistirbutionUIService  = new PimDistirbutionUIService();
        curUIService.PimDistirbution_DDJL(datas,contextJO, paramJO,  $event, xData,this,"PimDistirbution");
    }
...
<style lang='less'>
@import './pim-distirbution-ddrmgr-grid-view.less';
</style>