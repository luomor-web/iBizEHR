<template>
  <app-layout viewName="pcmddsqdmxjdsqgrgridview" viewTitle="借调申请" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-jdsqgrgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxJDSQGRGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxJDSQGRGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxJDSQGRGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxJDSQGRGridViewBase
	 */
	public viewtag: string = 'a2cfc4eb807985c6082969965bdd0df2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.jdsqgrgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.jdsqgrgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.jdsqgrgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxJDSQGRGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const parameters: any[] = [
            ...
            { pathName: 'grzzsqjdeditview', parameterName: 'grzzsqjdeditview' },
        ];
        const _this: any = this;
...
<style lang='less'>
@import './pcm-ddsqdmx-jdsqgrgrid-view.less';
</style>