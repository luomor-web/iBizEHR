<template>
  <app-layout viewName="pcmddsqdmxddjlgridview" viewTitle="调动记录" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-ddjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxDDJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxDDJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxDDJLGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxDDJLGridViewBase
	 */
	public viewtag: string = '1e3db0f223b69a63e7738f0def95aa68';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.ddjlgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.ddjlgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.ddjlgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ddsqdmx-ddjlgrid-view.less';
</style>