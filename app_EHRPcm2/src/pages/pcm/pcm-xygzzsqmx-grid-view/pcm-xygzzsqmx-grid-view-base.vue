<template>
  <app-layout viewName="pcmxygzzsqmxgridview" viewTitle="试用期员工转正申请明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-xygzzsqmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="试用期员工转正申请明细名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PcmXygzzsqmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzsqmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzsqmxService}
     * @memberof PcmXygzzsqmxGridViewBase
     */
	 ...
	 * @memberof PcmXygzzsqmxGridViewBase
	 */
	public viewtag: string = 'b8417dce40cadb61d0b9559fdbf901ac';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzsqmx.views.gridview.caption',
        srfTitle: 'entities.pcmxygzzsqmx.views.gridview.title',
        srfSubTitle: 'entities.pcmxygzzsqmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pcmxygzzsqmx;
        if(args.length >0){
            Object.assign(curViewParam,args[0]);
        }
        const deResParameters: any[] = [];
        const parameters: any[] = [
            { pathName: 'pcmxygzzsqmxes', parameterName: 'pcmxygzzsqmx' },
...
<style lang='less'>
@import './pcm-xygzzsqmx-grid-view.less';
</style>