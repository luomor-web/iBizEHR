<template>
  <app-layout viewName="pcmydjpmxgridview" viewTitle="异动解聘明细表" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjpmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjpmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjpmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjpmxService}
     * @memberof PcmYdjpmxGridViewBase
     */
	 ...
	 * @memberof PcmYdjpmxGridViewBase
	 */
	public viewtag: string = 'bafe5b6630f7ef513c5be76c13881f3b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjpmx.views.gridview.caption',
        srfTitle: 'entities.pcmydjpmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydjpmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjpmx");
    }
...
<style lang='less'>
@import './pcm-ydjpmx-grid-view.less';
</style>