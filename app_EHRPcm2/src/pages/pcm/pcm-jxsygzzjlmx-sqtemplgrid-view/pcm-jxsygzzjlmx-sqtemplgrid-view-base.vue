<template>
  <app-layout viewName="pcmjxsygzzjlmxsqtemplgridview" viewTitle="见习生员工转正记录引用明细表" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-jxsygzzjlmx-sqtemplgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmJxsygzzjlmxSQTEMPLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmJxsygzzjlmxSQTEMPLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmJxsygzzjlmxService}
     * @memberof PcmJxsygzzjlmxSQTEMPLGridViewBase
     */
	 ...
	 * @memberof PcmJxsygzzjlmxSQTEMPLGridViewBase
	 */
	public viewtag: string = '2033d35fd2c7e7d5a305b6d1f94f312b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmjxsygzzjlmx.views.sqtemplgridview.caption',
        srfTitle: 'entities.pcmjxsygzzjlmx.views.sqtemplgridview.title',
        srfSubTitle: 'entities.pcmjxsygzzjlmx.views.sqtemplgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmJxsygzzjlmxSQTEMPLGridView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
...
<style lang='less'>
@import './pcm-jxsygzzjlmx-sqtemplgrid-view.less';
</style>