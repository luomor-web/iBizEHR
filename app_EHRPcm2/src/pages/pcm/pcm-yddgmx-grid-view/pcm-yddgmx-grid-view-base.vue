<template>
  <app-layout viewName="pcmyddgmxgridview" viewTitle="异动待岗明细表" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-yddgmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYddgmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYddgmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof PcmYddgmxGridViewBase
     */
	 ...
	 * @memberof PcmYddgmxGridViewBase
	 */
	public viewtag: string = '0721b6b31f252591be03b7115c671651';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmyddgmx.views.gridview.caption',
        srfTitle: 'entities.pcmyddgmx.views.gridview.title',
        srfSubTitle: 'entities.pcmyddgmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
...
<style lang='less'>
@import './pcm-yddgmx-grid-view.less';
</style>