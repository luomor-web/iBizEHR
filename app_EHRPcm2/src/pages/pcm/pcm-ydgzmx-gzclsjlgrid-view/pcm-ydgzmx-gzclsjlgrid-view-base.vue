<template>
  <app-layout viewName="pcmydgzmxgzclsjlgridview" viewTitle="挂职出记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydgzmx-gzclsjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxGZCLSJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxGZCLSJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxGZCLSJLGridViewBase
     */
	 ...
	 * @memberof PcmYdgzmxGZCLSJLGridViewBase
	 */
	public viewtag: string = '8623dc0cf076ef91bf303f1a64fc5d4a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.gzclsjlgridview.caption',
        srfTitle: 'entities.pcmydgzmx.views.gzclsjlgridview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.gzclsjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdgzmxGZCLSJLGridView
     */
...
<style lang='less'>
@import './pcm-ydgzmx-gzclsjlgrid-view.less';
</style>