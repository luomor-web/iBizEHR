<template>
  <app-layout viewName="pcmydjpmxjpjlgridview" viewTitle="解聘记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjpmx-jpjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjpmxJPJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjpmxJPJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjpmxService}
     * @memberof PcmYdjpmxJPJLGridViewBase
     */
	 ...
	 * @memberof PcmYdjpmxJPJLGridViewBase
	 */
	public viewtag: string = '0744c064c5faabac7a65b5f0226ccb03';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjpmx.views.jpjlgridview.caption',
        srfTitle: 'entities.pcmydjpmx.views.jpjlgridview.title',
        srfSubTitle: 'entities.pcmydjpmx.views.jpjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdjpmxJPJLGridView
     */
...
<style lang='less'>
@import './pcm-ydjpmx-jpjlgrid-view.less';
</style>