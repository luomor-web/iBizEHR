<template>
  <app-layout viewName="pcmydlzmxlsjlgridview" viewTitle="离职记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydlzmx-lsjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdlzmxLSJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdlzmxLSJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdlzmxService}
     * @memberof PcmYdlzmxLSJLGridViewBase
     */
	 ...
	 * @memberof PcmYdlzmxLSJLGridViewBase
	 */
	public viewtag: string = 'd2a7679ac32cbd0cf6b21f54c1113595';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydlzmx.views.lsjlgridview.caption',
        srfTitle: 'entities.pcmydlzmx.views.lsjlgridview.title',
        srfSubTitle: 'entities.pcmydlzmx.views.lsjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdlzmxLSJLGridView
     */
...
<style lang='less'>
@import './pcm-ydlzmx-lsjlgrid-view.less';
</style>