<template>
  <app-layout viewName="pcmddsqdmxddsqgridview" viewTitle="调动申请" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-ddsqgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxDDSQGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxDDSQGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxDDSQGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxDDSQGridViewBase
	 */
	public viewtag: string = 'cabb53f72918b0ffb8a7688faa19af0c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.ddsqgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.ddsqgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.ddsqgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ddsqdmx-ddsqgrid-view.less';
</style>