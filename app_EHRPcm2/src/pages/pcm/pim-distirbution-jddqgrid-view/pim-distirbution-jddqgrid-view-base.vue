<template>
  <app-layout viewName="pimdistirbutionjddqgridview" viewTitle="借调人员" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-jddqgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionJDDQGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionJDDQGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof PimDistirbutionJDDQGridViewBase
     */
	 ...
	 * @memberof PimDistirbutionJDDQGridViewBase
	 */
	public viewtag: string = 'dfacd62b44a679bc0409d0f876a42bf9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.jddqgridview.caption',
        srfTitle: 'entities.pimdistirbution.views.jddqgridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.jddqgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionJDDQGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pim-distirbution-maturity-due-edit-view', 
            height: 0, 
            width: 0,  
...
<style lang='less'>
@import './pim-distirbution-jddqgrid-view.less';
</style>