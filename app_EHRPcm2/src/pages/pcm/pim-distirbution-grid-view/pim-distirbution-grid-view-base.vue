<template>
  <app-layout viewName="pimdistirbutiongridview" viewTitle="分配信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof PimDistirbutionGridViewBase
     */
	 ...
	 * @memberof PimDistirbutionGridViewBase
	 */
	public viewtag: string = 'f258817b8e2c6392f3079a7e380e0dcb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.gridview.caption',
        srfTitle: 'entities.pimdistirbution.views.gridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionGridView
     */
...
<style lang='less'>
@import './pim-distirbution-grid-view.less';
</style>