...
export default class PcmJxsygzzjlmxZZJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmJxsygzzjlmxService}
     * @memberof PcmJxsygzzjlmxZZJLGridViewBase
     */
	 ...
	 * @memberof PcmJxsygzzjlmxZZJLGridViewBase
	 */
	public viewtag: string = '472606b801b7bcc144af917f32c36acb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmjxsygzzjlmx.views.zzjlgridview.caption',
        srfTitle: 'entities.pcmjxsygzzjlmx.views.zzjlgridview.title',
        srfSubTitle: 'entities.pcmjxsygzzjlmx.views.zzjlgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-jxsygzzjlmx-zzjlgrid-view.less';
</style>