<template>
  <app-layout viewName="pcmddsqdmxjzsqgrgridview" viewTitle="兼职申请" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ddsqdmx-jzsqgrgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxJZSQGRGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxJZSQGRGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxJZSQGRGridViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxJZSQGRGridViewBase
	 */
	public viewtag: string = '495749f209414f8556f8ee0d109b2817';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.jzsqgrgridview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.jzsqgrgridview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.jzsqgrgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxJZSQGRGridView
     */
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const parameters: any[] = [
            ...
            { pathName: 'grzzsqjzeditview', parameterName: 'grzzsqjzeditview' },
        ];
        const _this: any = this;
...
<style lang='less'>
@import './pcm-ddsqdmx-jzsqgrgrid-view.less';
</style>