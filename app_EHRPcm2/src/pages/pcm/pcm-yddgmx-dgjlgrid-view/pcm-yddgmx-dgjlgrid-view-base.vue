<template>
  <app-layout viewName="pcmyddgmxdgjlgridview" viewTitle="待岗记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-yddgmx-dgjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYddgmxDGJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYddgmxDGJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof PcmYddgmxDGJLGridViewBase
     */
	 ...
	 * @memberof PcmYddgmxDGJLGridViewBase
	 */
	public viewtag: string = 'eef112819fd5981e294172049439758a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmyddgmx.views.dgjlgridview.caption',
        srfTitle: 'entities.pcmyddgmx.views.dgjlgridview.title',
        srfSubTitle: 'entities.pcmyddgmx.views.dgjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYddgmxDGJLGridView
     */
...
<style lang='less'>
@import './pcm-yddgmx-dgjlgrid-view.less';
</style>