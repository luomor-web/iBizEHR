<template>
  <app-layout viewName="pcmydgzmxgzrglgridview" viewTitle="挂职调入" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydgzmx-gzrglgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxGZRGLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxGZRGLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxGZRGLGridViewBase
     */
	 ...
	 * @memberof PcmYdgzmxGZRGLGridViewBase
	 */
	public viewtag: string = 'f3643aaced44ed1a742b4ad5ffa29399';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.gzrglgridview.caption',
        srfTitle: 'entities.pcmydgzmx.views.gzrglgridview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.gzrglgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdgzmxGZRGLGridView
     */
    public toolBarModels: any = {
        deuiaction1_xzgzr: { name: 'deuiaction1_xzgzr', caption: '新增','isShowCaption':true,'isShowIcon':true, tooltip: '新增', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'XZGZR', target: 'NONE' }, class: '' },

        deuiaction1_gzrjl: { name: 'deuiaction1_gzrjl', caption: '挂职进记录','isShowCaption':true,'isShowIcon':true, tooltip: '挂职进记录', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'GZRJL', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_xzgzr')) {
            this.toolbar_deuiaction1_xzgzr_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'deuiaction1_gzrjl')) {
            this.toolbar_deuiaction1_gzrjl_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_xzgzr_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PcmYdgzmx_XZGZR(datas,contextJO, paramJO,  $event, xData,this,"PcmYdgzmx");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_gzrjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PcmYdgzmxUIService  = new PcmYdgzmxUIService();
        curUIService.PcmYdgzmx_GZRJL(datas,contextJO, paramJO,  $event, xData,this,"PcmYdgzmx");
    }
...
<style lang='less'>
@import './pcm-ydgzmx-gzrglgrid-view.less';
</style>