<template>
  <app-layout viewName="pcmydntmxntjlgridview" viewTitle="内退记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydntmx-ntjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxNTJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxNTJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxNTJLGridViewBase
     */
	 ...
	 * @memberof PcmYdntmxNTJLGridViewBase
	 */
	public viewtag: string = 'f221ce8415e9f9f91e8f1d7a390294b5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.ntjlgridview.caption',
        srfTitle: 'entities.pcmydntmx.views.ntjlgridview.title',
        srfSubTitle: 'entities.pcmydntmx.views.ntjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdntmxNTJLGridView
     */
...
<style lang='less'>
@import './pcm-ydntmx-ntjlgrid-view.less';
</style>