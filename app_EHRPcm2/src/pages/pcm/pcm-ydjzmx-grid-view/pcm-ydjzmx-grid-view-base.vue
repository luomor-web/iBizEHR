<template>
  <app-layout viewName="pcmydjzmxgridview" viewTitle="异动兼职明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjzmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjzmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjzmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjzmxService}
     * @memberof PcmYdjzmxGridViewBase
     */
	 ...
	 * @memberof PcmYdjzmxGridViewBase
	 */
	public viewtag: string = 'a1669417849c3672c26fd59caf9e9d9e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjzmx.views.gridview.caption',
        srfTitle: 'entities.pcmydjzmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydjzmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjzmx");
    }
...
<style lang='less'>
@import './pcm-ydjzmx-grid-view.less';
</style>