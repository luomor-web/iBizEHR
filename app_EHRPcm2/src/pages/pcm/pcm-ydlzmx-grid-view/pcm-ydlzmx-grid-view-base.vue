<template>
  <app-layout viewName="pcmydlzmxgridview" viewTitle="异动离职明细表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydlzmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdlzmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdlzmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdlzmxService}
     * @memberof PcmYdlzmxGridViewBase
     */
	 ...
	 * @memberof PcmYdlzmxGridViewBase
	 */
	public viewtag: string = '05b284308ed6b260eddfbb857b457da4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydlzmx.views.gridview.caption',
        srfTitle: 'entities.pcmydlzmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydlzmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
...
<style lang='less'>
@import './pcm-ydlzmx-grid-view.less';
</style>