<template>
  <app-layout viewName="pcmydgzmxgzrlsjlgridview" viewTitle="挂职进记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydgzmx-gzrlsjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxGZRLSJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxGZRLSJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxGZRLSJLGridViewBase
     */
	 ...
	 * @memberof PcmYdgzmxGZRLSJLGridViewBase
	 */
	public viewtag: string = '517fd6f7683348ccf53b593aa584eea2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.gzrlsjlgridview.caption',
        srfTitle: 'entities.pcmydgzmx.views.gzrlsjlgridview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.gzrlsjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdgzmxGZRLSJLGridView
     */
...
<style lang='less'>
@import './pcm-ydgzmx-gzrlsjlgrid-view.less';
</style>