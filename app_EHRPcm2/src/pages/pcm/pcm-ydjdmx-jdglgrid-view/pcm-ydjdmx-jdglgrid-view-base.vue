<template>
  <app-layout viewName="pcmydjdmxjdglgridview" viewTitle="借调管理" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydjdmx-jdglgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="员工姓名，员工编号，异动借调明细名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PcmYdjdmxJDGLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjdmxJDGLGridViewBase extends GridViewBase {
	 ...
	 * @memberof PcmYdjdmxJDGLGridViewBase
	 */
	public viewtag: string = '7b11f4b33a5097e773dca5b66a9357e5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjdmx.views.jdglgridview.caption',
        srfTitle: 'entities.pcmydjdmx.views.jdglgridview.title',
        srfSubTitle: 'entities.pcmydjdmx.views.jdglgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem1_xzmx_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.PcmYdjdmx_XZMX(datas,contextJO, paramJO,  $event, xData,this,"PcmYdjdmx");
    }
    ...
    public toolbar_tbitem1_remove_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjdmx");
    }
    ...
    public toolbar_tbitem1_lsjdjl_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:PcmYdjdmxUIService  = new PcmYdjdmxUIService();
        curUIService.PcmYdjdmx_LSJDJL(datas,contextJO, paramJO,  $event, xData,this,"PcmYdjdmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjdmx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjdmx");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjdmx");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            ...
            height: 0, 
            width: 0,  
            title: this.$t('entities.pcmydjdmx.views.editview.title'),
...
<style lang='less'>
@import './pcm-ydjdmx-jdglgrid-view.less';
</style>