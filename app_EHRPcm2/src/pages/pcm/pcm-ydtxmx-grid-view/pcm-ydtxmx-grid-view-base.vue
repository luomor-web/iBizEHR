<template>
  <app-layout viewName="pcmydtxmxgridview" viewTitle="退休记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-ydtxmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="异动退休明细名称，员工姓名，员工编号" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PcmYdtxmxGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdtxmxGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdtxmxService}
     * @memberof PcmYdtxmxGridViewBase
     */
	 ...
	 * @memberof PcmYdtxmxGridViewBase
	 */
	public viewtag: string = 'ffdf242c2dbce056131f61cf5fdbf54c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydtxmx.views.gridview.caption',
        srfTitle: 'entities.pcmydtxmx.views.gridview.title',
        srfSubTitle: 'entities.pcmydtxmx.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
...
<style lang='less'>
@import './pcm-ydtxmx-grid-view.less';
</style>