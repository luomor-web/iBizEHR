<template>
  <app-layout viewName="pcmxygzzjlmxsyqzzjlgridview" viewTitle="试用期转正记录" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pcm-xygzzjlmx-syqzzjlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmXygzzjlmxSYQZZJLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzjlmxSYQZZJLGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzjlmxService}
     * @memberof PcmXygzzjlmxSYQZZJLGridViewBase
     */
	 ...
	 * @memberof PcmXygzzjlmxSYQZZJLGridViewBase
	 */
	public viewtag: string = '3c86db51a9f9692e282d44098444cb6f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzjlmx.views.syqzzjlgridview.caption',
        srfTitle: 'entities.pcmxygzzjlmx.views.syqzzjlgridview.title',
        srfSubTitle: 'entities.pcmxygzzjlmx.views.syqzzjlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmXygzzjlmxSYQZZJLGridView
     */
...
<style lang='less'>
@import './pcm-xygzzjlmx-syqzzjlgrid-view.less';
</style>