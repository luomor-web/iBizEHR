<template>
  <app-layout viewName="pimdistirbutionygfenpeigridview" viewTitle="分配信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-ygfen-pei-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionYGFenPeiGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionYGFenPeiGridViewBase extends GridViewBase {
	 ...
	 * @memberof PimDistirbutionYGFenPeiGridViewBase
	 */
	public viewtag: string = '5fc2c295abb090da79cd6bfa22422494';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.ygfenpeigridview.caption',
        srfTitle: 'entities.pimdistirbution.views.ygfenpeigridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.ygfenpeigridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionYGFenPeiGridView
     */
...
<style lang='less'>
@import './pim-distirbution-ygfen-pei-grid-view.less';
</style>