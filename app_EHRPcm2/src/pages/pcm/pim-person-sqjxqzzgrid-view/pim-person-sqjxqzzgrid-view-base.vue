...
export default class PimPersonSQJXQZZGridViewBase extends GridViewBase {
	 ...
	 * @memberof PimPersonSQJXQZZGridViewBase
	 */
	public viewtag: string = 'f3e7742ed5683077e42010283b9996b6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.sqjxqzzgridview.caption',
        srfTitle: 'entities.pimperson.views.sqjxqzzgridview.title',
        srfSubTitle: 'entities.pimperson.views.sqjxqzzgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_sqjxszz')) {
            this.toolbar_deuiaction1_sqjxszz_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'deuiaction4_jxqzzjl')) {
            this.toolbar_deuiaction4_jxqzzjl_click(null, '', $event2);
        }
    ...
    public toolbar_deuiaction1_sqjxszz_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.PimPerson_SQJXSZZ(datas,contextJO, paramJO,  $event, xData,this,"PimPerson");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction4_jxqzzjl_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:PimPersonUIService  = new PimPersonUIService();
        curUIService.PimPerson_JXQZZJL(datas,contextJO, paramJO,  $event, xData,this,"PimPerson");
    }
...
<style lang='less'>
@import './pim-person-sqjxqzzgrid-view.less';
</style>