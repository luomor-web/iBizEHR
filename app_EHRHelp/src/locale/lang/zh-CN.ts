import sallog_zh_CN from '@locale/lanres/sal-log/sal-log_zh_CN';
import trmdepart_zh_CN from '@locale/lanres/trm-depart/trm-depart_zh_CN';
import trmtrainplanterm_zh_CN from '@locale/lanres/trm-train-planterm/trm-train-planterm_zh_CN';
import salschemeitem_zh_CN from '@locale/lanres/sal-scheme-item/sal-scheme-item_zh_CN';
import trmlgbcost_zh_CN from '@locale/lanres/trm-lgb-cost/trm-lgb-cost_zh_CN';
import pcmjxsygzzsq_zh_CN from '@locale/lanres/pcm-jxsygzzsq/pcm-jxsygzzsq_zh_CN';
...
import salstdgwgzrate_zh_CN from '@locale/lanres/sal-std-gw-gzrate/sal-std-gw-gzrate_zh_CN';
...
import parlhmbkhmx_zh_CN from '@locale/lanres/par-lhmbkhmx/par-lhmbkhmx_zh_CN';
...
import trmteachercharge_zh_CN from '@locale/lanres/trm-teacher-charge/trm-teacher-charge_zh_CN';
import salstdzc_zh_CN from '@locale/lanres/sal-stdzc/sal-stdzc_zh_CN';
import pcmxygzzsq_zh_CN from '@locale/lanres/pcm-xygzzsq/pcm-xygzzsq_zh_CN';
import vacworkday_zh_CN from '@locale/lanres/vac-work-day/vac-work-day_zh_CN';
...
import parjxzgpc_zh_CN from '@locale/lanres/par-jxzgpc/par-jxzgpc_zh_CN';
import vacsystemhistory_zh_CN from '@locale/lanres/vac-system-history/vac-system-history_zh_CN';
import attendancemreportmx_zh_CN from '@locale/lanres/att-endance-mreportmx/att-endance-mreportmx_zh_CN';
import trmteachertrain_zh_CN from '@locale/lanres/trm-teacher-train/trm-teacher-train_zh_CN';
import parjxkhjcsz_zh_CN from '@locale/lanres/par-jxkhjcsz/par-jxkhjcsz_zh_CN';
...
import pcmzjdyzw_zh_CN from '@locale/lanres/pcm-zjdyzw/pcm-zjdyzw_zh_CN';
import pcmrcxl_zh_CN from '@locale/lanres/pcm-rcxl/pcm-rcxl_zh_CN';
import pimbyzzjlmx_zh_CN from '@locale/lanres/pim-byzzjlmx/pim-byzzjlmx_zh_CN';
...
import trmtrainactment_zh_CN from '@locale/lanres/trm-train-actment/trm-train-actment_zh_CN';
...
import parlhmbmx_zh_CN from '@locale/lanres/par-lhmbmx/par-lhmbmx_zh_CN';
import pimpersonability_zh_CN from '@locale/lanres/pim-person-ability/pim-person-ability_zh_CN';
import trminvoice_zh_CN from '@locale/lanres/trm-invoice/trm-invoice_zh_CN';
...
import salstdgw_zh_CN from '@locale/lanres/sal-stdgw/sal-stdgw_zh_CN';
...
import pcmsyqgz_zh_CN from '@locale/lanres/pcm-syqgz/pcm-syqgz_zh_CN';
import vacholiday_zh_CN from '@locale/lanres/vac-holiday/vac-holiday_zh_CN';
import salsalarydetail_zh_CN from '@locale/lanres/sal-salary-detail/sal-salary-detail_zh_CN';
import parjxmtfk_zh_CN from '@locale/lanres/par-jxmtfk/par-jxmtfk_zh_CN';
import attendancemreport_zh_CN from '@locale/lanres/att-endance-mreport/att-endance-mreport_zh_CN';
import trmtrainactapply_zh_CN from '@locale/lanres/trm-train-actapply/trm-train-actapply_zh_CN';
...
import ormxmxqhz_zh_CN from '@locale/lanres/orm-xmxqhz/orm-xmxqhz_zh_CN';
import pimqualmajor_zh_CN from '@locale/lanres/pim-qual-major/pim-qual-major_zh_CN';
import pcmxygzzkhjgjl_zh_CN from '@locale/lanres/pcm-xygzzkhjgjl/pcm-xygzzkhjgjl_zh_CN';
import parjxkhmbmx_zh_CN from '@locale/lanres/par-jxkhmbmx/par-jxkhmbmx_zh_CN';
import vacleavemanage_zh_CN from '@locale/lanres/vac-leave-manage/vac-leave-manage_zh_CN';
import pcmlog_zh_CN from '@locale/lanres/pcm-log/pcm-log_zh_CN';
...
import trmplanformu_zh_CN from '@locale/lanres/trm-plan-formu/trm-plan-formu_zh_CN';
import trmtraindemand_zh_CN from '@locale/lanres/trm-train-demand/trm-train-demand_zh_CN';
...
import trmtrainplan_zh_CN from '@locale/lanres/trm-train-plan/trm-train-plan_zh_CN';
import pimachievements_zh_CN from '@locale/lanres/pim-achievements/pim-achievements_zh_CN';
import pcmbdsqd_zh_CN from '@locale/lanres/pcm-bdsqd/pcm-bdsqd_zh_CN';
...
import trmtraffic_zh_CN from '@locale/lanres/trm-traffic/trm-traffic_zh_CN';
...
import vacleavesystemdtail_zh_CN from '@locale/lanres/vac-leave-system-dtail/vac-leave-system-dtail_zh_CN';
import parjxzgpcmx_zh_CN from '@locale/lanres/par-jxzgpcmx/par-jxzgpcmx_zh_CN';
...
import trmtraindata_zh_CN from '@locale/lanres/trm-train-data/trm-train-data_zh_CN';
import pcmgbhmc_zh_CN from '@locale/lanres/pcm-gbhmc/pcm-gbhmc_zh_CN';
import parjgbmpjbz_zh_CN from '@locale/lanres/par-jgbmpjbz/par-jgbmpjbz_zh_CN';
import parndlhmbkh_zh_CN from '@locale/lanres/par-ndlhmbkh/par-ndlhmbkh_zh_CN';
...
import vacinitnxj_zh_CN from '@locale/lanres/vac-initnxj/vac-initnxj_zh_CN';
import salstdzx_zh_CN from '@locale/lanres/sal-stdzx/sal-stdzx_zh_CN';
import pimworkflow_zh_CN from '@locale/lanres/pim-workflow/pim-workflow_zh_CN';
import salitem_zh_CN from '@locale/lanres/sal-item/sal-item_zh_CN';
import trmagencyrecord_zh_CN from '@locale/lanres/trm-agency-record/trm-agency-record_zh_CN';
import ormbmkqdz_zh_CN from '@locale/lanres/orm-bmkqdz/orm-bmkqdz_zh_CN';
import pcmpcmsgqmgr_zh_CN from '@locale/lanres/pcm-pcm-sgq-mgr/pcm-pcm-sgq-mgr_zh_CN';
import trmdepartneeds_zh_CN from '@locale/lanres/trm-depart-needs/trm-depart-needs_zh_CN';
import salstdxmgz_zh_CN from '@locale/lanres/sal-std-xmgz/sal-std-xmgz_zh_CN';
import pcmcsrcmspj_zh_CN from '@locale/lanres/pcm-csrcmspj/pcm-csrcmspj_zh_CN';
import parkhzcmx_zh_CN from '@locale/lanres/par-khzcmx/par-khzcmx_zh_CN';
import salstdzyzg_zh_CN from '@locale/lanres/sal-stdzyzg/sal-stdzyzg_zh_CN';
...
import trmdemdeftion_zh_CN from '@locale/lanres/trm-demdeftion/trm-demdeftion_zh_CN';
import parjxjg_zh_CN from '@locale/lanres/par-jxjg/par-jxjg_zh_CN';
import salsubject_zh_CN from '@locale/lanres/sal-subject/sal-subject_zh_CN';
...
import parxmbpjbz_zh_CN from '@locale/lanres/par-xmbpjbz/par-xmbpjbz_zh_CN';
import vacleavesystem_zh_CN from '@locale/lanres/vac-leave-system/vac-leave-system_zh_CN';
import pcmypzjkxx_zh_CN from '@locale/lanres/pcm-ypzjkxx/pcm-ypzjkxx_zh_CN';
import salstdgl_zh_CN from '@locale/lanres/sal-stdgl/sal-stdgl_zh_CN';
import pimarmycadres_zh_CN from '@locale/lanres/pim-armycadres/pim-armycadres_zh_CN';
import pimbyygzzsq_zh_CN from '@locale/lanres/pim-byygzzsq/pim-byygzzsq_zh_CN';
import trmtrainteacher_zh_CN from '@locale/lanres/trm-train-teacher/trm-train-teacher_zh_CN';
import pcmjxsbdjl_zh_CN from '@locale/lanres/pcm-jxsbdjl/pcm-jxsbdjl_zh_CN';
import trmtrainbuapply_zh_CN from '@locale/lanres/trm-train-buapply/trm-train-buapply_zh_CN';
import codelist1_zh_CN from '@locale/lanres/code-list1/code-list1_zh_CN';
import trmtrainagency_zh_CN from '@locale/lanres/trm-train-agency/trm-train-agency_zh_CN';
import pimresearchfindings_zh_CN from '@locale/lanres/pim-research-findings/pim-research-findings_zh_CN';
import salscheme_zh_CN from '@locale/lanres/sal-scheme/sal-scheme_zh_CN';
...
import salsalary_zh_CN from '@locale/lanres/sal-salary/sal-salary_zh_CN';
import pcmnorecyclinglibrary_zh_CN from '@locale/lanres/pcm-no-recycling-library/pcm-no-recycling-library_zh_CN';
import attendancedate_zh_CN from '@locale/lanres/att-endance-date/att-endance-date_zh_CN';
import pimnationmgr_zh_CN from '@locale/lanres/pim-nation-mgr/pim-nation-mgr_zh_CN';
import ormxmrypzxq_zh_CN from '@locale/lanres/orm-xmrypzxq/orm-xmrypzxq_zh_CN';
...
import parjxkhmb_zh_CN from '@locale/lanres/par-jxkhmb/par-jxkhmb_zh_CN';
import salpersonstd_zh_CN from '@locale/lanres/sal-person-std/sal-person-std_zh_CN';
import trmtraindemandsum_zh_CN from '@locale/lanres/trm-train-demand-sum/trm-train-demand-sum_zh_CN';
import salsalarybill_zh_CN from '@locale/lanres/sal-salary-bill/sal-salary-bill_zh_CN';
import parznbmmx_zh_CN from '@locale/lanres/par-znbmmx/par-znbmmx_zh_CN';
import trmemployeeretion_zh_CN from '@locale/lanres/trm-employee-retion/trm-employee-retion_zh_CN';
import parjxndkhjg_zh_CN from '@locale/lanres/par-jxndkhjg/par-jxndkhjg_zh_CN';
import trmstaff_zh_CN from '@locale/lanres/trm-staff/trm-staff_zh_CN';
import ormxmbmx_zh_CN from '@locale/lanres/orm-xmbmx/orm-xmbmx_zh_CN';
import parldkhqz_zh_CN from '@locale/lanres/par-ldkhqz/par-ldkhqz_zh_CN';
import pimquestions_zh_CN from '@locale/lanres/pim-questions/pim-questions_zh_CN';
import salruledetail_zh_CN from '@locale/lanres/sal-rule-detail/sal-rule-detail_zh_CN';
import salpersonstddetail_zh_CN from '@locale/lanres/salpersonstddetail/salpersonstddetail_zh_CN';
import trmstay_zh_CN from '@locale/lanres/trm-stay/trm-stay_zh_CN';
import trmcoursesystem_zh_CN from '@locale/lanres/trm-course-system/trm-course-system_zh_CN';
import attensummary_zh_CN from '@locale/lanres/att-ensummary/att-ensummary_zh_CN';
import salrule_zh_CN from '@locale/lanres/sal-rule/sal-rule_zh_CN';
import ormxmrlcb_zh_CN from '@locale/lanres/orm-xmrlcb/orm-xmrlcb_zh_CN';
...
import pcmsgqmgr_zh_CN from '@locale/lanres/pcm-sgq-mgr/pcm-sgq-mgr_zh_CN';
import salitemsub_zh_CN from '@locale/lanres/sal-item-sub/sal-item-sub_zh_CN';
...
import parjxbzgl_zh_CN from '@locale/lanres/par-jxbzgl/par-jxbzgl_zh_CN';
import vacusenxjmx_zh_CN from '@locale/lanres/vac-use-nxjmx/vac-use-nxjmx_zh_CN';
import vacsynjcx_zh_CN from '@locale/lanres/vac-synjcx/vac-synjcx_zh_CN';
import pcmzpmegl_zh_CN from '@locale/lanres/pcm-zpmegl/pcm-zpmegl_zh_CN';
import attensummarymx_zh_CN from '@locale/lanres/att-ensummarymx/att-ensummarymx_zh_CN';
import trmhmatser_zh_CN from '@locale/lanres/trm-hmatser/trm-hmatser_zh_CN';
import pcmtxfpsq_zh_CN from '@locale/lanres/pcm-txfpsq/pcm-txfpsq_zh_CN';
import ormzwdqgz_zh_CN from '@locale/lanres/orm-zwdqgz/orm-zwdqgz_zh_CN';
...
import attendancerecordtemp_zh_CN from '@locale/lanres/att-endance-record-temp/att-endance-record-temp_zh_CN';
import pcmgxxktemp_zh_CN from '@locale/lanres/pcmgxxk-temp/pcmgxxk-temp_zh_CN';
import pcmrzgl_zh_CN from '@locale/lanres/pcm-rzgl/pcm-rzgl_zh_CN';
import trmtrainfillin_zh_CN from '@locale/lanres/trm-train-fillin/trm-train-fillin_zh_CN';
import salstdxmgzrate_zh_CN from '@locale/lanres/sal-std-xmgz-rate/sal-std-xmgz-rate_zh_CN';
import vacdayoff_zh_CN from '@locale/lanres/vac-day-off/vac-day-off_zh_CN';
import trmstaffnodes_zh_CN from '@locale/lanres/trm-staffnodes/trm-staffnodes_zh_CN';
import pcmawardswons_zh_CN from '@locale/lanres/pcm-awards-wons/pcm-awards-wons_zh_CN';
import trmcouarrange_zh_CN from '@locale/lanres/trm-couarrange/trm-couarrange_zh_CN';
import pimrewardpunishment_zh_CN from '@locale/lanres/pim-reward-punishment/pim-reward-punishment_zh_CN';
import salstdzj_zh_CN from '@locale/lanres/sal-stdzj/sal-stdzj_zh_CN';
...
import trmtrainaddress_zh_CN from '@locale/lanres/trm-train-address/trm-train-address_zh_CN';
...
import trmtrainoutapply_zh_CN from '@locale/lanres/trm-train-out-apply/trm-train-out-apply_zh_CN';
import pimarchivalcatalogue_zh_CN from '@locale/lanres/pim-archival-catalogue/pim-archival-catalogue_zh_CN';
import parjxqdsz_zh_CN from '@locale/lanres/par-jxqdsz/par-jxqdsz_zh_CN';
import vacsituationdetail_zh_CN from '@locale/lanres/vac-situation-detail/vac-situation-detail_zh_CN';
import trmtraincourse_zh_CN from '@locale/lanres/trm-train-course/trm-train-course_zh_CN';
import parkhfa_zh_CN from '@locale/lanres/par-khfa/par-khfa_zh_CN';
import attendenceormorgscetor_zh_CN from '@locale/lanres/att-endence-ormorgscetor/att-endence-ormorgscetor_zh_CN';
import trmdutycadres_zh_CN from '@locale/lanres/trm-duty-cadres/trm-duty-cadres_zh_CN';
import vacoveralltion_zh_CN from '@locale/lanres/vac-overalltion/vac-overalltion_zh_CN';
import partzgg_zh_CN from '@locale/lanres/par-tzgg/par-tzgg_zh_CN';
import pcmydntmx_zh_CN from '@locale/lanres/pcm-ydntmx/pcm-ydntmx_zh_CN';
import trmgradecadres_zh_CN from '@locale/lanres/trm-gradecadres/trm-gradecadres_zh_CN';
import trmlgbdetail_zh_CN from '@locale/lanres/trm-lgb-detail/trm-lgb-detail_zh_CN';
import ormrelation_zh_CN from '@locale/lanres/orm-relation/orm-relation_zh_CN';
import trmtrainfacies_zh_CN from '@locale/lanres/trm-train-facies/trm-train-facies_zh_CN';
...
import salstddszn_zh_CN from '@locale/lanres/sal-stddszn/sal-stddszn_zh_CN';
import ormdepestman_zh_CN from '@locale/lanres/orm-dep-est-man/orm-dep-est-man_zh_CN';
import ormxmsfhz_zh_CN from '@locale/lanres/orm-xmsfhz/orm-xmsfhz_zh_CN';
import ormduty_zh_CN from '@locale/lanres/orm-duty/orm-duty_zh_CN';
import pcmmspjxx_zh_CN from '@locale/lanres/pcm-mspjxx/pcm-mspjxx_zh_CN';
import codeitem_zh_CN from '@locale/lanres/code-item/code-item_zh_CN';
import pimdaterule_zh_CN from '@locale/lanres/pim-date-rule/pim-date-rule_zh_CN';
...
import pimworkflowref_zh_CN from '@locale/lanres/pim-workflow-ref/pim-workflow-ref_zh_CN';
import parjxkhxhz_zh_CN from '@locale/lanres/par-jxkhxhz/par-jxkhxhz_zh_CN';
import pcmxygzzjlmx_zh_CN from '@locale/lanres/pcm-xygzzjlmx/pcm-xygzzjlmx_zh_CN';
import vacwfqj_zh_CN from '@locale/lanres/vac-wfqj/vac-wfqj_zh_CN';
import pcmjxszzkhjgjl_zh_CN from '@locale/lanres/pcm-jxszzkhjgjl/pcm-jxszzkhjgjl_zh_CN';
import salsource_zh_CN from '@locale/lanres/sal-source/sal-source_zh_CN';
...
import pcmjxsygzzsqmx_zh_CN from '@locale/lanres/pcm-jxsygzzsqmx/pcm-jxsygzzsqmx_zh_CN';
import pimprovince_zh_CN from '@locale/lanres/pim-province/pim-province_zh_CN';
import pcmzsgl_zh_CN from '@locale/lanres/pcm-zsgl/pcm-zsgl_zh_CN';
import ormpost_zh_CN from '@locale/lanres/orm-post/orm-post_zh_CN';
import salplan_zh_CN from '@locale/lanres/sal-plan/sal-plan_zh_CN';
import pcmzpmeglmx_zh_CN from '@locale/lanres/pcm-zpmeglmx/pcm-zpmeglmx_zh_CN';
import parjxbzglmx_zh_CN from '@locale/lanres/par-jxbzglmx/par-jxbzglmx_zh_CN';
import salstdgwgz_zh_CN from '@locale/lanres/sal-stdgwgz/sal-stdgwgz_zh_CN';
...
import attenmembwes_zh_CN from '@locale/lanres/att-enmembwes/att-enmembwes_zh_CN';
import ormerporg_zh_CN from '@locale/lanres/orm-erporg/orm-erporg_zh_CN';
import parbmfzjyx_zh_CN from '@locale/lanres/par-bmfzjyx/par-bmfzjyx_zh_CN';
...
import vacsituation_zh_CN from '@locale/lanres/vac-situation/vac-situation_zh_CN';
import pcmbdsqdmx_zh_CN from '@locale/lanres/pcm-bdsqdmx/pcm-bdsqdmx_zh_CN';
import pcmjxsygzzjlmx_zh_CN from '@locale/lanres/pcm-jxsygzzjlmx/pcm-jxsygzzjlmx_zh_CN';
import vacsystemapplication_zh_CN from '@locale/lanres/vac-system-application/vac-system-application_zh_CN';
import trmzzobm_zh_CN from '@locale/lanres/trm-zzobm/trm-zzobm_zh_CN';
...
import pcmxygzzjgwh_zh_CN from '@locale/lanres/pcm-xygzzjgwh/pcm-xygzzjgwh_zh_CN';
import salparam_zh_CN from '@locale/lanres/sal-param/sal-param_zh_CN';
import parjxlhmb_zh_CN from '@locale/lanres/par-jxlhmb/par-jxlhmb_zh_CN';
import pcmxygzzsqmx_zh_CN from '@locale/lanres/pcm-xygzzsqmx/pcm-xygzzsqmx_zh_CN';
...
import parfzsmx_zh_CN from '@locale/lanres/par-fzsmx/par-fzsmx_zh_CN';
...
import trmtrainresment_zh_CN from '@locale/lanres/trm-train-resment/trm-train-resment_zh_CN';
