...
export default class FillPersonInfoLogicBase {
    ...
    */
    private async executePrepareparam2(context:any,params:any,isloading:boolean){
        ...
        Object.assign(context,{pcmydjdmx:params.pimpersonid ? params.pimpersonid : null});
        ...
        Object.assign(context,{pcmydjdmx:params.ormorgid ? params.ormorgid : null});
        Object.assign(params,{bmid:params.ormorgsectorid});
        Object.assign(context,{pcmydjdmx:params.ormorgsectorid ? params.ormorgsectorid : null});
        return params;
    }
