...
// 实体接口
    ...
    public async CheckKey(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
            return Http.getInstance().post(`/msgtemplates/${context.msgtemplate}/checkkey`,data,isloading);
    }
    ...
    public async Remove(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
            return Http.getInstance().delete(`/msgtemplates/${context.msgtemplate}`,isloading);
    ...
    public async FetchDefault(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        return Http.getInstance().get(`/msgtemplates/fetchdefault`,tempData,isloading);
    }
}