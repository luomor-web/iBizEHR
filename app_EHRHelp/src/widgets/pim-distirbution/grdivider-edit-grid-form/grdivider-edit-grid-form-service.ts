...
import GRDividerEditGridModel from './grdivider-edit-grid-form-model';
...
/**
 * GRDividerEditGrid 部件服务对象
 *
 * @export
 * @class GRDividerEditGridService
 */
export default class GRDividerEditGridService extends ControlService {

    /**
     * 分配信息服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof GRDividerEditGridService
     */
    ...
    /**
     * Creates an instance of GRDividerEditGridService.
     * 
     * @param {*} [opts={}]
     * @memberof GRDividerEditGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GRDividerEditGridModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimdistirbutionid = PrimaryKey;
        Data.pimdistirbution = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimdistirbutionid = PrimaryKey;
