<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimdistirbution_grdividereditgrid' style="">
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimdistirbution_grdividereditgrid',popTitle:'主编辑表单（分配信息个人)'});
    }
