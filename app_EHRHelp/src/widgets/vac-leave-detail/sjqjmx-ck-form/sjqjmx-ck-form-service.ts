...
import SJQJMX_CKModel from './sjqjmx-ck-form-model';
 ...
 *
 * @export
 * @class SJQJMX_CKService
 */
export default class SJQJMX_CKService extends ControlService {

    /**
     * 请假明细服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof SJQJMX_CKService
     */
    public appEntityService: VacLeaveDetailService = new VacLeaveDetailService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of SJQJMX_CKService.
     * 
     * @param {*} [opts={}]
     * @memberof SJQJMX_CKService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.vacleavedetailid = PrimaryKey;
        Data.vacleavedetail = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.vacleavedetailid = PrimaryKey;
