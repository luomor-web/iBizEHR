<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimresearchfindings_greditform' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimresearchfindings.greditform_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimresearchfindingsname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimresearchfindingsname' :itemRules="this.rules.pimresearchfindingsname" class='' :caption="$t('entities.pimresearchfindings.greditform_form.details.pimresearchfindingsname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimresearchfindingsname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.hqsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='hqsj' :itemRules="this.rules.hqsj" class='' :caption="$t('entities.pimresearchfindings.greditform_form.details.hqsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.hqsj.error" :isEmptyCaption="false" labelPos="LEFT">
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimresearchfindings_greditform',popTitle:'主编辑表单(个人)'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSGREditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSGREditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSGREditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMRESEARCHFINDINGSGREditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
