...
import GRContractEditGridModel from './grcontract-edit-grid-form-model';
import OrmOrgService from '@/service/orm-org/orm-org-service';


/**
 * GRContractEditGrid 部件服务对象
 *
 * @export
 * @class GRContractEditGridService
 */
export default class GRContractEditGridService extends ControlService {
    ...
    /**
     * Creates an instance of GRContractEditGridService.
     * 
     * @param {*} [opts={}]
     * @memberof GRContractEditGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GRContractEditGridModel();
    }
