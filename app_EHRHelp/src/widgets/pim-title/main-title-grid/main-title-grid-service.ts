...
import Main_TitleModel from './main-title-grid-model';
 ...
 *
 * @export
 * @class Main_TitleService
 */
export default class Main_TitleService extends ControlService {
    ...
    /**
     * Creates an instance of Main_TitleService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_TitleService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_TitleModel();
    }
