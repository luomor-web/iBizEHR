...
import YTGModel from './ytg-form-model';
 ...
 * @class YTGService
 */
export default class YTGService extends ControlService {
     ...
     * @memberof YTGService
     */
    public appEntityService: VacLeaveManageService = new VacLeaveManageService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of YTGService.
     * 
     * @param {*} [opts={}]
     * @memberof YTGService
     */
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'PimPersonService') && Object.is(interfaceName, 'FetchKQJRYCX')) {
            return this.doItems(this.pimpersonService.FetchKQJRYCX(JSON.parse(JSON.stringify(context)),data, isloading), 'pimpersonid', 'pimperson');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.vacleavemanageid = PrimaryKey;
        Data.vacleavemanage = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.vacleavemanageid = PrimaryKey;
