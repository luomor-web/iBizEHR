...
import RYInfoForm_2Model from './ryinfo-form-2-form-model';
import PimCityService from '@/service/pim-city/pim-city-service';
 ...
 *
 * @export
 * @class RYInfoForm_2Service
 */
export default class RYInfoForm_2Service extends ControlService {

    /**
     * 人员信息服务对象
     *
     * @type {PimPersonService}
     * @memberof RYInfoForm_2Service
     */
    ...
    /**
     * Creates an instance of RYInfoForm_2Service.
     * 
     * @param {*} [opts={}]
     * @memberof RYInfoForm_2Service
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RYInfoForm_2Model();
    }
