...
export default class GREditFormService extends ControlService {
     ...
     */
    public appEntityService: PimPaperService = new PimPaperService({ $store: this.getStore() });
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimpaperid = PrimaryKey;
        Data.pimpaper = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimpaperid = PrimaryKey;
