<template>
    ...
    <row >
    <tabs :animated="false" name='spz' :value="detailsModel.form.activiedPage" 
        @on-click="detailsModel.form.clickPage($event)">
            <tab-pane v-show="detailsModel.formpage1.visible" name='formpage1' :index="0" tab='spz' class=''  
                :label="(h) =>{
                    return h('span',{
                        class:'caption'
                    },[
                    $t('entities.vacleavemanage.spz_form.details.formpage1')
                    ])
                }">
                    
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.vacleavemanage.spz_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.pimpersonname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='pimpersonname' :itemRules="this.rules.pimpersonname" class='' :caption="$t('entities.vacleavemanage.spz_form.details.pimpersonname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.pimpersonname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-picker 
  :formState="formState"
  :data="data"
  :context="context"
  ...
  :service="service"
  :acParams="{ serviceName: 'PIMPERSONService', interfaceName: 'FetchKQJRYCX'}"
  valueitem='pimpersonid' 
  :value="data.pimpersonname" 
  editortype="" 
  :pickupView="{ viewname: 'pimpersonkqjrypickup-view', title: $t('entities.pimperson.views.kqjrypickupview.title'), deResParameters: [], parameters: [{ pathName: 'pimpeople', parameterName: 'pimperson' }, { pathName: 'kqjrypickupview', parameterName: 'kqjrypickupview' } ], placement:'' }"
  style=""  
...
<i-col v-show="detailsModel.ormorgname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormorgname' :itemRules="this.rules.ormorgname" class='' :caption="$t('entities.vacleavemanage.spz_form.details.ormorgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ormorgsectorname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ormorgsectorname' :itemRules="this.rules.ormorgsectorname" class='' :caption="$t('entities.vacleavemanage.spz_form.details.ormorgsectorname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ormorgsectorname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.qjsy.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='qjsy' :itemRules="this.rules.qjsy" class='' :caption="$t('entities.vacleavemanage.spz_form.details.qjsy')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.qjsy.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.grouppanel2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.vacleavemanage.spz_form.details.grouppanel2')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.druipart2.visible" :style="{'height': '500px !important',}"  :lg="{ span: 24, offset: 0 }">
    <app-form-druipart
    ...
    viewname='vacleavedetailjhqjmx-ck-grid-view' 
    ...
    style="height:500px;overflow: auto;">
            ...
            <tab-pane v-show="detailsModel.formpage2.visible" name='formpage2' :index="1" tab='spz' class=''  
                :label="(h) =>{
                    return h('span',{
                        class:'caption'
                    },[
                    $t('entities.vacleavemanage.spz_form.details.formpage2')
                    ])
                }">
...
export default class SPZBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '请假管理标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '请假管理标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '请假管理标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '请假管理标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
        ...
        qjsy: [
            { type: 'string', message: '请假事由 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '请假事由 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '请假事由 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '请假事由 值不能为空', trigger: 'blur' },
        ],
        wfqqjstate: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '请假信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.vacleavemanage.spz_form', extractMode: 'ITEM', details: [] } })
, 
        druipart2: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart2', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '请假明细', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.vacleavemanage.spz_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '请假管理标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '请假人员', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        qjsy: new FormItemModel({ caption: '请假事由', detailType: 'FORMITEM', name: 'qjsy', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
        wfqqjstate: new FormItemModel({ caption: '请销假状态', detailType: 'FORMITEM', name: 'wfqqjstate', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    onQjsyChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'qjsy', newVal: newVal, oldVal: oldVal });
    }
    ...
    onWfqqjstateChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'wfqqjstate', newVal: newVal, oldVal: oldVal });
    }
    ...
    public formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }): void {
        ...
        if(Object.is(name, 'pimpersonname')){
            const details: string[] = ['ormorgsectorname', 'ormorgname'];
            this.updateFormItems('GetFJSJofPerson', this.data, details, true);
        }
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.vacleavemanage){
            Object.assign(this.context,{vacleavemanage:data.vacleavemanage})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.vacleavemanage = copyData.srfkey;
        copyData.vacleavemanageid = copyData.srfkey;
        Object.assign(this.context,{vacleavemanage:copyData.vacleavemanage})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'VACLEAVEMANAGESPZEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'VACLEAVEMANAGESPZEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'VACLEAVEMANAGESPZEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'VACLEAVEMANAGESPZEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.vacleavemanage || Object.is(arg.vacleavemanage, '')) {
            return;
        }
    ...
    */
    ...
    public updateDefault(){                    
        ...
        if (this.data.hasOwnProperty('pimpersonname') && !this.data.pimpersonname) {
            this.data['pimpersonname'] = this.context['SRFUSERNAME'];
        }
    }
