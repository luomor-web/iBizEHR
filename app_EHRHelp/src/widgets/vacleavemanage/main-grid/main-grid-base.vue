    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ vacleavemanage: keys.join(';') }),Object.assign({ vacleavemanage: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
