...
import GRPatentEditFormModel from './grpatent-edit-form-form-model';


/**
 * GRPatentEditForm 部件服务对象
 *
 * @export
 * @class GRPatentEditFormService
 */
export default class GRPatentEditFormService extends ControlService {

    /**
     * 专利信息服务对象
     *
     * @type {PimPatentService}
     * @memberof GRPatentEditFormService
     */
    public appEntityService: PimPatentService = new PimPatentService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of GRPatentEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof GRPatentEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new GRPatentEditFormModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimpatentid = PrimaryKey;
        Data.pimpatent = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimpatentid = PrimaryKey;
