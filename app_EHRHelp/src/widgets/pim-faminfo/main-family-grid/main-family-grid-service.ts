...
import Main_FamilyModel from './main-family-grid-model';
 ...
 *
 * @export
 * @class Main_FamilyService
 */
export default class Main_FamilyService extends ControlService {
    ...
    /**
     * Creates an instance of Main_FamilyService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_FamilyService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_FamilyModel();
    }
