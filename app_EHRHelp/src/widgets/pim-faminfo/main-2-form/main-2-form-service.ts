...
export default class Main_2Service extends ControlService {
     ...
     */
    public appEntityService: PimFaminfoService = new PimFaminfoService({ $store: this.getStore() });
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.pimfaminfoid = PrimaryKey;
        Data.pimfaminfo = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.pimfaminfoid = PrimaryKey;
