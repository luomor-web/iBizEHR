<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='pimquestions_yh_check' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimquestions.yh_check_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.wtbh.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wtbh' :itemRules="this.rules.wtbh" class='' :caption="$t('entities.pimquestions.yh_check_form.details.wtbh')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wtbh.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.questionsname.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='questionsname' :itemRules="this.rules.questionsname" class='' :caption="$t('entities.pimquestions.yh_check_form.details.questionsname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.questionsname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.jjcd.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='jjcd' :itemRules="this.rules.jjcd" class='' :caption="$t('entities.pimquestions.yh_check_form.details.jjcd')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.jjcd.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.ym.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='ym' :itemRules="this.rules.ym" class='' :caption="$t('entities.pimquestions.yh_check_form.details.ym')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.ym.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.wtzt.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wtzt' :itemRules="this.rules.wtzt" class='' :caption="$t('entities.pimquestions.yh_check_form.details.wtzt')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wtzt.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.kfz.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='kfz' :itemRules="this.rules.kfz" class='' :caption="$t('entities.pimquestions.yh_check_form.details.kfz')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.kfz.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.wcsj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='wcsj' :itemRules="this.rules.wcsj" class='' :caption="$t('entities.pimquestions.yh_check_form.details.wcsj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.wcsj.error" :isEmptyCaption="false" labelPos="LEFT">
...
, 
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.pimquestions){
            Object.assign(this.context,{pimquestions:data.pimquestions})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pimquestions = copyData.srfkey;
        copyData.questionsid = copyData.srfkey;
        Object.assign(this.context,{pimquestions:copyData.pimquestions})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'pimquestions_yh_check',popTitle:'本页问题表单（用户查看）'});
    }
    ...
    */
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pimquestions || Object.is(arg.pimquestions, '')) {
            return;
        }
