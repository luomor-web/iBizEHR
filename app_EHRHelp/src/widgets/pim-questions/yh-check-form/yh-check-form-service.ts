...
import YH_CheckModel from './yh-check-form-model';
 ...
 *
 * @export
 * @class YH_CheckService
 */
export default class YH_CheckService extends ControlService {

    /**
     * 问题收集服务对象
     *
     * @type {PimQuestionsService}
     * @memberof YH_CheckService
     */
    ...
    /**
     * Creates an instance of YH_CheckService.
     * 
     * @param {*} [opts={}]
     * @memberof YH_CheckService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.questionsid = PrimaryKey;
        Data.pimquestions = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                response.data.questionsid = PrimaryKey;
