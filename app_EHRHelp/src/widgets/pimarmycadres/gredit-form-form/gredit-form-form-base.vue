...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.pimarmycadres.greditform_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
    ...
    <app-form-item name='trooptype' :itemRules="this.rules.trooptype" class='' :caption="$t('entities.pimarmycadres.greditform_form.details.trooptype')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.trooptype.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.trooptype" :data="data" :itemParam="{}" :disabled="detailsModel.trooptype.disabled"  tag='PIMCL_TROOPTYPE' codelistType='DYNAMIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>
...
<i-col v-show="detailsModel.leveltype.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='leveltype' :itemRules="this.rules.leveltype" class='' :caption="$t('entities.pimarmycadres.greditform_form.details.leveltype')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.leveltype.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.leveltype" :data="data" :itemParam="{}" :disabled="detailsModel.leveltype.disabled"  tag='PIMCL_LEVEL' codelistType='DYNAMIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.fssj.visible" :style="{}"  :lg="{ span: 8, offset: 0 }">
    <app-form-item name='fssj' :itemRules="this.rules.fssj" class='' :caption="$t('entities.pimarmycadres.greditform_form.details.fssj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.fssj.error" :isEmptyCaption="false" labelPos="LEFT">
    <date-picker type="date" :transfer="true" format="yyyy-MM-dd" placeholder="请选择时间..." :value="data.fssj" :disabled="detailsModel.fssj.disabled" style="min-width: 150px; width:100px;width:100%;" @on-change="(val1, val2) => { this.data.fssj = val1 }"></date-picker>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.fj.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='fj' :itemRules="this.rules.fj" class='' :caption="$t('entities.pimarmycadres.greditform_form.details.fj')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.fj.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class GREditFormBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        srfkey: [
            { type: 'string', message: '军转干部标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '军转干部标识 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '军转干部标识 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '军转干部标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '军转干部名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '军转干部名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '军转干部名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '军转干部名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        leveltype: [
            ...
            { required: true, type: 'string', message: '级别(*) 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '级别(*) 值不能为空', trigger: 'blur' },
        ],
        fssj: [
            { type: 'string', message: '发生时间(*) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '发生时间(*) 值必须为字符串类型', trigger: 'blur' },
            { required: true, type: 'string', message: '发生时间(*) 值不能为空', trigger: 'change' },
            { required: true, type: 'string', message: '发生时间(*) 值不能为空', trigger: 'blur' },
        ],
        fj: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '军转干部基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.pimarmycadres.greditform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '军转干部标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '军转干部名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        trooptype: new FormItemModel({ caption: '类型(*)', detailType: 'FORMITEM', name: 'trooptype', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        leveltype: new FormItemModel({ caption: '级别(*)', detailType: 'FORMITEM', name: 'leveltype', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        fssj: new FormItemModel({ caption: '发生时间(*)', detailType: 'FORMITEM', name: 'fssj', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        pimarmycadresid: new FormItemModel({ caption: '军转干部标识', detailType: 'FORMITEM', name: 'pimarmycadresid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
     ...
     * @memberof GREditForm
     */
    @Watch('data.trooptype')
    onTrooptypeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'trooptype', newVal: newVal, oldVal: oldVal });
    }
     ...
     * @memberof GREditForm
     */
    @Watch('data.leveltype')
    onLeveltypeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'leveltype', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.fssj')
    onFssjChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'fssj', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 pimarmycadresid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof GREditForm
     */
    @Watch('data.pimarmycadresid')
    onPimarmycadresidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'pimarmycadresid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.pimarmycadres = copyData.srfkey;
        copyData.pimarmycadresid = copyData.srfkey;
        Object.assign(this.context,{pimarmycadres:copyData.pimarmycadres})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGREditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGREditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGREditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGREditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.pimarmycadres || Object.is(arg.pimarmycadres, '')) {
            return;
        }
