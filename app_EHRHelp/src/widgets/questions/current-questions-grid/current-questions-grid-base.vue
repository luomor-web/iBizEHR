    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'wtbh',
            label: '问题编号',
            langtag: 'entities.questions.currentquestions_grid.columns.wtbh',
            show: true,
            util: 'px'
        },
        {
            name: 'questionsname',
            label: '问题',
            langtag: 'entities.questions.currentquestions_grid.columns.questionsname',
            show: true,
            util: 'px'
        },
        {
            name: 'jjcd',
            label: '紧急程度',
            langtag: 'entities.questions.currentquestions_grid.columns.jjcd',
            show: true,
            util: 'px'
        },
        {
            name: 'createman',
            label: '提出人',
            langtag: 'entities.questions.currentquestions_grid.columns.createman',
            show: true,
            util: 'PX'
        },
        {
            name: 'createdate',
            label: '提出时间',
            langtag: 'entities.questions.currentquestions_grid.columns.createdate',
            show: true,
            util: 'PX'
        },
        {
            name: 'wtms',
            label: '问题描述',
            langtag: 'entities.questions.currentquestions_grid.columns.wtms',
            show: true,
            util: 'STAR'
        },
        {
            name: 'wtzt',
            label: '问题状态',
            langtag: 'entities.questions.currentquestions_grid.columns.wtzt',
            show: true,
            util: 'px'
        },
        {
            name: 'wcsj',
            label: '完成时间',
            langtag: 'entities.questions.currentquestions_grid.columns.wcsj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ questions: keys.join(';') }),Object.assign({ questions: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public save(args: any[], params?: any, $event?: any, xData?: any): void {
        ...
        _this.items.forEach((item:any)=>{
            if(!item.rowDataState){
                ...
                Object.assign(item,{viewparams:this.viewparams});
                if(item.questions){
                    Object.assign(this.context,{questions:item.questions})
                }
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.questions,args.row.questions);
        });
