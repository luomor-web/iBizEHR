...
import JHQJMX_CKModel from './jhqjmx-ck-form-model';
 ...
 *
 * @export
 * @class JHQJMX_CKService
 */
export default class JHQJMX_CKService extends ControlService {

    /**
     * 请假明细服务对象
     *
     * @type {VACLEAVEDETAILService}
     * @memberof JHQJMX_CKService
     */
    ...
    /**
     * Creates an instance of JHQJMX_CKService.
     * 
     * @param {*} [opts={}]
     * @memberof JHQJMX_CKService
     */
