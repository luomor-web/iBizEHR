    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ vacleavedetail: keys.join(';') }),Object.assign({ vacleavedetail: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
