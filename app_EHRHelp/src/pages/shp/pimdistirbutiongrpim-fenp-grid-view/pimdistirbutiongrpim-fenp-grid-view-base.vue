<template>
  <app-layout viewName="pimdistirbutiongrpimfenpgridview" viewTitle="分配信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimdistirbutiongrpim-fenp-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<style lang='less'>
@import './pimdistirbutiongrpim-fenp-grid-view.less';
</style>