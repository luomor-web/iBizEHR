<template>
  <app-layout viewName="pimcontractgrcontractgridview" viewTitle="合同信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimcontractgrcontract-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMCONTRACTGRContractGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTGRContractGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimContractService}
     * @memberof PIMCONTRACTGRContractGridViewBase
     */
	 ...
	 * @memberof PIMCONTRACTGRContractGridViewBase
	 */
	public viewtag: string = 'fcc2d91b5309470d632f56c66938be02';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontract.views.grcontractgridview.caption',
        srfTitle: 'entities.pimcontract.views.grcontractgridview.title',
        srfSubTitle: 'entities.pimcontract.views.grcontractgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTGRContractGridView
     */
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"PimContract");
    }
...
<style lang='less'>
@import './pimcontractgrcontract-grid-view.less';
</style>