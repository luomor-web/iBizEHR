<template>
  <app-layout viewName="vacleavedetailjhqjmx_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vacleavedetailjhqjmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VACLEAVEDETAILJHQJMX_GridViewBase extends GridViewBase {
	 ...
	 * @memberof VACLEAVEDETAILJHQJMX_GridViewBase
	 */
	public viewtag: string = '8bcc6b59d8eb2a403ab018d9a9f42a9f';
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vacleavedetailjhqjmx-edit-view', 
            height: 700, 
            width: 0,  
...
<style lang='less'>
@import './vacleavedetailjhqjmx-grid-view.less';
</style>