<template>
  <app-layout viewName="vacleavedetailjhqjmx_editview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vacleavedetailjhqjmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VACLEAVEDETAILJHQJMX_EditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VACLEAVEDETAILJHQJMX_EditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof VACLEAVEDETAILJHQJMX_EditViewBase
     */
	 ...
	 * @memberof VACLEAVEDETAILJHQJMX_EditViewBase
	 */
	public viewtag: string = '0f731a857ff34f575337c534880d7743';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavedetail.views.jhqjmx_editview.caption',
        srfTitle: 'entities.vacleavedetail.views.jhqjmx_editview.title',
        srfSubTitle: 'entities.vacleavedetail.views.jhqjmx_editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VACLEAVEDETAILJHQJMX_EditView
     */
...
<style lang='less'>
@import './vacleavedetailjhqjmx-edit-view.less';
</style>