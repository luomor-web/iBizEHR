<template>
  <app-layout viewName="pimpatentgrpatentgridview" viewTitle="专利信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpatentgrpatentgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="专利名称(*)" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMPATENTGRPATENTGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPATENTGRPATENTGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPatentService}
     * @memberof PIMPATENTGRPATENTGridViewBase
     */
	 ...
	 * @memberof PIMPATENTGRPATENTGridViewBase
	 */
	public viewtag: string = '940fc200799331fea59fb89973f1d281';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpatent.views.grpatentgridview.caption',
        srfTitle: 'entities.pimpatent.views.grpatentgridview.title',
        srfSubTitle: 'entities.pimpatent.views.grpatentgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPATENTGRPATENTGridView
     */
...
<style lang='less'>
@import './pimpatentgrpatentgrid-view.less';
</style>