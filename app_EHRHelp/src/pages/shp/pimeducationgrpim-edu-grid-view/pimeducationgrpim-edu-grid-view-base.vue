<template>
  <app-layout viewName="pimeducationgrpimedugridview" viewTitle="教育信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimeducationgrpim-edu-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEDUCATIONGRPimEduGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEDUCATIONGRPimEduGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMEDUCATIONGRPimEduGridViewBase
	 */
	public viewtag: string = '0381f5daeb17f3c1f499e56ec297fc33';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimeducation.views.grpimedugridview.caption',
        srfTitle: 'entities.pimeducation.views.grpimedugridview.title',
        srfSubTitle: 'entities.pimeducation.views.grpimedugridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEDUCATIONGRPimEduGridView
     */
 ...
 tbitem13: { name: 'tbitem13', caption: '导出数据','isShowCaption':true,'isShowIcon':true, tooltip: '导出数据', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimeducation: args[0].pimeducation })
            }
...
<style lang='less'>
@import './pimeducationgrpim-edu-grid-view.less';
</style>