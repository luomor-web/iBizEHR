<template>
  <app-layout viewName="vacleavedetailjhqjmx_ck_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vacleavedetailjhqjmx-ck-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VACLEAVEDETAILJHQJMX_CK_GridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VACLEAVEDETAILJHQJMX_CK_GridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof VACLEAVEDETAILJHQJMX_CK_GridViewBase
     */
	 ...
	 * @memberof VACLEAVEDETAILJHQJMX_CK_GridViewBase
	 */
	public viewtag: string = 'b7bde6adb20c2ff22ff8005d941e91de';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavedetail.views.jhqjmx_ck_gridview.caption',
        srfTitle: 'entities.vacleavedetail.views.jhqjmx_ck_gridview.title',
        srfSubTitle: 'entities.vacleavedetail.views.jhqjmx_ck_gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VACLEAVEDETAILJHQJMX_CK_GridView
     */
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"VacLeaveDetail");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vacleavedetailjhqjmx-ck-edit-view', 
            height: 700, 
            width: 0,  
            title: this.$t('entities.vacleavedetail.views.jhqjmx_ck_editview.title'),
        };
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { vacleavedetail: args[0].vacleavedetail })
            }
...
<style lang='less'>
@import './vacleavedetailjhqjmx-ck-grid-view.less';
</style>