<template>
  <app-layout viewName="pimpapergrpapergridview" viewTitle="论文信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimpapergr-papergrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="论文名称(*)" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMPAPERGrPAPERGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPAPERGrPAPERGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPaperService}
     * @memberof PIMPAPERGrPAPERGridViewBase
     */
	 ...
	 * @memberof PIMPAPERGrPAPERGridViewBase
	 */
	public viewtag: string = 'b400171da8f193d395641c45ecb8d568';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpaper.views.grpapergridview.caption',
        srfTitle: 'entities.pimpaper.views.grpapergridview.title',
        srfSubTitle: 'entities.pimpaper.views.grpapergridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPAPERGrPAPERGridView
     */
...
<style lang='less'>
@import './pimpapergr-papergrid-view.less';
</style>