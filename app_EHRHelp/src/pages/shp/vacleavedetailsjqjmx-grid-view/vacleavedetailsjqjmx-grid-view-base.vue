<template>
  <app-layout viewName="vacleavedetailsjqjmx_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vacleavedetailsjqjmx-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VACLEAVEDETAILSJQJMX_GridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VACLEAVEDETAILSJQJMX_GridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof VACLEAVEDETAILSJQJMX_GridViewBase
     */
	 ...
	 * @memberof VACLEAVEDETAILSJQJMX_GridViewBase
	 */
	public viewtag: string = 'fed14324e88f2e47f5fb67c1192ba27f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavedetail.views.sjqjmx_gridview.caption',
        srfTitle: 'entities.vacleavedetail.views.sjqjmx_gridview.title',
        srfSubTitle: 'entities.vacleavedetail.views.sjqjmx_gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VACLEAVEDETAILSJQJMX_GridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vacleavedetailsjqjmx-edit-view', 
            height: 700, 
            width: 0,  
            title: this.$t('entities.vacleavedetail.views.sjqjmx_editview.title'),
        };
...
<style lang='less'>
@import './vacleavedetailsjqjmx-grid-view.less';
</style>