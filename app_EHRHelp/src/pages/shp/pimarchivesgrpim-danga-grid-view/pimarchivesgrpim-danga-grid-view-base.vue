<template>
  <app-layout viewName="pimarchivesgrpimdangagridview" viewTitle="档案信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchivesgrpim-danga-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESGRPimDangaGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESGRPimDangaGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesService}
     * @memberof PIMARCHIVESGRPimDangaGridViewBase
     */
	 ...
	 * @memberof PIMARCHIVESGRPimDangaGridViewBase
	 */
	public viewtag: string = '766f929bbf90b24ccc6802900ad5fab4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.grpimdangagridview.caption',
        srfTitle: 'entities.pimarchives.views.grpimdangagridview.title',
        srfSubTitle: 'entities.pimarchives.views.grpimdangagridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESGRPimDangaGridView
     */
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"PimArchives");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.pimarchives;
        if(args.length >0){
        ...
        const view: any = {
            viewname: 'pimarchivesedit-view', 
            height: 0, 
            width: 1366,  
            title: this.$t('entities.pimarchives.views.editview.title'),
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimarchives: args[0].pimarchives })
            }
...
<style lang='less'>
@import './pimarchivesgrpim-danga-grid-view.less';
</style>