<template>
  <app-layout viewName="vacleavedetailsjqjmx_editview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vacleavedetailsjqjmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class VACLEAVEDETAILSJQJMX_EditViewBase extends EditViewBase {
	 ...
	 * @memberof VACLEAVEDETAILSJQJMX_EditViewBase
	 */
	public viewtag: string = '14f8499b1252ace2a37fbc566e81bd29';
...
<style lang='less'>
@import './vacleavedetailsjqjmx-edit-view.less';
</style>