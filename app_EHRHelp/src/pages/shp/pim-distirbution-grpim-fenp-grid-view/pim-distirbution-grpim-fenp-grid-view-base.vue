<template>
  <app-layout viewName="pimdistirbutiongrpimfenpgridview" viewTitle="分配信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pim-distirbution-grpim-fenp-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionGRPImFenpGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionGRPImFenpGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof PimDistirbutionGRPImFenpGridViewBase
     */
	 ...
	 * @memberof PimDistirbutionGRPImFenpGridViewBase
	 */
	public viewtag: string = '4bfac398a112a783a48db95e77335987';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.grpimfenpgridview.caption',
        srfTitle: 'entities.pimdistirbution.views.grpimfenpgridview.title',
        srfSubTitle: 'entities.pimdistirbution.views.grpimfenpgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionGRPImFenpGridView
     */
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'pim-distirbution-grdivider-edit-view', 
            height: 0, 
            width: 0,  
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimdistirbution: args[0].pimdistirbution })
            }
...
<style lang='less'>
@import './pim-distirbution-grpim-fenp-grid-view.less';
</style>