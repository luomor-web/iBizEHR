<template>
  <app-layout viewName="pimresearchfindingsgrresearchgridview" viewTitle="科研成果表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimresearchfindingsgrresearchgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMRESEARCHFINDINGSGRRESEARCHGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMRESEARCHFINDINGSGRRESEARCHGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMRESEARCHFINDINGSGRRESEARCHGridViewBase
	 */
	public viewtag: string = 'bfcf94c7a9b500349ebc8ba0beb70159';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimresearchfindings.views.grresearchgridview.caption',
        srfTitle: 'entities.pimresearchfindings.views.grresearchgridview.title',
        srfSubTitle: 'entities.pimresearchfindings.views.grresearchgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMRESEARCHFINDINGSGRRESEARCHGridView
     */
...
<style lang='less'>
@import './pimresearchfindingsgrresearchgrid-view.less';
</style>