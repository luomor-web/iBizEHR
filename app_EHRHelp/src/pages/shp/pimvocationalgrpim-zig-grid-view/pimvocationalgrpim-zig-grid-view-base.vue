<template>
  <app-layout viewName="pimvocationalgrpimziggridview" viewTitle="证书信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimvocationalgrpim-zig-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMVOCATIONALGRPimZigGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMVOCATIONALGRPimZigGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimVocationalService}
     * @memberof PIMVOCATIONALGRPimZigGridViewBase
     */
	 ...
	 * @memberof PIMVOCATIONALGRPimZigGridViewBase
	 */
	public viewtag: string = '8dad9b1569e0c57b455b03c77c6030d0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimvocational.views.grpimziggridview.caption',
        srfTitle: 'entities.pimvocational.views.grpimziggridview.title',
        srfSubTitle: 'entities.pimvocational.views.grpimziggridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMVOCATIONALGRPimZigGridView
     */
...
<style lang='less'>
@import './pimvocationalgrpim-zig-grid-view.less';
</style>