<template>
  <app-layout viewName="pimrewardpunishmentgrpimjanglgridview" viewTitle="奖励惩罚表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimrewardpunishmentgrpim-jangl-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMREWARDPUNISHMENTGRPimJanglGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMREWARDPUNISHMENTGRPimJanglGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMREWARDPUNISHMENTGRPimJanglGridViewBase
	 */
	public viewtag: string = '101f36644e505d91300c1d0f914a6fb3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimrewardpunishment.views.grpimjanglgridview.caption',
        srfTitle: 'entities.pimrewardpunishment.views.grpimjanglgridview.title',
        srfSubTitle: 'entities.pimrewardpunishment.views.grpimjanglgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMREWARDPUNISHMENTGRPimJanglGridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimrewardpunishment;
        if(args.length >0){
...
<style lang='less'>
@import './pimrewardpunishmentgrpim-jangl-grid-view.less';
</style>