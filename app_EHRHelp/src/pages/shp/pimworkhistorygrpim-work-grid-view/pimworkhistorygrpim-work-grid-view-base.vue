<template>
  <app-layout viewName="pimworkhistorygrpimworkgridview" viewTitle="工作履历表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimworkhistorygrpim-work-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMWORKHISTORYGRPimWorkGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMWORKHISTORYGRPimWorkGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimWorkHistoryService}
     * @memberof PIMWORKHISTORYGRPimWorkGridViewBase
     */
	 ...
	 * @memberof PIMWORKHISTORYGRPimWorkGridViewBase
	 */
	public viewtag: string = 'a27997a7ab6cfbcecdeb079e81422d1f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimworkhistory.views.grpimworkgridview.caption',
        srfTitle: 'entities.pimworkhistory.views.grpimworkgridview.title',
        srfSubTitle: 'entities.pimworkhistory.views.grpimworkgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMWORKHISTORYGRPimWorkGridView
     */
...
<style lang='less'>
@import './pimworkhistorygrpim-work-grid-view.less';
</style>