<template>
  <app-layout viewName="pimtitlegrpimzhicgridview" viewTitle="职称信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimtitlegrpim-zhic-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTITLEGRPimZhicGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLEGRPimZhicGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMTITLEService}
     * @memberof PIMTITLEGRPimZhicGridViewBase
     */
	 ...
	 * @memberof PIMTITLEGRPimZhicGridViewBase
	 */
	public viewtag: string = '57ec9f3986f46390ea3a5758a56efbf9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitle.views.grpimzhicgridview.caption',
        srfTitle: 'entities.pimtitle.views.grpimzhicgridview.title',
        srfSubTitle: 'entities.pimtitle.views.grpimzhicgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMTITLEGRPimZhicGridView
     */
...
<style lang='less'>
@import './pimtitlegrpim-zhic-grid-view.less';
</style>