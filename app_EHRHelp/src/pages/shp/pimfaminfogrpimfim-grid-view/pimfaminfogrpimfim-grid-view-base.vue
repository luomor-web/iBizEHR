<template>
  <app-layout viewName="pimfaminfogrpimfimgridview" viewTitle="家庭情况表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimfaminfogrpimfim-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMFAMINFOGRPimfimGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMFAMINFOGRPimfimGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimFaminfoService}
     * @memberof PIMFAMINFOGRPimfimGridViewBase
     */
	 ...
	 * @memberof PIMFAMINFOGRPimfimGridViewBase
	 */
	public viewtag: string = '3314b53b31b1a65581eb64c278b11166';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimfaminfo.views.grpimfimgridview.caption',
        srfTitle: 'entities.pimfaminfo.views.grpimfimgridview.title',
        srfSubTitle: 'entities.pimfaminfo.views.grpimfimgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMFAMINFOGRPimfimGridView
     */
...
<style lang='less'>
@import './pimfaminfogrpimfim-grid-view.less';
</style>