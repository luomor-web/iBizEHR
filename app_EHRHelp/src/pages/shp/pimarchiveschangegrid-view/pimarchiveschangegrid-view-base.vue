 ...
 *
 * @export
 * @class PIMARCHIVESCHANGEGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESCHANGEGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARCHIVESCHANGEGridViewBase
	 */
	public viewtag: string = '50c4c9e1e32c2f7c8f8b9fa44c2d39ce';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchiveschange.views.gridview.caption',
        srfTitle: 'entities.pimarchiveschange.views.gridview.title',
        srfSubTitle: 'entities.pimarchiveschange.views.gridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimarchiveschangegrid-view.less';
</style>