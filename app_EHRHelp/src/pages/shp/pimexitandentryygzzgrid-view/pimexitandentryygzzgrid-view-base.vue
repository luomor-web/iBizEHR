<template>
  <app-layout viewName="pimexitandentryygzzgridview" viewTitle="出入境管理实体表格视图（员工自助）" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimexitandentryygzzgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEXITANDENTRYYGZZGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXITANDENTRYYGZZGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PIMEXITANDENTRYService}
     * @memberof PIMEXITANDENTRYYGZZGridViewBase
     */
	 ...
	 * @memberof PIMEXITANDENTRYYGZZGridViewBase
	 */
	public viewtag: string = '71745cf2abffaef1c6df14d241ffb2d8';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexitandentry.views.ygzzgridview.caption',
        srfTitle: 'entities.pimexitandentry.views.ygzzgridview.title',
        srfSubTitle: 'entities.pimexitandentry.views.ygzzgridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        tbitem1_newgr: { name: 'tbitem1_newgr', caption: '新建','isShowCaption':true,'isShowIcon':true, tooltip: '新建', iconcls: 'fa fa-file-text-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'newGR', target: 'NONE' }, class: '' },
    ...
    public toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'tbitem1_newgr')) {
            this.toolbar_tbitem1_newgr_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_tbitem1_newgr_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PIMEXITANDENTRY_newGR(datas,contextJO, paramJO,  $event, xData,this,"PIMEXITANDENTRY");
    }
...
<style lang='less'>
@import './pimexitandentryygzzgrid-view.less';
</style>