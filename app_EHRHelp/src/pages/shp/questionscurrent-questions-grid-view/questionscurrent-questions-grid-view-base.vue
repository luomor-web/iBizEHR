...
export default class QUESTIONSCurrentQuestionsGridViewBase extends GridViewBase {
     ...
     */
    public model: any = {
        srfCaption: 'entities.questions.views.currentquestionsgridview.caption',
        srfTitle: 'entities.questions.views.currentquestionsgridview.title',
        srfSubTitle: 'entities.questions.views.currentquestionsgridview.subtitle',
        dataInfo: ''
    }
