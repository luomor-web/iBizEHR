<template>
  <app-layout viewName="pimlanguageabilitygryynlgridview" viewTitle="语言能力表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimlanguageabilitygryynlgrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
import PimLanguageAbilityUIService from '@/uiservice/pim-language-ability/pim-language-ability-ui-service';
 ...
 *
 * @export
 * @class PIMLANGUAGEABILITYGRYYNLGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLANGUAGEABILITYGRYYNLGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMLANGUAGEABILITYGRYYNLGridViewBase
	 */
	public viewtag: string = 'cd0b6c276c4cb5a0d32d1ffa5d4c3852';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlanguageability.views.gryynlgridview.caption',
        srfTitle: 'entities.pimlanguageability.views.gryynlgridview.title',
        srfSubTitle: 'entities.pimlanguageability.views.gryynlgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMLANGUAGEABILITYGRYYNLGridView
     */
    public toolBarModels: any = {
        tbitem1_custremove: { name: 'tbitem1_custremove', caption: '删除','isShowCaption':true,'isShowIcon':true, tooltip: '删除', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'CustRemove', target: 'SINGLEKEY' }, class: '' },
 ...
 tbitem13: { name: 'tbitem13', caption: '导出数据','isShowCaption':true,'isShowIcon':true, tooltip: '导出数据', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
     ...
     * @memberof 
     */
    public toolbar_tbitem1_custremove_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.PimLanguageAbility_CustRemove(datas,contextJO, paramJO,  $event, xData,this,"PimLanguageAbility");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimlanguageability;
        if(args.length >0){
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimlanguageability: args[0].pimlanguageability })
            }
...
<style lang='less'>
@import './pimlanguageabilitygryynlgrid-view.less';
</style>