<template>
  <app-layout viewName="pimdistirbutiongrdividereditview" viewTitle="分配信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimdistirbutiongrdivider-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
<style lang='less'>
@import './pimdistirbutiongrdivider-edit-view.less';
</style>