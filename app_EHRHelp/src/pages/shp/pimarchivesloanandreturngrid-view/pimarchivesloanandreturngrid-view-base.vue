<template>
  <app-layout viewName="pimarchivesloanandreturngridview" viewTitle="借阅记录表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimarchivesloanandreturngrid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
    ...
    <template slot="headerRight">
      <div class="view-header-right">
        <app-header-menus :toolbarModel="toolBarModels" @menu-click="toolbar_click($event)" mode="view" :openMode="openMode" :isEnableQuickSearch="true" searchPlaceholder="请输入档案借阅及归还记录名称" v-model="query" @search="onSearch($event)"/>
      </div>
    </template>
 ...
 *
 * @export
 * @class PIMARCHIVESLOANANDRETURNGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESLOANANDRETURNGridViewBase extends GridViewBase {
	 ...
	 * @memberof PIMARCHIVESLOANANDRETURNGridViewBase
	 */
	public viewtag: string = 'a312b0a9771b834c87f8f0f328276d48';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchivesloanandreturn.views.gridview.caption',
        srfTitle: 'entities.pimarchivesloanandreturn.views.gridview.title',
        srfSubTitle: 'entities.pimarchivesloanandreturn.views.gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESLOANANDRETURNGridView
     */
 ...
 tbitem13: { name: 'tbitem13', caption: '导出数据','isShowCaption':true,'isShowIcon':true, tooltip: '导出数据', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 5000, class: '' },
    ...
    public toolbar2_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"PIMARCHIVESLOANANDRETURN");
    }
    ...
    public toolbar2_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAllEditRow(datas, contextJO,paramJO,  $event, xData,this,"PIMARCHIVESLOANANDRETURN");
    }
    ...
    public toolbar2_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.CloseRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMARCHIVESLOANANDRETURN");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PIMARCHIVESLOANANDRETURN");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        if(curViewParam.pimarchives && true){
            deResParameters = [
...
<style lang='less'>
@import './pimarchivesloanandreturngrid-view.less';
</style>