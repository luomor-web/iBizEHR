<template>
  <app-layout viewName="vacleavedetailsjqjmx_ck_gridview" viewTitle="请假明细" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'vacleavedetailsjqjmx-ck-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VACLEAVEDETAILSJQJMX_CK_GridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VACLEAVEDETAILSJQJMX_CK_GridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveDetailService}
     * @memberof VACLEAVEDETAILSJQJMX_CK_GridViewBase
     */
	 ...
	 * @memberof VACLEAVEDETAILSJQJMX_CK_GridViewBase
	 */
	public viewtag: string = 'edd151ee6faa6806d346d2a96d2dce5e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavedetail.views.sjqjmx_ck_gridview.caption',
        srfTitle: 'entities.vacleavedetail.views.sjqjmx_ck_gridview.title',
        srfSubTitle: 'entities.vacleavedetail.views.sjqjmx_ck_gridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VACLEAVEDETAILSJQJMX_CK_GridView
     */
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'vacleavedetailsjqjmx-ck-edit-view', 
            height: 700, 
            width: 0,  
            title: this.$t('entities.vacleavedetail.views.sjqjmx_ck_editview.title'),
        };
...
<style lang='less'>
@import './vacleavedetailsjqjmx-ck-grid-view.less';
</style>