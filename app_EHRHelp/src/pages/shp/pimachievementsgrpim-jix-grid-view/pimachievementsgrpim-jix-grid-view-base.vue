<template>
  <app-layout viewName="pimachievementsgrpimjixgridview" viewTitle="绩效信息表格视图" :className="{ 'view-container': true, 'default-mode-view': true, 'degridview': true, 'pimachievementsgrpim-jix-grid-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMACHIEVEMENTSGRPimJixGridViewBase
 * @extends {GridViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMACHIEVEMENTSGRPimJixGridViewBase extends GridViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimAchievementsService}
     * @memberof PIMACHIEVEMENTSGRPimJixGridViewBase
     */
	 ...
	 * @memberof PIMACHIEVEMENTSGRPimJixGridViewBase
	 */
	public viewtag: string = '13c485c96cbc38055b4a81363aad8049';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimachievements.views.grpimjixgridview.caption',
        srfTitle: 'entities.pimachievements.views.grpimjixgridview.title',
        srfSubTitle: 'entities.pimachievements.views.grpimjixgridview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMACHIEVEMENTSGRPimJixGridView
     */
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"PimAchievements");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.OpenRowEdit(datas, contextJO,paramJO,  $event, xData,this,"PimAchievements");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.pimachievements;
        if(args.length >0){
    ...
    public View(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { pimachievements: args[0].pimachievements })
            }
...
<style lang='less'>
@import './pimachievementsgrpim-jix-grid-view.less';
</style>