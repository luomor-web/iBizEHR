...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrhelp\/trmtrainplanterms\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: getwflink");
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrhelp\/trmtrainplanterms\/process-definitions-nodes$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: getwfstep");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// createBatch
mock.onPost(new RegExp(/^\/trmtrainplanterms\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: createBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// updateBatch
mock.onPut(new RegExp(/^\/trmtrainplanterms\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: updateBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// removeBatch
mock.onDelete(new RegExp(/^\/trmtrainplanterms\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: removeBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// Select
mock.onGet(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    ...
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
...
// Select
mock.onGet(new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: Select");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
mock.onPost(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['trmtrainagencyid','trmtrainteacherid','trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// CheckKey
mock.onPost(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
    ...
    mockDatas.forEach((item)=>{
        if(item['trmtrainplantermid'] == tempValue['trmtrainplantermid'] ){
...
// Update
mock.onPut(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['trmtrainagencyid','trmtrainteacherid','trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Update
mock.onPut(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: Update");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Save
mock.onPost(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/save$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['trmtrainagencyid','trmtrainteacherid','trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/save$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Save
mock.onPost(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})\/save$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: Save");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/save$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// GetDraft
mock.onGet(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/getdraft$/)).reply((config: any) => {
...
// GetDraft
mock.onGet(new RegExp(/^\/trmtrainplanterms\/getdraft$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: GetDraft");
    console.table({url:config.url, method: config.method, data:config.data});
    // GetDraft
    let status = MockAdapter.mockStatus(config);
...
// KB
mock.onPost(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/kb$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['trmtrainagencyid','trmtrainteacherid','trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/kb$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// KB
mock.onPost(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})\/kb$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: KB");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/kb$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Create
mock.onPost(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
...
// Create
mock.onPost(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: Create");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// QX
mock.onPost(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/qx$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['trmtrainagencyid','trmtrainteacherid','trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/qx$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// QX
mock.onPost(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})\/qx$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: QX");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/qx$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// LX
mock.onPost(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/lx$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['trmtrainagencyid','trmtrainteacherid','trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/lx$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// LX
mock.onPost(new RegExp(/^\/trmtrainplanterms\/?([a-zA-Z0-9\-\;]{0,35})\/lx$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: LX");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['trmtrainplantermid'];
    const matchArray:any = new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})\/lx$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// FetchDefault
mock.onGet(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/fetchdefault$/)).reply((config: any) => {
    ...
    let tempValue: any = {};
    const matchArray:any = new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/fetchdefault$/).exec(config.url);
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
                enumerable: true,
...
// FetchDefault
mock.onGet(new RegExp(/^\/trmtrainplanterms\/fetchdefault$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: FetchDefault");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// FetchDefault
mock.onGet(new RegExp(/^\/trmtrainplanterms\/fetchdefault(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: FetchDefault");
    console.table({url:config.url, method: config.method, data:config.data});
...
// Get
mock.onGet(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
...
// Get
mock.onGet(new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: Get");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// Remove
mock.onDelete(new RegExp(/^\/trmtrainagencies\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainteachers\/([a-zA-Z0-9\-\;]{1,35})\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
...
// Remove
mock.onDelete(new RegExp(/^\/trmtrainplanterms\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:trmtrainplanterm 方法: Remove");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
