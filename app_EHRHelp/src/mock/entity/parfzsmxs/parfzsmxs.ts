...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrhelp\/parfzsmxes\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: getwflink");
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ehr-app-ehrhelp\/parfzsmxes\/process-definitions-nodes$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: getwfstep");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// createBatch
mock.onPost(new RegExp(/^\/parfzsmxes\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: createBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// updateBatch
mock.onPut(new RegExp(/^\/parfzsmxes\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: updateBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// removeBatch
mock.onDelete(new RegExp(/^\/parfzsmxes\/batch$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: removeBatch");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
mock.onGet(new RegExp(/^\/parfzsmxes\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    ...
    const matchArray:any = new RegExp(/^\/parfzsmxes\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Update
mock.onPut(new RegExp(/^\/parfzsmxes\/?([a-zA-Z0-9\-\;]{0,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: Update");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    mockDatas.forEach((item)=>{
        if(item['parfzsmxid'] == tempValue['parfzsmxid'] ){
...
// CheckKey
mock.onPost(new RegExp(/^\/parfzsmxes\/?([a-zA-Z0-9\-\;]{0,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['parfzsmxid'];
    const matchArray:any = new RegExp(/^\/parfzsmxes\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
mock.onPost(new RegExp(/^\/parfzsmxes\/?([a-zA-Z0-9\-\;]{0,35})\/save$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['parfzsmxid'];
    const matchArray:any = new RegExp(/^\/parfzsmxes\/([a-zA-Z0-9\-\;]{1,35})\/save$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// FetchDefault
mock.onGet(new RegExp(/^\/parfzsmxes\/fetchdefault$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: FetchDefault");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// FetchDefault
mock.onGet(new RegExp(/^\/parfzsmxes\/fetchdefault(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: FetchDefault");
    console.table({url:config.url, method: config.method, data:config.data});
...
// Get
mock.onGet(new RegExp(/^\/parfzsmxes\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:parfzsmx 方法: Get");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
